...
- The Railgun damage oracle is exact and modifier-free: `base=50`, `minimum=50`, `falloffStartM=512`, `falloffEndM=512`, `headMultiplier=1`, and `limbMultiplier=1`. Runtime authority may honestly clamp `damageApplied` to remaining health, but every admitted target outcome retains `damageRequested=50`; critical, headshot, limb, range, penetration and temporary-buff paths cannot alter it.
