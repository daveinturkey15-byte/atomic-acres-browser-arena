...
- Death lifecycle: death resets per-life streak progress and earned-this-life markers, but never deletes an earned unconsumed reward. Retain that reward through any number of respawns until exactly-once consumption or match-epoch reset.
