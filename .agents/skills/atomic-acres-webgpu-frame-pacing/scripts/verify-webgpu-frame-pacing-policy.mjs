...
export function auditRepositorySources(sources = readRepositorySources()) {
  ...
  // Pass 68 moved authored arena construction into admission. Freeze the
  // resulting SwiftShader-safe CI bounds without changing any native hardware
  // frame-tail or presentation threshold.
  requireText(genericStartSolo, '{ timeout: 60_000 }', 'frozen generic startSolo timeout', failures);
