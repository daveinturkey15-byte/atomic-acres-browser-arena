...
describe('railgun presentation', () => {
  ...
  it('creates no pawn/DOM proxy and binds compatibility telemetry to actual shared reveal layers', () => {
    ...
    expect(presentation.telemetry()).toMatchObject({
      ...
      exactModelDepthTestDisabled: true,
      exactModelDepthWriteDisabled: true,
      exactHaloVisible: true,
      exactHaloColorWrite: true,
      exactHaloOpacity: 0.88,
      exactHaloDepthTestDisabled: true,
      exactHaloDepthWriteDisabled: true,
      orangeHalo: true,
    ...
    presentation.syncExactOperatorReveal(true, {
      ...
      exactModelVisible: true, exactModelColorWrite: true, exactModelOpacity: 1,
      exactModelDepthTestDisabled: true, exactModelDepthWriteDisabled: true,
      haloVisible: true, haloColorWrite: true, haloOpacity: 0.88,
