const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./main-HQ9ozyma.js","./preload-helper-d_geVdlX.js","./release-identity-BoQhyZ_A.js","./style-DakOjq2P.css"])))=>i.map(i=>d[i]);
import { n as PENDING_PRODUCTION_RELEASE, s as release_channels_default, t as CHANGELOG } from "./changelog-2L-416DW.js";
/* empty css               */
...
var stableFallback = releaseChannels.pass73Retained ?? releaseChannels.stable;
var newestBuildIsPublished = CHANGELOG[0]?.releasedAt !== PENDING_PRODUCTION_RELEASE;
var latestDescription = newestBuildIsPublished ? releaseChannels.latest.description : `${releaseChannels.latest.description} Local HITL candidate - not yet published.`;
...
async function loadLatestBuild() {
	...
	app.replaceChildren();
	await __vitePreload(() => import("./main-HQ9ozyma.js"), __vite__mapDeps([0,1,2,3]), import.meta.url);
}
