import { $c as Matrix4, Ba as Box3, Cu as RGBAFormat, Dd as Shape, Fc as LinearMipmapLinearFilter, Fs as Group, Ga as BufferGeometry, Ha as BoxGeometry, If as Vector3, Ld as SphereGeometry, Od as ShapeGeometry, Po as CylinderGeometry, Qa as CapsuleGeometry, Ro as DataTexture, Rs as HemisphereLight, Sd as SRGBColorSpace, Vd as SpotLight, Xc as MathUtils, Ys as InstancedMesh, Za as CanvasTexture, _s as Float32BufferAttribute, ds as Euler, ff as TorusGeometry, fo as ConeGeometry, i as mergeGeometries, jc as LinearFilter, md as RepeatWrapping, ms as ExtrudeGeometry, mu as Quaternion, nl as MeshBasicMaterial, ru as PointLight, tl as Mesh, tu as PlaneGeometry, ul as MeshStandardMaterial } from "./vendor-three-aHPbjK02.js";
import { $r as applyBotEmissiveBrightness, E as movementProfile, H as poseOperator, Ot as WEAPON_IDS, P as buildOperator, Qn as PASS65_KILLSTREAK_CATALOG, o as WEAPONS } from "./gameplay-CLjw_XSX.js";
...
function buildRustworks1v1(scene) {
	...
	box(builder, "rustworks-lower-deck", [
		...
		deckThickness,
		lowerDeckSize
	], grate, { ballisticMaterial: "structural-metal" });
	box(builder, "rustworks-upper-deck", [
		...
		deckThickness,
		upperDeckSize
	], rust, { ballisticMaterial: "structural-metal" });
	...
	box(builder, "rustworks-lower-ramp-foot-pad", [
		...
		.16,
		1.6
	], concrete, { ballisticMaterial: "concrete" });
	...
	for (const x of trenchWallXs) for (const z of trenchSegments) {
		const wall = box(builder, "rustworks-service-trench-wall", [
			...
			1.3,
			7
		], concreteDark, { ballisticMaterial: "concrete" });
	...
	for (const [index, placement] of containerRows.entries()) {
		...
		if (placement.opening !== "closed") {
			...
			for (const part of shellParts) {
				const shell = box(builder, `rustworks-open-container-${part.suffix}`, part.position, part.size, material, { ballisticMaterial: "container" });
			...
			if (placement.opening === "open-one") {
				...
				const end = box(builder, "rustworks-open-one-container-closed-end", alongX ? [
					...
					containerSize[1],
					endThickness
				], material, { ballisticMaterial: "container" });
...
//#endregion
export { projectGunRangeTestBayDoorState as C, auditLocalLightOcclusion as D, nearestGunRangeWeaponStation as E, makeEmissiveOnly as O, nearestGunRangeTestBayWeaponStation as S, GUN_RANGE_WEAPON_STATIONS as T, advanceGunRangeTestBayDoorForObservers as _, applyGunRangeTestBayDoorState as a, gunRangeTestBayRenderedDummyPose as b, box as c, buildSkylineTerminal as d, emptyTelemetry as f, GUN_RANGE_TEST_BAY_CONTRACT as g, updateGunRangePresentation as h, applyAdditionalMapPresentationProfile as i, makeShadowedLocal as k, buildGunRange as l, standard as m, RUSTWORKS_CONTAINER_LIGHTS as n, applyRustworksPresentationProfile as o, spawnRecord as p, RUSTWORKS_WORK_LIGHTS as r, batchPresentationOnlyBoxes as s, GUN_RANGE_FIRING_LINE_Z as t, buildRustworks1v1 as u, createGunRangeTestBayDoorState as v, resolveGunRangeDummyDamage as w, nearestGunRangeTestBaySupportStation as x, gunRangeTestBayDummyPose as y };
