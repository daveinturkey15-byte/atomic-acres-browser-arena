const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./main-CEpkneO5.js","./preload-helper-d_geVdlX.js","./release-identity-BoQhyZ_A.js","./style-DakOjq2P.css"])))=>i.map(i=>d[i]);
...
async function loadLatestBuild() {
	...
	app.replaceChildren();
	await __vitePreload(() => import("./main-CEpkneO5.js"), __vite__mapDeps([0,1,2,3]), import.meta.url);
}
