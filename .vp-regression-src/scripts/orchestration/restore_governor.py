#!/usr/bin/env python3
"""Give the machine back when the owner's ComfyUI window closes (currently 18:15).
...
for a, b in [("RESERVE_GB = 11.0  # 18:15 window: owner needs ~9 GB for ComfyUI", "RESERVE_GB = 5.5"),
             ("BROWSER_SLOTS = 1  # 18:15 window", "BROWSER_SLOTS = 2"),
             ("VERIFY_SLOTS = 1  # 18:15 window; vitest peaks at 5.63 GB", "VERIFY_SLOTS = 2")]:
    s = s.replace(a, b, 1)
