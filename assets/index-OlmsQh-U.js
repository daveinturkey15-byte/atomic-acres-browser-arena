...
s=-\r
t=0 0\r
`},n.getDirection=function(e,t){let r=n.splitLines(e);for(let e=0;e<r.length;e++)switch(r[e]){case`a=sendrecv`:case`a=sendonly`:case`a=recvonly`:case`a=inactive`:return r[e].substring(2);default:}return t?n.getDirection(t):`sendrecv`},n.getKind=function(e){return n.splitLines(e)[0].split(` `)[0].substring(2)},n.isRejected=function(e){return e.split(` `,2)[1]===`0`},n.parseMLine=function(e){let t=n.splitLines(e)[0].substring(2).split(` `);return{kind:t[0],port:parseInt(t[1],10),protocol:t[2],fmt:t.slice(3).join(` `)}},n.parseOLine=function(e){let t=n.matchPrefix(e,`o=`)[0].substring(2).split(` `);return{username:t[0],sessionId:t[1],sessionVersion:parseInt(t[2],10),netType:t[3],addressType:t[4],address:t[5]}},n.isValidSDP=function(e){if(typeof e!=`string`||e.length===0)return!1;let t=n.splitLines(e);for(let e=0;e<t.length;e++)if(t[e].length<2||t[e].charAt(1)!==`=`)return!1;return!0},typeof t==`object`&&(t.exports=n)})),Tp=s({removeExtmapAllowMixed:()=>Mp,shimAddIceCandidateNullOrEmpty:()=>Np,shimConnectionState:()=>jp,shimMaxMessageSize:()=>kp,shimParameterlessSetLocalDescription:()=>Pp,shimRTCIceCandidate:()=>Dp,shimRTCIceCandidateRelayProtocol:()=>Op,shimSendThrowTypeError:()=>Ap}),Ep=l(wp());function Dp(e){if(!e.RTCIceCandidate||e.RTCIceCandidate&&`foundation`in e.RTCIceCandidate.prototype)return;let t=e.RTCIceCandidate;e.RTCIceCandidate=function(e){if(typeof e==`object`&&e.candidate&&e.candidate.indexOf(`a=`)===0&&(e=JSON.parse(JSON.stringify(e)),e.candidate=e.candidate.substring(2)),e.candidate&&e.candidate.length){let n=new t(e),r=Ep.default.parseCandidate(e.candidate);for(let e in r)e in n||Object.defineProperty(n,e,{value:r[e]});return n.toJSON=function(){return{candidate:n.candidate,sdpMid:n.sdpMid,sdpMLineIndex:n.sdpMLineIndex,usernameFragment:n.usernameFragment}},n}return new t(e)},e.RTCIceCandidate.prototype=t.prototype,Nf(e,`icecandidate`,t=>(t.candidate&&Object.defineProperty(t,"candidate",{value:new e.RTCIceCandidate(t.candidate),writable:`false`}),t))}function Op(e){!e.RTCIceCandidate||e.RTCIceCandidate&&`relayProtocol`in e.RTCIceCandidate.prototype||Nf(e,`icecandidate`,e=>{if(e.candidate){let t=Ep.default.parseCandidate(e.candidate.candidate);t.type===`relay`&&(e.candidate.relayProtocol={0:`tls`,1:`tcp`,2:`udp`}[t.priority>>24])}return e})}function kp(e,t){if(!e.RTCPeerConnection||t.browser===`chrome`&&t.version>102||t.browser===`firefox`&&t.version>=113)return;`sctp`in e.RTCPeerConnection.prototype||Object.defineProperty(e.RTCPeerConnection.prototype,"sctp",{get(){return this._sctp===void 0?null:this._sctp}});let n=function(e){if(!e||!e.sdp)return!1;let t=Ep.default.splitSections(e.sdp);return t.shift(),t.some(e=>{let t=Ep.default.parseMLine(e);return t&&t.kind===`application`&&t.protocol.indexOf(`SCTP`)!==-1})},r=function(e){let t=e.sdp.match(/mozilla...THIS_IS_SDPARTA-(\d+)/);if(t===null||t.length<2)return-1;let n=parseInt(t[1],10);return n===n?n:-1},i=function(e){let n=65536;return t.browser===`firefox`&&(n=t.version<57?e===-1?16384:2147483637:t.version<60?t.version===57?65535:65536:2147483637),n},a=function(e,n){let r=65536;t.browser===`firefox`&&t.version===57&&(r=65535);let i=Ep.default.matchPrefix(e.sdp,`a=max-message-size:`);return i.length>0?r=parseInt(i[0].substring(19),10):t.browser===`firefox`&&n!==-1&&(r=2147483637),r},o=e.RTCPeerConnection.prototype.setRemoteDescription;e.RTCPeerConnection.prototype.setRemoteDescription=function(){if(this._sctp=null,t.browser===`chrome`&&t.version>=76){let{sdpSemantics:e}=this.getConfiguration();e===`plan-b`&&Object.defineProperty(this,"sctp",{get(){return this._sctp===void 0?null:this._sctp},enumerable:!0,configurable:!0})}if(n(arguments[0])){let e=r(arguments[0]),t=i(e),n=a(arguments[0],e),o;o=t===0&&n===0?1/0:t===0||n===0?Math.max(t,n):Math.min(t,n);let s={};Object.defineProperty(s,"maxMessageSize",{get(){return o}}),this._sctp=s}return o.apply(this,arguments)}}function Ap(e,t){if(!(e.RTCPeerConnection&&`createDataChannel`in e.RTCPeerConnection.prototype)||t.browser===`chrome`&&t.version>=149||t.browser===`firefox`&&t.version>60)return;function n(e,t){let n=e.send;e.send=function(){let r=arguments[0],i=r.length||r.size||r.byteLength;if(e.readyState===`open`&&t.sctp&&i>t.sctp.maxMessageSize)throw TypeError(`Message too large (can send a maximum of `+t.sctp.maxMessageSize+` bytes)`);return n.apply(e,arguments)}}let r=e.RTCPeerConnection.prototype.createDataChannel;e.RTCPeerConnection.prototype.createDataChannel=function(){let e=r.apply(this,arguments);return n(e,this),e},Nf(e,`datachannel`,e=>(n(e.channel,e.target),e))}function jp(e){if(!e.RTCPeerConnection||`connectionState`in e.RTCPeerConnection.prototype)return;let t=e.RTCPeerConnection.prototype;Object.defineProperty(t,"connectionState",{get(){return{completed:`connected`,checking:`connecting`}[this.iceConnectionState]||this.iceConnectionState},enumerable:!0,configurable:!0}),Object.defineProperty(t,"onconnectionstatechange",{get(){return this._onconnectionstatechange||null},set(e){this._onconnectionstatechange&&(this.removeEventListener(`connectionstatechange`,this._onconnectionstatechange),delete this._onconnectionstatechange),e&&this.addEventListener(`connectionstatechange`,this._onconnectionstatechange=e)},enumerable:!0,configurable:!0}),[`setLocalDescription`,`setRemoteDescription`].forEach(e=>{let n=t[e];t[e]=function(){return this._connectionstatechangepoly||(this._connectionstatechangepoly=e=>{let t=e.target;if(t._lastConnectionState!==t.connectionState){t._lastConnectionState=t.connectionState;let n=new Event(`connectionstatechange`,e);t.dispatchEvent(n)}return e},this.addEventListener(`iceconnectionstatechange`,this._connectionstatechangepoly)),n.apply(this,arguments)}})}function Mp(e,t){if(!e.RTCPeerConnection||t.browser===`chrome`&&t.version>=71||t.browser===`safari`&&t._safariVersion>=13.1)return;let n=e.RTCPeerConnection.prototype.setRemoteDescription;e.RTCPeerConnection.prototype.setRemoteDescription=function(t){if(t&&t.sdp&&t.sdp.indexOf(`
a=extmap-allow-mixed`)!==-1){let n=t.sdp.split(`
`).filter(e=>e.trim()!==`a=extmap-allow-mixed`).join(`
`);e.RTCSessionDescription&&t instanceof e.RTCSessionDescription?arguments[0]=new e.RTCSessionDescription({type:t.type,sdp:n}):t.sdp=n}return n.apply(this,arguments)}}function Np(e,t){if(!(e.RTCPeerConnection&&e.RTCPeerConnection.prototype))return;let n=e.RTCPeerConnection.prototype.addIceCandidate;!n||n.length===0||(e.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?(t.browser===`chrome`&&t.version<78||t.browser===`firefox`&&t.version<68||t.browser===`safari`)&&arguments[0]&&arguments[0].candidate===``?Promise.resolve():n.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())})}function Pp(e,t){if(!(e.RTCPeerConnection&&e.RTCPeerConnection.prototype))return;let n=e.RTCPeerConnection.prototype.setLocalDescription;!n||n.length===0||(e.RTCPeerConnection.prototype.setLocalDescription=function(){let e=arguments[0]||{};if(typeof e!=`object`||e.type&&e.sdp)return n.apply(this,arguments);if(e={type:e.type,sdp:e.sdp},!e.type)switch(this.signalingState){case`stable`:case`have-local-offer`:case`have-remote-pranswer`:e.type=`offer`;break;default:e.type=`answer`;break}return e.sdp||e.type!==`offer`&&e.type!==`answer`?n.apply(this,[e]):(e.type===`offer`?this.createOffer:this.createAnswer).apply(this).then(e=>n.apply(this,[e]))})}function Fp({window:e}={},t={shimChrome:!0,shimFirefox:!0,shimSafari:!0}){let n=If,r=Rf(e),i={browserDetails:r,commonShim:Tp,extractVersion:Mf,disableLog:Pf,disableWarnings:Ff,sdp:Ep};switch(r.browser){case`chrome`:if(!Gf||!Qf||!t.shimChrome)return n(`Chrome shim is not included in this adapter release.`),i;if(r.version===null)return n(`Chrome shim can not determine version, not shimming.`),i;n(`adapter.js shimming chrome.`),i.browserShim=Gf,Np(e,r),Pp(e,r),Wf(e,r),Kf(e,r),Qf(e,r),qf(e,r),Zf(e,r),Jf(e,r),Yf(e,r),$f(e,r),Dp(e,r),Op(e,r),jp(e,r),kp(e,r),Ap(e,r),Mp(e,r);break;case`firefox`:if(!np||!ip||!t.shimFirefox)return n(`Firefox shim is not included in this adapter release.`),i;n(`adapter.js shimming firefox.`),i.browserShim=np,Np(e,r),Pp(e,r),ep(e,r),ip(e,r),ap(e,r),rp(e,r),cp(e,r),op(e,r),sp(e,r),lp(e,r),up(e,r),dp(e,r),fp(e,r),pp(e,r),Dp(e,r),jp(e,r),kp(e,r),Ap(e,r);break;case`safari`:if(!mp||!t.shimSafari)return n(`Safari shim is not included in this adapter release.`),i;n(`adapter.js shimming safari.`),i.browserShim=mp,Np(e,r),Pp(e,r),bp(e,r),Sp(e,r),_p(e,r),hp(e,r),gp(e,r),xp(e,r),vp(e,r),Cp(e,r),Dp(e,r),Op(e,r),kp(e,r),Ap(e,r),Mp(e,r);break;default:n(`Unsupported browser!`);break}return i}var Ip=Fp({window:typeof window>`u`?void 0:window});function Lp(e,t,n,r){Object.defineProperty(e,t,{get:n,set:r,enumerable:!0,configurable:!0})}var Rp=class{constructor(){this.chunkedMTU=16300,this._dataCount=1,this.chunk=e=>{let t=[],n=e.byteLength,r=Math.ceil(n/this.chunkedMTU),i=0,a=0;for(;a<n;){let o=Math.min(n,a+this.chunkedMTU),s=e.slice(a,o),c={__peerData:this._dataCount,n:i,data:s,total:r};t.push(c),a=o,i++}return this._dataCount++,t}}};function zp(e){let t=0;for(let n of e)t+=n.byteLength;let n=new Uint8Array(t),r=0;for(let t of e)n.set(t,r),r+=t.byteLength;return n}var Bp=Ip.default||Ip,Vp=new class{isWebRTCSupported(){return typeof RTCPeerConnection<`u`}isBrowserSupported(){let e=this.getBrowser(),t=this.getVersion();return this.supportedBrowsers.includes(e)?e===`chrome`?t>=this.minChromeVersion:e===`firefox`?t>=this.minFirefoxVersion:e===`safari`?!this.isIOS&&t>=this.minSafariVersion:!1:!1}getBrowser(){return Bp.browserDetails.browser}getVersion(){return Bp.browserDetails.version||0}isUnifiedPlanSupported(){let e=this.getBrowser(),t=Bp.browserDetails.version||0;if(e===`chrome`&&t<this.minChromeVersion)return!1;if(e===`firefox`&&t>=this.minFirefoxVersion)return!0;if(!window.RTCRtpTransceiver||!(`currentDirection`in RTCRtpTransceiver.prototype))return!1;let n,r=!1;try{n=new RTCPeerConnection,n.addTransceiver(`audio`),r=!0}catch{}finally{n&&n.close()}return r}toString(){return`Supports:
    browser:${this.getBrowser()}
    version:${this.getVersion()}
    isIOS:${this.isIOS}
    isWebRTCSupported:${this.isWebRTCSupported()}
    isBrowserSupported:${this.isBrowserSupported()}
    isUnifiedPlanSupported:${this.isUnifiedPlanSupported()}`}constructor(){this.isIOS=typeof navigator<`u`?[`iPad`,`iPhone`,`iPod`].includes(navigator.platform):!1,this.supportedBrowsers=[`firefox`,`chrome`,`safari`],this.minFirefoxVersion=59,this.minChromeVersion=72,this.minSafariVersion=605}},Hp=e=>!e||/^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(e),Up=()=>Math.random().toString(36).slice(2),Wp={iceServers:[{urls:`stun:stun.l.google.com:19302`},{urls:[`turn:eu-0.turn.peerjs.com:3478`,`turn:us-0.turn.peerjs.com:3478`],username:`peerjs`,credential:`peerjsp`}],sdpSemantics:`unified-plan`},Gp=new class extends Rp{noop(){}blobToArrayBuffer(e,t){let n=new FileReader;return n.onload=function(e){e.target&&t(e.target.result)},n.readAsArrayBuffer(e),n}binaryStringToArrayBuffer(e){let t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n)&255;return t.buffer}isSecure(){return location.protocol===`https:`}constructor(...e){super(...e),this.CLOUD_HOST=`0.peerjs.com`,this.CLOUD_PORT=443,this.chunkedBrowsers={Chrome:1,chrome:1},this.defaultConfig=Wp,this.browser=Vp.getBrowser(),this.browserVersion=Vp.getVersion(),this.pack=Df,this.unpack=Ef,this.supports=function(){let e={browser:Vp.isBrowserSupported(),webRTC:Vp.isWebRTCSupported(),audioVideo:!1,data:!1,binaryBlob:!1,reliable:!1};if(!e.webRTC)return e;let t;try{t=new RTCPeerConnection(Wp),e.audioVideo=!0;let n;try{n=t.createDataChannel(`_PEERJSTEST`,{ordered:!0}),e.data=!0,e.reliable=!!n.ordered;try{n.binaryType=`blob`,e.binaryBlob=!Vp.isIOS}catch{}}catch{}finally{n&&n.close()}}catch{}finally{t&&t.close()}return e}(),this.validateId=Hp,this.randomToken=Up}},Kp=`PeerJS: `,Z=new class{get logLevel(){return this._logLevel}set logLevel(e){this._logLevel=e}log(...e){this._logLevel>=3&&this._print(3,...e)}warn(...e){this._logLevel>=2&&this._print(2,...e)}error(...e){this._logLevel>=1&&this._print(1,...e)}setLogFunction(e){this._print=e}_print(e,...t){let n=[Kp,...t];for(let e in n)n[e]instanceof Error&&(n[e]=`(`+n[e].name+`) `+n[e].message);e>=3?console.log(...n):e>=2?console.warn(`WARNING`,...n):e>=1&&console.error(`ERROR`,...n)}constructor(){this._logLevel=0}},qp={},Jp=Object.prototype.hasOwnProperty,Yp=`~`;function Xp(){}Object.create&&(Xp.prototype=Object.create(null),new Xp().__proto__||(Yp=!1));function Zp(e,t,n){this.fn=e,this.context=t,this.once=n||!1}function Qp(e,t,n,r,i){if(typeof n!=`function`)throw TypeError(`The listener must be a function`);var a=new Zp(n,r||e,i),o=Yp?Yp+t:t;return e._events[o]?e._events[o].fn?e._events[o]=[e._events[o],a]:e._events[o].push(a):(e._events[o]=a,e._eventsCount++),e}function $p(e,t){--e._eventsCount===0?e._events=new Xp:delete e._events[t]}function em(){this._events=new Xp,this._eventsCount=0}em.prototype.eventNames=function(){var e=[],t,n;if(this._eventsCount===0)return e;for(n in t=this._events)Jp.call(t,n)&&e.push(Yp?n.slice(1):n);return Object.getOwnPropertySymbols?e.concat(Object.getOwnPropertySymbols(t)):e},em.prototype.listeners=function(e){var t=Yp?Yp+e:e,n=this._events[t];if(!n)return[];if(n.fn)return[n.fn];for(var r=0,i=n.length,a=Array(i);r<i;r++)a[r]=n[r].fn;return a},em.prototype.listenerCount=function(e){var t=Yp?Yp+e:e,n=this._events[t];return n?n.fn?1:n.length:0},em.prototype.emit=function(e,t,n,r,i,a){var o=Yp?Yp+e:e;if(!this._events[o])return!1;var s=this._events[o],c=arguments.length,l,u;if(s.fn){switch(s.once&&this.removeListener(e,s.fn,void 0,!0),c){case 1:return s.fn.call(s.context),!0;case 2:return s.fn.call(s.context,t),!0;case 3:return s.fn.call(s.context,t,n),!0;case 4:return s.fn.call(s.context,t,n,r),!0;case 5:return s.fn.call(s.context,t,n,r,i),!0;case 6:return s.fn.call(s.context,t,n,r,i,a),!0}for(u=1,l=Array(c-1);u<c;u++)l[u-1]=arguments[u];s.fn.apply(s.context,l)}else{var d=s.length,f;for(u=0;u<d;u++)switch(s[u].once&&this.removeListener(e,s[u].fn,void 0,!0),c){case 1:s[u].fn.call(s[u].context);break;case 2:s[u].fn.call(s[u].context,t);break;case 3:s[u].fn.call(s[u].context,t,n);break;case 4:s[u].fn.call(s[u].context,t,n,r);break;default:if(!l)for(f=1,l=Array(c-1);f<c;f++)l[f-1]=arguments[f];s[u].fn.apply(s[u].context,l)}}return!0},em.prototype.on=function(e,t,n){return Qp(this,e,t,n,!1)},em.prototype.once=function(e,t,n){return Qp(this,e,t,n,!0)},em.prototype.removeListener=function(e,t,n,r){var i=Yp?Yp+e:e;if(!this._events[i])return this;if(!t)return $p(this,i),this;var a=this._events[i];if(a.fn)a.fn===t&&(!r||a.once)&&(!n||a.context===n)&&$p(this,i);else{for(var o=0,s=[],c=a.length;o<c;o++)(a[o].fn!==t||r&&!a[o].once||n&&a[o].context!==n)&&s.push(a[o]);s.length?this._events[i]=s.length===1?s[0]:s:$p(this,i)}return this},em.prototype.removeAllListeners=function(e){var t;return e?(t=Yp?Yp+e:e,this._events[t]&&$p(this,t)):(this._events=new Xp,this._eventsCount=0),this},em.prototype.off=em.prototype.removeListener,em.prototype.addListener=em.prototype.on,em.prefixed=Yp,em.EventEmitter=em,qp=em;var tm={};Lp(tm,`ConnectionType`,()=>nm),Lp(tm,`PeerErrorType`,()=>rm),Lp(tm,`BaseConnectionErrorType`,()=>im),Lp(tm,`DataConnectionErrorType`,()=>am),Lp(tm,`SerializationType`,()=>om),Lp(tm,`SocketEventType`,()=>sm),Lp(tm,`ServerMessageType`,()=>cm);var nm=function(e){return e.Data=`data`,e.Media=`media`,e}({}),rm=function(e){return e.BrowserIncompatible=`browser-incompatible`,e.Disconnected=`disconnected`,e.InvalidID=`invalid-id`,e.InvalidKey=`invalid-key`,e.Network=`network`,e.PeerUnavailable=`peer-unavailable`,e.SslUnavailable=`ssl-unavailable`,e.ServerError=`server-error`,e.SocketError=`socket-error`,e.SocketClosed=`socket-closed`,e.UnavailableID=`unavailable-id`,e.WebRTC=`webrtc`,e}({}),im=function(e){return e.NegotiationFailed=`negotiation-failed`,e.ConnectionClosed=`connection-closed`,e}({}),am=function(e){return e.NotOpenYet=`not-open-yet`,e.MessageToBig=`message-too-big`,e}({}),om=function(e){return e.Binary=`binary`,e.BinaryUTF8=`binary-utf8`,e.JSON=`json`,e.None=`raw`,e}({}),sm=function(e){return e.Message=`message`,e.Disconnected=`disconnected`,e.Error=`error`,e.Close=`close`,e}({}),cm=function(e){return e.Heartbeat=`HEARTBEAT`,e.Candidate=`CANDIDATE`,e.Offer=`OFFER`,e.Answer=`ANSWER`,e.Open=`OPEN`,e.Error=`ERROR`,e.IdTaken=`ID-TAKEN`,e.InvalidKey=`INVALID-KEY`,e.Leave=`LEAVE`,e.Expire=`EXPIRE`,e}({}),lm=`1.5.5`,um=class extends qp.EventEmitter{constructor(e,t,n,r,i,a=5e3){super(),this.pingInterval=a,this._disconnected=!0,this._messagesQueue=[];let o=e?`wss://`:`ws://`;this._baseUrl=o+t+`:`+n+r+`peerjs?key=`+i}start(e,t){this._id=e;let n=`${this._baseUrl}&id=${e}&token=${t}`;this._socket||!this._disconnected||(this._socket=new WebSocket(n+`&version=1.5.5`),this._disconnected=!1,this._socket.onmessage=e=>{let t;try{t=JSON.parse(e.data),Z.log(`Server message received:`,t)}catch{Z.log(`Invalid server message`,e.data);return}this.emit(sm.Message,t)},this._socket.onclose=e=>{this._disconnected||(Z.log(`Socket closed.`,e),this._cleanup(),this._disconnected=!0,this.emit(sm.Disconnected))},this._socket.onopen=()=>{this._disconnected||(this._sendQueuedMessages(),Z.log(`Socket open`),this._scheduleHeartbeat())})}_scheduleHeartbeat(){this._wsPingTimer=setTimeout(()=>{this._sendHeartbeat()},this.pingInterval)}_sendHeartbeat(){if(!this._wsOpen()){Z.log(`Cannot send heartbeat, because socket closed`);return}let e=JSON.stringify({type:cm.Heartbeat});this._socket.send(e),this._scheduleHeartbeat()}_wsOpen(){return!!this._socket&&this._socket.readyState===1}_sendQueuedMessages(){let e=[...this._messagesQueue];this._messagesQueue=[];for(let t of e)this.send(t)}send(e){if(this._disconnected)return;if(!this._id){this._messagesQueue.push(e);return}if(!e.type){this.emit(sm.Error,`Invalid message`);return}if(!this._wsOpen())return;let t=JSON.stringify(e);this._socket.send(t)}close(){this._disconnected||=(this._cleanup(),!0)}_cleanup(){this._socket&&=(this._socket.onopen=this._socket.onmessage=this._socket.onclose=null,this._socket.close(),void 0),clearTimeout(this._wsPingTimer)}},dm=class{constructor(e){this.connection=e}startConnection(e){let t=this._startPeerConnection();if(this.connection.peerConnection=t,this.connection.type===nm.Media&&e._stream&&this._addTracksToConnection(e._stream,t),e.originator){let n=this.connection,r={ordered:!!e.reliable},i=t.createDataChannel(n.label,r);n._initializeDataChannel(i),this._makeOffer()}else this.handleSDP(`OFFER`,e.sdp)}_startPeerConnection(){Z.log(`Creating RTCPeerConnection.`);let e=new RTCPeerConnection(this.connection.provider.options.config);return this._setupListeners(e),e}_setupListeners(e){let t=this.connection.peer,n=this.connection.connectionId,r=this.connection.type,i=this.connection.provider;Z.log(`Listening for ICE candidates.`),e.onicecandidate=e=>{!e.candidate||!e.candidate.candidate||(Z.log(`Received ICE candidates for ${t}:`,e.candidate),i.socket.send({type:cm.Candidate,payload:{candidate:e.candidate,type:r,connectionId:n},dst:t}))},e.oniceconnectionstatechange=()=>{switch(e.iceConnectionState){case`failed`:Z.log(`iceConnectionState is failed, closing connections to `+t),this.connection.emitError(im.NegotiationFailed,`Negotiation of connection to `+t+` failed.`),this.connection.close();break;case`closed`:Z.log(`iceConnectionState is closed, closing connections to `+t),this.connection.emitError(im.ConnectionClosed,`Connection to `+t+` closed.`),this.connection.close();break;case`disconnected`:Z.log(`iceConnectionState changed to disconnected on the connection with `+t);break;case`completed`:e.onicecandidate=()=>{};break}this.connection.emit(`iceStateChanged`,e.iceConnectionState)},Z.log(`Listening for data channel`),e.ondatachannel=e=>{Z.log(`Received data channel`);let r=e.channel;i.getConnection(t,n)._initializeDataChannel(r)},Z.log(`Listening for remote stream`),e.ontrack=e=>{Z.log(`Received remote stream`);let r=e.streams[0],a=i.getConnection(t,n);if(a.type===nm.Media){let e=a;this._addStreamToMediaConnection(r,e)}}}cleanup(){Z.log(`Cleaning up PeerConnection to `+this.connection.peer);let e=this.connection.peerConnection;if(!e)return;this.connection.peerConnection=null,e.onicecandidate=e.oniceconnectionstatechange=e.ondatachannel=e.ontrack=()=>{};let t=e.signalingState!==`closed`,n=!1,r=this.connection.dataChannel;r&&(n=!!r.readyState&&r.readyState!==`closed`),(t||n)&&e.close()}async _makeOffer(){let e=this.connection.peerConnection,t=this.connection.provider;try{let n=await e.createOffer(this.connection.options.constraints);Z.log(`Created offer.`),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform==`function`&&(n.sdp=this.connection.options.sdpTransform(n.sdp)||n.sdp);try{await e.setLocalDescription(n),Z.log(`Set localDescription:`,n,`for:${this.connection.peer}`);let r={sdp:n,type:this.connection.type,connectionId:this.connection.connectionId,metadata:this.connection.metadata};if(this.connection.type===nm.Data){let e=this.connection;r={...r,label:e.label,reliable:e.reliable,serialization:e.serialization}}t.socket.send({type:cm.Offer,payload:r,dst:this.connection.peer})}catch(e){e!=`OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer`&&(t.emitError(rm.WebRTC,e),Z.log(`Failed to setLocalDescription, `,e))}}catch(e){t.emitError(rm.WebRTC,e),Z.log(`Failed to createOffer, `,e)}}async _makeAnswer(){let e=this.connection.peerConnection,t=this.connection.provider;try{let n=await e.createAnswer();Z.log(`Created answer.`),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform==`function`&&(n.sdp=this.connection.options.sdpTransform(n.sdp)||n.sdp);try{await e.setLocalDescription(n),Z.log(`Set localDescription:`,n,`for:${this.connection.peer}`),t.socket.send({type:cm.Answer,payload:{sdp:n,type:this.connection.type,connectionId:this.connection.connectionId},dst:this.connection.peer})}catch(e){t.emitError(rm.WebRTC,e),Z.log(`Failed to setLocalDescription, `,e)}}catch(e){t.emitError(rm.WebRTC,e),Z.log(`Failed to create answer, `,e)}}async handleSDP(e,t){t=new RTCSessionDescription(t);let n=this.connection.peerConnection,r=this.connection.provider;Z.log(`Setting remote description`,t);let i=this;try{await n.setRemoteDescription(t),Z.log(`Set remoteDescription:${e} for:${this.connection.peer}`),e===`OFFER`&&await i._makeAnswer()}catch(e){r.emitError(rm.WebRTC,e),Z.log(`Failed to setRemoteDescription, `,e)}}async handleCandidate(e){Z.log(`handleCandidate:`,e);try{await this.connection.peerConnection.addIceCandidate(e),Z.log(`Added ICE candidate for:${this.connection.peer}`)}catch(e){this.connection.provider.emitError(rm.WebRTC,e),Z.log(`Failed to handleCandidate, `,e)}}_addTracksToConnection(e,t){if(Z.log(`add tracks from stream ${e.id} to peer connection`),!t.addTrack)return Z.error(`Your browser does't support RTCPeerConnection#addTrack. Ignored.`);e.getTracks().forEach(n=>{t.addTrack(n,e)})}_addStreamToMediaConnection(e,t){Z.log(`add stream ${e.id} to media connection ${t.connectionId}`),t.addStream(e)}},fm=class extends qp.EventEmitter{emitError(e,t){Z.error(`Error:`,t),this.emit(`error`,new pm(`${e}`,t))}},pm=class extends Error{constructor(e,t){typeof t==`string`?super(t):(super(),Object.assign(this,t)),this.type=e}},mm=class extends fm{get open(){return this._open}constructor(e,t,n){super(),this.peer=e,this.provider=t,this.options=n,this._open=!1,this.metadata=n.metadata}},hm=class e extends mm{static#e=this.ID_PREFIX=`mc_`;get type(){return nm.Media}get localStream(){return this._localStream}get remoteStream(){return this._remoteStream}constructor(t,n,r){super(t,n,r),this._localStream=this.options._stream,this.connectionId=this.options.connectionId||e.ID_PREFIX+Gp.randomToken(),this._negotiator=new dm(this),this._localStream&&this._negotiator.startConnection({_stream:this._localStream,originator:!0})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{Z.log(`DC#${this.connectionId} dc connection success`),this.emit(`willCloseOnRemote`)},this.dataChannel.onclose=()=>{Z.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}addStream(e){Z.log(`Receiving stream`,e),this._remoteStream=e,super.emit(`stream`,e)}handleMessage(e){let t=e.type,n=e.payload;switch(e.type){case cm.Answer:this._negotiator.handleSDP(t,n.sdp),this._open=!0;break;case cm.Candidate:this._negotiator.handleCandidate(n.candidate);break;default:Z.warn(`Unrecognized message type:${t} from peer:${this.peer}`);break}}answer(e,t={}){if(this._localStream){Z.warn(`Local stream already exists on this MediaConnection. Are you answering a call twice?`);return}this._localStream=e,t&&t.sdpTransform&&(this.options.sdpTransform=t.sdpTransform),this._negotiator.startConnection({...this.options._payload,_stream:e});let n=this.provider._getMessages(this.connectionId);for(let e of n)this.handleMessage(e);this._open=!0}close(){this._negotiator&&=(this._negotiator.cleanup(),null),this._localStream=null,this._remoteStream=null,this.provider&&=(this.provider._removeConnection(this),null),this.options&&this.options._stream&&(this.options._stream=null),this.open&&(this._open=!1,super.emit(`close`))}},gm=class{constructor(e){this._options=e}_buildRequest(e){let t=this._options.secure?`https`:`http`,{host:n,port:r,path:i,key:a}=this._options,o=new URL(`${t}://${n}:${r}${i}${a}/${e}`);return o.searchParams.set(`ts`,`${Date.now()}${Math.random()}`),o.searchParams.set(`version`,lm),fetch(o.href,{referrerPolicy:this._options.referrerPolicy})}async retrieveId(){try{let e=await this._buildRequest(`id`);if(e.status!==200)throw Error(`Error. Status:${e.status}`);return e.text()}catch(e){Z.error(`Error retrieving ID`,e);let t=``;throw this._options.path===`/`&&this._options.host!==Gp.CLOUD_HOST&&(t=" If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."),Error(`Could not get an ID from the server.`+t)}}async listAllPeers(){try{let e=await this._buildRequest(`peers`);if(e.status!==200){if(e.status===401){let e=``;throw e=this._options.host===Gp.CLOUD_HOST?`It looks like you're using the cloud server. You can email team@peerjs.com to enable peer listing for your API key.`:"You need to enable `allow_discovery` on your self-hosted PeerServer to use this feature.",Error(`It doesn't look like you have permission to list peers IDs. `+e)}throw Error(`Error. Status:${e.status}`)}return e.json()}catch(e){throw Z.error(`Error retrieving list peers`,e),Error(`Could not get list peers from the server.`+e)}}},_m=class e extends mm{static#e=this.ID_PREFIX=`dc_`;static#t=this.MAX_BUFFERED_AMOUNT=8388608;get type(){return nm.Data}constructor(t,n,r){super(t,n,r),this.connectionId=this.options.connectionId||e.ID_PREFIX+Up(),this.label=this.options.label||this.connectionId,this.reliable=!!this.options.reliable,this._negotiator=new dm(this),this._negotiator.startConnection(this.options._payload||{originator:!0,reliable:this.reliable})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{Z.log(`DC#${this.connectionId} dc connection success`),this._open=!0,this.emit(`open`)},this.dataChannel.onmessage=e=>{Z.log(`DC#${this.connectionId} dc onmessage:`,e.data)},this.dataChannel.onclose=()=>{Z.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}close(e){if(e?.flush){this.send({__peerData:{type:`close`}});return}this._negotiator&&=(this._negotiator.cleanup(),null),this.provider&&=(this.provider._removeConnection(this),null),this.dataChannel&&=(this.dataChannel.onopen=null,this.dataChannel.onmessage=null,this.dataChannel.onclose=null,null),this.open&&(this._open=!1,super.emit(`close`))}send(e,t=!1){if(!this.open){this.emitError(am.NotOpenYet,"Connection is not open. You should listen for the `open` event before sending messages.");return}return this._send(e,t)}async handleMessage(e){let t=e.payload;switch(e.type){case cm.Answer:await this._negotiator.handleSDP(e.type,t.sdp);break;case cm.Candidate:await this._negotiator.handleCandidate(t.candidate);break;default:Z.warn(`Unrecognized message type:`,e.type,`from peer:`,this.peer);break}}},vm=class extends _m{get bufferSize(){return this._bufferSize}_initializeDataChannel(e){super._initializeDataChannel(e),this.dataChannel.binaryType=`arraybuffer`,this.dataChannel.addEventListener(`message`,e=>this._handleDataMessage(e))}_bufferedSend(e){(this._buffering||!this._trySend(e))&&(this._buffer.push(e),this._bufferSize=this._buffer.length)}_trySend(e){if(!this.open)return!1;if(this.dataChannel.bufferedAmount>_m.MAX_BUFFERED_AMOUNT)return this._buffering=!0,setTimeout(()=>{this._buffering=!1,this._tryBuffer()},50),!1;try{this.dataChannel.send(e)}catch(e){return Z.error(`DC#:${this.connectionId} Error when sending:`,e),this._buffering=!0,this.close(),!1}return!0}_tryBuffer(){if(!this.open||this._buffer.length===0)return;let e=this._buffer[0];this._trySend(e)&&(this._buffer.shift(),this._bufferSize=this._buffer.length,this._tryBuffer())}close(e){if(e?.flush){this.send({__peerData:{type:`close`}});return}this._buffer=[],this._bufferSize=0,super.close()}constructor(...e){super(...e),this._buffer=[],this._bufferSize=0,this._buffering=!1}},ym=class extends vm{close(e){super.close(e),this._chunkedData={}}constructor(e,t,n){super(e,t,n),this.chunker=new Rp,this.serialization=om.Binary,this._chunkedData={}}_handleDataMessage({data:e}){let t=Ef(e),n=t.__peerData;if(n){if(n.type===`close`){this.close();return}this._handleChunk(t);return}this.emit(`data`,t)}_handleChunk(e){let t=e.__peerData,n=this._chunkedData[t]||{data:[],count:0,total:e.total};if(n.data[e.n]=new Uint8Array(e.data),n.count++,this._chunkedData[t]=n,n.total===n.count){delete this._chunkedData[t];let e=zp(n.data);this._handleDataMessage({data:e})}}_send(e,t){let n=Df(e);if(n instanceof Promise)return this._send_blob(n);if(!t&&n.byteLength>this.chunker.chunkedMTU){this._sendChunks(n);return}this._bufferedSend(n)}async _send_blob(e){let t=await e;if(t.byteLength>this.chunker.chunkedMTU){this._sendChunks(t);return}this._bufferedSend(t)}_sendChunks(e){let t=this.chunker.chunk(e);Z.log(`DC#${this.connectionId} Try to send ${t.length} chunks...`);for(let e of t)this.send(e,!0)}},bm=class extends vm{_handleDataMessage({data:e}){super.emit(`data`,e)}_send(e,t){this._bufferedSend(e)}constructor(...e){super(...e),this.serialization=om.None}},xm=class extends vm{_handleDataMessage({data:e}){let t=this.parse(this.decoder.decode(e)),n=t.__peerData;if(n&&n.type===`close`){this.close();return}this.emit(`data`,t)}_send(e,t){let n=this.encoder.encode(this.stringify(e));if(n.byteLength>=Gp.chunkedMTU){this.emitError(am.MessageToBig,`Message too big for JSON channel`);return}this._bufferedSend(n)}constructor(...e){super(...e),this.serialization=om.JSON,this.encoder=new TextEncoder,this.decoder=new TextDecoder,this.stringify=JSON.stringify,this.parse=JSON.parse}},Sm=class e extends fm{static#e=this.DEFAULT_KEY=`peerjs`;get id(){return this._id}get options(){return this._options}get open(){return this._open}get socket(){return this._socket}get connections(){let e=Object.create(null);for(let[t,n]of this._connections)e[t]=n;return e}get destroyed(){return this._destroyed}get disconnected(){return this._disconnected}constructor(t,n){super(),this._serializers={raw:bm,json:xm,binary:ym,"binary-utf8":ym,default:ym},this._id=null,this._lastServerId=null,this._destroyed=!1,this._disconnected=!1,this._open=!1,this._connections=new Map,this._lostMessages=new Map;let r;if(t&&t.constructor==Object?n=t:t&&(r=t.toString()),n={debug:0,host:Gp.CLOUD_HOST,port:Gp.CLOUD_PORT,path:`/`,key:e.DEFAULT_KEY,token:Gp.randomToken(),config:Gp.defaultConfig,referrerPolicy:`strict-origin-when-cross-origin`,serializers:{},...n},this._options=n,this._serializers={...this._serializers,...this.options.serializers},this._options.host===`/`&&(this._options.host=window.location.hostname),this._options.path&&(this._options.path[0]!==`/`&&(this._options.path=`/`+this._options.path),this._options.path[this._options.path.length-1]!==`/`&&(this._options.path+=`/`)),this._options.secure===void 0&&this._options.host!==Gp.CLOUD_HOST?this._options.secure=Gp.isSecure():this._options.host==Gp.CLOUD_HOST&&(this._options.secure=!0),this._options.logFunction&&Z.setLogFunction(this._options.logFunction),Z.logLevel=this._options.debug||0,this._api=new gm(n),this._socket=this._createServerConnection(),!Gp.supports.audioVideo&&!Gp.supports.data){this._delayedAbort(rm.BrowserIncompatible,`The current browser does not support WebRTC`);return}if(r&&!Gp.validateId(r)){this._delayedAbort(rm.InvalidID,`ID "${r}" is invalid`);return}r?this._initialize(r):this._api.retrieveId().then(e=>this._initialize(e)).catch(e=>this._abort(rm.ServerError,e))}_createServerConnection(){let e=new um(this._options.secure,this._options.host,this._options.port,this._options.path,this._options.key,this._options.pingInterval);return e.on(sm.Message,e=>{this._handleMessage(e)}),e.on(sm.Error,e=>{this._abort(rm.SocketError,e)}),e.on(sm.Disconnected,()=>{this.disconnected||(this.emitError(rm.Network,`Lost connection to server.`),this.disconnect())}),e.on(sm.Close,()=>{this.disconnected||this._abort(rm.SocketClosed,`Underlying socket is already closed.`)}),e}_initialize(e){this._id=e,this.socket.start(e,this._options.token)}_handleMessage(e){let t=e.type,n=e.payload,r=e.src;switch(t){case cm.Open:this._lastServerId=this.id,this._open=!0,this.emit(`open`,this.id);break;case cm.Error:this._abort(rm.ServerError,n.msg);break;case cm.IdTaken:this._abort(rm.UnavailableID,`ID "${this.id}" is taken`);break;case cm.InvalidKey:this._abort(rm.InvalidKey,`API KEY "${this._options.key}" is invalid`);break;case cm.Leave:Z.log(`Received leave message from ${r}`),this._cleanupPeer(r),this._connections.delete(r);break;case cm.Expire:this.emitError(rm.PeerUnavailable,`Could not connect to peer ${r}`);break;case cm.Offer:{let e=n.connectionId,t=this.getConnection(r,e);if(t&&(t.close(),Z.warn(`Offer received for existing Connection ID:${e}`)),n.type===nm.Media){let i=new hm(r,this,{connectionId:e,_payload:n,metadata:n.metadata});t=i,this._addConnection(r,t),this.emit(`call`,i)}else if(n.type===nm.Data){let i=new this._serializers[n.serialization](r,this,{connectionId:e,_payload:n,metadata:n.metadata,label:n.label,serialization:n.serialization,reliable:n.reliable});t=i,this._addConnection(r,t),this.emit(`connection`,i)}else{Z.warn(`Received malformed connection type:${n.type}`);return}let i=this._getMessages(e);for(let e of i)t.handleMessage(e);break}default:{if(!n){Z.warn(`You received a malformed message from ${r} of type ${t}`);return}let i=n.connectionId,a=this.getConnection(r,i);a&&a.peerConnection?a.handleMessage(e):i?this._storeMessage(i,e):Z.warn(`You received an unrecognized message:`,e);break}}}_storeMessage(e,t){this._lostMessages.has(e)||this._lostMessages.set(e,[]),this._lostMessages.get(e).push(t)}_getMessages(e){let t=this._lostMessages.get(e);return t?(this._lostMessages.delete(e),t):[]}connect(e,t={}){if(t={serialization:`default`,...t},this.disconnected){Z.warn(`You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect, or call reconnect on this peer if you believe its ID to still be available.`),this.emitError(rm.Disconnected,`Cannot connect to new Peer after disconnecting from server.`);return}let n=new this._serializers[t.serialization](e,this,t);return this._addConnection(e,n),n}call(e,t,n={}){if(this.disconnected){Z.warn(`You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect.`),this.emitError(rm.Disconnected,`Cannot connect to new Peer after disconnecting from server.`);return}if(!t){Z.error("To call a peer, you must provide a stream from your browser's `getUserMedia`.");return}let r=new hm(e,this,{...n,_stream:t});return this._addConnection(e,r),r}_addConnection(e,t){Z.log(`add connection ${t.type}:${t.connectionId} to peerId:${e}`),this._connections.has(e)||this._connections.set(e,[]),this._connections.get(e).push(t)}_removeConnection(e){let t=this._connections.get(e.peer);if(t){let n=t.indexOf(e);n!==-1&&t.splice(n,1)}this._lostMessages.delete(e.connectionId)}getConnection(e,t){let n=this._connections.get(e);if(!n)return null;for(let e of n)if(e.connectionId===t)return e;return null}_delayedAbort(e,t){setTimeout(()=>{this._abort(e,t)},0)}_abort(e,t){Z.error(`Aborting!`),this.emitError(e,t),this._lastServerId?this.disconnect():this.destroy()}destroy(){this.destroyed||(Z.log(`Destroy peer with ID:${this.id}`),this.disconnect(),this._cleanup(),this._destroyed=!0,this.emit(`close`))}_cleanup(){for(let e of this._connections.keys())this._cleanupPeer(e),this._connections.delete(e);this.socket.removeAllListeners()}_cleanupPeer(e){let t=this._connections.get(e);if(t)for(let e of t)e.close()}disconnect(){if(this.disconnected)return;let e=this.id;Z.log(`Disconnect peer with ID:${e}`),this._disconnected=!0,this._open=!1,this.socket.close(),this._lastServerId=e,this._id=null,this.emit(`disconnected`,e)}reconnect(){if(this.disconnected&&!this.destroyed)Z.log(`Attempting reconnection to server with ID ${this._lastServerId}`),this._disconnected=!1,this._initialize(this._lastServerId);else if(this.destroyed)throw Error(`This peer cannot reconnect to the server. It has already been destroyed.`);else if(!this.disconnected&&!this.open)Z.error(`In a hurry? We're still trying to make the initial connection!`);else throw Error(`Peer ${this.id} cannot reconnect because it is not disconnected from the server!`)}listAllPeers(e=e=>{}){this._api.listAllPeers().then(t=>e(t)).catch(e=>this._abort(rm.ServerError,e))}},Cm=new Set([`carbine`,`smg`,`scattergun`]);function wm(e){if(!e||typeof e!=`object`)return!1;let t=e;return typeof t.id==`string`&&t.id.length>0&&t.id.length<=80&&typeof t.name==`string`&&t.name.length>0&&t.name.length<=20&&(t.team===0||t.team===1)&&[`x`,`y`,`z`,`yaw`,`pitch`,`hp`,`kills`,`deaths`,`seq`].every(e=>Number.isFinite(t[e]))&&Cm.has(t.weapon)}function Tm(e){if(!e||typeof e!=`object`)return!1;let t=e;switch(t.type){case`join`:case`state`:return wm(t.player);case`shot`:return typeof t.by==`string`&&Cm.has(t.weapon)&&Array.isArray(t.origin)&&t.origin.length===3&&t.origin.every(Number.isFinite)&&Array.isArray(t.direction)&&t.direction.length===3&&t.direction.every(Number.isFinite)&&Number.isFinite(t.nonce);case`hit`:return typeof t.by==`string`&&typeof t.target==`string`&&Number.isFinite(t.damage)&&Number(t.damage)>0&&Number(t.damage)<=100&&Number.isFinite(t.nonce);case`death`:return typeof t.killer==`string`&&typeof t.victim==`string`&&Number.isFinite(t.nonce);case`leave`:return typeof t.playerId==`string`;case`chat`:return typeof t.by==`string`&&typeof t.text==`string`&&t.text.length<=160;default:return!1}}function Em(e){return e.replace(/[^a-zA-Z0-9 _-]/g,``).trim().slice(0,16)||`Player${Math.floor(Math.random()*900+100)}`}var Dm=class{role=`offline`;roomCode=``;peer=null;hostConnection=null;guests=new Set;onMessage;onStatus;onReady=null;constructor(e,t){this.onMessage=e,this.onStatus=t}host(e){this.close(),this.role=`host`,this.onReady=e,this.onStatus(`Opening a secure peer lobby…`);let t=new Sm;this.peer=t,t.on(`open`,t=>{this.roomCode=t,this.onStatus(`Lobby ready — share the room code`,`ok`),e()}),t.on(`connection`,e=>this.wireGuest(e)),t.on(`error`,e=>this.onStatus(this.describeError(e),`error`)),t.on(`disconnected`,()=>this.onStatus(`Signalling disconnected; existing peers may continue`,`warn`))}join(e,t){if(this.close(),this.role=`client`,this.roomCode=e.trim(),this.onReady=t,!this.roomCode){this.onStatus(`Enter a room code first`,`error`);return}this.onStatus(`Connecting to peer lobby…`);let n=new Sm;this.peer=n,n.on(`open`,()=>{let e=n.connect(this.roomCode,{reliable:!0,serialization:`json`});this.hostConnection=e,this.wireHost(e)}),n.on(`error`,e=>this.onStatus(this.describeError(e),`error`)),n.on(`disconnected`,()=>this.onStatus(`Signalling disconnected; attempting to preserve session`,`warn`))}send(e){Tm(e)&&(this.role===`host`?this.broadcast(e):this.role===`client`&&this.hostConnection?.open&&this.hostConnection.send(e))}close(){if(this.hostConnection)try{this.hostConnection.close()}catch{}for(let e of this.guests)try{e.close()}catch{}if(this.guests.clear(),this.hostConnection=null,this.peer)try{this.peer.destroy()}catch{}this.peer=null,this.roomCode=``,this.role=`offline`,this.onReady=null}wireGuest(e){this.guests.add(e);let t=``;e.on(`open`,()=>this.onStatus(`${this.guests.size} guest connection${this.guests.size===1?``:`s`}`,`ok`)),e.on(`data`,n=>{Tm(n)&&(n.type===`join`&&(t=n.player.id),this.onMessage(n),this.broadcast(n,e))}),e.on(`close`,()=>{if(this.guests.delete(e),t){let e={type:`leave`,playerId:t};this.onMessage(e),this.broadcast(e)}this.onStatus(`A guest left the lobby`,`warn`)}),e.on(`error`,()=>this.onStatus(`Guest data channel failed`,`error`))}wireHost(e){e.on(`open`,()=>{this.onStatus(`Connected to host`,`ok`),this.onReady?.()}),e.on(`data`,e=>{Tm(e)&&this.onMessage(e)}),e.on(`close`,()=>this.onStatus(`Host connection closed`,`error`)),e.on(`error`,()=>this.onStatus(`Could not establish peer data channel`,`error`))}broadcast(e,t){for(let n of this.guests)n!==t&&n.open&&n.send(e)}describeError(e){let t=e instanceof Error?e.message:String(e);return/peer-unavailable/i.test(t)?`Room not found. Check the code and try again.`:/network|server/i.test(t)?`Peer signalling is unavailable. Check the connection and retry.`:`Network error: ${t.slice(0,120)}`}},Om=`modulepreload`,km=function(e,t){return new URL(e,t).href},Am={},jm=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,new URL(`../../../src/node/plugins/importAnalysisBuild.ts`,import.meta.url)).href}r=o(t.map(t=>{if(t=km(t,n),t=s(t),t in Am)return;Am[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:Om,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},Mm=.38,Nm=.53,Pm=.72,Fm=class e{world;body;collider;controller;constructor(e,t,n){this.world=e,this.body=t,this.collider=n,this.controller=e.createCharacterController(.025),this.controller.setSlideEnabled(!0),this.controller.enableAutostep(.42,.22,!1),this.controller.enableSnapToGround(.24),this.controller.setMaxSlopeClimbAngle(50*Math.PI/180),this.controller.setMinSlopeSlideAngle(55*Math.PI/180)}static async create(t,n){let{default:r}=await jm(async()=>{let{default:e}=await import(`./rapier-B45baom8.js`);return{default:e}},[],import.meta.url),i=console.warn;console.warn=(...e)=>{e.length===1&&e[0]===`using deprecated parameters for the initialization function; pass a single object instead`||i(...e)};try{await r.init()}finally{console.warn=i}let a=new r.World({x:0,y:-22,z:0});a.timestep=1/120,a.createCollider(r.ColliderDesc.cuboid((n.maxX-n.minX)/2,.1,(n.maxZ-n.minZ)/2).setTranslation((n.minX+n.maxX)/2,-.1,(n.minZ+n.maxZ)/2));for(let e of t){let t=e.minY??0,n=e.maxY??8,i=Math.max(.01,(e.maxX-e.minX)/2),o=Math.max(.01,(n-t)/2),s=Math.max(.01,(e.maxZ-e.minZ)/2);a.createCollider(r.ColliderDesc.cuboid(i,o,s).setTranslation((e.minX+e.maxX)/2,(t+n)/2,(e.minZ+e.maxZ)/2))}let o=a.createRigidBody(r.RigidBodyDesc.kinematicPositionBased()),s=a.createCollider(r.ColliderDesc.capsule(Nm,Mm).setFriction(0).setActiveCollisionTypes(r.ActiveCollisionTypes.ALL),o),c=new e(a,o,s);return c.teleportEye({x:0,y:1.7,z:0}),c}teleportEye(e){this.body.setTranslation({x:e.x,y:e.y-Pm,z:e.z},!0),this.world.propagateModifiedBodyPositionsToColliders()}eyePosition(){let e=this.body.translation();return{x:e.x,y:e.y+Pm,z:e.z}}move(e,t){this.world.timestep=t,this.controller.computeColliderMovement(this.collider,e);let n=this.controller.computedMovement(),r=this.body.translation();this.body.setNextKinematicTranslation({x:r.x+n.x,y:r.y+n.y,z:r.z+n.z}),this.world.step();let i=this.eyePosition(),a=5e-4;return{position:i,grounded:this.controller.computedGrounded(),blockedX:Math.abs(n.x-e.x)>a,blockedY:Math.abs(n.y-e.y)>a,blockedZ:Math.abs(n.z-e.z)>a,appliedDelta:{x:n.x,y:n.y,z:n.z}}}dispose(){this.world.free()}},Im=class{flattenMaterials;root=new Ln;models=new Map;active=`carbine`;recoil=0;reloadStart=0;reloadDuration=0;switchBlend=1;swayX=0;swayY=0;meleeStart=0;grenadeStart=0;muzzleLight;muzzleFlash;casings=[];adsBlend=0;sprintBlend=0;constructor(e,t=!1){this.flattenMaterials=t,this.root.name=`original-weapon-view`,this.root.position.set(.31,-.31,-.7),this.root.scale.setScalar(.78),e.add(this.root);let n=new K({color:2505784,roughness:.9}),r=new K({color:1185819,roughness:.94}),i=new Ln;i.name=`first-person-arms`;let a=Y(`right-forearm`,[.18,.18,.68],n,.08,4);a.position.set(.18,-.2,.3),a.rotation.set(-.2,-.12,-.12);let o=Y(`right-glove`,[.2,.19,.25],r,.075,4);o.position.set(.1,-.15,-.02),o.rotation.x=-.12;let s=Y(`left-forearm`,[.19,.19,.75],n,.08,4);s.position.set(-.24,-.23,.12),s.rotation.set(-.42,.28,.08);let c=Y(`left-glove`,[.21,.2,.27],r,.075,4);c.position.set(-.08,-.07,-.43),c.rotation.set(-.18,.15,0),i.add(a,o,s,c),this.root.add(i),this.muzzleLight=new Ts(16761706,0,4.5,2),this.muzzleLight.position.set(0,.08,-1.15),this.root.add(this.muzzleLight),this.muzzleFlash=new Ln,this.muzzleFlash.position.set(0,.08,-1.15);let l=new hi({color:16765834,transparent:!0,opacity:.92,depthWrite:!1}),u=new G(new oa(.085,.42,8),l);u.rotation.x=-Math.PI/2,u.position.z=-.2;let d=new G(new To(.34,.34),l.clone());d.rotation.z=Math.PI/4,this.muzzleFlash.add(u,d),this.muzzleFlash.visible=!1,this.root.add(this.muzzleFlash)}async load(e){let t=[`carbine`,`smg`,`scattergun`];t.forEach((n,r)=>{let i=Dd(n,this.flattenMaterials);i.visible=!1,this.models.set(n,i),this.root.add(i),e?.(r+1,t.length)}),this.setWeapon(this.active,!0)}isReady(){return this.models.size===3}setWeapon(e,t=!1){this.active=e,this.switchBlend=+!!t,this.reloadDuration=0;for(let[t,n]of this.models)n.visible=t===e}fire(e){this.recoil=Math.min(1,this.recoil+.24+e*5.2),this.muzzleLight.intensity=this.active===`scattergun`?7.2:4.8,this.muzzleFlash.visible=!0,this.muzzleFlash.scale.setScalar(this.active===`scattergun`?1.45:this.active===`smg`?.78:1),this.muzzleFlash.rotation.z=Math.random()*Math.PI;let t=new K({color:13149788,roughness:.3,metalness:.78}),n=new G(new aa(.018,.018,.085,7),t);n.rotation.z=Math.PI/2,n.position.set(.12,.04,-.48),this.root.add(n),this.casings.push({mesh:n,velocity:new B(.95+Math.random()*.25,.75+Math.random()*.2,.1),life:.42})}reload(e){this.reloadStart=performance.now(),this.reloadDuration=e*1e3}cancelReload(){this.reloadDuration=0}melee(){this.meleeStart=performance.now()}throwGrenade(){this.grenadeStart=performance.now()}addMouseDelta(e,t){this.swayX=zt.clamp(this.swayX+e*8e-5,-.025,.025),this.swayY=zt.clamp(this.swayY+t*6e-5,-.02,.02)}update(e){let t=t=>1-Math.exp(-t*e.dt);this.recoil=zt.lerp(this.recoil,0,t(16)),this.muzzleLight.intensity=zt.lerp(this.muzzleLight.intensity,0,t(30)),this.switchBlend=zt.lerp(this.switchBlend,1,t(10)),this.swayX=zt.lerp(this.swayX,0,t(7)),this.swayY=zt.lerp(this.swayY,0,t(7)),this.adsBlend=zt.lerp(this.adsBlend,+!!e.ads,t(e.ads?18:15)),this.sprintBlend=zt.lerp(this.sprintBlend,+!!e.sprinting,t(13)),this.muzzleFlash.visible=this.muzzleLight.intensity>.45;for(let t=this.casings.length-1;t>=0;--t){let n=this.casings[t];n.life-=e.dt,n.velocity.y-=4.5*e.dt,n.mesh.position.addScaledVector(n.velocity,e.dt),n.mesh.rotation.x+=e.dt*18,n.mesh.rotation.z+=e.dt*11,n.life<=0&&(this.root.remove(n.mesh),n.mesh.geometry.dispose(),n.mesh.material.dispose(),this.casings.splice(t,1))}let n=e.moving?e.sprinting?1.22:e.ads?.18:e.crouched?.32:.56:.05,r=Math.cos(e.phase*.5)*.017*n,i=Math.sin(e.phase)*.019*n,a=Math.sin(performance.now()*.0017)*(e.ads?.0015:.0045),o=this.adsBlend*-.305,s=this.adsBlend*.255,c=this.adsBlend*.22,l=this.sprintBlend*-.16,u=e.crouched?.035:0,d=(1-this.switchBlend)*-.34,f=0,p=0;if(this.reloadDuration>0){let e=(performance.now()-this.reloadStart)/this.reloadDuration;if(e>=1)this.reloadDuration=0;else{let t=zt.clamp(e,0,1),n=Math.sin(Math.PI*t),r=t>.65?Math.sin((t-.65)/.35*Math.PI):0;f=n*.78-r*.12,p=n*-.22+r*.035}}let m=zt.clamp((performance.now()-this.meleeStart)/430,0,1),h=this.meleeStart>0&&m<1?Math.sin(m*Math.PI):0,g=zt.clamp((performance.now()-this.grenadeStart)/620,0,1),_=this.grenadeStart>0&&g<1?Math.sin(g*Math.PI):0,v=new B(.31+o+r+this.swayX-e.lateralSpeed*.012-h*.24+_*.18,-.31+s+i+a+l+u+d+p-this.recoil*.08-e.landingImpulse*.075,-.7+c+this.recoil*.13-h*.32+_*.24);this.root.position.lerp(v,t(18)),this.root.rotation.x=zt.lerp(this.root.rotation.x,this.recoil*.18-this.swayY-_*.42,t(22)),this.root.rotation.y=zt.lerp(this.root.rotation.y,-this.swayX*2-this.sprintBlend*.38-h*.65,t(13)),this.root.rotation.z=zt.lerp(this.root.rotation.z,f-this.sprintBlend*.22-e.lateralSpeed*.025+h*.42,t(13))}};window.addEventListener(`error`,e=>{console.error(`[Atomic Acres runtime error]`,e.message||`unknown error`,e.error?.stack||``)}),window.addEventListener(`unhandledrejection`,e=>{let t=e.reason instanceof Error?`${e.reason.message}\n${e.reason.stack??``}`:String(e.reason);console.error(`[Atomic Acres unhandled rejection]`,t)});var Lm=[`carbine`,`smg`,`scattergun`],Rm=[new B(-25,0,-12),new B(-18,0,15),new B(-4,0,24),new B(8,0,15),new B(24,0,8),new B(19,0,-18),new B(2,0,-24),new B(-12,0,-17)];function zm(){return typeof globalThis.crypto?.randomUUID==`function`?globalThis.crypto.randomUUID():`player-${Date.now().toString(36)}-${Math.random().toString(36).slice(2,10)}`}var Bm=document.querySelector(`#app`);if(!Bm)throw Error(`Missing #app root`);Bm.innerHTML=`
...
`;function Q(e){let t=document.querySelector(e);if(!t)throw Error(`Missing element ${e}`);return t}var Vm=Q(`#game`),Hm=Q(`#menu`),Um=Q(`#hud`),Wm=Q(`#room-card`),Gm=Q(`#room-code`),Km=Q(`#network-status`),qm=Q(`#minimap`),Jm=qm.getContext(`2d`);if(!Jm)throw Error(`Canvas2D minimap is unavailable`);var Ym=Jm,Xm=new Fd,Zm=new URLSearchParams(window.location.search).get(`render`)===`compat`;document.documentElement.classList.toggle(`compat-render`,Zm);var Qm=new pd({canvas:Vm,antialias:!Zm,powerPreference:`high-performance`});Qm.outputColorSpace=Ze,Qm.shadowMap.enabled=!Zm,Qm.shadowMap.type=1,Qm.toneMapping=4,Qm.toneMappingExposure=1.22,Qm.setPixelRatio(Zm?.2:Math.min(window.devicePixelRatio,1.75));var $m=new Kn;$m.fog=new Gn(11453127,62,128);var eh=new Cs(76,1,.08,180);eh.rotation.order=`YXZ`,$m.add(eh);function th(){let e=new Oo(150,32,18),t=new Ro({side:1,depthWrite:!1,uniforms:{top:{value:new U(2909837)},horizon:{value:new U(11258833)},bottom:{value:new U(14209974)}},vertexShader:`varying vec3 worldPos; void main(){ worldPos=(modelMatrix*vec4(position,1.0)).xyz; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }`,fragmentShader:`varying vec3 worldPos; uniform vec3 top; uniform vec3 horizon; uniform vec3 bottom; void main(){ float h=normalize(worldPos).y; vec3 c=h>0.0?mix(horizon,top,smoothstep(0.0,.75,h)):mix(horizon,bottom,smoothstep(0.0,-.35,h)); gl_FragColor=vec4(c,1.0); }`});$m.add(new G(e,t)),$m.add(new ds(14282751,5400139,1.7)),$m.add(new ks(13161945,.62));let n=new Os(16769461,2.55);n.position.set(-32,68,34),n.castShadow=!0,n.shadow.mapSize.set(2048,2048),n.shadow.camera.left=-48,n.shadow.camera.right=48,n.shadow.camera.top=54,n.shadow.camera.bottom=-54,n.shadow.camera.near=10,n.shadow.camera.far=150,n.shadow.bias=-4e-4,$m.add(n)}th();var nh=df($m),$={id:zm(),name:`Player`,team:0,position:new B,velocity:new B,yaw:0,pitch:0,hp:100,kills:0,deaths:0,weapon:`carbine`,ammo:{carbine:Ud.carbine.mag,smg:Ud.smg.mag,scattergun:Ud.scattergun.mag},reserve:{carbine:Ud.carbine.reserve,smg:Ud.smg.reserve,scattergun:Ud.scattergun.reserve},reloadState:null,switchingUntil:0,lastShotAt:0,nextShotAt:0,sustainedShots:0,crouched:!1,grenades:1,lastMeleeAt:-1e4,alive:!0,invulnerableUntil:0,seq:0},rh=new Set,ih=new Map,ah=new Map,oh=[],sh=new Set,ch=!1,lh=`solo`,uh=!1,dh=0,fh=0,ph=0,mh={pitch:0,yaw:0},hh=0,gh=0,_h=0,vh=0,yh=!1,bh=0,xh=-1e4,Sh=-1e4,Ch=0,wh=performance.now(),Th=0,Eh=new URLSearchParams(window.location.search).get(`renderPaused`)===`1`,Dh=cf(performance.now()),Oh=!1,kh=!1,Ah=!1,jh=!1,Mh={x:0,y:0},Nh=!1,Ph=!1,Fh=[],Ih=!1,Lh=!1,Rh=1,zh=82,Bh=!1,Vh=!1,Hh=null,Uh=null;function Wh(e,t=`ok`){Km.textContent=e,Km.dataset.kind=t}function Gh(e){let t=e instanceof Error?e.message:String(e);uh=!1,Wh(`Game paused: ${t}`,`error`),Hm.classList.remove(`hidden`);let n=Q(`#banner`);n.innerHTML=`<strong>SYSTEM PAUSED</strong><span>Reload the page to re-enter the test block.</span>`,n.hidden=!1,console.error(`[Atomic Acres fatal]`,e)}var Kh=typeof window.RTCPeerConnection==`function`;Kh?typeof Vm.requestPointerLock!=`function`&&Wh(`Pointer lock is unavailable; keyboard movement works but mouse aim may not.`,`warn`):(Q(`#host`).disabled=!0,Q(`#join`).disabled=!0,Wh(`This browser lacks WebRTC; solo training is still available.`,`warn`)),Vm.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),Gh(Error(`Graphics context was lost`))}),Vm.addEventListener(`webglcontextrestored`,()=>window.location.reload());var qh=new Dm(Qh,Wh),Jh=new Im(eh,Zm),Yh=new Ts(14216447,.9,5);Yh.position.set(0,.4,.2),eh.add(Yh);function Xh(e){let t=Md(e.team,`remote-player`,Zm);t.userData.playerId=e.id,t.traverse(n=>{n.userData.playerId=e.id,n.userData.targetRoot=t});let n=document.createElement(`canvas`);n.width=256,n.height=64;let r=n.getContext(`2d`);r.fillStyle=`rgba(10,18,22,.72)`,r.fillRect(0,0,256,64),r.fillStyle=`#f7ecd4`,r.font=`700 30px Arial`,r.textAlign=`center`,r.textBaseline=`middle`,r.fillText(e.name,128,32);let i=new Qi(n);i.colorSpace=Ze;let a=new ai(new Gr({map:i,transparent:!0,depthTest:!0,depthWrite:!1}));return a.visible=e.team===$.team,a.position.y=2.5,a.scale.set(2.4,.6,1),t.add(a),t.position.set(e.x,e.y-1.7,e.z),$m.add(t),{root:t,snapshot:e,target:new B(e.x,e.y-1.7,e.z),targetYaw:e.yaw,lastSeen:performance.now()}}function Zh(){return{id:$.id,name:$.name,team:$.team,x:$.position.x,y:$.position.y,z:$.position.z,yaw:$.yaw,pitch:$.pitch,hp:$.hp,kills:$.kills,deaths:$.deaths,weapon:$.weapon,seq:++$.seq}}function Qh(e){if(e.type===`join`||e.type===`state`){let t=e.player;if(t.id===$.id)return;let n=ih.get(t.id);n||(n=Xh(t),ih.set(t.id,n),Ag(`${t.name} entered the test block`,t.team===0?`aqua`:`coral`),e.type===`join`&&qh.send({type:`state`,player:Zh()})),t.seq>=n.snapshot.seq&&(n.snapshot=t,n.target.set(t.x,t.y-1.7,t.z),n.targetYaw=t.yaw,n.lastSeen=performance.now(),n.root.visible=t.hp>0);return}if(e.type===`shot`){e.by!==$.id&&eg(e);return}if(e.type===`hit`&&e.target===$.id&&!sh.has(e.nonce)){sh.add(e.nonce),ng(e.damage,e.by),$h();return}if(e.type===`death`&&!sh.has(e.nonce)){sh.add(e.nonce),rg(e),$h();return}e.type===`leave`&&ig(e.playerId,`left the block`)}function $h(){sh.size>512&&sh.clear()}function eg(e){let t=new B(...e.origin);Og(t,new B(...e.direction).normalize(),50,Ud[e.weapon].color),Xm.shot(e.weapon,!0,t.distanceTo(eh.position))}function tg(e){let t=ih.get(e)?.target??ah.get(e)?.position;if(!t||e===$.id)return;let n=t.x-$.position.x,r=t.z-$.position.z,i=Math.atan2(-n,-r),a=Q(`#damage-direction`);a.style.setProperty(`--damage-angle`,`${Vd($.yaw,i)}rad`),a.classList.remove(`pulse`),requestAnimationFrame(()=>a.classList.add(`pulse`))}function ng(e,t){let n=performance.now();if(!(!$.alive||n<$.invulnerableUntil)&&($.hp=Math.max(0,$.hp-Math.min(100,Math.max(1,e))),Sh=n,Xm.damage(),tg(t),Q(`#damage-flash`).classList.remove(`pulse`),requestAnimationFrame(()=>Q(`#damage-flash`).classList.add(`pulse`)),$.hp<=0)){$.alive=!1,$.deaths+=1;let e={type:`death`,killer:t,victim:$.id,nonce:lg()};qh.send(e),rg(e),Q(`#respawn`).hidden=!1,document.exitPointerLock(),setTimeout(sg,1900)}}function rg(e){let t=e.killer===$.id?$.name:ih.get(e.killer)?.snapshot.name??ah.get(e.killer)?.name??`Unknown`,n=e.victim===$.id?$.name:ih.get(e.victim)?.snapshot.name??ah.get(e.victim)?.name??`Unknown`;e.killer===$.id&&e.victim!==$.id&&($.kills+=1,Xm.kill()),Ag(`${t} eliminated ${n}`,e.killer===$.id?`gold`:void 0);let r=ih.get(e.victim);r&&(r.root.visible=!1);let i=ah.get(e.victim);i&&(i.root.visible=!1),Fg()}function ig(e,t){let n=ih.get(e);n&&($m.remove(n.root),ih.delete(e),Ag(`${n.snapshot.name} ${t}`))}function ag(){let e=nh.spawns[$.team],t=[...ih.values()].map(e=>e.target),n=e.map(e=>({point:e,distance:t.length?Math.min(...t.map(t=>t.distanceToSquared(e))):1/0}));return n.sort((e,t)=>t.distance-e.distance),n[0].point.clone()}function og(){try{let e=Vm.requestPointerLock();e instanceof Promise&&e.catch(()=>void 0)}catch{}}function sg(e=!0){$.position.copy(ag()),Uh?.teleportEye($.position),$.velocity.set(0,0,0),$.hp=100,Sh=-1e4,$.grenades=1,$.reloadState=null,$.crouched=!1,$.alive=!0,$.invulnerableUntil=performance.now()+1350,$.yaw=$.team===0?Math.PI:0,$.pitch=0,mh={pitch:0,yaw:0},_h=0,vh=0,xh=-1e4,Q(`#respawn`).hidden=!0,ch&&e&&og(),qh.send({type:`state`,player:Zh()})}function cg(e,t=!0){$.name=Em(Q(`#player-name`).value),$.team=+(Number(Q(`#team`).value)===1),ch=!0,Jh.root.visible=!0,lh=e,Bh=!1,Dh=cf(performance.now()),Oh=!1,Hm.classList.add(`hidden`),Um.hidden=!1,Q(`#connection-pill`).textContent=e===`solo`?`BOT SKIRMISH`:e===`host`?`HOST`:`PEER`,Q(`#room-hud`).textContent=qh.roomCode?`ROOM ${qh.roomCode.slice(0,8).toUpperCase()}`:``,sg(t),e===`solo`&&hg(),Xm.unlock(),Ag(`Welcome to Atomic Acres`,`gold`),e!==`solo`&&qh.send({type:`join`,player:Zh()})}function lg(){return Math.floor(performance.now()*1e3+Math.random()*1e6)}function ug(e){let t=Lm[e];if(!(!t||t===$.weapon||!$.alive)){if($.reloadState){if(!ef($.reloadState,performance.now()))return;$.reloadState=null,Jh.cancelReload()}$.weapon=t,$.switchingUntil=performance.now()+360,$.sustainedShots=0,Jh.setWeapon(t),Xm.weaponSwitch()}}function dg(){if(!$.alive||Dh.phase!==`active`)return;let e=Ud[$.weapon],t=$.ammo[$.weapon];$.reloadState||t>=e.mag||$.reserve[$.weapon]<=0||($.reloadState=$d(e,t,$.reserve[$.weapon],performance.now()),Xm.reload(),Jh.reload(e.reload),Ag(`Reloading ${e.name}`))}function fg(e){if(!$.reloadState)return;let t=tf($.reloadState,e,$.ammo[$.weapon],$.reserve[$.weapon]);t.completed&&($.ammo[$.weapon]=t.ammo,$.reserve[$.weapon]=t.reserve,$.reloadState=null)}function pg(e){if(!$.alive||!ch||!Vh&&document.pointerLockElement!==Vm||Dh.phase!==`active`)return;let t=Ud[$.weapon];if(!uh&&t.automatic||e<$.switchingUntil)return;if($.reloadState){if(!ef($.reloadState,e))return;$.reloadState=null,Jh.cancelReload()}let n=6e4/t.rpm;if(e<$.nextShotAt)return;if(($.nextShotAt===0||e-$.nextShotAt>n*2)&&($.nextShotAt=e),$.nextShotAt+=n,$.ammo[$.weapon]<=0){Xm.empty(),dg(),$.lastShotAt=e;return}$.sustainedShots=e-$.lastShotAt<260?$.sustainedShots+1:0,$.lastShotAt=e,--$.ammo[$.weapon];let r=Q(`#ammo`);r.classList.remove(`fired`),requestAnimationFrame(()=>r.classList.add(`fired`));let i=rf(t,$.sustainedShots,Math.random());mh.pitch=Math.min(.16,mh.pitch+i.pitch),mh.yaw=zt.clamp(mh.yaw+i.yaw,-.075,.075),ph=Math.min(.24,ph+i.pitch*4.2),Jh.fire(i.pitch),Xm.shot($.weapon);let a=eh.getWorldPosition(new B),o=eh.getWorldDirection(new B),s=Math.hypot($.velocity.x,$.velocity.z)>1.2,c=Xd(t,{ads:kh,moving:s,crouched:$.crouched,sustainedShots:$.sustainedShots}),l=new Map,u=new B(1,0,0).applyQuaternion(eh.quaternion),d=new B(0,1,0).applyQuaternion(eh.quaternion);for(let e=0;e<t.pellets;e+=1){let e=Zd(c,Math.random(),Math.random()),n=o.clone().addScaledVector(u,e.x).addScaledVector(d,e.y).normalize(),r=mg(a,n);if(Og(a,n,r.distance,t.color),!r.playerId&&!r.targetId&&r.distance<89&&Dg(a.clone().addScaledVector(n,r.distance)),r.playerId){let e=r.hitZone??`body`,n=Qd(t,r.distance,e),i=l.get(r.playerId);l.set(r.playerId,{damage:(i?.damage??0)+n,zone:i?.zone===`head`||e===`head`?`head`:e})}r.targetId&&Tg(r.targetId)}for(let[e,t]of l){let n=ah.get(e);if(n)vg(n,Math.min(100,t.damage),t.zone);else{let n=ih.get(e);if(n&&n.snapshot.team!==$.team){let n=lg();qh.send({type:`hit`,by:$.id,target:e,damage:Math.min(100,t.damage),nonce:n}),kg(t.zone===`head`),Xm.hit(t.zone===`head`)}}}let f={type:`shot`,by:$.id,weapon:$.weapon,origin:a.toArray(),direction:o.toArray(),nonce:lg()};qh.send(f),$.ammo[$.weapon]===0&&setTimeout(dg,120)}function mg(e,t){let n=new qs(e,t,.1,110),r=[...ih.values()].filter(e=>e.root.visible).map(e=>e.root),i=[...ah.values()].filter(e=>e.alive&&e.root.visible).map(e=>e.root),a=nh.targets.filter(e=>e.active).map(e=>e.root),o=n.intersectObjects([...nh.raycastMeshes,...r,...i,...a],!0)[0];if(!o)return{distance:90};let s=o.object,c,l,u;for(;s;)c??=s.userData.playerId,l??=s.userData.targetId,u??=s.userData.hitZone,s=s.parent;let d=o.object.userData.targetRoot;return l??=d?.userData.targetId,{distance:Math.min(o.distance,110),playerId:c,targetId:l,hitZone:u}}function hg(){gg();let e=+($.team===0),t=[`RIVET`,`MABEL`,`BOLT`,`TANGO`],n=nh.spawns[e];t.forEach((t,r)=>{let i=`bot-${r}`,a=Md(e,`bot-operator`,Zm);a.userData.playerId=i,a.traverse(e=>{e.userData.playerId=i,e.userData.targetRoot=a});let o=n[r%n.length],s=new B(o.x,o.y-1.7,o.z);a.position.copy(s),$m.add(a),ah.set(i,{id:i,name:t,team:e,root:a,position:s,velocity:new B,hp:100,alive:!0,kills:0,deaths:0,lastShotAt:0,lastSightAt:0,hasLineOfSight:!1,sightStartedAt:0,burstShots:0,nextDecisionAt:0,strafeSign:r%2==0?1:-1,invulnerableUntil:performance.now()+1e3,respawnAt:0,waypoint:r})}),Ag(`Four hostile operators entered the block`,`coral`)}function gg(){for(let e of ah.values())$m.remove(e.root);ah.clear()}function _g(e){let t={x:e.position.x,y:e.position.y+1.65,z:e.position.z},n={x:$.position.x,y:$.position.y,z:$.position.z};return!nh.colliders.some(e=>Rd(t,n,e))}function vg(e,t,n){let r=performance.now();!e.alive||r<e.invulnerableUntil||(e.hp=Math.max(0,e.hp-t),kg(n===`head`),Xm.hit(n===`head`),!(e.hp>0)&&(e.alive=!1,e.deaths+=1,e.respawnAt=r+2200,e.root.visible=!1,$.kills+=1,Xm.kill(),Ag(`${$.name} eliminated ${e.name}${n===`head`?` · HEADSHOT`:``}`,`gold`),Fg()))}function yg(e,t){let n=Pd(t),r=nh.spawns[e.team],i=r[(e.deaths+e.waypoint)%r.length];e.position.set(i.x,i.y-1.7,i.z),e.root.position.copy(e.position),e.hp=n.health,e.alive=n.alive,e.invulnerableUntil=n.invulnerableUntil,e.lastShotAt=n.lastShotAt,e.lastSightAt=0,e.hasLineOfSight=!1,e.sightStartedAt=0,e.burstShots=0,e.nextDecisionAt=0,e.root.visible=!0}function bg(e,t){if(lh!==`solo`||Dh.phase!==`active`||Bh)return;let n=0;for(let r of ah.values()){if(n+=1,!r.alive){t>=r.respawnAt&&!Oh&&yg(r,t);continue}let i=$.position.clone().setY(0).sub(r.position.clone().setY(0)),a=i.length(),o=120+n*19;if(t-r.lastSightAt>=o){r.lastSightAt=t;let e=r.hasLineOfSight;r.hasLineOfSight=$.alive&&_g(r),r.hasLineOfSight&&!e&&(r.sightStartedAt=t),r.hasLineOfSight||(r.sightStartedAt=0,r.burstShots=0)}let s=r.hasLineOfSight;t>=r.nextDecisionAt&&(r.strafeSign=r.strafeSign===1?-1:1,r.nextDecisionAt=t+850+n*95);let c=Rm[r.waypoint%Rm.length],l=c.clone().sub(r.position).setY(0),u=l.lengthSq()<5.2;u&&(r.waypoint=(r.waypoint+1+n)%Rm.length);let d=Nd({alive:r.alive,distanceToPlayer:a,hasLineOfSight:s,health:r.hp,now:t,lastShotAt:r.lastShotAt,waypointReached:u,random:r.strafeSign===1?.25:.75,lineOfSightSince:r.sightStartedAt,reactionDelay:210+n*45,burstShotsRemaining:r.burstShots}),f=s?i:l,p=f.lengthSq()>.01?f.normalize():new B(0,0,-1),m=new B(-p.z,0,p.x),h=d.movement===`advance`?p:d.movement===`retreat`?p.clone().multiplyScalar(-1):d.movement===`strafe-left`?m.clone().multiplyScalar(-1):d.movement===`strafe-right`?m:new B,g=d.movement.startsWith(`strafe`)?3.5:s?4.05:4.45,_=r.position.clone().addScaledVector(h,g*e),v=Bd(r.position,_,nh.colliders,nh.bounds,.44);if(Math.hypot(v.x-r.position.x,v.z-r.position.z)<.002&&h.lengthSq()>0){let t=r.position.clone().addScaledVector(m,r.strafeSign*g*e*1.5);v=Bd(r.position,t,nh.colliders,nh.bounds,.44),r.waypoint=(r.waypoint+1)%Rm.length}r.position.set(v.x,r.position.y,v.z),r.root.position.copy(r.position);let y=s?$.position:c;if(r.root.lookAt(y.x,r.position.y+1.1,y.z),d.fire&&$.alive){r.burstShots<=0&&(r.burstShots=2+n%2),--r.burstShots,r.lastShotAt=t;let e=r.position.clone().add(new B(0,1.42,0)),i=$.position.clone().sub(e).normalize(),o=zt.lerp(.038,.014,Math.min(1,(t-Dh.phaseStartedAt)/12e4))+r.burstShots*.004;i.x+=(Math.random()-.5)*o,i.y+=(Math.random()-.5)*o,i.z+=(Math.random()-.5)*o,i.normalize(),Og(e,i,Math.min(a,75),Ud.carbine.color),Xm.shot(`carbine`,!0),new mi(e,i).closestPointToPoint($.position,new B).distanceTo($.position)<.55&&s&&(ng(Qd(Ud.carbine,a,`body`)*.62,r.id),$.alive||(r.kills+=1,Fg()))}}}function xg(){let e=performance.now();if(!sf(2,e,$.lastMeleeAt).hit||!$.alive||Dh.phase!==`active`)return;$.lastMeleeAt=e,Jh.melee(),Xm.melee();let t=mg(eh.getWorldPosition(new B),eh.getWorldDirection(new B));if(!t.playerId||t.distance>2.25)return;let n=ah.get(t.playerId);n?vg(n,70,t.hitZone??`body`):ih.has(t.playerId)&&qh.send({type:`hit`,by:$.id,target:t.playerId,damage:70,nonce:lg()})}function Sg(){if(!$.alive||$.grenades<=0||Dh.phase!==`active`)return;--$.grenades,Jh.throwGrenade();let e=eh.getWorldDirection(new B),t=eh.getWorldPosition(new B).addScaledVector(e,.7),n=new G(new Oo(.16,14,10),new K({color:3424570,roughness:.55,metalness:.48}));n.position.copy(t),n.castShadow=!0,$m.add(n),oh.push({mesh:n,velocity:e.multiplyScalar(13).add(new B(0,5.2,0)),explodeAt:performance.now()+2300,lastBounceAt:0})}function Cg(e){let t=e.mesh.position.clone();$m.remove(e.mesh),Xm.explosion();let n=new G(new Oo(1,20,14),new hi({color:16757324,transparent:!0,opacity:.72}));n.position.copy(t),n.scale.setScalar(.2),$m.add(n);let r=new Ts(16743214,12,18,2);r.position.copy(t),$m.add(r);let i=performance.now(),a=()=>{let e=(performance.now()-i)/420;if(e>=1){$m.remove(n,r);return}n.scale.setScalar(.2+e*5.5),n.material.opacity=.72*(1-e),r.intensity=12*(1-e),requestAnimationFrame(a)};a();for(let e of ah.values()){let n=e.position.clone().add(new B(0,1.1,0)),r=nh.colliders.some(e=>Rd(t,n,e))?0:of(e.position.distanceTo(t));r>0&&vg(e,r,`body`)}for(let e of ih.values()){let n=e.target.clone().add(new B(0,1.1,0));if(nh.colliders.some(e=>Rd(t,n,e)))continue;let r=of(n.distanceTo(t));r>0&&qh.send({type:`hit`,by:$.id,target:e.snapshot.id,damage:r,nonce:lg()})}let o=nh.colliders.some(e=>Rd(t,$.position,e))?0:of($.position.distanceTo(t))*.35;o>0&&ng(o,$.id)}function wg(e,t){for(let n=oh.length-1;n>=0;--n){let r=oh[n];r.velocity.y-=18*e;let i=r.mesh.position.clone(),a=r.velocity.clone().multiplyScalar(e),o=Id(i,a,nh.colliders);if(o){let e=new B(o.normal.x,o.normal.y,o.normal.z);r.mesh.position.copy(i).addScaledVector(a,o.time).addScaledVector(e,.025);let n=r.velocity.dot(e);r.velocity.addScaledVector(e,-(1.38*n)),r.velocity.multiplyScalar(.76),Math.abs(n)>1.8&&t-r.lastBounceAt>90&&(r.lastBounceAt=t,Xm.grenadeBounce(Math.abs(n)))}else r.mesh.position.add(a);if(r.mesh.rotation.x+=e*8,r.mesh.rotation.z+=e*11,r.mesh.position.y<.18){let e=Math.abs(r.velocity.y);e>1.8&&t-r.lastBounceAt>90&&(r.lastBounceAt=t,Xm.grenadeBounce(e)),r.mesh.position.y=.18,r.velocity.y=Math.abs(r.velocity.y)*.42,r.velocity.x*=.72,r.velocity.z*=.72}t>=r.explodeAt&&(oh.splice(n,1),Cg(r))}}function Tg(e){let t=nh.targets.find(t=>t.id===e);!t||!t.active||(t.active=!1,t.root.visible=!1,t.respawnAt=performance.now()+3200,dh+=1,kg(),Xm.hit(),Ag(`+1 test mannequin`,`gold`))}function Eg(e){for(let t of nh.targets){if(lh===`solo`){t.root.visible=!1;continue}!t.active&&e>=t.respawnAt&&(t.active=!0,t.root.visible=!0)}}function Dg(e){let t=new hi({color:16768416,transparent:!0,opacity:.9,depthWrite:!1}),n=new G(new wo(.075,0),t);n.position.copy(e),n.scale.set(1,.55,1),$m.add(n),window.setTimeout(()=>{$m.remove(n),n.geometry.dispose(),t.dispose()},72)}function Og(e,t,n,r){let i=new zr().setFromPoints([e.clone(),e.clone().addScaledVector(t,n)]),a=new Ki(i,new Ri({color:r,transparent:!0,opacity:.72}));$m.add(a),setTimeout(()=>{$m.remove(a),i.dispose(),a.material.dispose()},55)}function kg(e=!1){let t=Q(`#hitmarker`);t.classList.remove(`show`,`headshot`),e&&t.classList.add(`headshot`),requestAnimationFrame(()=>t.classList.add(`show`))}function Ag(e,t){let n=Q(`#killfeed`),r=document.createElement(`div`);for(r.textContent=e,t&&r.classList.add(t),n.prepend(r);n.children.length>6;)n.lastElementChild?.remove();setTimeout(()=>r.classList.add(`fade`),4200),setTimeout(()=>r.remove(),5e3)}function jg(e){if(!ch||!$.alive||Dh.phase===`ended`||!Uh)return;let t=new B(-Math.sin($.yaw),0,-Math.cos($.yaw)),n=new B(Math.cos($.yaw),0,-Math.sin($.yaw)),r=zt.clamp(Number(rh.has(`KeyW`))-Number(rh.has(`KeyS`))-Mh.y,-1,1),i=zt.clamp(Number(rh.has(`KeyD`))-Number(rh.has(`KeyA`))+Mh.x,-1,1),a=t.clone().multiplyScalar(r).addScaledVector(n,i);a.lengthSq()>1&&a.normalize();let o=performance.now();$.crouched=(rh.has(`KeyC`)||Ph)&&Ih,yh=(rh.has(`ShiftLeft`)||Nh)&&a.lengthSq()>0&&Ih&&!uh&&!$.reloadState&&o>=$.switchingUntil&&o-$.lastMeleeAt>500&&qd(r,i,kh,$.crouched);let s=Wd({crouched:$.crouched,ads:kh,sprinting:yh,grounded:Ih}),c=Kd({x:$.velocity.x,z:$.velocity.z},{x:a.x,z:a.z},s,e);$.velocity.x=c.x,$.velocity.z=c.z,$.hp<100&&o-Sh>=5e3&&($.hp=Math.min(100,$.hp+18*e)),Ih&&(bh=o);let l=o-xh<=125,u=Ih||o-bh<=95;l&&u&&!kh&&!$.crouched&&Dh.phase===`active`?($.velocity.y=s.jumpVelocity,Ih=!1,xh=-1e4):($.velocity.y-=24.5*e,Ih&&($.velocity.y=Math.max(0,$.velocity.y)));let d=$.velocity.y,f=Uh.move({x:$.velocity.x*e,y:$.velocity.y*e,z:$.velocity.z*e},e);$.position.set(f.position.x,f.position.y,f.position.z),Ih=f.grounded,Ih&&(bh=o),Ih&&!Lh&&d<-5&&(hh=Math.min(1,Math.abs(d)/14),Xm.land(Math.abs(d))),Lh=Ih,f.blockedX&&($.velocity.x=f.appliedDelta.x/Math.max(e,.001)),f.blockedY&&$.velocity.y<0&&($.velocity.y=0),f.blockedZ&&($.velocity.z=f.appliedDelta.z/Math.max(e,.001));let p=a.lengthSq()>0&&Ih;p&&o-Ch>=(yh?300:$.crouched?575:405)&&(Ch=o,Xm.footstep(yh,$.crouched)),gh+=e*(yh?15:$.crouched?7:10)*(p?1:.25),ph=nf(ph,Ud[$.weapon],e),mh=af(mh,Ud[$.weapon],e),hh=Hd(hh,0,10,e),_h=Hd(_h,$.crouched?-.54:0,15,e);let m=$.velocity.dot(n)/Math.max(1,s.maxSpeed);vh=Hd(vh,-m*(kh?.006:.016),11,e),Jh.update({dt:e,moving:p,sprinting:yh,crouched:$.crouched,ads:kh,phase:gh,landingImpulse:hh,lateralSpeed:m}),eh.fov=Hd(eh.fov,kh?Math.max(55,zh-20):yh?zh+4.5:zh,10,e),eh.updateProjectionMatrix(),eh.position.copy($.position),eh.position.y+=_h-hh*.035,eh.rotation.y=$.yaw+mh.yaw,eh.rotation.x=zt.clamp($.pitch-mh.pitch,-1.42,1.42),eh.rotation.z=vh}function Mg(e,t){for(let[n,r]of ih){if(t-r.lastSeen>12e3){ig(n,`timed out`);continue}let i=1-Math.exp(-13*e);r.root.position.lerp(r.target,i),r.root.rotation.y+=Vd(r.root.rotation.y,r.targetYaw)*i}}function Ng(){let e=$.team===0?$.kills:0,t=$.team===1?$.kills:0;for(let n of ih.values())n.snapshot.team===0?e+=n.snapshot.kills:t+=n.snapshot.kills;for(let n of ah.values())n.team===0?e+=n.kills:t+=n.kills;return[e,t]}function Pg(e){let t=Dh.phase,n=Ng();if(Dh=lf(Dh,e,n),t===Dh.phase)return;let r=Q(`#banner`);if(Dh.phase===`active`){r.innerHTML=`<strong>ENGAGE</strong><span>First squad to 25</span>`,r.hidden=!1,window.setTimeout(()=>{Dh.phase===`active`&&(r.hidden=!0)},900);return}if(Dh.phase===`ended`){Oh=!0;let e=Dh.winner===$.team;r.innerHTML=`<strong>${Dh.winner===`draw`?`DRAW`:e?`VICTORY`:`DEFEAT`}</strong><span>${n[0]} — ${n[1]} · CLICK BOT SKIRMISH FOR REMATCH</span>`,r.hidden=!1,document.exitPointerLock()}}function Fg(){Pg(performance.now())}function Ig(e){let t=Ym,n=qm.width,r=qm.height,i=nh.bounds,a=(e,t)=>ff(e,t,i,n,r);t.clearRect(0,0,n,r),t.fillStyle=`rgba(7, 15, 18, .78)`,t.fillRect(0,0,n,r),t.strokeStyle=`rgba(244, 196, 79, .5)`,t.lineWidth=2,t.strokeRect(2,2,n-4,r-4);let[o]=a(-10.25,0),[s]=a(10.25,0);t.fillStyle=`rgba(126, 137, 132, .18)`,t.fillRect(o,2,s-o,r-4);for(let[e,o,s]of[[-11,-34,0],[11,34,1]]){let[c,l]=a(e,o),u=16.4/(i.maxX-i.minX)*n,d=15/(i.maxZ-i.minZ)*r;t.fillStyle=s===0?`rgba(88, 227, 220, .2)`:`rgba(255, 118, 95, .2)`,t.fillRect(c-u/2,l-d/2,u,d)}for(let e of ih.values()){let n=e.snapshot.team===$.team;if(!n&&e.target.distanceTo($.position)>15)continue;let[r,i]=a(e.target.x,e.target.z);t.fillStyle=n?`#58e3dc`:`#ff765f`,t.beginPath(),t.arc(r,i,3.5,0,Math.PI*2),t.fill()}for(let n of ah.values()){if(!n.alive||!pf(n.position.distanceTo($.position),e,n.lastShotAt))continue;let[r,i]=a(n.position.x,n.position.z);t.fillStyle=`#ff765f`,t.beginPath(),t.arc(r,i,3.5,0,Math.PI*2),t.fill()}let[c,l]=a($.position.x,$.position.z);t.save(),t.translate(c,l),t.rotate(-$.yaw),t.fillStyle=$.team===0?`#58e3dc`:`#ff765f`,t.beginPath(),t.moveTo(0,-7),t.lineTo(5,6),t.lineTo(-5,6),t.closePath(),t.fill(),t.restore()}function Lg(e){if(e-Th<100)return;Th=e,ch&&Pg(e);let t=Ud[$.weapon],n=Math.hypot($.velocity.x,$.velocity.z),r=Xd(t,{ads:kh,moving:n>1.2,crouched:$.crouched,sustainedShots:$.sustainedShots}),i=zt.clamp(5+r*320,5,23),a=Q(`#crosshair`);a.style.setProperty(`--spread`,`${i}px`),a.classList.toggle(`ads`,kh);let[o,s]=Ng();Q(`#health`).textContent=String(Math.ceil($.hp)),Q(`#health-fill`).style.width=`${$.hp}%`,Q(`#weapon-name`).textContent=t.name.toUpperCase(),Q(`#ammo`).textContent=String($.ammo[$.weapon]),Q(`#reserve`).textContent=String($.reserve[$.weapon]),Q(`#aqua-score`).textContent=String(o),Q(`#coral-score`).textContent=String(s);let c=Math.max(0,Dh.endsAt-e),l=Dh.phase===`warmup`?Math.ceil(c/1e3):Math.floor(c/1e3);Q(`#timer`).textContent=Dh.phase===`warmup`?`00:0${Math.min(9,l)}`:`${String(Math.floor(l/60)).padStart(2,`0`)}:${String(l%60).padStart(2,`0`)}`,Q(`#objective`).textContent=Dh.phase===`warmup`?`MATCH STARTS IN ${l}`:`ATOMIC ACRES · FIRST TO 25`,Q(`#reload-state`).textContent=$.reloadState?`RELOADING ${Math.max(0,($.reloadState.endsAt-e)/1e3).toFixed(1)}s`:lh===`solo`?`${$.kills} K / ${$.deaths} D · ${dh} TARGETS`:`${$.kills} K / ${$.deaths} D`,Q(`#stance`).textContent=$.crouched?`CROUCHED`:`STANDING`,Q(`#grenades`).textContent=`FRAG ×${$.grenades}`,Q(`#health-block`).classList.toggle(`critical`,$.hp<=30),Ig(e),Q(`#roster`).hidden||Rg()}function Rg(){let e=[Zh(),...[...ih.values()].map(e=>e.snapshot),...[...ah.values()].map(e=>({id:e.id,name:e.name,team:e.team,x:e.position.x,y:e.position.y,z:e.position.z,yaw:e.root.rotation.y,pitch:0,hp:e.hp,kills:e.kills,deaths:e.deaths,weapon:`carbine`,seq:0}))].sort((e,t)=>t.kills-e.kills||e.deaths-t.deaths);Q(`#roster-list`).innerHTML=e.map(e=>`<div><span class="${e.team===0?`aqua`:`coral`}">${zg(e.name)}</span><b>${e.kills}</b><i>${e.deaths}</i><em>${e.hp>0?Math.ceil(e.hp)+` HP`:`DOWN`}</em></div>`).join(``)}function zg(e){return e.replace(/[&<>'"]/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,"'":`&#39;`,'"':`&quot;`})[e])}function Bg(){let e=window.innerWidth,t=window.innerHeight;Qm.setSize(e,t,!1),eh.aspect=e/Math.max(1,t),eh.updateProjectionMatrix()}window.addEventListener(`resize`,Bg),Bg();var Vg=new URLSearchParams(window.location.search),Hg=Vg.get(`room`)?.trim()??``;Hg&&(Q(`#room-input`).value=Hg);var Ug=Vg.get(`name`);Ug&&(Q(`#player-name`).value=Em(Ug)),Vg.get(`team`)===`1`&&(Q(`#team`).value=`1`);var Wg=Q(`#sensitivity`),Gg=Q(`#field-of-view`);Rh=Number(localStorage.getItem(`atomic-acres-sensitivity`)??Wg.value)||1,zh=Number(localStorage.getItem(`atomic-acres-fov`)??Gg.value)||82,Wg.value=String(Rh),Gg.value=String(zh),Wg.addEventListener(`input`,()=>{Rh=Number(Wg.value),localStorage.setItem(`atomic-acres-sensitivity`,String(Rh))}),Gg.addEventListener(`input`,()=>{zh=Number(Gg.value),localStorage.setItem(`atomic-acres-fov`,String(zh))});function Kg(e){let t=navigator.getGamepads?.().find(e=>!!(e&&e.connected));if(!t){Mh={x:0,y:0},Nh=!1,Ph=!1,Fh=[],uh=Ah,kh=Hh??jh;return}Mh=Yd(t.axes[0]??0,t.axes[1]??0,.14,1.6);let n=Yd(t.axes[2]??0,t.axes[3]??0,.1,1.6),r=t.buttons.map(e=>e.pressed||e.value>.55),i=e=>r[e]&&!Fh[e];Nh=!!r[10],Ph=!!r[1];let a=!!r[6]||(t.buttons[6]?.value??0)>.22,o=!!r[7]||(t.buttons[7]?.value??0)>.22;if(kh=Hh??(jh||a),uh=Ah||o,!(ch&&$.alive&&!Hm.classList.contains(`hidden`))&&ch&&$.alive){let t=kh?1.92:3.66;$.yaw-=n.x*t*e,$.pitch=zt.clamp($.pitch-n.y*t*.82*e,-1.42,1.42),i(0)&&(xh=performance.now()),i(2)&&dg(),i(3)&&ug((Lm.indexOf($.weapon)+1)%Lm.length),i(4)&&Sg(),i(5)&&xg()}Fh=r}window.addEventListener(`keydown`,e=>{rh.add(e.code),e.code===`Space`&&!e.repeat&&(xh=performance.now()),e.code===`Digit1`&&ug(0),e.code===`Digit2`&&ug(1),e.code===`Digit3`&&ug(2),e.code===`KeyR`&&dg(),e.code===`KeyV`&&!e.repeat&&xg(),e.code===`KeyG`&&!e.repeat&&Sg(),e.code===`Tab`&&(e.preventDefault(),Rg(),Q(`#roster`).hidden=!1)}),window.addEventListener(`keyup`,e=>{rh.delete(e.code),e.code===`Tab`&&(Q(`#roster`).hidden=!0)}),window.addEventListener(`blur`,()=>{rh.clear(),Ah=!1,jh=!1,uh=!1,kh=!1}),window.addEventListener(`mousemove`,e=>{if(document.pointerLockElement!==Vm||!$.alive)return;let t=Jd(kh,yh);$.yaw-=e.movementX*.00215*Rh*t,$.pitch=Math.max(-1.42,Math.min(1.42,$.pitch-e.movementY*.0019*Rh*t)),Jh.addMouseDelta(e.movementX,e.movementY)}),Vm.addEventListener(`contextmenu`,e=>e.preventDefault()),Vm.addEventListener(`mousedown`,e=>{if(document.pointerLockElement!==Vm){og();return}if(e.button===2){jh=!0,kh=!0;return}e.button===0&&(Ah=!0,uh=!0,pg(performance.now()))}),window.addEventListener(`mouseup`,e=>{e.button===0&&(Ah=!1),e.button===2&&(jh=!1),uh=Ah,kh=jh}),document.addEventListener(`pointerlockchange`,()=>{document.pointerLockElement===Vm?(Q(`#resume`).hidden=!0,Hm.classList.add(`hidden`)):(Ah=!1,jh=!1,uh=!1,kh=!1,ch&&$.alive&&(Q(`#resume`).hidden=Oh,Hm.classList.remove(`hidden`)))});function qg(){$.kills=0,$.deaths=0,$.hp=100,$.grenades=1,$.reloadState=null,$.sustainedShots=0,$.crouched=!1,dh=0,gg();for(let e of oh)$m.remove(e.mesh);oh.length=0;for(let e of ih.keys())ig(e,`cleared`);Q(`#banner`).hidden=!0,$.ammo={carbine:Ud.carbine.mag,smg:Ud.smg.mag,scattergun:Ud.scattergun.mag},$.reserve={carbine:Ud.carbine.reserve,smg:Ud.smg.reserve,scattergun:Ud.scattergun.reserve}}Q(`#resume`).addEventListener(`click`,()=>{ch&&$.alive&&!Oh&&og()}),Q(`#solo`).addEventListener(`click`,()=>{qh.close(),qg(),cg(`solo`)}),Q(`#host`).addEventListener(`click`,()=>{qg(),qh.host(()=>{Wm.hidden=!1,Gm.textContent=qh.roomCode,cg(`host`)})}),Q(`#join`).addEventListener(`click`,()=>{qg();let e=Q(`#room-input`).value.trim();qh.join(e,()=>cg(`client`))}),Q(`#copy-room`).addEventListener(`click`,async()=>{let e=`${window.location.origin}${window.location.pathname}?room=${encodeURIComponent(qh.roomCode)}`;try{await navigator.clipboard.writeText(e),Wh(`Invite link copied`,`ok`)}catch{Q(`#room-input`).value=qh.roomCode,Wh(`Clipboard blocked — code placed in join field`,`warn`)}}),Hg&&Vg.get(`autojoin`)===`1`&&window.setTimeout(()=>Q(`#join`).click(),100),setInterval(()=>{ch&&qh.role!==`offline`&&$.alive&&qh.send({type:`state`,player:Zh()})},60),window.addEventListener(`beforeunload`,()=>{qh.role!==`offline`&&qh.send({type:`leave`,playerId:$.id}),qh.close()});function Jg(e){try{let t=Math.min(.05,Math.max(0,(e-wh)/1e3));wh=e,Kg(t),fh+=t;let n=1/120,r=0;for(;fh>=n&&r<6;)jg(n),fh-=n,r+=1;uh&&Ud[$.weapon].automatic&&pg(e),fg(e),Eg(e),bg(t,e),wg(t,e),Mg(t,e),Lg(e),Eh||Qm.render($m,eh),requestAnimationFrame(Jg)}catch(e){Gh(e)}}var Yg=window;Yg.__ATOMIC_ACRES_DEBUG__={snapshot:()=>({gameStarted:ch,gameMode:lh,matchPhase:Dh.phase,player:{hp:$.hp,kills:$.kills,deaths:$.deaths,weapon:$.weapon,ammo:$.ammo[$.weapon],reserve:$.reserve[$.weapon],crouched:$.crouched,sprinting:yh,grenades:$.grenades,position:$.position.toArray()},bots:[...ah.values()].map(e=>({id:e.id,hp:e.hp,alive:e.alive,kills:e.kills,position:e.position.toArray()})),remotes:ih.size,grenades:oh.length,originalArtLoaded:$m.getObjectByName(`original-arena-art`)!==void 0,weaponReady:Jh.isReady(),menuVisible:!Hm.classList.contains(`hidden`),render:{calls:Qm.info.render.calls,triangles:Qm.info.render.triangles,points:Qm.info.render.points,lines:Qm.info.render.lines,sceneObjects:$m.children.length,reducedMode:Zm}}),startSolo:()=>{qh.close(),qg(),cg(`solo`,!1)},setBotsFrozen:e=>{Bh=e},setRenderPaused:e=>{Eh=e},fireOnce:()=>{Vh=!0,uh=!0,pg(performance.now()),uh=!1,Vh=!1},throwGrenade:()=>Sg(),switchWeapon:e=>ug(e),reload:()=>dg(),melee:()=>xg(),setAds:e=>{Hh=e,kh=e},damage:e=>{$.invulnerableUntil=0,ng(e,ah.keys().next().value??$.id)}};function Xg(e,t){let n=new Set;e.traverse(e=>{if(!(e instanceof G)||t.getObjectById(e.id))return;let r=Array.isArray(e.material)?e.material:[e.material];for(let e of r){if(n.has(e)||!(e instanceof K))continue;n.add(e);let{r:t,g:r,b:i}=e.color;Math.max(t,r,i)<.16&&e.color.lerp(new U(5989988),.24)}})}async function Zg(){let e=Q(`#solo`),t=Q(`#host`),n=Q(`#join`);e.disabled=!0,t.disabled=!0,n.disabled=!0,Wh(`Loading authored arena art, weapons and advanced collision…`);let r=Fm.create(nh.colliders,nh.bounds),i=Jh.load((e,t)=>{Wh(`Loading authored weapons ${e}/${t}…`)}),a=Cf($m,(e,t)=>{Wh(`Loading authored arena models ${e}/${t}…`)},Zm),[o,,s]=await Promise.all([r,i,a]);Uh=o;let c=nh.raycastMeshes.filter(e=>e.visible||e.userData.collisionProxy===!0);nh.raycastMeshes.splice(0,nh.raycastMeshes.length,...c),s.root.traverse(e=>{e instanceof G&&e.userData.blocksShots===!0&&nh.raycastMeshes.push(e)});let l=$m.getObjectByName(`Atomic Acres arena`);l&&Sd(l,$m,()=>``,Zm),Sd(s.root,$m,()=>``,Zm),Xg($m,Jh.root),Jh.setWeapon($.weapon,!0),sg(),Jh.root.visible=!1,eh.position.set(-32,10.5,-17),eh.lookAt(0,2.8,4),eh.fov=72,eh.updateProjectionMatrix(),e.disabled=!1,t.disabled=!Kh,n.disabled=!Kh,Wh(`Combat Feel Pass 02 ready — tuned locomotion, layered audio, expanded arena art and recoil systems active.`,`ok`),requestAnimationFrame(Jg)}Zg().catch(Gh);