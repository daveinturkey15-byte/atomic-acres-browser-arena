const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./main-BXyiytL8.js","./vendor-peer-vSyl0g0-.js","./preload-helper-DxopCoYJ.js","./preload-helper-C5qjly_W.css","./vendor-three-C4vkaCNH.js","./vendor-three-loaders-Oidku-D7.js"])))=>i.map(i=>d[i]);
import{a as e,t}from"./preload-helper-DxopCoYJ.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var n={schemaVersion:1,canonicalHostname:`daveinturkey15-byte.github.io`,latest:{label:`NEW BUILD`,description:`The newest approved production build.`},stable:{label:`RECENT STABLE`,description:`The exact version that was live immediately before the new build.`,pass:`PASS 59`,pagesSha:`b29d44f1f45a6ade65e72738fc4adb58235f6f26`,path:`channels/recent-stable`}};function r(e,t,n){let r=new URLSearchParams(e);if(r.get(`room`)?.trim())return`latest`;let i=r.get(`release`)?.trim().toLowerCase();return i===`latest`?`latest`:i===`stable`?`stable`:i===`choose`||t.toLowerCase()===n.toLowerCase()?`choose`:`latest`}function i(e,t){let n=t.replace(/^\/+|\/+$/g,``);if(!n||n.split(`/`).some(e=>e===`.`||e===`..`))throw Error(`Stable release path must be a safe relative path`);return new URL(`./${n}/`,e).toString()}var a=n,o=e(),s=document.querySelector(`#app`);if(!s)throw Error(`Missing #app root`);var c=s;async function l(){document.title=`Atomic Acres — Browser Arena FPS`,c.replaceChildren(),await t(()=>import(`./main-BXyiytL8.js`),__vite__mapDeps([0,1,2,3,4,5]),import.meta.url)}function u(){window.location.assign(i(document.baseURI,a.stable.path))}function d(){document.title=`Choose build — Atomic Acres`,c.innerHTML=`
