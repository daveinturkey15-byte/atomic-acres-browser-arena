const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./main-DUPQN3PJ.js","./preload-helper-DI69WAqr.js","./preload-helper-B8MUqsSe.css","./release-identity-DClff7eD.js"])))=>i.map(i=>d[i]);
import{n as e,s as t,t as n}from"./changelog-Cc2a_7xf.js";import{t as r}from"./preload-helper-DI69WAqr.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function i(e,t,n){let r=new URLSearchParams(e);if(r.get(`room`)?.trim())return`latest`;let i=r.get(`release`)?.trim().toLowerCase();return i===`latest`||i===`normal`||i===`experimental`?`latest`:i===`stable`?`stable`:i===`choose`||t.toLowerCase()===n.toLowerCase()?`choose`:`latest`}function a(e,t){let n=t.replace(/^\/+|\/+$/g,``);if(!n||n.split(`/`).some(e=>e===`.`||e===`..`))throw Error(`Stable release path must be a safe relative path`);let r=new URL(`./${n}/`,e);return r.searchParams.set(`release`,`latest`),r.toString()}var o=t,s=o.rollback??o.stable,c=n[0]?.releasedAt!==e,l=c?`The approved Pass 70 gameplay and presentation build.`:`The local Pass 70 HITL candidate. Publication remains disabled until owner approval.`,u=document.querySelector(`#app`);if(!u)throw Error(`Missing #app root`);var d=u;async function f(){document.title=`Nuke Town — Browser Arena FPS`,d.replaceChildren(),await r(()=>import(`./main-DUPQN3PJ.js`),__vite__mapDeps([0,1,2,3]),import.meta.url)}function p(){window.location.assign(a(document.baseURI,s.path))}function m(){document.title=`Choose build — Nuke Town`,d.innerHTML=`
  ...
  `,d.querySelector(`[data-release-choice="latest"]`)?.addEventListener(`click`,()=>{let e=new URL(window.location.href);e.searchParams.set(`release`,`latest`),window.history.replaceState(null,``,e),f()}),d.querySelector(`[data-release-choice="stable"]`)?.addEventListener(`click`,p),d.querySelector(`#release-channel-hard-refresh`)?.addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0;try{if(`caches`in window){let e=await window.caches.keys();await Promise.all(e.map(e=>window.caches.delete(e)))}}finally{let e=new URL(window.location.href);e.searchParams.set(`cachebust`,String(Date.now())),window.location.replace(e.toString())}})}var h=i(window.location.search,window.location.hostname,o.canonicalHostname);h===`choose`?m():h===`stable`?p():f();