const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./main-lQly7H__.js","./preload-helper-2pKNDMXs.js","./preload-helper-BRilSLBe.css","./release-identity-BiLHVgwl.js"])))=>i.map(i=>d[i]);
import{t as e}from"./release-channels-BYO6y9Kk.js";import{t}from"./preload-helper-2pKNDMXs.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function n(e,t,n){let r=new URLSearchParams(e);if(r.get(`room`)?.trim())return`latest`;let i=r.get(`release`)?.trim().toLowerCase();return i===`latest`||i===`normal`||i===`experimental`?`latest`:i===`stable`?`stable`:i===`choose`||t.toLowerCase()===n.toLowerCase()?`choose`:`latest`}function r(e,t){let n=t.replace(/^\/+|\/+$/g,``);if(!n||n.split(`/`).some(e=>e===`.`||e===`..`))throw Error(`Stable release path must be a safe relative path`);let r=new URL(`./${n}/`,e);return r.searchParams.set(`release`,`latest`),r.toString()}var i=e,a=document.querySelector(`#app`);if(!a)throw Error(`Missing #app root`);var o=a;async function s(){document.title=`Nuke Town — Browser Arena FPS`,o.replaceChildren(),await t(()=>import(`./main-lQly7H__.js`),__vite__mapDeps([0,1,2,3]),import.meta.url)}function c(){window.location.assign(r(document.baseURI,i.stable.path))}function l(){document.title=`Choose build — Nuke Town`,o.innerHTML=`
