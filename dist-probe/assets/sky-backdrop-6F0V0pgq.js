import { Ia as ClampToEdgeWrapping, Ju as RepeatWrapping, Ss as ImageLoader, Vd as Texture, dc as LinearFilter, ja as CanvasTexture, nd as SRGBColorSpace } from "./vendor-three-VV5gneRl.js";
...
function skyBackdropPreset(preset) {
	return preset === "sunset-farmland" || preset === "industrial-night" || preset === "airport-dawn" || preset === "indoor-range" || preset === "jungle-golden-hour" || preset === "open-ocean-day" ? preset : "airport-dawn";
}
...
//#endregion
export { waitForSkyBackdropAdmission as a, applySkyBackdrop as i, RUSTWORKS_GENERATED_SKY_ASSET_URL as n, TERMINAL_GENERATED_SKY_ASSET_URL as r, ATOMIC_ACRES_GENERATED_SKY_ASSET_URL as t };
