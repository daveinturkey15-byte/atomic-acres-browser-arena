...
- [Pass 65 decision receipts](PASS65_DECISION_RECEIPTS.json) and [schema](PASS65_DECISION_RECEIPTS.schema.json) - canonical 16-entry receipt registry; P0 created DEC-01…DEC-15 as `OPEN`, Dave froze them on 2026-07-26, and the normalized 2026-07-27 Desktop feedback adds frozen DEC-16 plus supersession lineage for DEC-04/07/08/13.
...
- [Pass 65 estimation and critical path](PASS65_ESTIMATION_AND_CRITICAL_PATH.md) - one-to-one 122-task P50/P90 register, confidence, waits, reserves, and dependency-derived schedule model.
