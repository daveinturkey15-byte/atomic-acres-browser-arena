...
| Task | Owner | Dependencies | Outcome | Requirements | Smallest validation | Exit evidence |
|---|---|---|---|---|---|---|
| P01 | Spec owner | G05,G06 | Add repo-local numbered Pass 65 spec mapped to all 94 requirements/15 decisions. | R005 | Acceptance schema lints. | Spec digest and mapping report. |
...
| P04 | Decision owner | P01 | Maintain typed DEC-01…DEC-15 receipts with `OPEN`/`FROZEN`/`SUPERSEDED`, value, rationale, owner and timestamp; `P04[DEC-x=FROZEN]` alone unlocks a dependent task. | R005 | Decision-ID/status/dependency linter rejects defaults or OPEN receipts as gates. | Validated product-decision register. |
| P05 | QA owner | P01,G06 | Add only classifier-safe docs for the future manifest mapping and evidence-index policy; do not create an invalid pre-preview `acceptance/pass-65.json`. | R005,R009 | Impact classifier, requirement mapping and evidence-policy lint. | Process-only QA policy. |
...
| K04 | RNG/Nuke owner | F12,K03,P04[DEC-03=FROZEN,DEC-13=FROZEN] | Exact integer-unit cost-monotonic pool, hidden host roll, exact 1% and verifier-green care-only Nuke lifecycle. | R503,R512,R604 | Pool/privacy/arithmetic/property/repeat-seed/forced-Nuke tests. | Stored roll/weight/Nuke report. |
...
| K09 | Swarm owner | K08,A05 | Exactly 12, 20-round reload loops, ≤60s, indoor/outdoor acquisition. | R506,R511 | Count/HP/ammo/lifetime/nav/cover stress. | Swarm evidence. |
...
| K12 | Support perf/red team | K03–K11,B01 | Combined package/chopper/bomber/swarm/pilot resource and manifest-driven chaos stress. | R510–R512,R606,R607,R610 | RTX/network/disposal matrix against frozen thresholds. | Support stress receipt. |
...
| Task | Owner | Dependencies | Outcome | Requirements | Smallest validation | Exit evidence |
|---|---|---|---|---|---|---|
| RL01 | Release-shell owner | F00,M01,M02,M03,M04,P04[DEC-15=FROZEN] | Stage exact Pass 65 Live + frozen Pass 64 Stable, the frozen Pass 62 availability policy, chooser/changelog/project-map, aliases and workflow labels before S0. | R002,R003,R007,R611,R612 | Topology/alias/impact/tree tests and staged browser smoke. | Release-shell tree digest and candidate receipt. |
...
| PV01 | Preview owner | RL01,Q01,M04,W16,O06,DW11,K12,S09 | Freeze the final integrated source as immutable S0, record runtime/release-shell tree digests, push that exact candidate and obtain/digest `pr-preview-<pr>-<S0>`; any later runtime/release-shell edit creates a new S0. | R006,R611 | Clean SHA/build/tree/artifact identity, ancestry and deliberate mutation negative fixture. | S0 preview receipt, artifact digest and frozen-path declaration. |
...
| Q04 | Visual QA | PV01,S01–S09,V03,W02–W14,O02–O04,DW10,K03–K11,M04 | Generate the indexed deterministic capability-applicable action/effect/map/profile corpus at exact S0. | R100–R111,R608,R609 | S0 capture index completeness and forbidden-state tests. | S0 contact sheets/videos. |
| Q05 | Accessibility QA | PV01,S02,S08,M01,O03,P04[DEC-14=FROZEN] | Rerun reduced motion/flash/sensory, numeric final-frame flash limits, focus/keyboard/readability/audio controls at exact S0. | R305,R609 | Automated standard plus viewport/state matrix tied to S0. | S0 accessibility report. |
| Q06 | RTX hardware QA | PV01,B01,S04,S05,S06,O06,DW11,K12,M04,RL01 | Same-machine RTX 5080 High/Max all arenas + combined stress at exact S0 against frozen absolute/delta thresholds. | R606,R607,R610 | OS/browser/backend/adapter/pipeline proof and repeated samples. | Immutable S0 local hardware receipt/digest. |
...
| Q10 | Acceptance owner | PV01,Q02–Q09 | Populate all 94 R-rows with S0-bound expected/falsifier/evidence/status while leaving approval absent. | R005,R611 | SHA/digest/evidence lints; missing approval fails only acceptance. | S0 unapproved manifest/evidence digest. |
| Q11 | Hosted CI owner | PV01,Q10 | Four mechanical checks and all Pass 65 hosted groups green on S0; hosted jobs validate local RTX receipt schema/SHA/digest but do not claim the hardware run. | R009,R606,R611 | Hosted exact-SHA matrix; acceptance expected red only for missing approval. | Workflow run IDs and sole-red reason. |
| H01 | Integrator + Dave | PV01,Q11,Q06 | Immutable S0 preview handoff, concise owner route and precomputed evidence review. | R006,R611 | Preview/source/runtime/release-shell/evidence digests agree. | HITL packet. |
| H02 | Dave | H01 | Explicit approve/reject exact preview SHA. | R006 | User decision tied to SHA. | Approval timestamp/SHA. |
| R01 | Integrator | H02 approved | Create approval-only S1 manifest/process commit and prove S0 ancestry plus runtime/release-shell tree parity. | R006,R611 | Path-impact, ancestry and tree-digest comparison. | S1 approval commit and parity receipt. |
...
| R04 | Release/browser verifier | R03 | S0→S1→S2 lineage, controlled build differences or exact-artifact promotion, Pages/receipt/chooser/live/stable/benchmark policy/aliases/logs agree. | R002,R003,R611,R612 | Cache-busted public/tree/lineage checks. | Final production and release-lineage receipt. |
