...
| K09 | Swarm owner | K08,A05,P04[DEC-13=FROZEN] | Exactly 24, behind-caller fast ingress, distributed divergent individual/small-group routes, 20-round unlimited reload loops, ≤60s, indoor/outdoor acquisition of eligible opposing living players and bots, and frozen approximately-five-second exposure/escape survival pressure. | R506,R511 | Count/HP/ammo/lifetime/ingress/separation/route-diversity/nav plus player/bot/team/life target matrix and fixed-start/cover/seed/sample survival-percentile stress. | Swarm eligibility and pressure evidence. |
