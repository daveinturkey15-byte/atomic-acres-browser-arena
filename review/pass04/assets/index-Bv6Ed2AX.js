...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Dc(e,t,n){let r=new Float32Array(pc),i=new z(0,1,0);return new Bo({name:`SphericalGaussianBlur`,defines:{n:pc,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ac(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Oc(){return new Bo({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ac(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function kc(){return new Bo({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ac(),fragmentShader:`
	...
	`}var jc=class extends sn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new $i(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var nu={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function ru(e,t){let n=nu[t];return n===void 0?(F(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var iu=new z;function au(){return V.getLuminanceCoefficients(iu),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${iu.x.toFixed(4)}, ${iu.y.toFixed(4)}, ${iu.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
s=-\r
t=0 0\r
`},n.getDirection=function(e,t){let r=n.splitLines(e);for(let e=0;e<r.length;e++)switch(r[e]){case`a=sendrecv`:case`a=sendonly`:case`a=recvonly`:case`a=inactive`:return r[e].substring(2);default:}return t?n.getDirection(t):`sendrecv`},n.getKind=function(e){return n.splitLines(e)[0].split(` `)[0].substring(2)},n.isRejected=function(e){return e.split(` `,2)[1]===`0`},n.parseMLine=function(e){let t=n.splitLines(e)[0].substring(2).split(` `);return{kind:t[0],port:parseInt(t[1],10),protocol:t[2],fmt:t.slice(3).join(` `)}},n.parseOLine=function(e){let t=n.matchPrefix(e,`o=`)[0].substring(2).split(` `);return{username:t[0],sessionId:t[1],sessionVersion:parseInt(t[2],10),netType:t[3],addressType:t[4],address:t[5]}},n.isValidSDP=function(e){if(typeof e!=`string`||e.length===0)return!1;let t=n.splitLines(e);for(let e=0;e<t.length;e++)if(t[e].length<2||t[e].charAt(1)!==`=`)return!1;return!0},typeof t==`object`&&(t.exports=n)})),Xp=s({removeExtmapAllowMixed:()=>rm,shimAddIceCandidateNullOrEmpty:()=>im,shimConnectionState:()=>nm,shimMaxMessageSize:()=>em,shimParameterlessSetLocalDescription:()=>am,shimRTCIceCandidate:()=>Qp,shimRTCIceCandidateRelayProtocol:()=>$p,shimSendThrowTypeError:()=>tm}),Zp=l(Yp());function Qp(e){if(!e.RTCIceCandidate||e.RTCIceCandidate&&`foundation`in e.RTCIceCandidate.prototype)return;let t=e.RTCIceCandidate;e.RTCIceCandidate=function(e){if(typeof e==`object`&&e.candidate&&e.candidate.indexOf(`a=`)===0&&(e=JSON.parse(JSON.stringify(e)),e.candidate=e.candidate.substring(2)),e.candidate&&e.candidate.length){let n=new t(e),r=Zp.default.parseCandidate(e.candidate);for(let e in r)e in n||Object.defineProperty(n,e,{value:r[e]});return n.toJSON=function(){return{candidate:n.candidate,sdpMid:n.sdpMid,sdpMLineIndex:n.sdpMLineIndex,usernameFragment:n.usernameFragment}},n}return new t(e)},e.RTCIceCandidate.prototype=t.prototype,ip(e,`icecandidate`,t=>(t.candidate&&Object.defineProperty(t,"candidate",{value:new e.RTCIceCandidate(t.candidate),writable:`false`}),t))}function $p(e){!e.RTCIceCandidate||e.RTCIceCandidate&&`relayProtocol`in e.RTCIceCandidate.prototype||ip(e,`icecandidate`,e=>{if(e.candidate){let t=Zp.default.parseCandidate(e.candidate.candidate);t.type===`relay`&&(e.candidate.relayProtocol={0:`tls`,1:`tcp`,2:`udp`}[t.priority>>24])}return e})}function em(e,t){if(!e.RTCPeerConnection||t.browser===`chrome`&&t.version>102||t.browser===`firefox`&&t.version>=113)return;`sctp`in e.RTCPeerConnection.prototype||Object.defineProperty(e.RTCPeerConnection.prototype,"sctp",{get(){return this._sctp===void 0?null:this._sctp}});let n=function(e){if(!e||!e.sdp)return!1;let t=Zp.default.splitSections(e.sdp);return t.shift(),t.some(e=>{let t=Zp.default.parseMLine(e);return t&&t.kind===`application`&&t.protocol.indexOf(`SCTP`)!==-1})},r=function(e){let t=e.sdp.match(/mozilla...THIS_IS_SDPARTA-(\d+)/);if(t===null||t.length<2)return-1;let n=parseInt(t[1],10);return n===n?n:-1},i=function(e){let n=65536;return t.browser===`firefox`&&(n=t.version<57?e===-1?16384:2147483637:t.version<60?t.version===57?65535:65536:2147483637),n},a=function(e,n){let r=65536;t.browser===`firefox`&&t.version===57&&(r=65535);let i=Zp.default.matchPrefix(e.sdp,`a=max-message-size:`);return i.length>0?r=parseInt(i[0].substring(19),10):t.browser===`firefox`&&n!==-1&&(r=2147483637),r},o=e.RTCPeerConnection.prototype.setRemoteDescription;e.RTCPeerConnection.prototype.setRemoteDescription=function(){if(this._sctp=null,t.browser===`chrome`&&t.version>=76){let{sdpSemantics:e}=this.getConfiguration();e===`plan-b`&&Object.defineProperty(this,"sctp",{get(){return this._sctp===void 0?null:this._sctp},enumerable:!0,configurable:!0})}if(n(arguments[0])){let e=r(arguments[0]),t=i(e),n=a(arguments[0],e),o;o=t===0&&n===0?1/0:t===0||n===0?Math.max(t,n):Math.min(t,n);let s={};Object.defineProperty(s,"maxMessageSize",{get(){return o}}),this._sctp=s}return o.apply(this,arguments)}}function tm(e,t){if(!(e.RTCPeerConnection&&`createDataChannel`in e.RTCPeerConnection.prototype)||t.browser===`chrome`&&t.version>=149||t.browser===`firefox`&&t.version>60)return;function n(e,t){let n=e.send;e.send=function(){let r=arguments[0],i=r.length||r.size||r.byteLength;if(e.readyState===`open`&&t.sctp&&i>t.sctp.maxMessageSize)throw TypeError(`Message too large (can send a maximum of `+t.sctp.maxMessageSize+` bytes)`);return n.apply(e,arguments)}}let r=e.RTCPeerConnection.prototype.createDataChannel;e.RTCPeerConnection.prototype.createDataChannel=function(){let e=r.apply(this,arguments);return n(e,this),e},ip(e,`datachannel`,e=>(n(e.channel,e.target),e))}function nm(e){if(!e.RTCPeerConnection||`connectionState`in e.RTCPeerConnection.prototype)return;let t=e.RTCPeerConnection.prototype;Object.defineProperty(t,"connectionState",{get(){return{completed:`connected`,checking:`connecting`}[this.iceConnectionState]||this.iceConnectionState},enumerable:!0,configurable:!0}),Object.defineProperty(t,"onconnectionstatechange",{get(){return this._onconnectionstatechange||null},set(e){this._onconnectionstatechange&&(this.removeEventListener(`connectionstatechange`,this._onconnectionstatechange),delete this._onconnectionstatechange),e&&this.addEventListener(`connectionstatechange`,this._onconnectionstatechange=e)},enumerable:!0,configurable:!0}),[`setLocalDescription`,`setRemoteDescription`].forEach(e=>{let n=t[e];t[e]=function(){return this._connectionstatechangepoly||(this._connectionstatechangepoly=e=>{let t=e.target;if(t._lastConnectionState!==t.connectionState){t._lastConnectionState=t.connectionState;let n=new Event(`connectionstatechange`,e);t.dispatchEvent(n)}return e},this.addEventListener(`iceconnectionstatechange`,this._connectionstatechangepoly)),n.apply(this,arguments)}})}function rm(e,t){if(!e.RTCPeerConnection||t.browser===`chrome`&&t.version>=71||t.browser===`safari`&&t._safariVersion>=13.1)return;let n=e.RTCPeerConnection.prototype.setRemoteDescription;e.RTCPeerConnection.prototype.setRemoteDescription=function(t){if(t&&t.sdp&&t.sdp.indexOf(`
a=extmap-allow-mixed`)!==-1){let n=t.sdp.split(`
`).filter(e=>e.trim()!==`a=extmap-allow-mixed`).join(`
`);e.RTCSessionDescription&&t instanceof e.RTCSessionDescription?arguments[0]=new e.RTCSessionDescription({type:t.type,sdp:n}):t.sdp=n}return n.apply(this,arguments)}}function im(e,t){if(!(e.RTCPeerConnection&&e.RTCPeerConnection.prototype))return;let n=e.RTCPeerConnection.prototype.addIceCandidate;!n||n.length===0||(e.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?(t.browser===`chrome`&&t.version<78||t.browser===`firefox`&&t.version<68||t.browser===`safari`)&&arguments[0]&&arguments[0].candidate===``?Promise.resolve():n.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())})}function am(e,t){if(!(e.RTCPeerConnection&&e.RTCPeerConnection.prototype))return;let n=e.RTCPeerConnection.prototype.setLocalDescription;!n||n.length===0||(e.RTCPeerConnection.prototype.setLocalDescription=function(){let e=arguments[0]||{};if(typeof e!=`object`||e.type&&e.sdp)return n.apply(this,arguments);if(e={type:e.type,sdp:e.sdp},!e.type)switch(this.signalingState){case`stable`:case`have-local-offer`:case`have-remote-pranswer`:e.type=`offer`;break;default:e.type=`answer`;break}return e.sdp||e.type!==`offer`&&e.type!==`answer`?n.apply(this,[e]):(e.type===`offer`?this.createOffer:this.createAnswer).apply(this).then(e=>n.apply(this,[e]))})}function om({window:e}={},t={shimChrome:!0,shimFirefox:!0,shimSafari:!0}){let n=sp,r=lp(e),i={browserDetails:r,commonShim:Xp,extractVersion:rp,disableLog:ap,disableWarnings:op,sdp:Zp};switch(r.browser){case`chrome`:if(!gp||!Cp||!t.shimChrome)return n(`Chrome shim is not included in this adapter release.`),i;if(r.version===null)return n(`Chrome shim can not determine version, not shimming.`),i;n(`adapter.js shimming chrome.`),i.browserShim=gp,im(e,r),am(e,r),hp(e,r),_p(e,r),Cp(e,r),vp(e,r),Sp(e,r),yp(e,r),bp(e,r),wp(e,r),Qp(e,r),$p(e,r),nm(e,r),em(e,r),tm(e,r),rm(e,r);break;case`firefox`:if(!Dp||!kp||!t.shimFirefox)return n(`Firefox shim is not included in this adapter release.`),i;n(`adapter.js shimming firefox.`),i.browserShim=Dp,im(e,r),am(e,r),Tp(e,r),kp(e,r),Ap(e,r),Op(e,r),Np(e,r),jp(e,r),Mp(e,r),Pp(e,r),Fp(e,r),Ip(e,r),Lp(e,r),Rp(e,r),Qp(e,r),nm(e,r),em(e,r),tm(e,r);break;case`safari`:if(!zp||!t.shimSafari)return n(`Safari shim is not included in this adapter release.`),i;n(`adapter.js shimming safari.`),i.browserShim=zp,im(e,r),am(e,r),Gp(e,r),qp(e,r),Hp(e,r),Bp(e,r),Vp(e,r),Kp(e,r),Up(e,r),Jp(e,r),Qp(e,r),$p(e,r),em(e,r),tm(e,r),rm(e,r);break;default:n(`Unsupported browser!`);break}return i}var sm=om({window:typeof window>`u`?void 0:window});function cm(e,t,n,r){Object.defineProperty(e,t,{get:n,set:r,enumerable:!0,configurable:!0})}var lm=class{constructor(){this.chunkedMTU=16300,this._dataCount=1,this.chunk=e=>{let t=[],n=e.byteLength,r=Math.ceil(n/this.chunkedMTU),i=0,a=0;for(;a<n;){let o=Math.min(n,a+this.chunkedMTU),s=e.slice(a,o),c={__peerData:this._dataCount,n:i,data:s,total:r};t.push(c),a=o,i++}return this._dataCount++,t}}};function um(e){let t=0;for(let n of e)t+=n.byteLength;let n=new Uint8Array(t),r=0;for(let t of e)n.set(t,r),r+=t.byteLength;return n}var dm=sm.default||sm,fm=new class{isWebRTCSupported(){return typeof RTCPeerConnection<`u`}isBrowserSupported(){let e=this.getBrowser(),t=this.getVersion();return this.supportedBrowsers.includes(e)?e===`chrome`?t>=this.minChromeVersion:e===`firefox`?t>=this.minFirefoxVersion:e===`safari`?!this.isIOS&&t>=this.minSafariVersion:!1:!1}getBrowser(){return dm.browserDetails.browser}getVersion(){return dm.browserDetails.version||0}isUnifiedPlanSupported(){let e=this.getBrowser(),t=dm.browserDetails.version||0;if(e===`chrome`&&t<this.minChromeVersion)return!1;if(e===`firefox`&&t>=this.minFirefoxVersion)return!0;if(!window.RTCRtpTransceiver||!(`currentDirection`in RTCRtpTransceiver.prototype))return!1;let n,r=!1;try{n=new RTCPeerConnection,n.addTransceiver(`audio`),r=!0}catch{}finally{n&&n.close()}return r}toString(){return`Supports:
    browser:${this.getBrowser()}
    version:${this.getVersion()}
    isIOS:${this.isIOS}
    isWebRTCSupported:${this.isWebRTCSupported()}
    isBrowserSupported:${this.isBrowserSupported()}
    isUnifiedPlanSupported:${this.isUnifiedPlanSupported()}`}constructor(){this.isIOS=typeof navigator<`u`?[`iPad`,`iPhone`,`iPod`].includes(navigator.platform):!1,this.supportedBrowsers=[`firefox`,`chrome`,`safari`],this.minFirefoxVersion=59,this.minChromeVersion=72,this.minSafariVersion=605}},pm=e=>!e||/^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(e),mm=()=>Math.random().toString(36).slice(2),hm={iceServers:[{urls:`stun:stun.l.google.com:19302`},{urls:[`turn:eu-0.turn.peerjs.com:3478`,`turn:us-0.turn.peerjs.com:3478`],username:`peerjs`,credential:`peerjsp`}],sdpSemantics:`unified-plan`},gm=new class extends lm{noop(){}blobToArrayBuffer(e,t){let n=new FileReader;return n.onload=function(e){e.target&&t(e.target.result)},n.readAsArrayBuffer(e),n}binaryStringToArrayBuffer(e){let t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n)&255;return t.buffer}isSecure(){return location.protocol===`https:`}constructor(...e){super(...e),this.CLOUD_HOST=`0.peerjs.com`,this.CLOUD_PORT=443,this.chunkedBrowsers={Chrome:1,chrome:1},this.defaultConfig=hm,this.browser=fm.getBrowser(),this.browserVersion=fm.getVersion(),this.pack=Qf,this.unpack=Zf,this.supports=function(){let e={browser:fm.isBrowserSupported(),webRTC:fm.isWebRTCSupported(),audioVideo:!1,data:!1,binaryBlob:!1,reliable:!1};if(!e.webRTC)return e;let t;try{t=new RTCPeerConnection(hm),e.audioVideo=!0;let n;try{n=t.createDataChannel(`_PEERJSTEST`,{ordered:!0}),e.data=!0,e.reliable=!!n.ordered;try{n.binaryType=`blob`,e.binaryBlob=!fm.isIOS}catch{}}catch{}finally{n&&n.close()}}catch{}finally{t&&t.close()}return e}(),this.validateId=pm,this.randomToken=mm}},_m=`PeerJS: `,X=new class{get logLevel(){return this._logLevel}set logLevel(e){this._logLevel=e}log(...e){this._logLevel>=3&&this._print(3,...e)}warn(...e){this._logLevel>=2&&this._print(2,...e)}error(...e){this._logLevel>=1&&this._print(1,...e)}setLogFunction(e){this._print=e}_print(e,...t){let n=[_m,...t];for(let e in n)n[e]instanceof Error&&(n[e]=`(`+n[e].name+`) `+n[e].message);e>=3?console.log(...n):e>=2?console.warn(`WARNING`,...n):e>=1&&console.error(`ERROR`,...n)}constructor(){this._logLevel=0}},vm={},ym=Object.prototype.hasOwnProperty,bm=`~`;function xm(){}Object.create&&(xm.prototype=Object.create(null),new xm().__proto__||(bm=!1));function Sm(e,t,n){this.fn=e,this.context=t,this.once=n||!1}function Cm(e,t,n,r,i){if(typeof n!=`function`)throw TypeError(`The listener must be a function`);var a=new Sm(n,r||e,i),o=bm?bm+t:t;return e._events[o]?e._events[o].fn?e._events[o]=[e._events[o],a]:e._events[o].push(a):(e._events[o]=a,e._eventsCount++),e}function wm(e,t){--e._eventsCount===0?e._events=new xm:delete e._events[t]}function Tm(){this._events=new xm,this._eventsCount=0}Tm.prototype.eventNames=function(){var e=[],t,n;if(this._eventsCount===0)return e;for(n in t=this._events)ym.call(t,n)&&e.push(bm?n.slice(1):n);return Object.getOwnPropertySymbols?e.concat(Object.getOwnPropertySymbols(t)):e},Tm.prototype.listeners=function(e){var t=bm?bm+e:e,n=this._events[t];if(!n)return[];if(n.fn)return[n.fn];for(var r=0,i=n.length,a=Array(i);r<i;r++)a[r]=n[r].fn;return a},Tm.prototype.listenerCount=function(e){var t=bm?bm+e:e,n=this._events[t];return n?n.fn?1:n.length:0},Tm.prototype.emit=function(e,t,n,r,i,a){var o=bm?bm+e:e;if(!this._events[o])return!1;var s=this._events[o],c=arguments.length,l,u;if(s.fn){switch(s.once&&this.removeListener(e,s.fn,void 0,!0),c){case 1:return s.fn.call(s.context),!0;case 2:return s.fn.call(s.context,t),!0;case 3:return s.fn.call(s.context,t,n),!0;case 4:return s.fn.call(s.context,t,n,r),!0;case 5:return s.fn.call(s.context,t,n,r,i),!0;case 6:return s.fn.call(s.context,t,n,r,i,a),!0}for(u=1,l=Array(c-1);u<c;u++)l[u-1]=arguments[u];s.fn.apply(s.context,l)}else{var d=s.length,f;for(u=0;u<d;u++)switch(s[u].once&&this.removeListener(e,s[u].fn,void 0,!0),c){case 1:s[u].fn.call(s[u].context);break;case 2:s[u].fn.call(s[u].context,t);break;case 3:s[u].fn.call(s[u].context,t,n);break;case 4:s[u].fn.call(s[u].context,t,n,r);break;default:if(!l)for(f=1,l=Array(c-1);f<c;f++)l[f-1]=arguments[f];s[u].fn.apply(s[u].context,l)}}return!0},Tm.prototype.on=function(e,t,n){return Cm(this,e,t,n,!1)},Tm.prototype.once=function(e,t,n){return Cm(this,e,t,n,!0)},Tm.prototype.removeListener=function(e,t,n,r){var i=bm?bm+e:e;if(!this._events[i])return this;if(!t)return wm(this,i),this;var a=this._events[i];if(a.fn)a.fn===t&&(!r||a.once)&&(!n||a.context===n)&&wm(this,i);else{for(var o=0,s=[],c=a.length;o<c;o++)(a[o].fn!==t||r&&!a[o].once||n&&a[o].context!==n)&&s.push(a[o]);s.length?this._events[i]=s.length===1?s[0]:s:wm(this,i)}return this},Tm.prototype.removeAllListeners=function(e){var t;return e?(t=bm?bm+e:e,this._events[t]&&wm(this,t)):(this._events=new xm,this._eventsCount=0),this},Tm.prototype.off=Tm.prototype.removeListener,Tm.prototype.addListener=Tm.prototype.on,Tm.prefixed=bm,Tm.EventEmitter=Tm,vm=Tm;var Em={};cm(Em,`ConnectionType`,()=>Dm),cm(Em,`PeerErrorType`,()=>Om),cm(Em,`BaseConnectionErrorType`,()=>km),cm(Em,`DataConnectionErrorType`,()=>Am),cm(Em,`SerializationType`,()=>jm),cm(Em,`SocketEventType`,()=>Mm),cm(Em,`ServerMessageType`,()=>Nm);var Dm=function(e){return e.Data=`data`,e.Media=`media`,e}({}),Om=function(e){return e.BrowserIncompatible=`browser-incompatible`,e.Disconnected=`disconnected`,e.InvalidID=`invalid-id`,e.InvalidKey=`invalid-key`,e.Network=`network`,e.PeerUnavailable=`peer-unavailable`,e.SslUnavailable=`ssl-unavailable`,e.ServerError=`server-error`,e.SocketError=`socket-error`,e.SocketClosed=`socket-closed`,e.UnavailableID=`unavailable-id`,e.WebRTC=`webrtc`,e}({}),km=function(e){return e.NegotiationFailed=`negotiation-failed`,e.ConnectionClosed=`connection-closed`,e}({}),Am=function(e){return e.NotOpenYet=`not-open-yet`,e.MessageToBig=`message-too-big`,e}({}),jm=function(e){return e.Binary=`binary`,e.BinaryUTF8=`binary-utf8`,e.JSON=`json`,e.None=`raw`,e}({}),Mm=function(e){return e.Message=`message`,e.Disconnected=`disconnected`,e.Error=`error`,e.Close=`close`,e}({}),Nm=function(e){return e.Heartbeat=`HEARTBEAT`,e.Candidate=`CANDIDATE`,e.Offer=`OFFER`,e.Answer=`ANSWER`,e.Open=`OPEN`,e.Error=`ERROR`,e.IdTaken=`ID-TAKEN`,e.InvalidKey=`INVALID-KEY`,e.Leave=`LEAVE`,e.Expire=`EXPIRE`,e}({}),Pm=`1.5.5`,Fm=class extends vm.EventEmitter{constructor(e,t,n,r,i,a=5e3){super(),this.pingInterval=a,this._disconnected=!0,this._messagesQueue=[];let o=e?`wss://`:`ws://`;this._baseUrl=o+t+`:`+n+r+`peerjs?key=`+i}start(e,t){this._id=e;let n=`${this._baseUrl}&id=${e}&token=${t}`;this._socket||!this._disconnected||(this._socket=new WebSocket(n+`&version=1.5.5`),this._disconnected=!1,this._socket.onmessage=e=>{let t;try{t=JSON.parse(e.data),X.log(`Server message received:`,t)}catch{X.log(`Invalid server message`,e.data);return}this.emit(Mm.Message,t)},this._socket.onclose=e=>{this._disconnected||(X.log(`Socket closed.`,e),this._cleanup(),this._disconnected=!0,this.emit(Mm.Disconnected))},this._socket.onopen=()=>{this._disconnected||(this._sendQueuedMessages(),X.log(`Socket open`),this._scheduleHeartbeat())})}_scheduleHeartbeat(){this._wsPingTimer=setTimeout(()=>{this._sendHeartbeat()},this.pingInterval)}_sendHeartbeat(){if(!this._wsOpen()){X.log(`Cannot send heartbeat, because socket closed`);return}let e=JSON.stringify({type:Nm.Heartbeat});this._socket.send(e),this._scheduleHeartbeat()}_wsOpen(){return!!this._socket&&this._socket.readyState===1}_sendQueuedMessages(){let e=[...this._messagesQueue];this._messagesQueue=[];for(let t of e)this.send(t)}send(e){if(this._disconnected)return;if(!this._id){this._messagesQueue.push(e);return}if(!e.type){this.emit(Mm.Error,`Invalid message`);return}if(!this._wsOpen())return;let t=JSON.stringify(e);this._socket.send(t)}close(){this._disconnected||=(this._cleanup(),!0)}_cleanup(){this._socket&&=(this._socket.onopen=this._socket.onmessage=this._socket.onclose=null,this._socket.close(),void 0),clearTimeout(this._wsPingTimer)}},Im=class{constructor(e){this.connection=e}startConnection(e){let t=this._startPeerConnection();if(this.connection.peerConnection=t,this.connection.type===Dm.Media&&e._stream&&this._addTracksToConnection(e._stream,t),e.originator){let n=this.connection,r={ordered:!!e.reliable},i=t.createDataChannel(n.label,r);n._initializeDataChannel(i),this._makeOffer()}else this.handleSDP(`OFFER`,e.sdp)}_startPeerConnection(){X.log(`Creating RTCPeerConnection.`);let e=new RTCPeerConnection(this.connection.provider.options.config);return this._setupListeners(e),e}_setupListeners(e){let t=this.connection.peer,n=this.connection.connectionId,r=this.connection.type,i=this.connection.provider;X.log(`Listening for ICE candidates.`),e.onicecandidate=e=>{!e.candidate||!e.candidate.candidate||(X.log(`Received ICE candidates for ${t}:`,e.candidate),i.socket.send({type:Nm.Candidate,payload:{candidate:e.candidate,type:r,connectionId:n},dst:t}))},e.oniceconnectionstatechange=()=>{switch(e.iceConnectionState){case`failed`:X.log(`iceConnectionState is failed, closing connections to `+t),this.connection.emitError(km.NegotiationFailed,`Negotiation of connection to `+t+` failed.`),this.connection.close();break;case`closed`:X.log(`iceConnectionState is closed, closing connections to `+t),this.connection.emitError(km.ConnectionClosed,`Connection to `+t+` closed.`),this.connection.close();break;case`disconnected`:X.log(`iceConnectionState changed to disconnected on the connection with `+t);break;case`completed`:e.onicecandidate=()=>{};break}this.connection.emit(`iceStateChanged`,e.iceConnectionState)},X.log(`Listening for data channel`),e.ondatachannel=e=>{X.log(`Received data channel`);let r=e.channel;i.getConnection(t,n)._initializeDataChannel(r)},X.log(`Listening for remote stream`),e.ontrack=e=>{X.log(`Received remote stream`);let r=e.streams[0],a=i.getConnection(t,n);if(a.type===Dm.Media){let e=a;this._addStreamToMediaConnection(r,e)}}}cleanup(){X.log(`Cleaning up PeerConnection to `+this.connection.peer);let e=this.connection.peerConnection;if(!e)return;this.connection.peerConnection=null,e.onicecandidate=e.oniceconnectionstatechange=e.ondatachannel=e.ontrack=()=>{};let t=e.signalingState!==`closed`,n=!1,r=this.connection.dataChannel;r&&(n=!!r.readyState&&r.readyState!==`closed`),(t||n)&&e.close()}async _makeOffer(){let e=this.connection.peerConnection,t=this.connection.provider;try{let n=await e.createOffer(this.connection.options.constraints);X.log(`Created offer.`),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform==`function`&&(n.sdp=this.connection.options.sdpTransform(n.sdp)||n.sdp);try{await e.setLocalDescription(n),X.log(`Set localDescription:`,n,`for:${this.connection.peer}`);let r={sdp:n,type:this.connection.type,connectionId:this.connection.connectionId,metadata:this.connection.metadata};if(this.connection.type===Dm.Data){let e=this.connection;r={...r,label:e.label,reliable:e.reliable,serialization:e.serialization}}t.socket.send({type:Nm.Offer,payload:r,dst:this.connection.peer})}catch(e){e!=`OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer`&&(t.emitError(Om.WebRTC,e),X.log(`Failed to setLocalDescription, `,e))}}catch(e){t.emitError(Om.WebRTC,e),X.log(`Failed to createOffer, `,e)}}async _makeAnswer(){let e=this.connection.peerConnection,t=this.connection.provider;try{let n=await e.createAnswer();X.log(`Created answer.`),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform==`function`&&(n.sdp=this.connection.options.sdpTransform(n.sdp)||n.sdp);try{await e.setLocalDescription(n),X.log(`Set localDescription:`,n,`for:${this.connection.peer}`),t.socket.send({type:Nm.Answer,payload:{sdp:n,type:this.connection.type,connectionId:this.connection.connectionId},dst:this.connection.peer})}catch(e){t.emitError(Om.WebRTC,e),X.log(`Failed to setLocalDescription, `,e)}}catch(e){t.emitError(Om.WebRTC,e),X.log(`Failed to create answer, `,e)}}async handleSDP(e,t){t=new RTCSessionDescription(t);let n=this.connection.peerConnection,r=this.connection.provider;X.log(`Setting remote description`,t);let i=this;try{await n.setRemoteDescription(t),X.log(`Set remoteDescription:${e} for:${this.connection.peer}`),e===`OFFER`&&await i._makeAnswer()}catch(e){r.emitError(Om.WebRTC,e),X.log(`Failed to setRemoteDescription, `,e)}}async handleCandidate(e){X.log(`handleCandidate:`,e);try{await this.connection.peerConnection.addIceCandidate(e),X.log(`Added ICE candidate for:${this.connection.peer}`)}catch(e){this.connection.provider.emitError(Om.WebRTC,e),X.log(`Failed to handleCandidate, `,e)}}_addTracksToConnection(e,t){if(X.log(`add tracks from stream ${e.id} to peer connection`),!t.addTrack)return X.error(`Your browser does't support RTCPeerConnection#addTrack. Ignored.`);e.getTracks().forEach(n=>{t.addTrack(n,e)})}_addStreamToMediaConnection(e,t){X.log(`add stream ${e.id} to media connection ${t.connectionId}`),t.addStream(e)}},Lm=class extends vm.EventEmitter{emitError(e,t){X.error(`Error:`,t),this.emit(`error`,new Rm(`${e}`,t))}},Rm=class extends Error{constructor(e,t){typeof t==`string`?super(t):(super(),Object.assign(this,t)),this.type=e}},zm=class extends Lm{get open(){return this._open}constructor(e,t,n){super(),this.peer=e,this.provider=t,this.options=n,this._open=!1,this.metadata=n.metadata}},Bm=class e extends zm{static#e=this.ID_PREFIX=`mc_`;get type(){return Dm.Media}get localStream(){return this._localStream}get remoteStream(){return this._remoteStream}constructor(t,n,r){super(t,n,r),this._localStream=this.options._stream,this.connectionId=this.options.connectionId||e.ID_PREFIX+gm.randomToken(),this._negotiator=new Im(this),this._localStream&&this._negotiator.startConnection({_stream:this._localStream,originator:!0})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{X.log(`DC#${this.connectionId} dc connection success`),this.emit(`willCloseOnRemote`)},this.dataChannel.onclose=()=>{X.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}addStream(e){X.log(`Receiving stream`,e),this._remoteStream=e,super.emit(`stream`,e)}handleMessage(e){let t=e.type,n=e.payload;switch(e.type){case Nm.Answer:this._negotiator.handleSDP(t,n.sdp),this._open=!0;break;case Nm.Candidate:this._negotiator.handleCandidate(n.candidate);break;default:X.warn(`Unrecognized message type:${t} from peer:${this.peer}`);break}}answer(e,t={}){if(this._localStream){X.warn(`Local stream already exists on this MediaConnection. Are you answering a call twice?`);return}this._localStream=e,t&&t.sdpTransform&&(this.options.sdpTransform=t.sdpTransform),this._negotiator.startConnection({...this.options._payload,_stream:e});let n=this.provider._getMessages(this.connectionId);for(let e of n)this.handleMessage(e);this._open=!0}close(){this._negotiator&&=(this._negotiator.cleanup(),null),this._localStream=null,this._remoteStream=null,this.provider&&=(this.provider._removeConnection(this),null),this.options&&this.options._stream&&(this.options._stream=null),this.open&&(this._open=!1,super.emit(`close`))}},Vm=class{constructor(e){this._options=e}_buildRequest(e){let t=this._options.secure?`https`:`http`,{host:n,port:r,path:i,key:a}=this._options,o=new URL(`${t}://${n}:${r}${i}${a}/${e}`);return o.searchParams.set(`ts`,`${Date.now()}${Math.random()}`),o.searchParams.set(`version`,Pm),fetch(o.href,{referrerPolicy:this._options.referrerPolicy})}async retrieveId(){try{let e=await this._buildRequest(`id`);if(e.status!==200)throw Error(`Error. Status:${e.status}`);return e.text()}catch(e){X.error(`Error retrieving ID`,e);let t=``;throw this._options.path===`/`&&this._options.host!==gm.CLOUD_HOST&&(t=" If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."),Error(`Could not get an ID from the server.`+t)}}async listAllPeers(){try{let e=await this._buildRequest(`peers`);if(e.status!==200){if(e.status===401){let e=``;throw e=this._options.host===gm.CLOUD_HOST?`It looks like you're using the cloud server. You can email team@peerjs.com to enable peer listing for your API key.`:"You need to enable `allow_discovery` on your self-hosted PeerServer to use this feature.",Error(`It doesn't look like you have permission to list peers IDs. `+e)}throw Error(`Error. Status:${e.status}`)}return e.json()}catch(e){throw X.error(`Error retrieving list peers`,e),Error(`Could not get list peers from the server.`+e)}}},Hm=class e extends zm{static#e=this.ID_PREFIX=`dc_`;static#t=this.MAX_BUFFERED_AMOUNT=8388608;get type(){return Dm.Data}constructor(t,n,r){super(t,n,r),this.connectionId=this.options.connectionId||e.ID_PREFIX+mm(),this.label=this.options.label||this.connectionId,this.reliable=!!this.options.reliable,this._negotiator=new Im(this),this._negotiator.startConnection(this.options._payload||{originator:!0,reliable:this.reliable})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{X.log(`DC#${this.connectionId} dc connection success`),this._open=!0,this.emit(`open`)},this.dataChannel.onmessage=e=>{X.log(`DC#${this.connectionId} dc onmessage:`,e.data)},this.dataChannel.onclose=()=>{X.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}close(e){if(e?.flush){this.send({__peerData:{type:`close`}});return}this._negotiator&&=(this._negotiator.cleanup(),null),this.provider&&=(this.provider._removeConnection(this),null),this.dataChannel&&=(this.dataChannel.onopen=null,this.dataChannel.onmessage=null,this.dataChannel.onclose=null,null),this.open&&(this._open=!1,super.emit(`close`))}send(e,t=!1){if(!this.open){this.emitError(Am.NotOpenYet,"Connection is not open. You should listen for the `open` event before sending messages.");return}return this._send(e,t)}async handleMessage(e){let t=e.payload;switch(e.type){case Nm.Answer:await this._negotiator.handleSDP(e.type,t.sdp);break;case Nm.Candidate:await this._negotiator.handleCandidate(t.candidate);break;default:X.warn(`Unrecognized message type:`,e.type,`from peer:`,this.peer);break}}},Um=class extends Hm{get bufferSize(){return this._bufferSize}_initializeDataChannel(e){super._initializeDataChannel(e),this.dataChannel.binaryType=`arraybuffer`,this.dataChannel.addEventListener(`message`,e=>this._handleDataMessage(e))}_bufferedSend(e){(this._buffering||!this._trySend(e))&&(this._buffer.push(e),this._bufferSize=this._buffer.length)}_trySend(e){if(!this.open)return!1;if(this.dataChannel.bufferedAmount>Hm.MAX_BUFFERED_AMOUNT)return this._buffering=!0,setTimeout(()=>{this._buffering=!1,this._tryBuffer()},50),!1;try{this.dataChannel.send(e)}catch(e){return X.error(`DC#:${this.connectionId} Error when sending:`,e),this._buffering=!0,this.close(),!1}return!0}_tryBuffer(){if(!this.open||this._buffer.length===0)return;let e=this._buffer[0];this._trySend(e)&&(this._buffer.shift(),this._bufferSize=this._buffer.length,this._tryBuffer())}close(e){if(e?.flush){this.send({__peerData:{type:`close`}});return}this._buffer=[],this._bufferSize=0,super.close()}constructor(...e){super(...e),this._buffer=[],this._bufferSize=0,this._buffering=!1}},Wm=class extends Um{close(e){super.close(e),this._chunkedData={}}constructor(e,t,n){super(e,t,n),this.chunker=new lm,this.serialization=jm.Binary,this._chunkedData={}}_handleDataMessage({data:e}){let t=Zf(e),n=t.__peerData;if(n){if(n.type===`close`){this.close();return}this._handleChunk(t);return}this.emit(`data`,t)}_handleChunk(e){let t=e.__peerData,n=this._chunkedData[t]||{data:[],count:0,total:e.total};if(n.data[e.n]=new Uint8Array(e.data),n.count++,this._chunkedData[t]=n,n.total===n.count){delete this._chunkedData[t];let e=um(n.data);this._handleDataMessage({data:e})}}_send(e,t){let n=Qf(e);if(n instanceof Promise)return this._send_blob(n);if(!t&&n.byteLength>this.chunker.chunkedMTU){this._sendChunks(n);return}this._bufferedSend(n)}async _send_blob(e){let t=await e;if(t.byteLength>this.chunker.chunkedMTU){this._sendChunks(t);return}this._bufferedSend(t)}_sendChunks(e){let t=this.chunker.chunk(e);X.log(`DC#${this.connectionId} Try to send ${t.length} chunks...`);for(let e of t)this.send(e,!0)}},Gm=class extends Um{_handleDataMessage({data:e}){super.emit(`data`,e)}_send(e,t){this._bufferedSend(e)}constructor(...e){super(...e),this.serialization=jm.None}},Km=class extends Um{_handleDataMessage({data:e}){let t=this.parse(this.decoder.decode(e)),n=t.__peerData;if(n&&n.type===`close`){this.close();return}this.emit(`data`,t)}_send(e,t){let n=this.encoder.encode(this.stringify(e));if(n.byteLength>=gm.chunkedMTU){this.emitError(Am.MessageToBig,`Message too big for JSON channel`);return}this._bufferedSend(n)}constructor(...e){super(...e),this.serialization=jm.JSON,this.encoder=new TextEncoder,this.decoder=new TextDecoder,this.stringify=JSON.stringify,this.parse=JSON.parse}},qm=class e extends Lm{static#e=this.DEFAULT_KEY=`peerjs`;get id(){return this._id}get options(){return this._options}get open(){return this._open}get socket(){return this._socket}get connections(){let e=Object.create(null);for(let[t,n]of this._connections)e[t]=n;return e}get destroyed(){return this._destroyed}get disconnected(){return this._disconnected}constructor(t,n){super(),this._serializers={raw:Gm,json:Km,binary:Wm,"binary-utf8":Wm,default:Wm},this._id=null,this._lastServerId=null,this._destroyed=!1,this._disconnected=!1,this._open=!1,this._connections=new Map,this._lostMessages=new Map;let r;if(t&&t.constructor==Object?n=t:t&&(r=t.toString()),n={debug:0,host:gm.CLOUD_HOST,port:gm.CLOUD_PORT,path:`/`,key:e.DEFAULT_KEY,token:gm.randomToken(),config:gm.defaultConfig,referrerPolicy:`strict-origin-when-cross-origin`,serializers:{},...n},this._options=n,this._serializers={...this._serializers,...this.options.serializers},this._options.host===`/`&&(this._options.host=window.location.hostname),this._options.path&&(this._options.path[0]!==`/`&&(this._options.path=`/`+this._options.path),this._options.path[this._options.path.length-1]!==`/`&&(this._options.path+=`/`)),this._options.secure===void 0&&this._options.host!==gm.CLOUD_HOST?this._options.secure=gm.isSecure():this._options.host==gm.CLOUD_HOST&&(this._options.secure=!0),this._options.logFunction&&X.setLogFunction(this._options.logFunction),X.logLevel=this._options.debug||0,this._api=new Vm(n),this._socket=this._createServerConnection(),!gm.supports.audioVideo&&!gm.supports.data){this._delayedAbort(Om.BrowserIncompatible,`The current browser does not support WebRTC`);return}if(r&&!gm.validateId(r)){this._delayedAbort(Om.InvalidID,`ID "${r}" is invalid`);return}r?this._initialize(r):this._api.retrieveId().then(e=>this._initialize(e)).catch(e=>this._abort(Om.ServerError,e))}_createServerConnection(){let e=new Fm(this._options.secure,this._options.host,this._options.port,this._options.path,this._options.key,this._options.pingInterval);return e.on(Mm.Message,e=>{this._handleMessage(e)}),e.on(Mm.Error,e=>{this._abort(Om.SocketError,e)}),e.on(Mm.Disconnected,()=>{this.disconnected||(this.emitError(Om.Network,`Lost connection to server.`),this.disconnect())}),e.on(Mm.Close,()=>{this.disconnected||this._abort(Om.SocketClosed,`Underlying socket is already closed.`)}),e}_initialize(e){this._id=e,this.socket.start(e,this._options.token)}_handleMessage(e){let t=e.type,n=e.payload,r=e.src;switch(t){case Nm.Open:this._lastServerId=this.id,this._open=!0,this.emit(`open`,this.id);break;case Nm.Error:this._abort(Om.ServerError,n.msg);break;case Nm.IdTaken:this._abort(Om.UnavailableID,`ID "${this.id}" is taken`);break;case Nm.InvalidKey:this._abort(Om.InvalidKey,`API KEY "${this._options.key}" is invalid`);break;case Nm.Leave:X.log(`Received leave message from ${r}`),this._cleanupPeer(r),this._connections.delete(r);break;case Nm.Expire:this.emitError(Om.PeerUnavailable,`Could not connect to peer ${r}`);break;case Nm.Offer:{let e=n.connectionId,t=this.getConnection(r,e);if(t&&(t.close(),X.warn(`Offer received for existing Connection ID:${e}`)),n.type===Dm.Media){let i=new Bm(r,this,{connectionId:e,_payload:n,metadata:n.metadata});t=i,this._addConnection(r,t),this.emit(`call`,i)}else if(n.type===Dm.Data){let i=new this._serializers[n.serialization](r,this,{connectionId:e,_payload:n,metadata:n.metadata,label:n.label,serialization:n.serialization,reliable:n.reliable});t=i,this._addConnection(r,t),this.emit(`connection`,i)}else{X.warn(`Received malformed connection type:${n.type}`);return}let i=this._getMessages(e);for(let e of i)t.handleMessage(e);break}default:{if(!n){X.warn(`You received a malformed message from ${r} of type ${t}`);return}let i=n.connectionId,a=this.getConnection(r,i);a&&a.peerConnection?a.handleMessage(e):i?this._storeMessage(i,e):X.warn(`You received an unrecognized message:`,e);break}}}_storeMessage(e,t){this._lostMessages.has(e)||this._lostMessages.set(e,[]),this._lostMessages.get(e).push(t)}_getMessages(e){let t=this._lostMessages.get(e);return t?(this._lostMessages.delete(e),t):[]}connect(e,t={}){if(t={serialization:`default`,...t},this.disconnected){X.warn(`You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect, or call reconnect on this peer if you believe its ID to still be available.`),this.emitError(Om.Disconnected,`Cannot connect to new Peer after disconnecting from server.`);return}let n=new this._serializers[t.serialization](e,this,t);return this._addConnection(e,n),n}call(e,t,n={}){if(this.disconnected){X.warn(`You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect.`),this.emitError(Om.Disconnected,`Cannot connect to new Peer after disconnecting from server.`);return}if(!t){X.error("To call a peer, you must provide a stream from your browser's `getUserMedia`.");return}let r=new Bm(e,this,{...n,_stream:t});return this._addConnection(e,r),r}_addConnection(e,t){X.log(`add connection ${t.type}:${t.connectionId} to peerId:${e}`),this._connections.has(e)||this._connections.set(e,[]),this._connections.get(e).push(t)}_removeConnection(e){let t=this._connections.get(e.peer);if(t){let n=t.indexOf(e);n!==-1&&t.splice(n,1)}this._lostMessages.delete(e.connectionId)}getConnection(e,t){let n=this._connections.get(e);if(!n)return null;for(let e of n)if(e.connectionId===t)return e;return null}_delayedAbort(e,t){setTimeout(()=>{this._abort(e,t)},0)}_abort(e,t){X.error(`Aborting!`),this.emitError(e,t),this._lastServerId?this.disconnect():this.destroy()}destroy(){this.destroyed||(X.log(`Destroy peer with ID:${this.id}`),this.disconnect(),this._cleanup(),this._destroyed=!0,this.emit(`close`))}_cleanup(){for(let e of this._connections.keys())this._cleanupPeer(e),this._connections.delete(e);this.socket.removeAllListeners()}_cleanupPeer(e){let t=this._connections.get(e);if(t)for(let e of t)e.close()}disconnect(){if(this.disconnected)return;let e=this.id;X.log(`Disconnect peer with ID:${e}`),this._disconnected=!0,this._open=!1,this.socket.close(),this._lastServerId=e,this._id=null,this.emit(`disconnected`,e)}reconnect(){if(this.disconnected&&!this.destroyed)X.log(`Attempting reconnection to server with ID ${this._lastServerId}`),this._disconnected=!1,this._initialize(this._lastServerId);else if(this.destroyed)throw Error(`This peer cannot reconnect to the server. It has already been destroyed.`);else if(!this.disconnected&&!this.open)X.error(`In a hurry? We're still trying to make the initial connection!`);else throw Error(`Peer ${this.id} cannot reconnect because it is not disconnected from the server!`)}listAllPeers(e=e=>{}){this._api.listAllPeers().then(t=>e(t)).catch(e=>this._abort(Om.ServerError,e))}},Jm=new Set([`carbine`,`smg`,`scattergun`]);function Ym(e){if(!e||typeof e!=`object`)return!1;let t=e;return typeof t.id==`string`&&t.id.length>0&&t.id.length<=80&&typeof t.name==`string`&&t.name.length>0&&t.name.length<=20&&(t.team===0||t.team===1)&&[`x`,`y`,`z`,`yaw`,`pitch`,`hp`,`kills`,`deaths`,`seq`].every(e=>Number.isFinite(t[e]))&&(t.stance===void 0||t.stance===`stand`||t.stance===`crouch`||t.stance===`prone`)&&Jm.has(t.weapon)}function Xm(e){if(!e||typeof e!=`object`)return!1;let t=e;switch(t.type){case`join`:case`state`:return Ym(t.player);case`shot`:return typeof t.by==`string`&&Jm.has(t.weapon)&&Array.isArray(t.origin)&&t.origin.length===3&&t.origin.every(Number.isFinite)&&Array.isArray(t.direction)&&t.direction.length===3&&t.direction.every(Number.isFinite)&&Number.isFinite(t.nonce);case`hit`:return typeof t.by==`string`&&typeof t.target==`string`&&Number.isFinite(t.damage)&&Number(t.damage)>0&&Number(t.damage)<=100&&Number.isFinite(t.nonce);case`death`:return typeof t.killer==`string`&&typeof t.victim==`string`&&Number.isFinite(t.nonce);case`leave`:return typeof t.playerId==`string`;case`chat`:return typeof t.by==`string`&&typeof t.text==`string`&&t.text.length<=160;default:return!1}}function Zm(e){return e.replace(/[^a-zA-Z0-9 _-]/g,``).trim().slice(0,16)||`Player${Math.floor(Math.random()*900+100)}`}var Qm=class{role=`offline`;roomCode=``;peer=null;hostConnection=null;guests=new Set;onMessage;onStatus;onReady=null;constructor(e,t){this.onMessage=e,this.onStatus=t}host(e){this.close(),this.role=`host`,this.onReady=e,this.onStatus(`Opening a secure peer lobby…`);let t=new qm;this.peer=t,t.on(`open`,t=>{this.roomCode=t,this.onStatus(`Lobby ready — share the room code`,`ok`),e()}),t.on(`connection`,e=>this.wireGuest(e)),t.on(`error`,e=>this.onStatus(this.describeError(e),`error`)),t.on(`disconnected`,()=>this.onStatus(`Signalling disconnected; existing peers may continue`,`warn`))}join(e,t){if(this.close(),this.role=`client`,this.roomCode=e.trim(),this.onReady=t,!this.roomCode){this.onStatus(`Enter a room code first`,`error`);return}this.onStatus(`Connecting to peer lobby…`);let n=new qm;this.peer=n,n.on(`open`,()=>{let e=n.connect(this.roomCode,{reliable:!0,serialization:`json`});this.hostConnection=e,this.wireHost(e)}),n.on(`error`,e=>this.onStatus(this.describeError(e),`error`)),n.on(`disconnected`,()=>this.onStatus(`Signalling disconnected; attempting to preserve session`,`warn`))}send(e){Xm(e)&&(this.role===`host`?this.broadcast(e):this.role===`client`&&this.hostConnection?.open&&this.hostConnection.send(e))}close(){if(this.hostConnection)try{this.hostConnection.close()}catch{}for(let e of this.guests)try{e.close()}catch{}if(this.guests.clear(),this.hostConnection=null,this.peer)try{this.peer.destroy()}catch{}this.peer=null,this.roomCode=``,this.role=`offline`,this.onReady=null}wireGuest(e){this.guests.add(e);let t=``;e.on(`open`,()=>this.onStatus(`${this.guests.size} guest connection${this.guests.size===1?``:`s`}`,`ok`)),e.on(`data`,n=>{Xm(n)&&(n.type===`join`&&(t=n.player.id),this.onMessage(n),this.broadcast(n,e))}),e.on(`close`,()=>{if(this.guests.delete(e),t){let e={type:`leave`,playerId:t};this.onMessage(e),this.broadcast(e)}this.onStatus(`A guest left the lobby`,`warn`)}),e.on(`error`,()=>this.onStatus(`Guest data channel failed`,`error`))}wireHost(e){e.on(`open`,()=>{this.onStatus(`Connected to host`,`ok`),this.onReady?.()}),e.on(`data`,e=>{Xm(e)&&this.onMessage(e)}),e.on(`close`,()=>this.onStatus(`Host connection closed`,`error`)),e.on(`error`,()=>this.onStatus(`Could not establish peer data channel`,`error`))}broadcast(e,t){for(let n of this.guests)n!==t&&n.open&&n.send(e)}describeError(e){let t=e instanceof Error?e.message:String(e);return/peer-unavailable/i.test(t)?`Room not found. Check the code and try again.`:/network|server/i.test(t)?`Peer signalling is unavailable. Check the connection and retry.`:`Network error: ${t.slice(0,120)}`}},$m=`modulepreload`,eh=function(e,t){return new URL(e,t).href},th={},nh=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,new URL(`../../../src/node/plugins/importAnalysisBuild.ts`,import.meta.url)).href}r=o(t.map(t=>{if(t=eh(t,n),t=s(t),t in th)return;th[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:$m,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},rh=.38,ih=.53,ah={stand:{halfHeight:ih,radius:rh,eyeFromCenter:.79},crouch:{halfHeight:.22,radius:.36,eyeFromCenter:.58},prone:{halfHeight:.04,radius:.31,eyeFromCenter:.15}},oh=class e{makeCapsule;world;body;collider;controller;stance=`stand`;constructor(e,t,n,r){this.makeCapsule=r,this.world=e,this.body=t,this.collider=n,this.controller=e.createCharacterController(.025),this.controller.setSlideEnabled(!0),this.controller.enableAutostep(.42,.22,!1),this.controller.enableSnapToGround(.24),this.controller.setMaxSlopeClimbAngle(50*Math.PI/180),this.controller.setMinSlopeSlideAngle(55*Math.PI/180)}static async create(t,n){let{default:r}=await nh(async()=>{let{default:e}=await import(`./rapier-B45baom8.js`);return{default:e}},[],import.meta.url),i=console.warn;console.warn=(...e)=>{e.length===1&&e[0]===`using deprecated parameters for the initialization function; pass a single object instead`||i(...e)};try{await r.init()}finally{console.warn=i}let a=new r.World({x:0,y:-22,z:0});a.timestep=1/120,a.createCollider(r.ColliderDesc.cuboid((n.maxX-n.minX)/2,.1,(n.maxZ-n.minZ)/2).setTranslation((n.minX+n.maxX)/2,-.1,(n.minZ+n.maxZ)/2));for(let e of t){let t=e.minY??0,n=e.maxY??8,i=Math.max(.01,(e.maxX-e.minX)/2),o=Math.max(.01,(n-t)/2),s=Math.max(.01,(e.maxZ-e.minZ)/2);a.createCollider(r.ColliderDesc.cuboid(i,o,s).setTranslation((e.minX+e.maxX)/2,(t+n)/2,(e.minZ+e.maxZ)/2))}let o=a.createRigidBody(r.RigidBodyDesc.kinematicPositionBased()),s=a.createCollider(r.ColliderDesc.capsule(ih,rh).setFriction(0).setActiveCollisionTypes(r.ActiveCollisionTypes.ALL),o),c=new e(a,o,s,(e,t)=>new r.Capsule(e,t));return c.teleportEye({x:0,y:1.7,z:0}),c}teleportEye(e){let t=ah[this.stance].eyeFromCenter;this.body.setTranslation({x:e.x,y:e.y-t,z:e.z},!0),this.world.propagateModifiedBodyPositionsToColliders()}eyePosition(){let e=this.body.translation();return{x:e.x,y:e.y+ah[this.stance].eyeFromCenter,z:e.z}}setStance(e){if(e===this.stance)return!0;let t=ah[this.stance],n=ah[e],r=this.body.translation(),i=t.halfHeight+t.radius,a=n.halfHeight+n.radius,o=r.y-i,s={x:r.x,y:o+a,z:r.z},c=this.makeCapsule(n.halfHeight,n.radius);if(a>i){let e=!1;if(this.world.intersectionsWithShape(s,{x:0,y:0,z:0,w:1},c,()=>(e=!0,!1),void 0,void 0,this.collider),e)return!1}return this.collider.setShape(c),this.body.setTranslation(s,!0),this.world.propagateModifiedBodyPositionsToColliders(),this.stance=e,e===`prone`?this.controller.disableAutostep():this.controller.enableAutostep(.42,.22,!1),!0}currentStance(){return this.stance}move(e,t){this.world.timestep=t,this.controller.computeColliderMovement(this.collider,e);let n=this.controller.computedMovement(),r=this.body.translation();this.body.setNextKinematicTranslation({x:r.x+n.x,y:r.y+n.y,z:r.z+n.z}),this.world.step();let i=this.eyePosition(),a=5e-4;return{position:i,grounded:this.controller.computedGrounded(),blockedX:Math.abs(n.x-e.x)>a,blockedY:Math.abs(n.y-e.y)>a,blockedZ:Math.abs(n.z-e.z)>a,appliedDelta:{x:n.x,y:n.y,z:n.z}}}dispose(){this.world.free()}};function sh(e,t,n,r,i){let a=t.clone().sub(e),o=a.length(),s=o>1e-6?a.multiplyScalar(1/o):new z(0,0,-1),c=Math.abs(n-r)+1e-4,l=n+r-1e-4,u=Bt.clamp(o,c,l),d=(n*n-r*r+u*u)/(2*u),f=Math.sqrt(Math.max(0,n*n-d*d)),p=i.clone().sub(s.clone().multiplyScalar(i.dot(s)));return p.lengthSq()<1e-6&&p.crossVectors(s,Math.abs(s.y)<.9?new z(0,1,0):new z(1,0,0)),p.normalize(),e.clone().addScaledVector(s,d).addScaledVector(p,f)}var ch=class{flattenMaterials;root=new Rn;models=new Map;active=`carbine`;recoil=0;reloadStart=0;reloadDuration=0;switchBlend=1;swayX=0;swayY=0;meleeStart=0;grenadeStart=0;muzzleLight;muzzleFlash;casings=[];armRigs=[];brassGeometry=new sa(.018,.018,.085,7);shellGeometry=new sa(.025,.025,.105,8);brassMaterial=new W({color:13149788,roughness:.3,metalness:.78});shellMaterial=new W({color:11812658,roughness:.58,metalness:.18});shotStarted=-1e4;casingCursor=0;adsBlend=0;sprintBlend=0;constructor(e,t=!1){this.flattenMaterials=t,this.root.name=`original-weapon-view`,this.root.position.set(.36,-.38,-.78),this.root.scale.setScalar(.6),e.add(this.root);let n=new W({color:2505784,roughness:.9}),r=new W({color:1185819,roughness:.94}),i=new Rn;i.name=`first-person-arms`;let a=e=>{let t=e===`left`?-1:1,i=.56,a=.58,o=new Rn;o.name=`${e}-shoulder-joint`,o.position.set(t*.25,e===`right`?-.17:-.12,e===`right`?.52:.45);let s=q(`${e}-upper-arm`,[.19,.19,i],n,.075,3);s.position.z=-.56/2,o.add(s);let c=new Rn;c.name=`${e}-elbow-joint`,c.position.z=-.56,o.add(c);let l=q(`${e}-forearm`,[.18,.18,a],n,.075,3);l.position.z=-.58/2,c.add(l);let u=q(`${e}-glove`,[.17,.15,.22],r,.06,3);u.position.set(t*-.015,-.01,-.58),u.rotation.x=-.12,c.add(u);let d=q(`${e}-thumb`,[.07,.1,.16],r,.028,2);return d.position.set(t*-.1,-.04,-.5599999999999999),d.rotation.z=t*.32,c.add(d),this.armRigs.push({side:e,shoulder:o,elbow:c,upperLength:i,lowerLength:a}),o};i.add(a(`right`),a(`left`)),i.scale.setScalar(.74),i.position.set(0,-.08,.02),this.root.add(i),this.muzzleLight=new Ds(16761706,0,4.5,2),this.muzzleLight.position.set(0,.08,-1.15),this.root.add(this.muzzleLight),this.muzzleFlash=new Rn,this.muzzleFlash.position.set(0,.08,-1.15);let o=new _i({color:16765834,transparent:!0,opacity:.92,depthWrite:!1}),s=new U(new ca(.085,.42,8),o);s.rotation.x=-Math.PI/2,s.position.z=-.2;let c=new U(new Do(.34,.34),o.clone());c.rotation.z=Math.PI/4,this.muzzleFlash.add(s,c),this.muzzleFlash.visible=!1,this.root.add(this.muzzleFlash);for(let e=0;e<16;e+=1){let t=new U(this.brassGeometry,this.brassMaterial);t.name=`pooled-casing-${e}`,t.visible=!1,t.rotation.z=Math.PI/2,this.root.add(t),this.casings.push({mesh:t,velocity:new z,life:0,active:!1})}}async load(e){let t=[`carbine`,`smg`,`scattergun`];t.forEach((n,r)=>{let i=Od(n,this.flattenMaterials);i.visible=!1,this.models.set(n,i),this.root.add(i),e?.(r+1,t.length)}),this.setWeapon(this.active,!0)}isReady(){return this.models.size===3}setWeapon(e,t=!1){this.active=e,this.switchBlend=+!!t,this.reloadDuration=0;for(let[t,n]of this.models)n.visible=t===e;let n=this.models.get(e)?.getObjectByName(`muzzle-socket`);n&&(this.muzzleLight.position.copy(n.position),this.muzzleFlash.position.copy(n.position))}fire(e){this.recoil=Math.min(1,this.recoil+.24+e*5.2),this.shotStarted=performance.now(),this.muzzleLight.intensity=this.active===`scattergun`?7.2:4.8,this.muzzleFlash.visible=!0,this.muzzleFlash.scale.setScalar(this.active===`scattergun`?1.45:this.active===`smg`?.78:1),this.muzzleFlash.rotation.z=Math.random()*Math.PI;let t=this.casings[this.casingCursor++%this.casings.length],n=this.active===`scattergun`;t.mesh.geometry=n?this.shellGeometry:this.brassGeometry,t.mesh.material=n?this.shellMaterial:this.brassMaterial;let r=this.models.get(this.active)?.getObjectByName(`eject-socket`);t.mesh.position.copy(r?.position??new z(.12,.04,-.48)),t.mesh.rotation.set(Math.random()*.4,0,Math.PI/2),t.mesh.visible=!0,t.velocity.set(n?.72:.95+Math.random()*.25,n?.55:.75+Math.random()*.2,n?.16:.1),t.life=n?.62:.42,t.active=!0}reload(e){this.reloadStart=performance.now(),this.reloadDuration=e*1e3}cancelReload(){this.reloadDuration=0}melee(){this.meleeStart=performance.now()}throwGrenade(){this.grenadeStart=performance.now()}addMouseDelta(e,t){this.swayX=Bt.clamp(this.swayX+e*8e-5,-.025,.025),this.swayY=Bt.clamp(this.swayY+t*6e-5,-.02,.02)}solveArms(e,t){if(t){this.root.updateMatrixWorld(!0);for(let n of this.armRigs){let r=n.side===`right`?`grip-socket-r`:`support-socket-l`,i=t.getObjectByName(r);if(!i)continue;let a=i.getWorldPosition(new z),o=e.worldToLocal(a.clone()),s=new z(n.side===`left`?-.48:.48,-1,.22),c=sh(n.shoulder.position,o,n.upperLength,n.lowerLength,s).sub(n.shoulder.position).normalize();n.shoulder.quaternion.setFromUnitVectors(new z(0,0,-1),c),n.elbow.position.set(0,0,-n.upperLength),n.shoulder.updateWorldMatrix(!0,!0);let l=n.shoulder.worldToLocal(a.clone()).sub(n.elbow.position).normalize();n.elbow.quaternion.setFromUnitVectors(new z(0,0,-1),l)}}}update(e){let t=t=>1-Math.exp(-t*e.dt);this.recoil=Bt.lerp(this.recoil,0,t(16)),this.muzzleLight.intensity=Bt.lerp(this.muzzleLight.intensity,0,t(30)),this.switchBlend=Bt.lerp(this.switchBlend,1,t(10)),this.swayX=Bt.lerp(this.swayX,0,t(7)),this.swayY=Bt.lerp(this.swayY,0,t(7)),this.adsBlend=Bt.lerp(this.adsBlend,+!!e.ads,t(e.ads?18:15)),this.sprintBlend=Bt.lerp(this.sprintBlend,+!!e.sprinting,t(13)),this.muzzleFlash.visible=this.muzzleLight.intensity>.45;let n=this.root.getObjectByName(`first-person-arms`);n&&(n.position.y=Bt.lerp(-.08,-.3,this.adsBlend));for(let t of this.casings)t.active&&(t.life-=e.dt,t.velocity.y-=4.5*e.dt,t.mesh.position.addScaledVector(t.velocity,e.dt),t.mesh.rotation.x+=e.dt*18,t.mesh.rotation.z+=e.dt*11,t.life<=0&&(t.active=!1,t.mesh.visible=!1));let r=this.models.get(this.active),i=performance.now()-this.shotStarted,a=r?.getObjectByName(`bolt-or-slide`);if(a){let e=Number(a.userData.restZ??0),t=this.active===`smg`?44:62,n=Bt.clamp(i/t,0,1);a.position.z=e+Math.sin(n*Math.PI)*(this.active===`smg`?.09:.075)}let o=r?.getObjectByName(`pump`);if(o){let e=Number(o.userData.restZ??-.48),t=Bt.clamp((i-180)/440,0,1);o.position.z=e+Math.sin(t*Math.PI)*.22}let s=e.moving?e.sprinting?1.22:e.ads||e.prone?.12:e.crouched?.32:.56:.05,c=Math.cos(e.phase*.5)*.017*s,l=Math.sin(e.phase)*.019*s,u=Math.sin(performance.now()*.0017)*(e.ads?.0015:.0045),d=this.adsBlend*-.36,f=this.adsBlend*.251,p=this.adsBlend*-.04,m=this.sprintBlend*-.16,h=1-this.adsBlend,g=e.crouched?.035*h:0,_=e.prone?.018*h:0,v=(1-this.switchBlend)*-.34,y=0,b=0,x=0;if(this.reloadDuration>0){let e=(performance.now()-this.reloadStart)/this.reloadDuration;if(e>=1)this.reloadDuration=0;else{let t=Bt.clamp(e,0,1);x=t;let n=Math.sin(Math.PI*t),r=t>.65?Math.sin((t-.65)/.35*Math.PI):0;y=n*.78-r*.12,b=n*-.22+r*.035}}let S=r?.getObjectByName(this.active===`carbine`?`curved-magazine`:`straight-magazine`);if(S){let e=this.active===`carbine`?-.24:-.26,t=x>0?Math.sin(x*Math.PI):0;S.position.y=e-t*.38,S.rotation.z=t*.18}let C=Bt.clamp((performance.now()-this.meleeStart)/430,0,1),w=this.meleeStart>0&&C<1?Math.sin(C*Math.PI):0,T=Bt.clamp((performance.now()-this.grenadeStart)/620,0,1),E=this.grenadeStart>0&&T<1?Math.sin(T*Math.PI):0,D=new z(.36+d+c+this.swayX-e.lateralSpeed*.012-w*.24+E*.18,-.38+f+l+u+m+g+_+v+b-this.recoil*.08-e.landingImpulse*.075,-.78+p+this.recoil*.13-w*.32+E*.24);this.root.position.lerp(D,t(18)),this.root.rotation.x=Bt.lerp(this.root.rotation.x,this.recoil*.18-this.swayY-E*.42,t(22)),this.root.rotation.y=Bt.lerp(this.root.rotation.y,-this.swayX*2-this.sprintBlend*.38-w*.65,t(13)),this.root.rotation.z=Bt.lerp(this.root.rotation.z,y-this.sprintBlend*.22-e.lateralSpeed*(e.prone?.01:.025)+w*.42,t(13)),n&&this.solveArms(n,r)}};window.addEventListener(`error`,e=>{console.error(`[Atomic Acres runtime error]`,e.message||`unknown error`,e.error?.stack||``)}),window.addEventListener(`unhandledrejection`,e=>{let t=e.reason instanceof Error?`${e.reason.message}\n${e.reason.stack??``}`:String(e.reason);console.error(`[Atomic Acres unhandled rejection]`,t)});var lh=[`carbine`,`smg`,`scattergun`],uh=Ud.map(([e,t])=>new z(e,0,t));function dh(){return typeof globalThis.crypto?.randomUUID==`function`?globalThis.crypto.randomUUID():`player-${Date.now().toString(36)}-${Math.random().toString(36).slice(2,10)}`}var fh=document.querySelector(`#app`);if(!fh)throw Error(`Missing #app root`);fh.innerHTML=`
  ...
  <section id="menu" class="panel">
    ...
    <div class="menu-panel" data-menu-panel="kit" hidden>
      ...
      <div class="kit-grid">
        ${qd.map(e=>`<button type="button" class="kit-card" data-kit-id="${e.id}">
          <span>${e.role}</span><strong>${e.title}</strong><b>${mf[e.weapon].name}</b><p>${e.summary}</p>
...
`;function Z(e){let t=document.querySelector(e);if(!t)throw Error(`Missing element ${e}`);return t}var ph=Z(`#game`),mh=Z(`#menu`),hh=Z(`#hud`),gh=Z(`#room-card`),_h=Z(`#room-code`),vh=Z(`#network-status`),yh=Z(`#minimap`),bh=yh.getContext(`2d`);if(!bh)throw Error(`Canvas2D minimap is unavailable`);var xh=bh,Sh=new $d,Ch=new URLSearchParams(window.location.search).get(`render`)===`compat`;document.documentElement.classList.toggle(`compat-render`,Ch);var wh=new hd({canvas:ph,antialias:!Ch,powerPreference:`high-performance`});wh.outputColorSpace=Ze,wh.shadowMap.enabled=!Ch,wh.shadowMap.type=1,wh.toneMapping=4,wh.toneMappingExposure=1.22,wh.setPixelRatio(Ch?.2:Math.min(window.devicePixelRatio,1.75));var Th=new qn;Th.fog=new Kn(11453127,62,128);var Eh=new Ts(76,1,.08,180);Eh.rotation.order=`YXZ`,Th.add(Eh);function Dh(){let e=new Ao(150,32,18),t=new Bo({side:1,depthWrite:!1,uniforms:{top:{value:new H(2909837)},horizon:{value:new H(11258833)},bottom:{value:new H(14209974)}},vertexShader:`varying vec3 worldPos; void main(){ worldPos=(modelMatrix*vec4(position,1.0)).xyz; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }`,fragmentShader:`varying vec3 worldPos; uniform vec3 top; uniform vec3 horizon; uniform vec3 bottom; void main(){ float h=normalize(worldPos).y; vec3 c=h>0.0?mix(horizon,top,smoothstep(0.0,.75,h)):mix(horizon,bottom,smoothstep(0.0,-.35,h)); gl_FragColor=vec4(c,1.0); }`});Th.add(new U(e,t)),Th.add(new ps(14282751,5400139,1.7)),Th.add(new js(13161945,.62));let n=new As(16769461,2.55);n.position.set(-32,68,34),n.castShadow=!0,n.shadow.mapSize.set(2048,2048),n.shadow.camera.left=-48,n.shadow.camera.right=48,n.shadow.camera.top=54,n.shadow.camera.bottom=-54,n.shadow.camera.near=10,n.shadow.camera.far=150,n.shadow.bias=-4e-4,Th.add(n)}Dh();var Q=If(Th),$={id:dh(),name:`Player`,team:0,position:new z,velocity:new z,yaw:0,pitch:0,hp:100,kills:0,deaths:0,weapon:`carbine`,ammo:{carbine:mf.carbine.mag,smg:mf.smg.mag,scattergun:mf.scattergun.mag},reserve:{carbine:mf.carbine.reserve,smg:mf.smg.reserve,scattergun:mf.scattergun.reserve},reloadState:null,switchingUntil:0,lastShotAt:0,nextShotAt:0,sustainedShots:0,stance:`stand`,grenades:1,lastMeleeAt:-1e4,alive:!0,invulnerableUntil:0,seq:0},Oh=new Set,kh=new Map,Ah=new Map,jh=[],Mh=new Set,Nh=!1,Ph=`solo`,Fh=!1,Ih=0,Lh=0,Rh=0,zh={pitch:0,yaw:0},Bh=0,Vh=0,Hh=0,Uh=0,Wh=!1,Gh=0,Kh=0,qh=0,Jh=0,Yh=-1e4,Xh=-1e4,Zh=0,Qh=performance.now(),$h=0,eg=new URLSearchParams(window.location.search).get(`renderPaused`)===`1`,tg=Nf(performance.now()),ng=!1,rg=!1,ig=!1,ag=!1,og={x:0,y:0},sg=!1,cg=[],lg=!1,ug=!1,dg=1,fg=82,pg=!1,mg=!1,hg=null,gg=null;function _g(e,t=`ok`){vh.textContent=e,vh.dataset.kind=t}function vg(e){let t=e instanceof Error?e.message:String(e);Fh=!1,_g(`Game paused: ${t}`,`error`),mh.classList.remove(`hidden`);let n=Z(`#banner`);n.innerHTML=`<strong>SYSTEM PAUSED</strong><span>Reload the page to re-enter the test block.</span>`,n.hidden=!1,console.error(`[Atomic Acres fatal]`,e)}var yg=typeof window.RTCPeerConnection==`function`;yg?typeof ph.requestPointerLock!=`function`&&_g(`Pointer lock is unavailable; keyboard movement works but mouse aim may not.`,`warn`):(Z(`#host`).disabled=!0,Z(`#join`).disabled=!0,_g(`This browser lacks WebRTC; solo training is still available.`,`warn`)),ph.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),vg(Error(`Graphics context was lost`))}),ph.addEventListener(`webglcontextrestored`,()=>window.location.reload());var bg=new Qm(Ag,_g),xg=new ch(Eh,Ch),Sg=Zd(localStorage.getItem(Yd));function Cg(e){document.querySelectorAll(`[data-menu-tab]`).forEach(t=>{let n=t.dataset.menuTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,String(n))}),document.querySelectorAll(`[data-menu-panel]`).forEach(t=>{let n=t.dataset.menuPanel===e;t.classList.toggle(`active`,n),t.hidden=!n})}function wg(){let e=Xd(Sg),t=Nh&&$.weapon!==e.weapon;Z(`#selected-kit-summary`).innerHTML=`<span>${t?`QUEUED NEXT DEPLOYMENT`:`ACTIVE FIELD KIT`}</span><strong>${e.title}</strong><b>${mf[e.weapon].name}</b>`,document.querySelectorAll(`[data-kit-id]`).forEach(e=>{let t=e.dataset.kitId===Sg;e.classList.toggle(`selected`,t),e.setAttribute(`aria-pressed`,String(t))})}function Tg(e){Sg=Xd(e).id,localStorage.setItem(Yd,Qd(Sg)),Nh||($.weapon=Xd(Sg).weapon,xg.setWeapon($.weapon,!0)),wg()}document.querySelectorAll(`[data-menu-tab]`).forEach(e=>{e.addEventListener(`click`,()=>Cg(e.dataset.menuTab))}),document.querySelectorAll(`[data-kit-id]`).forEach(e=>{e.addEventListener(`click`,()=>Tg(e.dataset.kitId??`balanced`))}),$.weapon=Xd(Sg).weapon,wg();var Eg=new Ds(14216447,.9,5);Eg.position.set(0,.4,.2),Eh.add(Eg);function Dg(e){return e===`prone`?.5:e===`crouch`?1.16:1.7}function Og(e){let t=new Rn;t.name=`remote-player-world`,t.rotation.order=`YXZ`,t.userData.playerId=e.id;let n=Ld(e.team,`remote-player-model`,Ch,e.weapon);n.userData.playerId=e.id,n.traverse(n=>{n.userData.playerId=e.id,n.userData.targetRoot=t}),t.userData.operator=n,t.add(n);let r=document.createElement(`canvas`);r.width=256,r.height=64;let i=r.getContext(`2d`);i.fillStyle=`rgba(10,18,22,.72)`,i.fillRect(0,0,256,64),i.fillStyle=`#f7ecd4`,i.font=`700 30px Arial`,i.textAlign=`center`,i.textBaseline=`middle`,i.fillText(e.name,128,32);let a=new ea(r);a.colorSpace=Ze;let o=new si(new qr({map:a,transparent:!0,depthTest:!0,depthWrite:!1}));return o.visible=e.team===$.team,o.position.y=2.5,o.scale.set(2.4,.6,1),t.add(o),t.position.set(e.x,e.y-Dg(e.stance),e.z),Th.add(t),{root:t,snapshot:e,target:new z(e.x,e.y-Dg(e.stance),e.z),targetYaw:e.yaw,lastSeen:performance.now()}}function kg(){return{id:$.id,name:$.name,team:$.team,x:$.position.x,y:$.position.y,z:$.position.z,yaw:$.yaw,pitch:$.pitch,hp:$.hp,kills:$.kills,deaths:$.deaths,weapon:$.weapon,stance:$.stance,seq:++$.seq}}function Ag(e){if(e.type===`join`||e.type===`state`){let t=e.player;if(t.id===$.id||!lf(t,Q.bounds,.44))return;let n=kh.get(t.id);n||(n=Og(t),kh.set(t.id,n),u_(`${t.name} entered the test block`,t.team===0?`aqua`:`coral`),e.type===`join`&&bg.send({type:`state`,player:kg()})),t.seq>=n.snapshot.seq&&(n.snapshot=t,n.target.set(t.x,t.y-Dg(t.stance),t.z),n.targetYaw=t.yaw,n.lastSeen=performance.now(),n.root.visible=t.hp>0);return}if(e.type===`shot`){e.by!==$.id&&Mg(e);return}if(e.type===`hit`&&e.target===$.id&&!Mh.has(e.nonce)){let t=kh.get(e.by);if(!t||!lf(t.snapshot,Q.bounds,.44))return;let n={x:t.snapshot.x,y:t.snapshot.y,z:t.snapshot.z};if(Q.colliders.some(e=>rf(n,$.position,e)))return;Mh.add(e.nonce),Pg(e.damage,e.by),jg();return}if(e.type===`death`&&!Mh.has(e.nonce)){Mh.add(e.nonce),Fg(e),jg();return}e.type===`leave`&&Ig(e.playerId,`left the block`)}function jg(){Mh.size>512&&Mh.clear()}function Mg(e){let t=new z(...e.origin);if(!lf(t,Q.bounds,.44))return;let n=new z(...e.direction).normalize(),r=of(t,n,50,t.clone().addScaledVector(n,50),0,Q.colliders);c_(t,n,r.tracerDistance,mf[e.weapon].color);let i=kh.get(e.by)?.root.userData.operator;if(i&&Fd(i),r.blockedByCover){let e=t.clone().addScaledVector(n,r.tracerDistance);s_(e),Sh.coverImpact(e.distanceTo(Eh.position))}Sh.shot(e.weapon,!0,t.distanceTo(Eh.position))}function Ng(e){let t=kh.get(e)?.target??Ah.get(e)?.position;if(!t||e===$.id)return;let n=t.x-$.position.x,r=t.z-$.position.z,i=Math.atan2(-n,-r),a=Z(`#damage-direction`);a.style.setProperty(`--damage-angle`,`${df($.yaw,i)}rad`),a.classList.remove(`pulse`),requestAnimationFrame(()=>a.classList.add(`pulse`))}function Pg(e,t){let n=performance.now();if(!(!$.alive||n<$.invulnerableUntil)&&($.hp=Math.max(0,$.hp-Math.min(100,Math.max(1,e))),Xh=n,Sh.damage(),Ng(t),Z(`#damage-flash`).classList.remove(`pulse`),requestAnimationFrame(()=>Z(`#damage-flash`).classList.add(`pulse`)),$.hp<=0)){$.alive=!1,$.deaths+=1;let e={type:`death`,killer:t,victim:$.id,nonce:Hg()};bg.send(e),Fg(e),Z(`#respawn`).hidden=!1,document.exitPointerLock(),setTimeout(Bg,1900)}}function Fg(e){let t=e.killer===$.id?$.name:kh.get(e.killer)?.snapshot.name??Ah.get(e.killer)?.name??`Unknown`,n=e.victim===$.id?$.name:kh.get(e.victim)?.snapshot.name??Ah.get(e.victim)?.name??`Unknown`;e.killer===$.id&&e.victim!==$.id&&($.kills+=1,Sh.kill()),u_(`${t} eliminated ${n}`,e.killer===$.id?`gold`:void 0);let r=kh.get(e.victim);r&&(r.root.visible=!1);let i=Ah.get(e.victim);i&&(i.root.visible=!1),h_()}function Ig(e,t){let n=kh.get(e);n&&(Th.remove(n.root),kh.delete(e),u_(`${n.snapshot.name} ${t}`))}function Lg(){let e=Q.spawns[$.team],t=Ph===`client`?Math.min(1,e.length-1):Ph===`host`?0:$.deaths%e.length,n=[...kh.values()].map(e=>new z(e.snapshot.x,e.snapshot.y,e.snapshot.z)),r=[...[...kh.values()].filter(e=>e.snapshot.team!==$.team&&e.snapshot.hp>0).map(e=>new z(e.snapshot.x,e.snapshot.y,e.snapshot.z)),...[...Ah.values()].filter(e=>e.team!==$.team&&e.alive).map(e=>e.position.clone().add(new z(0,1.42,0)))],i=e.map((e,i)=>{let a=r.length===0?0:Math.min(...r.map(t=>t.distanceToSquared(e))),o=r.filter(t=>!Q.colliders.some(n=>rf(t,e,n))).length,s=n.some(t=>t.distanceToSquared(e)<20)?1e4:0,c=+(i===t);return{point:e,score:a-o*900-s+c}});return i.sort((e,t)=>t.score-e.score),i[0].point.clone()}function Rg(){try{let e=ph.requestPointerLock();e instanceof Promise&&e.catch(()=>void 0)}catch{}}function zg(e){if(!gg||!$.alive||!lg)return!1;let t=yf($.stance,e);if(t===$.stance)return!0;let n=$.stance,r=gg.eyePosition();if(!gg.setStance(t))return _g(`Low clearance — stance change blocked.`,`warn`),!1;let i=gg.eyePosition();return Hh+=r.y-i.y,$.position.set(i.x,i.y,i.z),$.stance=t,Gh=performance.now()+(t===`prone`?260:n===`prone`?290:135),Wh=!1,!0}function Bg(e=!0){$.stance=`stand`,gg?.setStance(`stand`),$.position.copy(Lg()),gg?.teleportEye($.position),$.velocity.set(0,0,0),$.hp=100,Xh=-1e4,$.grenades=1,$.reloadState=null,$.alive=!0,$.invulnerableUntil=performance.now()+1350,$.yaw=$.team===0?Math.PI:0,$.pitch=0,zh={pitch:0,yaw:0},Gh=0,Kh=0,qh=0,Hh=0,Uh=0,Yh=-1e4;let t=Xd(Sg).weapon;$.weapon!==t&&($.weapon=t,$.switchingUntil=0,xg.setWeapon(t,!0)),wg(),Z(`#respawn`).hidden=!0,Nh&&e&&Rg(),bg.send({type:`state`,player:kg()})}function Vg(e,t=!0){$.name=Zm(Z(`#player-name`).value),$.team=+(Number(Z(`#team`).value)===1),Nh=!0,xg.root.visible=!0,Ph=e,pg=!1,tg=Nf(performance.now()),ng=!1,mh.classList.add(`hidden`),hh.hidden=!1,Z(`#connection-pill`).textContent=e===`solo`?`BOT SKIRMISH`:e===`host`?`HOST`:`PEER`,Z(`#room-hud`).textContent=bg.roomCode?`ROOM ${bg.roomCode.slice(0,8).toUpperCase()}`:``,Bg(t),e===`solo`&&Yg(),Sh.unlock(),u_(`Welcome to Atomic Acres`,`gold`),e!==`solo`&&bg.send({type:`join`,player:kg()})}function Hg(){return Math.floor(performance.now()*1e3+Math.random()*1e6)}function Ug(e){let t=lh[e];if(!(!t||t===$.weapon||!$.alive)){if($.reloadState){if(!Ef($.reloadState,performance.now()))return;$.reloadState=null,xg.cancelReload()}$.weapon=t,$.switchingUntil=performance.now()+360,$.sustainedShots=0,xg.setWeapon(t),Sh.weaponSwitch()}}function Wg(){if(!$.alive||tg.phase!==`active`)return;let e=mf[$.weapon],t=$.ammo[$.weapon];$.reloadState||t>=e.mag||$.reserve[$.weapon]<=0||($.reloadState=Tf(e,t,$.reserve[$.weapon],performance.now()),Sh.reload(),xg.reload(e.reload),u_(`Reloading ${e.name}`))}function Gg(e){if(!$.reloadState)return;let t=Df($.reloadState,e,$.ammo[$.weapon],$.reserve[$.weapon]);t.completed&&($.ammo[$.weapon]=t.ammo,$.reserve[$.weapon]=t.reserve,$.reloadState=null)}function Kg(e){if(!$.alive||!Nh||!mg&&document.pointerLockElement!==ph||tg.phase!==`active`)return;Wh&&(Wh=!1,Kh=Math.max(Kh,e+150));let t=Math.max(Gh,Kh);if(e<t){qh<t&&(qh=t,window.setTimeout(()=>{qh=0,Fh&&Kg(performance.now())},Math.max(1,t-e+2)));return}qh=0;let n=mf[$.weapon];if(!Fh&&n.automatic||e<$.switchingUntil)return;if($.reloadState){if(!Ef($.reloadState,e))return;$.reloadState=null,xg.cancelReload()}let r=6e4/n.rpm;if(e<$.nextShotAt)return;if(($.nextShotAt===0||e-$.nextShotAt>r*2)&&($.nextShotAt=e),$.nextShotAt+=r,$.ammo[$.weapon]<=0){Sh.empty(),Wg(),$.lastShotAt=e;return}$.sustainedShots=e-$.lastShotAt<260?$.sustainedShots+1:0,$.lastShotAt=e,--$.ammo[$.weapon];let i=Z(`#ammo`);i.classList.remove(`fired`),requestAnimationFrame(()=>i.classList.add(`fired`));let a=kf(n,$.sustainedShots,Math.random());zh.pitch=Math.min(.16,zh.pitch+a.pitch),zh.yaw=Bt.clamp(zh.yaw+a.yaw,-.075,.075),Rh=Math.min(.24,Rh+a.pitch*4.2),xg.fire(a.pitch),Sh.shot($.weapon);let o=Eh.getWorldPosition(new z),s=Eh.getWorldDirection(new z),c=Math.hypot($.velocity.x,$.velocity.z)>1.2,l=Sf(n,{ads:rg,moving:c,crouched:$.stance===`crouch`,prone:$.stance===`prone`,sustainedShots:$.sustainedShots}),u=new Map,d=new z(1,0,0).applyQuaternion(Eh.quaternion),f=new z(0,1,0).applyQuaternion(Eh.quaternion);for(let e=0;e<n.pellets;e+=1){let e=Cf(l,Math.random(),Math.random()),t=s.clone().addScaledVector(d,e.x).addScaledVector(f,e.y).normalize(),r=qg(o,t);if(c_(o,t,r.distance,n.color),!r.playerId&&!r.targetId&&r.distance<89&&s_(o.clone().addScaledVector(t,r.distance)),r.playerId){let e=r.hitZone??`body`,t=wf(n,r.distance,e),i=u.get(r.playerId);u.set(r.playerId,{damage:(i?.damage??0)+t,zone:i?.zone===`head`||e===`head`?`head`:e})}r.targetId&&a_(r.targetId)}for(let[e,t]of u){let n=Ah.get(e);if(n)Qg(n,Math.min(100,t.damage),t.zone);else{let n=kh.get(e);if(n&&n.snapshot.team!==$.team){let n=Hg();bg.send({type:`hit`,by:$.id,target:e,damage:Math.min(100,t.damage),nonce:n}),l_(t.zone===`head`),Sh.hit(t.zone===`head`)}}}let p={type:`shot`,by:$.id,weapon:$.weapon,origin:o.toArray(),direction:s.toArray(),nonce:Hg()};bg.send(p),$.ammo[$.weapon]===0&&setTimeout(Wg,120)}function qg(e,t){let n=new Ys(e,t,.1,110),r=[...kh.values()].filter(e=>e.root.visible).map(e=>e.root),i=[...Ah.values()].filter(e=>e.alive&&e.root.visible).map(e=>e.root),a=Q.targets.filter(e=>e.active).map(e=>e.root),o=n.intersectObjects([...Q.raycastMeshes,...r,...i,...a],!0)[0];if(!o)return{distance:90};let s=o.object,c,l,u;for(;s;)c??=s.userData.playerId,l??=s.userData.targetId,u??=s.userData.hitZone,s=s.parent;let d=o.object.userData.targetRoot;return l??=d?.userData.targetId,{distance:Math.min(o.distance,110),playerId:c,targetId:l,hitZone:u}}function Jg(e,t){let n=Q.spawns[e];for(let e=0;e<n.length;e+=1){let r=n[(t+e)%n.length],i={x:r.x,y:0,z:r.z};if(Number.isFinite(r.x)&&Number.isFinite(r.z)&&lf(i,Q.bounds,.44)&&!sf(i,Q.colliders,.44))return r}throw Error(`No valid authored spawn for team ${e}`)}function Yg(){Xg();let e=+($.team===0);[`RIVET`].slice(0,1).forEach((t,n)=>{let r=`bot-${n}`,i=Ld(e,`bot-operator`,Ch);i.userData.playerId=r,i.traverse(e=>{e.userData.playerId=r,e.userData.targetRoot=i});let a=Jg(e,n),o=new z(a.x,a.y-1.7,a.z);i.position.copy(o),Th.add(i),Ah.set(r,{id:r,name:t,team:e,root:i,position:o,velocity:new z,hp:100,alive:!0,kills:0,deaths:0,lastShotAt:0,lastSightAt:0,hasLineOfSight:!1,sightStartedAt:0,burstShots:0,nextDecisionAt:0,strafeSign:n%2==0?1:-1,invulnerableUntil:performance.now()+1e3,respawnAt:0,waypoint:n})}),u_(`One hostile operator entered the block`,`coral`)}function Xg(){for(let e of Ah.values())Th.remove(e.root);Ah.clear()}function Zg(e){let t={x:e.position.x,y:e.position.y+1.42,z:e.position.z},n={x:$.position.x,y:$.position.y,z:$.position.z};return!Q.colliders.some(e=>rf(t,n,e))}function Qg(e,t,n){let r=performance.now();!e.alive||r<e.invulnerableUntil||(e.hp=Math.max(0,e.hp-t),l_(n===`head`),Sh.hit(n===`head`),!(e.hp>0)&&(e.alive=!1,e.deaths+=1,e.respawnAt=r+2200,e.root.visible=!1,$.kills+=1,Sh.kill(),u_(`${$.name} eliminated ${e.name}${n===`head`?` · HEADSHOT`:``}`,`gold`),h_()))}function $g(e,t){let n=Kd(t),r=Jg(e.team,e.deaths+e.waypoint);e.position.set(r.x,r.y-1.7,r.z),e.root.position.copy(e.position),e.hp=n.health,e.alive=n.alive,e.invulnerableUntil=n.invulnerableUntil,e.lastShotAt=n.lastShotAt,e.lastSightAt=0,e.hasLineOfSight=!1,e.sightStartedAt=0,e.burstShots=0,e.nextDecisionAt=0,e.root.visible=!0}function e_(e,t){if(Ph!==`solo`||tg.phase!==`active`||pg)return;let n=0;for(let r of Ah.values()){if(n+=1,!r.alive){t>=r.respawnAt&&!ng&&$g(r,t);continue}if(!lf(r.position,Q.bounds,.44)){let e=Jg(r.team,r.waypoint);r.position.set(e.x,e.y-1.7,e.z),r.root.position.copy(r.position),r.hasLineOfSight=!1,r.sightStartedAt=0,r.burstShots=0,r.lastSightAt=t;continue}let i=$.position.clone().setY(0).sub(r.position.clone().setY(0)),a=i.length(),o=120+n*19;if(t-r.lastSightAt>=o){r.lastSightAt=t;let e=r.hasLineOfSight;r.hasLineOfSight=$.alive&&Zg(r),r.hasLineOfSight&&!e&&(r.sightStartedAt=t),r.hasLineOfSight||(r.sightStartedAt=0,r.burstShots=0)}let s=r.hasLineOfSight;t>=r.nextDecisionAt&&(r.strafeSign=r.strafeSign===1?-1:1,r.nextDecisionAt=t+850+n*95);let c=uh[r.waypoint%uh.length],l=c.clone().sub(r.position).setY(0),u=l.lengthSq()<5.2;u&&(r.waypoint=(r.waypoint+1+n)%uh.length);let d=Gd({alive:r.alive,distanceToPlayer:a,hasLineOfSight:s,health:r.hp,now:t,lastShotAt:r.lastShotAt,waypointReached:u,random:r.strafeSign===1?.25:.75,lineOfSightSince:r.sightStartedAt,reactionDelay:650,burstShotsRemaining:r.burstShots}),f=s?i:l,p=f.lengthSq()>.01?f.normalize():new z(0,0,-1),m=new z(-p.z,0,p.x),h=d.movement===`advance`?p:d.movement===`retreat`?p.clone().multiplyScalar(-1):d.movement===`strafe-left`?m.clone().multiplyScalar(-1):d.movement===`strafe-right`?m:new z,g=d.movement.startsWith(`strafe`)?4.05:s?4.65:5.85,_=r.position.clone().addScaledVector(h,g*e),v=cf(r.position,_,Q.colliders,Q.bounds,.44);if(Math.hypot(v.x-r.position.x,v.z-r.position.z)<.002&&h.lengthSq()>0){let t=r.position.clone().addScaledVector(m,r.strafeSign*g*e*1.5);v=cf(r.position,t,Q.colliders,Q.bounds,.44),r.waypoint=(r.waypoint+1)%uh.length}r.position.set(v.x,r.position.y,v.z),r.root.position.copy(r.position);let y=s?$.position:c;if(r.root.lookAt(y.x,r.position.y+1.1,y.z),Id(r.root,`stand`,h.lengthSq()>0?g:0,t*.008+n,Math.min(1,e*12)),d.fire&&$.alive){r.burstShots<=0&&(r.burstShots=2+n%2),--r.burstShots,r.lastShotAt=t,Fd(r.root);let e=r.position.clone().add(new z(0,1.42,0)),i=$.position.clone().sub(e).normalize(),o=Wd(a)+r.burstShots*.006;i.x+=(Math.random()-.5)*o,i.y+=(Math.random()-.5)*o,i.z+=(Math.random()-.5)*o,i.normalize();let s=Math.min(a+2,75),c=$.stance===`prone`?.38:$.stance===`crouch`?.48:.55,l=of(e,i,s,$.position,c,Q.colliders);if(c_(e,i,l.tracerDistance,mf.carbine.color),l.blockedByCover){let t=e.clone().addScaledVector(i,l.tracerDistance);s_(t),Sh.coverImpact(t.distanceTo($.position))}Sh.shot(`carbine`,!0),l.hitTarget&&(Pg(wf(mf.carbine,a,`body`)*pf,r.id),$.alive||(r.kills+=1,h_()))}}}function t_(){let e=performance.now();if(!Mf(2,e,$.lastMeleeAt).hit||!$.alive||tg.phase!==`active`)return;$.lastMeleeAt=e,xg.melee(),Sh.melee();let t=qg(Eh.getWorldPosition(new z),Eh.getWorldDirection(new z));if(!t.playerId||t.distance>2.25)return;let n=Ah.get(t.playerId);n?Qg(n,70,t.hitZone??`body`):kh.has(t.playerId)&&bg.send({type:`hit`,by:$.id,target:t.playerId,damage:70,nonce:Hg()})}function n_(){if(!$.alive||$.grenades<=0||tg.phase!==`active`)return;--$.grenades,xg.throwGrenade();let e=Eh.getWorldDirection(new z),t=Eh.getWorldPosition(new z).addScaledVector(e,.7),n=new U(new Ao(.16,14,10),new W({color:3424570,roughness:.55,metalness:.48}));n.position.copy(t),n.castShadow=!0,Th.add(n),jh.push({mesh:n,velocity:e.multiplyScalar(13).add(new z(0,5.2,0)),explodeAt:performance.now()+2300,lastBounceAt:0})}function r_(e){let t=e.mesh.position.clone();Th.remove(e.mesh),Sh.explosion();let n=new U(new Ao(1,20,14),new _i({color:16757324,transparent:!0,opacity:.72}));n.position.copy(t),n.scale.setScalar(.2),Th.add(n);let r=new Ds(16743214,12,18,2);r.position.copy(t),Th.add(r);let i=performance.now(),a=()=>{let e=(performance.now()-i)/420;if(e>=1){Th.remove(n,r);return}n.scale.setScalar(.2+e*5.5),n.material.opacity=.72*(1-e),r.intensity=12*(1-e),requestAnimationFrame(a)};a();for(let e of Ah.values()){let n=e.position.clone().add(new z(0,1.1,0)),r=Q.colliders.some(e=>rf(t,n,e))?0:jf(e.position.distanceTo(t));r>0&&Qg(e,r,`body`)}for(let e of kh.values()){let n=e.target.clone().add(new z(0,1.1,0));if(Q.colliders.some(e=>rf(t,n,e)))continue;let r=jf(n.distanceTo(t));r>0&&bg.send({type:`hit`,by:$.id,target:e.snapshot.id,damage:r,nonce:Hg()})}let o=Q.colliders.some(e=>rf(t,$.position,e))?0:jf($.position.distanceTo(t))*.35;o>0&&Pg(o,$.id)}function i_(e,t){for(let n=jh.length-1;n>=0;--n){let r=jh[n];r.velocity.y-=18*e;let i=r.mesh.position.clone(),a=r.velocity.clone().multiplyScalar(e),o=ef(i,a,Q.colliders);if(o){let e=new z(o.normal.x,o.normal.y,o.normal.z);r.mesh.position.copy(i).addScaledVector(a,o.time).addScaledVector(e,.025);let n=r.velocity.dot(e);r.velocity.addScaledVector(e,-(1.38*n)),r.velocity.multiplyScalar(.76),Math.abs(n)>1.8&&t-r.lastBounceAt>90&&(r.lastBounceAt=t,Sh.grenadeBounce(Math.abs(n)))}else r.mesh.position.add(a);if(!lf(r.mesh.position,Q.bounds,.16)){let e=uf(r.mesh.position,Q.bounds,.16);r.mesh.position.set(e.x,e.y,e.z),s_(r.mesh.position.clone()),Sh.coverImpact(r.mesh.position.distanceTo($.position)),Th.remove(r.mesh),r.mesh.geometry.dispose(),r.mesh.material.dispose(),jh.splice(n,1);continue}if(r.mesh.rotation.x+=e*8,r.mesh.rotation.z+=e*11,r.mesh.position.y<.18){let e=Math.abs(r.velocity.y);e>1.8&&t-r.lastBounceAt>90&&(r.lastBounceAt=t,Sh.grenadeBounce(e)),r.mesh.position.y=.18,r.velocity.y=Math.abs(r.velocity.y)*.42,r.velocity.x*=.72,r.velocity.z*=.72}t>=r.explodeAt&&(jh.splice(n,1),r_(r))}}function a_(e){let t=Q.targets.find(t=>t.id===e);!t||!t.active||(t.active=!1,t.root.visible=!1,t.respawnAt=performance.now()+3200,Ih+=1,l_(),Sh.hit(),u_(`+1 test mannequin`,`gold`))}function o_(e){for(let t of Q.targets){if(Ph===`solo`){t.root.visible=!1;continue}!t.active&&e>=t.respawnAt&&(t.active=!0,t.root.visible=!0)}}function s_(e){let t=new _i({color:16768416,transparent:!0,opacity:.9,depthWrite:!1}),n=new U(new Eo(.075,0),t);n.position.copy(e),n.scale.set(1,.55,1),Th.add(n),window.setTimeout(()=>{Th.remove(n),n.geometry.dispose(),t.dispose()},72)}function c_(e,t,n,r){let i=new Vr().setFromPoints([e.clone(),e.clone().addScaledVector(t,n)]),a=new Ji(i,new Bi({color:r,transparent:!0,opacity:.72}));Th.add(a),setTimeout(()=>{Th.remove(a),i.dispose(),a.material.dispose()},55)}function l_(e=!1){let t=Z(`#hitmarker`);t.classList.remove(`show`,`headshot`),e&&t.classList.add(`headshot`),requestAnimationFrame(()=>t.classList.add(`show`))}function u_(e,t){let n=Z(`#killfeed`),r=document.createElement(`div`);for(r.textContent=e,t&&r.classList.add(t),n.prepend(r);n.children.length>6;)n.lastElementChild?.remove();setTimeout(()=>r.classList.add(`fade`),4200),setTimeout(()=>r.remove(),5e3)}function d_(e){if(!Nh||!$.alive||tg.phase===`ended`||!gg)return;let t=new z(-Math.sin($.yaw),0,-Math.cos($.yaw)),n=new z(Math.cos($.yaw),0,-Math.sin($.yaw)),r=Bt.clamp(Number(Oh.has(`KeyW`))-Number(Oh.has(`KeyS`))-og.y,-1,1),i=Bt.clamp(Number(Oh.has(`KeyD`))-Number(Oh.has(`KeyA`))+og.x,-1,1),a=t.clone().multiplyScalar(r).addScaledVector(n,i);a.lengthSq()>1&&a.normalize();let o=performance.now(),s=(Oh.has(`ShiftLeft`)||sg)&&a.lengthSq()>0&&lg;s&&$.stance!==`stand`&&zg(`stand`);let c=$.stance===`crouch`,l=$.stance===`prone`;Wh=s&&!Fh&&!$.reloadState&&o>=$.switchingUntil&&o-$.lastMeleeAt>500&&vf(r,i,rg,c,l);let u=hf({crouched:c,prone:l,ads:rg,sprinting:Wh,grounded:lg}),d=_f({x:$.velocity.x,z:$.velocity.z},{x:a.x,z:a.z},u,e);$.velocity.x=d.x,$.velocity.z=d.z,$.hp<100&&o-Xh>=5e3&&($.hp=Math.min(100,$.hp+18*e)),lg&&(Jh=o);let f=o-Yh<=125,p=lg||o-Jh<=95;f&&p&&!rg&&$.stance===`stand`&&tg.phase===`active`?($.velocity.y=u.jumpVelocity,lg=!1,Yh=-1e4):($.velocity.y-=24.5*e,lg&&($.velocity.y=Math.max(0,$.velocity.y)));let m=$.velocity.y,h=gg.move({x:$.velocity.x*e,y:$.velocity.y*e,z:$.velocity.z*e},e);$.position.set(h.position.x,h.position.y,h.position.z),lg=h.grounded,lg&&(Jh=o),lg&&!ug&&m<-5&&(Bh=Math.min(1,Math.abs(m)/14),Sh.land(Math.abs(m))),ug=lg,h.blockedX&&($.velocity.x=h.appliedDelta.x/Math.max(e,.001)),h.blockedY&&$.velocity.y<0&&($.velocity.y=0),h.blockedZ&&($.velocity.z=h.appliedDelta.z/Math.max(e,.001));let g=a.lengthSq()>0&&lg,_=Wh?300:l?760:c?575:405;g&&o-Zh>=_&&(Zh=o,Sh.footstep(Wh,c||l)),Vh+=e*(Wh?15:l?3.6:c?7:10)*(g?1:.25),Rh=Of(Rh,mf[$.weapon],e),zh=Af(zh,mf[$.weapon],e),Bh=ff(Bh,0,10,e),Hh=ff(Hh,0,l?9:15,e);let v=$.velocity.dot(n)/Math.max(1,u.maxSpeed);Uh=ff(Uh,-v*(rg?.006:.016),11,e),xg.update({dt:e,moving:g,sprinting:Wh,crouched:c,prone:l,ads:rg,phase:Vh,landingImpulse:Bh,lateralSpeed:v}),Eh.fov=ff(Eh.fov,rg?Math.max(55,fg-20):Wh?fg+4.5:fg,10,e),Eh.updateProjectionMatrix(),Eh.position.copy($.position),Eh.position.y+=Hh-Bh*.035,Eh.rotation.y=$.yaw+zh.yaw,Eh.rotation.x=Bt.clamp($.pitch-zh.pitch,-1.42,1.42),Eh.rotation.z=Uh}function f_(e,t){for(let[n,r]of kh){if(t-r.lastSeen>12e3){Ig(n,`timed out`);continue}let i=1-Math.exp(-13*e),a=r.root.position.distanceTo(r.target);r.root.position.lerp(r.target,i),r.root.rotation.y+=df(r.root.rotation.y,r.targetYaw)*i;let o=r.snapshot.stance??`stand`,s=r.root.userData.operator;Pd(s,r.snapshot.weapon,Ch),Id(s,o,a/Math.max(e,.001),t*.008,i,r.snapshot.pitch)}}function p_(){let e=$.team===0?$.kills:0,t=$.team===1?$.kills:0;for(let n of kh.values())n.snapshot.team===0?e+=n.snapshot.kills:t+=n.snapshot.kills;for(let n of Ah.values())n.team===0?e+=n.kills:t+=n.kills;return[e,t]}function m_(e){let t=tg.phase,n=p_();if(tg=Pf(tg,e,n),t===tg.phase)return;let r=Z(`#banner`);if(tg.phase===`active`){r.innerHTML=`<strong>ENGAGE</strong><span>First squad to 25</span>`,r.hidden=!1,window.setTimeout(()=>{tg.phase===`active`&&(r.hidden=!0)},900);return}if(tg.phase===`ended`){ng=!0;let e=tg.winner===$.team;r.innerHTML=`<strong>${tg.winner===`draw`?`DRAW`:e?`VICTORY`:`DEFEAT`}</strong><span>${n[0]} — ${n[1]} · CLICK BOT SKIRMISH FOR REMATCH</span>`,r.hidden=!1,document.exitPointerLock()}}function h_(){m_(performance.now())}function g_(e){let t=xh,n=yh.width,r=yh.height,i=Q.bounds,a=(e,t)=>Lf(e,t,i,n,r);t.clearRect(0,0,n,r),t.fillStyle=`rgba(7, 15, 18, .78)`,t.fillRect(0,0,n,r),t.strokeStyle=`rgba(244, 196, 79, .5)`,t.lineWidth=2,t.strokeRect(2,2,n-4,r-4);let[o]=a(-10.25,0),[s]=a(10.25,0);t.fillStyle=`rgba(126, 137, 132, .18)`,t.fillRect(o,2,s-o,r-4);for(let[e,o,s]of[[-11,-34,0],[11,34,1]]){let[c,l]=a(e,o),u=16.4/(i.maxX-i.minX)*n,d=15/(i.maxZ-i.minZ)*r;t.fillStyle=s===0?`rgba(88, 227, 220, .2)`:`rgba(255, 118, 95, .2)`,t.fillRect(c-u/2,l-d/2,u,d)}for(let e of kh.values()){let n=e.snapshot.team===$.team;if(!n&&e.target.distanceTo($.position)>15)continue;let[r,i]=a(e.target.x,e.target.z);t.fillStyle=n?`#58e3dc`:`#ff765f`,t.beginPath(),t.arc(r,i,3.5,0,Math.PI*2),t.fill()}for(let n of Ah.values()){if(!n.alive||!Rf(n.position.distanceTo($.position),e,n.lastShotAt))continue;let[r,i]=a(n.position.x,n.position.z);t.fillStyle=`#ff765f`,t.beginPath(),t.arc(r,i,3.5,0,Math.PI*2),t.fill()}let[c,l]=a($.position.x,$.position.z);t.save(),t.translate(c,l),t.rotate(-$.yaw),t.fillStyle=$.team===0?`#58e3dc`:`#ff765f`,t.beginPath(),t.moveTo(0,-7),t.lineTo(5,6),t.lineTo(-5,6),t.closePath(),t.fill(),t.restore()}function __(e){if(e-$h<100)return;$h=e,Nh&&m_(e);let t=mf[$.weapon],n=Math.hypot($.velocity.x,$.velocity.z),r=Sf(t,{ads:rg,moving:n>1.2,crouched:$.stance===`crouch`,prone:$.stance===`prone`,sustainedShots:$.sustainedShots}),i=Bt.clamp(5+r*320,5,23),a=Z(`#crosshair`);a.style.setProperty(`--spread`,`${i}px`),a.classList.toggle(`ads`,rg);let[o,s]=p_();Z(`#health`).textContent=String(Math.ceil($.hp)),Z(`#health-fill`).style.width=`${$.hp}%`,Z(`#weapon-name`).textContent=t.name.toUpperCase(),Z(`#ammo`).textContent=String($.ammo[$.weapon]),Z(`#reserve`).textContent=String($.reserve[$.weapon]),Z(`#aqua-score`).textContent=String(o),Z(`#coral-score`).textContent=String(s);let c=Math.max(0,tg.endsAt-e),l=tg.phase===`warmup`?Math.ceil(c/1e3):Math.floor(c/1e3);Z(`#timer`).textContent=tg.phase===`warmup`?`00:0${Math.min(9,l)}`:`${String(Math.floor(l/60)).padStart(2,`0`)}:${String(l%60).padStart(2,`0`)}`,Z(`#objective`).textContent=tg.phase===`warmup`?`MATCH STARTS IN ${l}`:`ATOMIC ACRES · FIRST TO 25`,Z(`#reload-state`).textContent=$.reloadState?`RELOADING ${Math.max(0,($.reloadState.endsAt-e)/1e3).toFixed(1)}s`:Ph===`solo`?`${$.kills} K / ${$.deaths} D · ${Ih} TARGETS`:`${$.kills} K / ${$.deaths} D`,Z(`#stance`).textContent=$.stance.toUpperCase(),Z(`#grenades`).textContent=`FRAG ×${$.grenades}`,Z(`#health-block`).classList.toggle(`critical`,$.hp<=30),g_(e),Z(`#roster`).hidden||v_()}function v_(){let e=[kg(),...[...kh.values()].map(e=>e.snapshot),...[...Ah.values()].map(e=>({id:e.id,name:e.name,team:e.team,x:e.position.x,y:e.position.y,z:e.position.z,yaw:e.root.rotation.y,pitch:0,hp:e.hp,kills:e.kills,deaths:e.deaths,weapon:`carbine`,seq:0}))].sort((e,t)=>t.kills-e.kills||e.deaths-t.deaths);Z(`#roster-list`).innerHTML=e.map(e=>`<div><span class="${e.team===0?`aqua`:`coral`}">${y_(e.name)}</span><b>${e.kills}</b><i>${e.deaths}</i><em>${e.hp>0?Math.ceil(e.hp)+` HP`:`DOWN`}</em></div>`).join(``)}function y_(e){return e.replace(/[&<>'"]/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,"'":`&#39;`,'"':`&quot;`})[e])}function b_(){let e=window.innerWidth,t=window.innerHeight;wh.setSize(e,t,!1),Eh.aspect=e/Math.max(1,t),Eh.updateProjectionMatrix()}window.addEventListener(`resize`,b_),b_();var x_=new URLSearchParams(window.location.search),S_=x_.get(`room`)?.trim()??``;S_&&(Z(`#room-input`).value=S_);var C_=x_.get(`name`);C_&&(Z(`#player-name`).value=Zm(C_)),x_.get(`team`)===`1`&&(Z(`#team`).value=`1`);var w_=Z(`#sensitivity`),T_=Z(`#field-of-view`);dg=Number(localStorage.getItem(`atomic-acres-sensitivity`)??w_.value)||1,fg=Number(localStorage.getItem(`atomic-acres-fov`)??T_.value)||82,w_.value=String(dg),T_.value=String(fg),w_.addEventListener(`input`,()=>{dg=Number(w_.value),localStorage.setItem(`atomic-acres-sensitivity`,String(dg))}),T_.addEventListener(`input`,()=>{fg=Number(T_.value),localStorage.setItem(`atomic-acres-fov`,String(fg))});function E_(e){let t=navigator.getGamepads?.().find(e=>!!(e&&e.connected));if(!t){og={x:0,y:0},sg=!1,cg=[],Fh=ig,rg=hg??ag;return}og=xf(t.axes[0]??0,t.axes[1]??0,.14,1.6);let n=xf(t.axes[2]??0,t.axes[3]??0,.1,1.6),r=t.buttons.map(e=>e.pressed||e.value>.55),i=e=>r[e]&&!cg[e];sg=!!r[10];let a=!!r[6]||(t.buttons[6]?.value??0)>.22,o=!!r[7]||(t.buttons[7]?.value??0)>.22;if(rg=hg??(ag||a),Fh=ig||o,!(Nh&&$.alive&&!mh.classList.contains(`hidden`))&&Nh&&$.alive){let t=rg?1.92:3.66;$.yaw-=n.x*t*e,$.pitch=Bt.clamp($.pitch-n.y*t*.82*e,-1.42,1.42),i(0)&&($.stance!==`stand`&&zg(`stand`),Yh=performance.now()),i(1)&&zg(`toggle-crouch`),i(13)&&zg(`toggle-prone`),i(2)&&Wg(),i(3)&&Ug((lh.indexOf($.weapon)+1)%lh.length),i(4)&&n_(),i(5)&&t_()}cg=r}window.addEventListener(`keydown`,e=>{Oh.add(e.code),e.code===`Space`&&!e.repeat&&($.stance!==`stand`&&zg(`stand`),Yh=performance.now()),e.code===`KeyC`&&!e.repeat&&zg(`toggle-crouch`),(e.code===`KeyZ`||e.code===`ControlLeft`)&&!e.repeat&&zg(`toggle-prone`),e.code===`Digit1`&&Ug(0),e.code===`Digit2`&&Ug(1),e.code===`Digit3`&&Ug(2),e.code===`KeyR`&&Wg(),e.code===`KeyV`&&!e.repeat&&t_(),e.code===`KeyG`&&!e.repeat&&n_(),e.code===`Tab`&&(e.preventDefault(),v_(),Z(`#roster`).hidden=!1)}),window.addEventListener(`keyup`,e=>{Oh.delete(e.code),e.code===`Tab`&&(Z(`#roster`).hidden=!0)}),window.addEventListener(`blur`,()=>{Oh.clear(),ig=!1,ag=!1,Fh=!1,rg=!1}),window.addEventListener(`mousemove`,e=>{if(document.pointerLockElement!==ph||!$.alive)return;let t=bf(rg,Wh);$.yaw-=e.movementX*.00215*dg*t,$.pitch=Math.max(-1.42,Math.min(1.42,$.pitch-e.movementY*.0019*dg*t)),xg.addMouseDelta(e.movementX,e.movementY)}),ph.addEventListener(`contextmenu`,e=>e.preventDefault()),ph.addEventListener(`mousedown`,e=>{if(document.pointerLockElement!==ph){Rg();return}if(e.button===2){ag=!0,rg=!0;return}e.button===0&&(ig=!0,Fh=!0,Kg(performance.now()))}),window.addEventListener(`mouseup`,e=>{e.button===0&&(ig=!1),e.button===2&&(ag=!1),Fh=ig,rg=ag}),document.addEventListener(`pointerlockchange`,()=>{document.pointerLockElement===ph?(Z(`#resume`).hidden=!0,mh.classList.add(`hidden`)):(ig=!1,ag=!1,Fh=!1,rg=!1,Nh&&$.alive&&(Z(`#resume`).hidden=ng,mh.classList.remove(`hidden`)))});function D_(){$.kills=0,$.deaths=0,$.hp=100,$.grenades=1,$.reloadState=null,$.sustainedShots=0,$.stance=`stand`,gg?.setStance(`stand`),Ih=0,Xg();for(let e of jh)Th.remove(e.mesh);jh.length=0;for(let e of kh.keys())Ig(e,`cleared`);Z(`#banner`).hidden=!0,$.weapon=Xd(Sg).weapon,$.switchingUntil=0,xg.setWeapon($.weapon,!0),wg(),$.ammo={carbine:mf.carbine.mag,smg:mf.smg.mag,scattergun:mf.scattergun.mag},$.reserve={carbine:mf.carbine.reserve,smg:mf.smg.reserve,scattergun:mf.scattergun.reserve}}Z(`#resume`).addEventListener(`click`,()=>{Nh&&$.alive&&!ng&&Rg()}),Z(`#solo`).addEventListener(`click`,()=>{bg.close(),D_(),Vg(`solo`)}),Z(`#host`).addEventListener(`click`,()=>{D_(),bg.host(()=>{gh.hidden=!1,_h.textContent=bg.roomCode,Vg(`host`)})}),Z(`#join`).addEventListener(`click`,()=>{D_();let e=Z(`#room-input`).value.trim();bg.join(e,()=>Vg(`client`))}),Z(`#copy-room`).addEventListener(`click`,async()=>{let e=`${window.location.origin}${window.location.pathname}?room=${encodeURIComponent(bg.roomCode)}`;try{await navigator.clipboard.writeText(e),_g(`Invite link copied`,`ok`)}catch{Z(`#room-input`).value=bg.roomCode,_g(`Clipboard blocked — code placed in join field`,`warn`)}}),S_&&x_.get(`autojoin`)===`1`&&window.setTimeout(()=>Z(`#join`).click(),100),setInterval(()=>{Nh&&bg.role!==`offline`&&$.alive&&bg.send({type:`state`,player:kg()})},60),window.addEventListener(`beforeunload`,()=>{bg.role!==`offline`&&bg.send({type:`leave`,playerId:$.id}),bg.close()});function O_(e){try{let t=Math.min(.05,Math.max(0,(e-Qh)/1e3));Qh=e,E_(t),Lh+=t;let n=1/120,r=0;for(;Lh>=n&&r<6;)d_(n),Lh-=n,r+=1;Fh&&mf[$.weapon].automatic&&Kg(e),Gg(e),o_(e),e_(t,e),i_(t,e),f_(t,e),__(e),eg||wh.render(Th,Eh),requestAnimationFrame(O_)}catch(e){vg(e)}}var k_=window;k_.__ATOMIC_ACRES_DEBUG__={snapshot:()=>({gameStarted:Nh,gameMode:Ph,matchPhase:tg.phase,player:{hp:$.hp,kills:$.kills,deaths:$.deaths,weapon:$.weapon,ammo:$.ammo[$.weapon],reserve:$.reserve[$.weapon],stance:$.stance,crouched:$.stance===`crouch`,prone:$.stance===`prone`,sprinting:Wh,grenades:$.grenades,position:$.position.toArray()},bots:[...Ah.values()].map(e=>({id:e.id,hp:e.hp,alive:e.alive,kills:e.kills,position:e.position.toArray()})),remotes:kh.size,remotePlayers:[...kh.values()].map(e=>({id:e.snapshot.id,stance:e.snapshot.stance??`stand`,position:e.target.toArray()})),grenades:jh.length,originalArtLoaded:Th.getObjectByName(`original-arena-art`)!==void 0,weaponReady:xg.isReady(),menuVisible:!mh.classList.contains(`hidden`),render:{calls:wh.info.render.calls,triangles:wh.info.render.triangles,points:wh.info.render.points,lines:wh.info.render.lines,sceneObjects:Th.children.length,reducedMode:Ch}}),startSolo:()=>{bg.close(),D_(),Vg(`solo`,!1)},setBotsFrozen:e=>{pg=e},setRenderPaused:e=>{eg=e},fireOnce:()=>{mg=!0,Fh=!0,Kg(performance.now()),Fh=!1,mg=!1},throwGrenade:()=>n_(),switchWeapon:e=>Ug(e),reload:()=>Wg(),melee:()=>t_(),setAds:e=>{hg=e,rg=e},setStance:e=>{e!==$.stance&&zg(e===`stand`?`stand`:e===`prone`?`toggle-prone`:`toggle-crouch`)},damage:e=>{$.invulnerableUntil=0,Pg(e,Ah.keys().next().value??$.id)}};function A_(e,t){let n=new Set;e.traverse(e=>{if(!(e instanceof U)||t.getObjectById(e.id))return;let r=Array.isArray(e.material)?e.material:[e.material];for(let e of r){if(n.has(e)||!(e instanceof W))continue;n.add(e);let{r:t,g:r,b:i}=e.color;Math.max(t,r,i)<.16&&e.color.lerp(new H(5989988),.24)}})}async function j_(){let e=Z(`#solo`),t=Z(`#host`),n=Z(`#join`);e.disabled=!0,t.disabled=!0,n.disabled=!0,_g(`Loading authored arena art, weapons and advanced collision…`);let r=oh.create(Q.colliders,Q.bounds),i=xg.load((e,t)=>{_g(`Loading authored weapons ${e}/${t}…`)}),a=Jf(Th,(e,t)=>{_g(`Loading authored arena models ${e}/${t}…`)},Ch),[o,,s]=await Promise.all([r,i,a]);gg=o;let c=Q.raycastMeshes.filter(e=>e.visible||e.userData.collisionProxy===!0);Q.raycastMeshes.splice(0,Q.raycastMeshes.length,...c),s.root.traverse(e=>{e instanceof U&&e.userData.blocksShots===!0&&Q.raycastMeshes.push(e)});let l=Th.getObjectByName(`Atomic Acres arena`);l&&wd(l,Th,()=>``,Ch),wd(s.root,Th,()=>``,Ch),A_(Th,xg.root),xg.setWeapon($.weapon,!0),Bg(),xg.root.visible=!1,Eh.position.set(0,30,-22),Eh.lookAt(0,.8,4),Eh.fov=65,Eh.updateProjectionMatrix(),e.disabled=!1,t.disabled=!yg,n.disabled=!yg,_g(`Layered Build Pass 04 ready — bounded solo rival and articulated procedural weapon rigs active.`),requestAnimationFrame(O_)}j_().catch(vg);