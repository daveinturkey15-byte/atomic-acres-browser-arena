...
s=-\r
t=0 0\r
`},n.getDirection=function(e,t){let r=n.splitLines(e);for(let e=0;e<r.length;e++)switch(r[e]){case`a=sendrecv`:case`a=sendonly`:case`a=recvonly`:case`a=inactive`:return r[e].substring(2);default:}return t?n.getDirection(t):`sendrecv`},n.getKind=function(e){return n.splitLines(e)[0].split(` `)[0].substring(2)},n.isRejected=function(e){return e.split(` `,2)[1]===`0`},n.parseMLine=function(e){let t=n.splitLines(e)[0].substring(2).split(` `);return{kind:t[0],port:parseInt(t[1],10),protocol:t[2],fmt:t.slice(3).join(` `)}},n.parseOLine=function(e){let t=n.matchPrefix(e,`o=`)[0].substring(2).split(` `);return{username:t[0],sessionId:t[1],sessionVersion:parseInt(t[2],10),netType:t[3],addressType:t[4],address:t[5]}},n.isValidSDP=function(e){if(typeof e!=`string`||e.length===0)return!1;let t=n.splitLines(e);for(let e=0;e<t.length;e++)if(t[e].length<2||t[e].charAt(1)!==`=`)return!1;return!0},typeof t==`object`&&(t.exports=n)})),mm=s({removeExtmapAllowMixed:()=>xm,shimAddIceCandidateNullOrEmpty:()=>Sm,shimConnectionState:()=>bm,shimMaxMessageSize:()=>vm,shimParameterlessSetLocalDescription:()=>Cm,shimRTCIceCandidate:()=>gm,shimRTCIceCandidateRelayProtocol:()=>_m,shimSendThrowTypeError:()=>ym}),hm=l(pm());function gm(e){if(!e.RTCIceCandidate||e.RTCIceCandidate&&`foundation`in e.RTCIceCandidate.prototype)return;let t=e.RTCIceCandidate;e.RTCIceCandidate=function(e){if(typeof e==`object`&&e.candidate&&e.candidate.indexOf(`a=`)===0&&(e=JSON.parse(JSON.stringify(e)),e.candidate=e.candidate.substring(2)),e.candidate&&e.candidate.length){let n=new t(e),r=hm.default.parseCandidate(e.candidate);for(let e in r)e in n||Object.defineProperty(n,e,{value:r[e]});return n.toJSON=function(){return{candidate:n.candidate,sdpMid:n.sdpMid,sdpMLineIndex:n.sdpMLineIndex,usernameFragment:n.usernameFragment}},n}return new t(e)},e.RTCIceCandidate.prototype=t.prototype,Sp(e,`icecandidate`,t=>(t.candidate&&Object.defineProperty(t,"candidate",{value:new e.RTCIceCandidate(t.candidate),writable:`false`}),t))}function _m(e){!e.RTCIceCandidate||e.RTCIceCandidate&&`relayProtocol`in e.RTCIceCandidate.prototype||Sp(e,`icecandidate`,e=>{if(e.candidate){let t=hm.default.parseCandidate(e.candidate.candidate);t.type===`relay`&&(e.candidate.relayProtocol={0:`tls`,1:`tcp`,2:`udp`}[t.priority>>24])}return e})}function vm(e,t){if(!e.RTCPeerConnection||t.browser===`chrome`&&t.version>102||t.browser===`firefox`&&t.version>=113)return;`sctp`in e.RTCPeerConnection.prototype||Object.defineProperty(e.RTCPeerConnection.prototype,"sctp",{get(){return this._sctp===void 0?null:this._sctp}});let n=function(e){if(!e||!e.sdp)return!1;let t=hm.default.splitSections(e.sdp);return t.shift(),t.some(e=>{let t=hm.default.parseMLine(e);return t&&t.kind===`application`&&t.protocol.indexOf(`SCTP`)!==-1})},r=function(e){let t=e.sdp.match(/mozilla...THIS_IS_SDPARTA-(\d+)/);if(t===null||t.length<2)return-1;let n=parseInt(t[1],10);return n===n?n:-1},i=function(e){let n=65536;return t.browser===`firefox`&&(n=t.version<57?e===-1?16384:2147483637:t.version<60?t.version===57?65535:65536:2147483637),n},a=function(e,n){let r=65536;t.browser===`firefox`&&t.version===57&&(r=65535);let i=hm.default.matchPrefix(e.sdp,`a=max-message-size:`);return i.length>0?r=parseInt(i[0].substring(19),10):t.browser===`firefox`&&n!==-1&&(r=2147483637),r},o=e.RTCPeerConnection.prototype.setRemoteDescription;e.RTCPeerConnection.prototype.setRemoteDescription=function(){if(this._sctp=null,t.browser===`chrome`&&t.version>=76){let{sdpSemantics:e}=this.getConfiguration();e===`plan-b`&&Object.defineProperty(this,"sctp",{get(){return this._sctp===void 0?null:this._sctp},enumerable:!0,configurable:!0})}if(n(arguments[0])){let e=r(arguments[0]),t=i(e),n=a(arguments[0],e),o;o=t===0&&n===0?1/0:t===0||n===0?Math.max(t,n):Math.min(t,n);let s={};Object.defineProperty(s,"maxMessageSize",{get(){return o}}),this._sctp=s}return o.apply(this,arguments)}}function ym(e,t){if(!(e.RTCPeerConnection&&`createDataChannel`in e.RTCPeerConnection.prototype)||t.browser===`chrome`&&t.version>=149||t.browser===`firefox`&&t.version>60)return;function n(e,t){let n=e.send;e.send=function(){let r=arguments[0],i=r.length||r.size||r.byteLength;if(e.readyState===`open`&&t.sctp&&i>t.sctp.maxMessageSize)throw TypeError(`Message too large (can send a maximum of `+t.sctp.maxMessageSize+` bytes)`);return n.apply(e,arguments)}}let r=e.RTCPeerConnection.prototype.createDataChannel;e.RTCPeerConnection.prototype.createDataChannel=function(){let e=r.apply(this,arguments);return n(e,this),e},Sp(e,`datachannel`,e=>(n(e.channel,e.target),e))}function bm(e){if(!e.RTCPeerConnection||`connectionState`in e.RTCPeerConnection.prototype)return;let t=e.RTCPeerConnection.prototype;Object.defineProperty(t,"connectionState",{get(){return{completed:`connected`,checking:`connecting`}[this.iceConnectionState]||this.iceConnectionState},enumerable:!0,configurable:!0}),Object.defineProperty(t,"onconnectionstatechange",{get(){return this._onconnectionstatechange||null},set(e){this._onconnectionstatechange&&(this.removeEventListener(`connectionstatechange`,this._onconnectionstatechange),delete this._onconnectionstatechange),e&&this.addEventListener(`connectionstatechange`,this._onconnectionstatechange=e)},enumerable:!0,configurable:!0}),[`setLocalDescription`,`setRemoteDescription`].forEach(e=>{let n=t[e];t[e]=function(){return this._connectionstatechangepoly||(this._connectionstatechangepoly=e=>{let t=e.target;if(t._lastConnectionState!==t.connectionState){t._lastConnectionState=t.connectionState;let n=new Event(`connectionstatechange`,e);t.dispatchEvent(n)}return e},this.addEventListener(`iceconnectionstatechange`,this._connectionstatechangepoly)),n.apply(this,arguments)}})}function xm(e,t){if(!e.RTCPeerConnection||t.browser===`chrome`&&t.version>=71||t.browser===`safari`&&t._safariVersion>=13.1)return;let n=e.RTCPeerConnection.prototype.setRemoteDescription;e.RTCPeerConnection.prototype.setRemoteDescription=function(t){if(t&&t.sdp&&t.sdp.indexOf(`
a=extmap-allow-mixed`)!==-1){let n=t.sdp.split(`
`).filter(e=>e.trim()!==`a=extmap-allow-mixed`).join(`
`);e.RTCSessionDescription&&t instanceof e.RTCSessionDescription?arguments[0]=new e.RTCSessionDescription({type:t.type,sdp:n}):t.sdp=n}return n.apply(this,arguments)}}function Sm(e,t){if(!(e.RTCPeerConnection&&e.RTCPeerConnection.prototype))return;let n=e.RTCPeerConnection.prototype.addIceCandidate;!n||n.length===0||(e.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?(t.browser===`chrome`&&t.version<78||t.browser===`firefox`&&t.version<68||t.browser===`safari`)&&arguments[0]&&arguments[0].candidate===``?Promise.resolve():n.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())})}function Cm(e,t){if(!(e.RTCPeerConnection&&e.RTCPeerConnection.prototype))return;let n=e.RTCPeerConnection.prototype.setLocalDescription;!n||n.length===0||(e.RTCPeerConnection.prototype.setLocalDescription=function(){let e=arguments[0]||{};if(typeof e!=`object`||e.type&&e.sdp)return n.apply(this,arguments);if(e={type:e.type,sdp:e.sdp},!e.type)switch(this.signalingState){case`stable`:case`have-local-offer`:case`have-remote-pranswer`:e.type=`offer`;break;default:e.type=`answer`;break}return e.sdp||e.type!==`offer`&&e.type!==`answer`?n.apply(this,[e]):(e.type===`offer`?this.createOffer:this.createAnswer).apply(this).then(e=>n.apply(this,[e]))})}function wm({window:e}={},t={shimChrome:!0,shimFirefox:!0,shimSafari:!0}){let n=Tp,r=Dp(e),i={browserDetails:r,commonShim:mm,extractVersion:xp,disableLog:Cp,disableWarnings:wp,sdp:hm};switch(r.browser){case`chrome`:if(!Pp||!Vp||!t.shimChrome)return n(`Chrome shim is not included in this adapter release.`),i;if(r.version===null)return n(`Chrome shim can not determine version, not shimming.`),i;n(`adapter.js shimming chrome.`),i.browserShim=Pp,Sm(e,r),Cm(e,r),Np(e,r),Fp(e,r),Vp(e,r),Ip(e,r),Bp(e,r),Lp(e,r),Rp(e,r),Hp(e,r),gm(e,r),_m(e,r),bm(e,r),vm(e,r),ym(e,r),xm(e,r);break;case`firefox`:if(!Gp||!qp||!t.shimFirefox)return n(`Firefox shim is not included in this adapter release.`),i;n(`adapter.js shimming firefox.`),i.browserShim=Gp,Sm(e,r),Cm(e,r),Up(e,r),qp(e,r),Jp(e,r),Kp(e,r),Zp(e,r),Yp(e,r),Xp(e,r),Qp(e,r),$p(e,r),em(e,r),tm(e,r),nm(e,r),gm(e,r),bm(e,r),vm(e,r),ym(e,r);break;case`safari`:if(!rm||!t.shimSafari)return n(`Safari shim is not included in this adapter release.`),i;n(`adapter.js shimming safari.`),i.browserShim=rm,Sm(e,r),Cm(e,r),lm(e,r),dm(e,r),om(e,r),im(e,r),am(e,r),um(e,r),sm(e,r),fm(e,r),gm(e,r),_m(e,r),vm(e,r),ym(e,r),xm(e,r);break;default:n(`Unsupported browser!`);break}return i}var Tm=wm({window:typeof window>`u`?void 0:window});function Em(e,t,n,r){Object.defineProperty(e,t,{get:n,set:r,enumerable:!0,configurable:!0})}var Dm=class{constructor(){this.chunkedMTU=16300,this._dataCount=1,this.chunk=e=>{let t=[],n=e.byteLength,r=Math.ceil(n/this.chunkedMTU),i=0,a=0;for(;a<n;){let o=Math.min(n,a+this.chunkedMTU),s=e.slice(a,o),c={__peerData:this._dataCount,n:i,data:s,total:r};t.push(c),a=o,i++}return this._dataCount++,t}}};function Om(e){let t=0;for(let n of e)t+=n.byteLength;let n=new Uint8Array(t),r=0;for(let t of e)n.set(t,r),r+=t.byteLength;return n}var km=Tm.default||Tm,Am=new class{isWebRTCSupported(){return typeof RTCPeerConnection<`u`}isBrowserSupported(){let e=this.getBrowser(),t=this.getVersion();return this.supportedBrowsers.includes(e)?e===`chrome`?t>=this.minChromeVersion:e===`firefox`?t>=this.minFirefoxVersion:e===`safari`?!this.isIOS&&t>=this.minSafariVersion:!1:!1}getBrowser(){return km.browserDetails.browser}getVersion(){return km.browserDetails.version||0}isUnifiedPlanSupported(){let e=this.getBrowser(),t=km.browserDetails.version||0;if(e===`chrome`&&t<this.minChromeVersion)return!1;if(e===`firefox`&&t>=this.minFirefoxVersion)return!0;if(!window.RTCRtpTransceiver||!(`currentDirection`in RTCRtpTransceiver.prototype))return!1;let n,r=!1;try{n=new RTCPeerConnection,n.addTransceiver(`audio`),r=!0}catch{}finally{n&&n.close()}return r}toString(){return`Supports:
    browser:${this.getBrowser()}
    version:${this.getVersion()}
    isIOS:${this.isIOS}
    isWebRTCSupported:${this.isWebRTCSupported()}
    isBrowserSupported:${this.isBrowserSupported()}
    isUnifiedPlanSupported:${this.isUnifiedPlanSupported()}`}constructor(){this.isIOS=typeof navigator<`u`?[`iPad`,`iPhone`,`iPod`].includes(navigator.platform):!1,this.supportedBrowsers=[`firefox`,`chrome`,`safari`],this.minFirefoxVersion=59,this.minChromeVersion=72,this.minSafariVersion=605}},jm=e=>!e||/^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(e),Mm=()=>Math.random().toString(36).slice(2),Nm={iceServers:[{urls:`stun:stun.l.google.com:19302`},{urls:[`turn:eu-0.turn.peerjs.com:3478`,`turn:us-0.turn.peerjs.com:3478`],username:`peerjs`,credential:`peerjsp`}],sdpSemantics:`unified-plan`},Pm=new class extends Dm{noop(){}blobToArrayBuffer(e,t){let n=new FileReader;return n.onload=function(e){e.target&&t(e.target.result)},n.readAsArrayBuffer(e),n}binaryStringToArrayBuffer(e){let t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n)&255;return t.buffer}isSecure(){return location.protocol===`https:`}constructor(...e){super(...e),this.CLOUD_HOST=`0.peerjs.com`,this.CLOUD_PORT=443,this.chunkedBrowsers={Chrome:1,chrome:1},this.defaultConfig=Nm,this.browser=Am.getBrowser(),this.browserVersion=Am.getVersion(),this.pack=gp,this.unpack=hp,this.supports=function(){let e={browser:Am.isBrowserSupported(),webRTC:Am.isWebRTCSupported(),audioVideo:!1,data:!1,binaryBlob:!1,reliable:!1};if(!e.webRTC)return e;let t;try{t=new RTCPeerConnection(Nm),e.audioVideo=!0;let n;try{n=t.createDataChannel(`_PEERJSTEST`,{ordered:!0}),e.data=!0,e.reliable=!!n.ordered;try{n.binaryType=`blob`,e.binaryBlob=!Am.isIOS}catch{}}catch{}finally{n&&n.close()}}catch{}finally{t&&t.close()}return e}(),this.validateId=jm,this.randomToken=Mm}},Fm=`PeerJS: `,X=new class{get logLevel(){return this._logLevel}set logLevel(e){this._logLevel=e}log(...e){this._logLevel>=3&&this._print(3,...e)}warn(...e){this._logLevel>=2&&this._print(2,...e)}error(...e){this._logLevel>=1&&this._print(1,...e)}setLogFunction(e){this._print=e}_print(e,...t){let n=[Fm,...t];for(let e in n)n[e]instanceof Error&&(n[e]=`(`+n[e].name+`) `+n[e].message);e>=3?console.log(...n):e>=2?console.warn(`WARNING`,...n):e>=1&&console.error(`ERROR`,...n)}constructor(){this._logLevel=0}},Im={},Lm=Object.prototype.hasOwnProperty,Rm=`~`;function zm(){}Object.create&&(zm.prototype=Object.create(null),new zm().__proto__||(Rm=!1));function Bm(e,t,n){this.fn=e,this.context=t,this.once=n||!1}function Vm(e,t,n,r,i){if(typeof n!=`function`)throw TypeError(`The listener must be a function`);var a=new Bm(n,r||e,i),o=Rm?Rm+t:t;return e._events[o]?e._events[o].fn?e._events[o]=[e._events[o],a]:e._events[o].push(a):(e._events[o]=a,e._eventsCount++),e}function Hm(e,t){--e._eventsCount===0?e._events=new zm:delete e._events[t]}function Um(){this._events=new zm,this._eventsCount=0}Um.prototype.eventNames=function(){var e=[],t,n;if(this._eventsCount===0)return e;for(n in t=this._events)Lm.call(t,n)&&e.push(Rm?n.slice(1):n);return Object.getOwnPropertySymbols?e.concat(Object.getOwnPropertySymbols(t)):e},Um.prototype.listeners=function(e){var t=Rm?Rm+e:e,n=this._events[t];if(!n)return[];if(n.fn)return[n.fn];for(var r=0,i=n.length,a=Array(i);r<i;r++)a[r]=n[r].fn;return a},Um.prototype.listenerCount=function(e){var t=Rm?Rm+e:e,n=this._events[t];return n?n.fn?1:n.length:0},Um.prototype.emit=function(e,t,n,r,i,a){var o=Rm?Rm+e:e;if(!this._events[o])return!1;var s=this._events[o],c=arguments.length,l,u;if(s.fn){switch(s.once&&this.removeListener(e,s.fn,void 0,!0),c){case 1:return s.fn.call(s.context),!0;case 2:return s.fn.call(s.context,t),!0;case 3:return s.fn.call(s.context,t,n),!0;case 4:return s.fn.call(s.context,t,n,r),!0;case 5:return s.fn.call(s.context,t,n,r,i),!0;case 6:return s.fn.call(s.context,t,n,r,i,a),!0}for(u=1,l=Array(c-1);u<c;u++)l[u-1]=arguments[u];s.fn.apply(s.context,l)}else{var d=s.length,f;for(u=0;u<d;u++)switch(s[u].once&&this.removeListener(e,s[u].fn,void 0,!0),c){case 1:s[u].fn.call(s[u].context);break;case 2:s[u].fn.call(s[u].context,t);break;case 3:s[u].fn.call(s[u].context,t,n);break;case 4:s[u].fn.call(s[u].context,t,n,r);break;default:if(!l)for(f=1,l=Array(c-1);f<c;f++)l[f-1]=arguments[f];s[u].fn.apply(s[u].context,l)}}return!0},Um.prototype.on=function(e,t,n){return Vm(this,e,t,n,!1)},Um.prototype.once=function(e,t,n){return Vm(this,e,t,n,!0)},Um.prototype.removeListener=function(e,t,n,r){var i=Rm?Rm+e:e;if(!this._events[i])return this;if(!t)return Hm(this,i),this;var a=this._events[i];if(a.fn)a.fn===t&&(!r||a.once)&&(!n||a.context===n)&&Hm(this,i);else{for(var o=0,s=[],c=a.length;o<c;o++)(a[o].fn!==t||r&&!a[o].once||n&&a[o].context!==n)&&s.push(a[o]);s.length?this._events[i]=s.length===1?s[0]:s:Hm(this,i)}return this},Um.prototype.removeAllListeners=function(e){var t;return e?(t=Rm?Rm+e:e,this._events[t]&&Hm(this,t)):(this._events=new zm,this._eventsCount=0),this},Um.prototype.off=Um.prototype.removeListener,Um.prototype.addListener=Um.prototype.on,Um.prefixed=Rm,Um.EventEmitter=Um,Im=Um;var Wm={};Em(Wm,`ConnectionType`,()=>Gm),Em(Wm,`PeerErrorType`,()=>Km),Em(Wm,`BaseConnectionErrorType`,()=>qm),Em(Wm,`DataConnectionErrorType`,()=>Jm),Em(Wm,`SerializationType`,()=>Ym),Em(Wm,`SocketEventType`,()=>Xm),Em(Wm,`ServerMessageType`,()=>Zm);var Gm=function(e){return e.Data=`data`,e.Media=`media`,e}({}),Km=function(e){return e.BrowserIncompatible=`browser-incompatible`,e.Disconnected=`disconnected`,e.InvalidID=`invalid-id`,e.InvalidKey=`invalid-key`,e.Network=`network`,e.PeerUnavailable=`peer-unavailable`,e.SslUnavailable=`ssl-unavailable`,e.ServerError=`server-error`,e.SocketError=`socket-error`,e.SocketClosed=`socket-closed`,e.UnavailableID=`unavailable-id`,e.WebRTC=`webrtc`,e}({}),qm=function(e){return e.NegotiationFailed=`negotiation-failed`,e.ConnectionClosed=`connection-closed`,e}({}),Jm=function(e){return e.NotOpenYet=`not-open-yet`,e.MessageToBig=`message-too-big`,e}({}),Ym=function(e){return e.Binary=`binary`,e.BinaryUTF8=`binary-utf8`,e.JSON=`json`,e.None=`raw`,e}({}),Xm=function(e){return e.Message=`message`,e.Disconnected=`disconnected`,e.Error=`error`,e.Close=`close`,e}({}),Zm=function(e){return e.Heartbeat=`HEARTBEAT`,e.Candidate=`CANDIDATE`,e.Offer=`OFFER`,e.Answer=`ANSWER`,e.Open=`OPEN`,e.Error=`ERROR`,e.IdTaken=`ID-TAKEN`,e.InvalidKey=`INVALID-KEY`,e.Leave=`LEAVE`,e.Expire=`EXPIRE`,e}({}),Qm=`1.5.5`,$m=class extends Im.EventEmitter{constructor(e,t,n,r,i,a=5e3){super(),this.pingInterval=a,this._disconnected=!0,this._messagesQueue=[];let o=e?`wss://`:`ws://`;this._baseUrl=o+t+`:`+n+r+`peerjs?key=`+i}start(e,t){this._id=e;let n=`${this._baseUrl}&id=${e}&token=${t}`;this._socket||!this._disconnected||(this._socket=new WebSocket(n+`&version=1.5.5`),this._disconnected=!1,this._socket.onmessage=e=>{let t;try{t=JSON.parse(e.data),X.log(`Server message received:`,t)}catch{X.log(`Invalid server message`,e.data);return}this.emit(Xm.Message,t)},this._socket.onclose=e=>{this._disconnected||(X.log(`Socket closed.`,e),this._cleanup(),this._disconnected=!0,this.emit(Xm.Disconnected))},this._socket.onopen=()=>{this._disconnected||(this._sendQueuedMessages(),X.log(`Socket open`),this._scheduleHeartbeat())})}_scheduleHeartbeat(){this._wsPingTimer=setTimeout(()=>{this._sendHeartbeat()},this.pingInterval)}_sendHeartbeat(){if(!this._wsOpen()){X.log(`Cannot send heartbeat, because socket closed`);return}let e=JSON.stringify({type:Zm.Heartbeat});this._socket.send(e),this._scheduleHeartbeat()}_wsOpen(){return!!this._socket&&this._socket.readyState===1}_sendQueuedMessages(){let e=[...this._messagesQueue];this._messagesQueue=[];for(let t of e)this.send(t)}send(e){if(this._disconnected)return;if(!this._id){this._messagesQueue.push(e);return}if(!e.type){this.emit(Xm.Error,`Invalid message`);return}if(!this._wsOpen())return;let t=JSON.stringify(e);this._socket.send(t)}close(){this._disconnected||=(this._cleanup(),!0)}_cleanup(){this._socket&&=(this._socket.onopen=this._socket.onmessage=this._socket.onclose=null,this._socket.close(),void 0),clearTimeout(this._wsPingTimer)}},eh=class{constructor(e){this.connection=e}startConnection(e){let t=this._startPeerConnection();if(this.connection.peerConnection=t,this.connection.type===Gm.Media&&e._stream&&this._addTracksToConnection(e._stream,t),e.originator){let n=this.connection,r={ordered:!!e.reliable},i=t.createDataChannel(n.label,r);n._initializeDataChannel(i),this._makeOffer()}else this.handleSDP(`OFFER`,e.sdp)}_startPeerConnection(){X.log(`Creating RTCPeerConnection.`);let e=new RTCPeerConnection(this.connection.provider.options.config);return this._setupListeners(e),e}_setupListeners(e){let t=this.connection.peer,n=this.connection.connectionId,r=this.connection.type,i=this.connection.provider;X.log(`Listening for ICE candidates.`),e.onicecandidate=e=>{!e.candidate||!e.candidate.candidate||(X.log(`Received ICE candidates for ${t}:`,e.candidate),i.socket.send({type:Zm.Candidate,payload:{candidate:e.candidate,type:r,connectionId:n},dst:t}))},e.oniceconnectionstatechange=()=>{switch(e.iceConnectionState){case`failed`:X.log(`iceConnectionState is failed, closing connections to `+t),this.connection.emitError(qm.NegotiationFailed,`Negotiation of connection to `+t+` failed.`),this.connection.close();break;case`closed`:X.log(`iceConnectionState is closed, closing connections to `+t),this.connection.emitError(qm.ConnectionClosed,`Connection to `+t+` closed.`),this.connection.close();break;case`disconnected`:X.log(`iceConnectionState changed to disconnected on the connection with `+t);break;case`completed`:e.onicecandidate=()=>{};break}this.connection.emit(`iceStateChanged`,e.iceConnectionState)},X.log(`Listening for data channel`),e.ondatachannel=e=>{X.log(`Received data channel`);let r=e.channel;i.getConnection(t,n)._initializeDataChannel(r)},X.log(`Listening for remote stream`),e.ontrack=e=>{X.log(`Received remote stream`);let r=e.streams[0],a=i.getConnection(t,n);if(a.type===Gm.Media){let e=a;this._addStreamToMediaConnection(r,e)}}}cleanup(){X.log(`Cleaning up PeerConnection to `+this.connection.peer);let e=this.connection.peerConnection;if(!e)return;this.connection.peerConnection=null,e.onicecandidate=e.oniceconnectionstatechange=e.ondatachannel=e.ontrack=()=>{};let t=e.signalingState!==`closed`,n=!1,r=this.connection.dataChannel;r&&(n=!!r.readyState&&r.readyState!==`closed`),(t||n)&&e.close()}async _makeOffer(){let e=this.connection.peerConnection,t=this.connection.provider;try{let n=await e.createOffer(this.connection.options.constraints);X.log(`Created offer.`),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform==`function`&&(n.sdp=this.connection.options.sdpTransform(n.sdp)||n.sdp);try{await e.setLocalDescription(n),X.log(`Set localDescription:`,n,`for:${this.connection.peer}`);let r={sdp:n,type:this.connection.type,connectionId:this.connection.connectionId,metadata:this.connection.metadata};if(this.connection.type===Gm.Data){let e=this.connection;r={...r,label:e.label,reliable:e.reliable,serialization:e.serialization}}t.socket.send({type:Zm.Offer,payload:r,dst:this.connection.peer})}catch(e){e!=`OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer`&&(t.emitError(Km.WebRTC,e),X.log(`Failed to setLocalDescription, `,e))}}catch(e){t.emitError(Km.WebRTC,e),X.log(`Failed to createOffer, `,e)}}async _makeAnswer(){let e=this.connection.peerConnection,t=this.connection.provider;try{let n=await e.createAnswer();X.log(`Created answer.`),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform==`function`&&(n.sdp=this.connection.options.sdpTransform(n.sdp)||n.sdp);try{await e.setLocalDescription(n),X.log(`Set localDescription:`,n,`for:${this.connection.peer}`),t.socket.send({type:Zm.Answer,payload:{sdp:n,type:this.connection.type,connectionId:this.connection.connectionId},dst:this.connection.peer})}catch(e){t.emitError(Km.WebRTC,e),X.log(`Failed to setLocalDescription, `,e)}}catch(e){t.emitError(Km.WebRTC,e),X.log(`Failed to create answer, `,e)}}async handleSDP(e,t){t=new RTCSessionDescription(t);let n=this.connection.peerConnection,r=this.connection.provider;X.log(`Setting remote description`,t);let i=this;try{await n.setRemoteDescription(t),X.log(`Set remoteDescription:${e} for:${this.connection.peer}`),e===`OFFER`&&await i._makeAnswer()}catch(e){r.emitError(Km.WebRTC,e),X.log(`Failed to setRemoteDescription, `,e)}}async handleCandidate(e){X.log(`handleCandidate:`,e);try{await this.connection.peerConnection.addIceCandidate(e),X.log(`Added ICE candidate for:${this.connection.peer}`)}catch(e){this.connection.provider.emitError(Km.WebRTC,e),X.log(`Failed to handleCandidate, `,e)}}_addTracksToConnection(e,t){if(X.log(`add tracks from stream ${e.id} to peer connection`),!t.addTrack)return X.error(`Your browser does't support RTCPeerConnection#addTrack. Ignored.`);e.getTracks().forEach(n=>{t.addTrack(n,e)})}_addStreamToMediaConnection(e,t){X.log(`add stream ${e.id} to media connection ${t.connectionId}`),t.addStream(e)}},th=class extends Im.EventEmitter{emitError(e,t){X.error(`Error:`,t),this.emit(`error`,new nh(`${e}`,t))}},nh=class extends Error{constructor(e,t){typeof t==`string`?super(t):(super(),Object.assign(this,t)),this.type=e}},rh=class extends th{get open(){return this._open}constructor(e,t,n){super(),this.peer=e,this.provider=t,this.options=n,this._open=!1,this.metadata=n.metadata}},ih=class e extends rh{static#e=this.ID_PREFIX=`mc_`;get type(){return Gm.Media}get localStream(){return this._localStream}get remoteStream(){return this._remoteStream}constructor(t,n,r){super(t,n,r),this._localStream=this.options._stream,this.connectionId=this.options.connectionId||e.ID_PREFIX+Pm.randomToken(),this._negotiator=new eh(this),this._localStream&&this._negotiator.startConnection({_stream:this._localStream,originator:!0})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{X.log(`DC#${this.connectionId} dc connection success`),this.emit(`willCloseOnRemote`)},this.dataChannel.onclose=()=>{X.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}addStream(e){X.log(`Receiving stream`,e),this._remoteStream=e,super.emit(`stream`,e)}handleMessage(e){let t=e.type,n=e.payload;switch(e.type){case Zm.Answer:this._negotiator.handleSDP(t,n.sdp),this._open=!0;break;case Zm.Candidate:this._negotiator.handleCandidate(n.candidate);break;default:X.warn(`Unrecognized message type:${t} from peer:${this.peer}`);break}}answer(e,t={}){if(this._localStream){X.warn(`Local stream already exists on this MediaConnection. Are you answering a call twice?`);return}this._localStream=e,t&&t.sdpTransform&&(this.options.sdpTransform=t.sdpTransform),this._negotiator.startConnection({...this.options._payload,_stream:e});let n=this.provider._getMessages(this.connectionId);for(let e of n)this.handleMessage(e);this._open=!0}close(){this._negotiator&&=(this._negotiator.cleanup(),null),this._localStream=null,this._remoteStream=null,this.provider&&=(this.provider._removeConnection(this),null),this.options&&this.options._stream&&(this.options._stream=null),this.open&&(this._open=!1,super.emit(`close`))}},ah=class{constructor(e){this._options=e}_buildRequest(e){let t=this._options.secure?`https`:`http`,{host:n,port:r,path:i,key:a}=this._options,o=new URL(`${t}://${n}:${r}${i}${a}/${e}`);return o.searchParams.set(`ts`,`${Date.now()}${Math.random()}`),o.searchParams.set(`version`,Qm),fetch(o.href,{referrerPolicy:this._options.referrerPolicy})}async retrieveId(){try{let e=await this._buildRequest(`id`);if(e.status!==200)throw Error(`Error. Status:${e.status}`);return e.text()}catch(e){X.error(`Error retrieving ID`,e);let t=``;throw this._options.path===`/`&&this._options.host!==Pm.CLOUD_HOST&&(t=" If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."),Error(`Could not get an ID from the server.`+t)}}async listAllPeers(){try{let e=await this._buildRequest(`peers`);if(e.status!==200){if(e.status===401){let e=``;throw e=this._options.host===Pm.CLOUD_HOST?`It looks like you're using the cloud server. You can email team@peerjs.com to enable peer listing for your API key.`:"You need to enable `allow_discovery` on your self-hosted PeerServer to use this feature.",Error(`It doesn't look like you have permission to list peers IDs. `+e)}throw Error(`Error. Status:${e.status}`)}return e.json()}catch(e){throw X.error(`Error retrieving list peers`,e),Error(`Could not get list peers from the server.`+e)}}},oh=class e extends rh{static#e=this.ID_PREFIX=`dc_`;static#t=this.MAX_BUFFERED_AMOUNT=8388608;get type(){return Gm.Data}constructor(t,n,r){super(t,n,r),this.connectionId=this.options.connectionId||e.ID_PREFIX+Mm(),this.label=this.options.label||this.connectionId,this.reliable=!!this.options.reliable,this._negotiator=new eh(this),this._negotiator.startConnection(this.options._payload||{originator:!0,reliable:this.reliable})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{X.log(`DC#${this.connectionId} dc connection success`),this._open=!0,this.emit(`open`)},this.dataChannel.onmessage=e=>{X.log(`DC#${this.connectionId} dc onmessage:`,e.data)},this.dataChannel.onclose=()=>{X.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}close(e){if(e?.flush){this.send({__peerData:{type:`close`}});return}this._negotiator&&=(this._negotiator.cleanup(),null),this.provider&&=(this.provider._removeConnection(this),null),this.dataChannel&&=(this.dataChannel.onopen=null,this.dataChannel.onmessage=null,this.dataChannel.onclose=null,null),this.open&&(this._open=!1,super.emit(`close`))}send(e,t=!1){if(!this.open){this.emitError(Jm.NotOpenYet,"Connection is not open. You should listen for the `open` event before sending messages.");return}return this._send(e,t)}async handleMessage(e){let t=e.payload;switch(e.type){case Zm.Answer:await this._negotiator.handleSDP(e.type,t.sdp);break;case Zm.Candidate:await this._negotiator.handleCandidate(t.candidate);break;default:X.warn(`Unrecognized message type:`,e.type,`from peer:`,this.peer);break}}},sh=class extends oh{get bufferSize(){return this._bufferSize}_initializeDataChannel(e){super._initializeDataChannel(e),this.dataChannel.binaryType=`arraybuffer`,this.dataChannel.addEventListener(`message`,e=>this._handleDataMessage(e))}_bufferedSend(e){(this._buffering||!this._trySend(e))&&(this._buffer.push(e),this._bufferSize=this._buffer.length)}_trySend(e){if(!this.open)return!1;if(this.dataChannel.bufferedAmount>oh.MAX_BUFFERED_AMOUNT)return this._buffering=!0,setTimeout(()=>{this._buffering=!1,this._tryBuffer()},50),!1;try{this.dataChannel.send(e)}catch(e){return X.error(`DC#:${this.connectionId} Error when sending:`,e),this._buffering=!0,this.close(),!1}return!0}_tryBuffer(){if(!this.open||this._buffer.length===0)return;let e=this._buffer[0];this._trySend(e)&&(this._buffer.shift(),this._bufferSize=this._buffer.length,this._tryBuffer())}close(e){if(e?.flush){this.send({__peerData:{type:`close`}});return}this._buffer=[],this._bufferSize=0,super.close()}constructor(...e){super(...e),this._buffer=[],this._bufferSize=0,this._buffering=!1}},ch=class extends sh{close(e){super.close(e),this._chunkedData={}}constructor(e,t,n){super(e,t,n),this.chunker=new Dm,this.serialization=Ym.Binary,this._chunkedData={}}_handleDataMessage({data:e}){let t=hp(e),n=t.__peerData;if(n){if(n.type===`close`){this.close();return}this._handleChunk(t);return}this.emit(`data`,t)}_handleChunk(e){let t=e.__peerData,n=this._chunkedData[t]||{data:[],count:0,total:e.total};if(n.data[e.n]=new Uint8Array(e.data),n.count++,this._chunkedData[t]=n,n.total===n.count){delete this._chunkedData[t];let e=Om(n.data);this._handleDataMessage({data:e})}}_send(e,t){let n=gp(e);if(n instanceof Promise)return this._send_blob(n);if(!t&&n.byteLength>this.chunker.chunkedMTU){this._sendChunks(n);return}this._bufferedSend(n)}async _send_blob(e){let t=await e;if(t.byteLength>this.chunker.chunkedMTU){this._sendChunks(t);return}this._bufferedSend(t)}_sendChunks(e){let t=this.chunker.chunk(e);X.log(`DC#${this.connectionId} Try to send ${t.length} chunks...`);for(let e of t)this.send(e,!0)}},lh=class extends sh{_handleDataMessage({data:e}){super.emit(`data`,e)}_send(e,t){this._bufferedSend(e)}constructor(...e){super(...e),this.serialization=Ym.None}},uh=class extends sh{_handleDataMessage({data:e}){let t=this.parse(this.decoder.decode(e)),n=t.__peerData;if(n&&n.type===`close`){this.close();return}this.emit(`data`,t)}_send(e,t){let n=this.encoder.encode(this.stringify(e));if(n.byteLength>=Pm.chunkedMTU){this.emitError(Jm.MessageToBig,`Message too big for JSON channel`);return}this._bufferedSend(n)}constructor(...e){super(...e),this.serialization=Ym.JSON,this.encoder=new TextEncoder,this.decoder=new TextDecoder,this.stringify=JSON.stringify,this.parse=JSON.parse}},dh=class e extends th{static#e=this.DEFAULT_KEY=`peerjs`;get id(){return this._id}get options(){return this._options}get open(){return this._open}get socket(){return this._socket}get connections(){let e=Object.create(null);for(let[t,n]of this._connections)e[t]=n;return e}get destroyed(){return this._destroyed}get disconnected(){return this._disconnected}constructor(t,n){super(),this._serializers={raw:lh,json:uh,binary:ch,"binary-utf8":ch,default:ch},this._id=null,this._lastServerId=null,this._destroyed=!1,this._disconnected=!1,this._open=!1,this._connections=new Map,this._lostMessages=new Map;let r;if(t&&t.constructor==Object?n=t:t&&(r=t.toString()),n={debug:0,host:Pm.CLOUD_HOST,port:Pm.CLOUD_PORT,path:`/`,key:e.DEFAULT_KEY,token:Pm.randomToken(),config:Pm.defaultConfig,referrerPolicy:`strict-origin-when-cross-origin`,serializers:{},...n},this._options=n,this._serializers={...this._serializers,...this.options.serializers},this._options.host===`/`&&(this._options.host=window.location.hostname),this._options.path&&(this._options.path[0]!==`/`&&(this._options.path=`/`+this._options.path),this._options.path[this._options.path.length-1]!==`/`&&(this._options.path+=`/`)),this._options.secure===void 0&&this._options.host!==Pm.CLOUD_HOST?this._options.secure=Pm.isSecure():this._options.host==Pm.CLOUD_HOST&&(this._options.secure=!0),this._options.logFunction&&X.setLogFunction(this._options.logFunction),X.logLevel=this._options.debug||0,this._api=new ah(n),this._socket=this._createServerConnection(),!Pm.supports.audioVideo&&!Pm.supports.data){this._delayedAbort(Km.BrowserIncompatible,`The current browser does not support WebRTC`);return}if(r&&!Pm.validateId(r)){this._delayedAbort(Km.InvalidID,`ID "${r}" is invalid`);return}r?this._initialize(r):this._api.retrieveId().then(e=>this._initialize(e)).catch(e=>this._abort(Km.ServerError,e))}_createServerConnection(){let e=new $m(this._options.secure,this._options.host,this._options.port,this._options.path,this._options.key,this._options.pingInterval);return e.on(Xm.Message,e=>{this._handleMessage(e)}),e.on(Xm.Error,e=>{this._abort(Km.SocketError,e)}),e.on(Xm.Disconnected,()=>{this.disconnected||(this.emitError(Km.Network,`Lost connection to server.`),this.disconnect())}),e.on(Xm.Close,()=>{this.disconnected||this._abort(Km.SocketClosed,`Underlying socket is already closed.`)}),e}_initialize(e){this._id=e,this.socket.start(e,this._options.token)}_handleMessage(e){let t=e.type,n=e.payload,r=e.src;switch(t){case Zm.Open:this._lastServerId=this.id,this._open=!0,this.emit(`open`,this.id);break;case Zm.Error:this._abort(Km.ServerError,n.msg);break;case Zm.IdTaken:this._abort(Km.UnavailableID,`ID "${this.id}" is taken`);break;case Zm.InvalidKey:this._abort(Km.InvalidKey,`API KEY "${this._options.key}" is invalid`);break;case Zm.Leave:X.log(`Received leave message from ${r}`),this._cleanupPeer(r),this._connections.delete(r);break;case Zm.Expire:this.emitError(Km.PeerUnavailable,`Could not connect to peer ${r}`);break;case Zm.Offer:{let e=n.connectionId,t=this.getConnection(r,e);if(t&&(t.close(),X.warn(`Offer received for existing Connection ID:${e}`)),n.type===Gm.Media){let i=new ih(r,this,{connectionId:e,_payload:n,metadata:n.metadata});t=i,this._addConnection(r,t),this.emit(`call`,i)}else if(n.type===Gm.Data){let i=new this._serializers[n.serialization](r,this,{connectionId:e,_payload:n,metadata:n.metadata,label:n.label,serialization:n.serialization,reliable:n.reliable});t=i,this._addConnection(r,t),this.emit(`connection`,i)}else{X.warn(`Received malformed connection type:${n.type}`);return}let i=this._getMessages(e);for(let e of i)t.handleMessage(e);break}default:{if(!n){X.warn(`You received a malformed message from ${r} of type ${t}`);return}let i=n.connectionId,a=this.getConnection(r,i);a&&a.peerConnection?a.handleMessage(e):i?this._storeMessage(i,e):X.warn(`You received an unrecognized message:`,e);break}}}_storeMessage(e,t){this._lostMessages.has(e)||this._lostMessages.set(e,[]),this._lostMessages.get(e).push(t)}_getMessages(e){let t=this._lostMessages.get(e);return t?(this._lostMessages.delete(e),t):[]}connect(e,t={}){if(t={serialization:`default`,...t},this.disconnected){X.warn(`You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect, or call reconnect on this peer if you believe its ID to still be available.`),this.emitError(Km.Disconnected,`Cannot connect to new Peer after disconnecting from server.`);return}let n=new this._serializers[t.serialization](e,this,t);return this._addConnection(e,n),n}call(e,t,n={}){if(this.disconnected){X.warn(`You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect.`),this.emitError(Km.Disconnected,`Cannot connect to new Peer after disconnecting from server.`);return}if(!t){X.error("To call a peer, you must provide a stream from your browser's `getUserMedia`.");return}let r=new ih(e,this,{...n,_stream:t});return this._addConnection(e,r),r}_addConnection(e,t){X.log(`add connection ${t.type}:${t.connectionId} to peerId:${e}`),this._connections.has(e)||this._connections.set(e,[]),this._connections.get(e).push(t)}_removeConnection(e){let t=this._connections.get(e.peer);if(t){let n=t.indexOf(e);n!==-1&&t.splice(n,1)}this._lostMessages.delete(e.connectionId)}getConnection(e,t){let n=this._connections.get(e);if(!n)return null;for(let e of n)if(e.connectionId===t)return e;return null}_delayedAbort(e,t){setTimeout(()=>{this._abort(e,t)},0)}_abort(e,t){X.error(`Aborting!`),this.emitError(e,t),this._lastServerId?this.disconnect():this.destroy()}destroy(){this.destroyed||(X.log(`Destroy peer with ID:${this.id}`),this.disconnect(),this._cleanup(),this._destroyed=!0,this.emit(`close`))}_cleanup(){for(let e of this._connections.keys())this._cleanupPeer(e),this._connections.delete(e);this.socket.removeAllListeners()}_cleanupPeer(e){let t=this._connections.get(e);if(t)for(let e of t)e.close()}disconnect(){if(this.disconnected)return;let e=this.id;X.log(`Disconnect peer with ID:${e}`),this._disconnected=!0,this._open=!1,this.socket.close(),this._lastServerId=e,this._id=null,this.emit(`disconnected`,e)}reconnect(){if(this.disconnected&&!this.destroyed)X.log(`Attempting reconnection to server with ID ${this._lastServerId}`),this._disconnected=!1,this._initialize(this._lastServerId);else if(this.destroyed)throw Error(`This peer cannot reconnect to the server. It has already been destroyed.`);else if(!this.disconnected&&!this.open)X.error(`In a hurry? We're still trying to make the initial connection!`);else throw Error(`Peer ${this.id} cannot reconnect because it is not disconnected from the server!`)}listAllPeers(e=e=>{}){this._api.listAllPeers().then(t=>e(t)).catch(e=>this._abort(Km.ServerError,e))}},fh=new Set([`carbine`,`smg`,`scattergun`]);function ph(e){if(!e||typeof e!=`object`)return!1;let t=e;return typeof t.id==`string`&&t.id.length>0&&t.id.length<=80&&typeof t.name==`string`&&t.name.length>0&&t.name.length<=20&&(t.team===0||t.team===1)&&[`x`,`y`,`z`,`yaw`,`pitch`,`hp`,`kills`,`deaths`,`seq`].every(e=>Number.isFinite(t[e]))&&(t.stance===void 0||t.stance===`stand`||t.stance===`crouch`||t.stance===`prone`)&&fh.has(t.weapon)}function mh(e){if(!e||typeof e!=`object`)return!1;let t=e;switch(t.type){case`join`:case`state`:return ph(t.player);case`shot`:return typeof t.by==`string`&&fh.has(t.weapon)&&Array.isArray(t.origin)&&t.origin.length===3&&t.origin.every(Number.isFinite)&&Array.isArray(t.direction)&&t.direction.length===3&&t.direction.every(Number.isFinite)&&Number.isFinite(t.nonce);case`hit`:return typeof t.by==`string`&&typeof t.target==`string`&&Number.isFinite(t.damage)&&Number(t.damage)>0&&Number(t.damage)<=100&&Number.isFinite(t.nonce);case`death`:return typeof t.killer==`string`&&typeof t.victim==`string`&&Number.isFinite(t.nonce);case`leave`:return typeof t.playerId==`string`;case`chat`:return typeof t.by==`string`&&typeof t.text==`string`&&t.text.length<=160;default:return!1}}function hh(e){return e.replace(/[^a-zA-Z0-9 _-]/g,``).trim().slice(0,16)||`Player${Math.floor(Math.random()*900+100)}`}var gh=class{role=`offline`;roomCode=``;peer=null;hostConnection=null;guests=new Set;onMessage;onStatus;onReady=null;constructor(e,t){this.onMessage=e,this.onStatus=t}host(e){this.close(),this.role=`host`,this.onReady=e,this.onStatus(`Opening a secure peer lobby…`);let t=new dh;this.peer=t,t.on(`open`,t=>{this.roomCode=t,this.onStatus(`Lobby ready — share the room code`,`ok`),e()}),t.on(`connection`,e=>this.wireGuest(e)),t.on(`error`,e=>this.onStatus(this.describeError(e),`error`)),t.on(`disconnected`,()=>this.onStatus(`Signalling disconnected; existing peers may continue`,`warn`))}join(e,t){if(this.close(),this.role=`client`,this.roomCode=e.trim(),this.onReady=t,!this.roomCode){this.onStatus(`Enter a room code first`,`error`);return}this.onStatus(`Connecting to peer lobby…`);let n=new dh;this.peer=n,n.on(`open`,()=>{let e=n.connect(this.roomCode,{reliable:!0,serialization:`json`});this.hostConnection=e,this.wireHost(e)}),n.on(`error`,e=>this.onStatus(this.describeError(e),`error`)),n.on(`disconnected`,()=>this.onStatus(`Signalling disconnected; attempting to preserve session`,`warn`))}send(e){mh(e)&&(this.role===`host`?this.broadcast(e):this.role===`client`&&this.hostConnection?.open&&this.hostConnection.send(e))}close(){if(this.hostConnection)try{this.hostConnection.close()}catch{}for(let e of this.guests)try{e.close()}catch{}if(this.guests.clear(),this.hostConnection=null,this.peer)try{this.peer.destroy()}catch{}this.peer=null,this.roomCode=``,this.role=`offline`,this.onReady=null}wireGuest(e){this.guests.add(e);let t=``;e.on(`open`,()=>this.onStatus(`${this.guests.size} guest connection${this.guests.size===1?``:`s`}`,`ok`)),e.on(`data`,n=>{mh(n)&&(n.type===`join`&&(t=n.player.id),this.onMessage(n),this.broadcast(n,e))}),e.on(`close`,()=>{if(this.guests.delete(e),t){let e={type:`leave`,playerId:t};this.onMessage(e),this.broadcast(e)}this.onStatus(`A guest left the lobby`,`warn`)}),e.on(`error`,()=>this.onStatus(`Guest data channel failed`,`error`))}wireHost(e){e.on(`open`,()=>{this.onStatus(`Connected to host`,`ok`),this.onReady?.()}),e.on(`data`,e=>{mh(e)&&this.onMessage(e)}),e.on(`close`,()=>this.onStatus(`Host connection closed`,`error`)),e.on(`error`,()=>this.onStatus(`Could not establish peer data channel`,`error`))}broadcast(e,t){for(let n of this.guests)n!==t&&n.open&&n.send(e)}describeError(e){let t=e instanceof Error?e.message:String(e);return/peer-unavailable/i.test(t)?`Room not found. Check the code and try again.`:/network|server/i.test(t)?`Peer signalling is unavailable. Check the connection and retry.`:`Network error: ${t.slice(0,120)}`}},_h=`modulepreload`,vh=function(e,t){return new URL(e,t).href},yh={},bh=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,new URL(`../../../src/node/plugins/importAnalysisBuild.ts`,import.meta.url)).href}r=o(t.map(t=>{if(t=vh(t,n),t=s(t),t in yh)return;yh[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:_h,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},xh=.38,Sh=.53,Ch={stand:{halfHeight:Sh,radius:xh,eyeFromCenter:.79},crouch:{halfHeight:.22,radius:.36,eyeFromCenter:.58},prone:{halfHeight:.04,radius:.31,eyeFromCenter:.15}},wh=class e{makeCapsule;world;body;collider;controller;stance=`stand`;constructor(e,t,n,r){this.makeCapsule=r,this.world=e,this.body=t,this.collider=n,this.controller=e.createCharacterController(.025),this.controller.setSlideEnabled(!0),this.controller.enableAutostep(.42,.22,!1),this.controller.enableSnapToGround(.24),this.controller.setMaxSlopeClimbAngle(50*Math.PI/180),this.controller.setMinSlopeSlideAngle(55*Math.PI/180)}static async create(t,n){let{default:r}=await bh(async()=>{let{default:e}=await import(`./rapier-B45baom8.js`);return{default:e}},[],import.meta.url),i=console.warn;console.warn=(...e)=>{e.length===1&&e[0]===`using deprecated parameters for the initialization function; pass a single object instead`||i(...e)};try{await r.init()}finally{console.warn=i}let a=new r.World({x:0,y:-22,z:0});a.timestep=1/120,a.createCollider(r.ColliderDesc.cuboid((n.maxX-n.minX)/2,.1,(n.maxZ-n.minZ)/2).setTranslation((n.minX+n.maxX)/2,-.1,(n.minZ+n.maxZ)/2));for(let e of t){let t=e.minY??0,n=e.maxY??8,i=Math.max(.01,(e.maxX-e.minX)/2),o=Math.max(.01,(n-t)/2),s=Math.max(.01,(e.maxZ-e.minZ)/2);a.createCollider(r.ColliderDesc.cuboid(i,o,s).setTranslation((e.minX+e.maxX)/2,(t+n)/2,(e.minZ+e.maxZ)/2))}let o=a.createRigidBody(r.RigidBodyDesc.kinematicPositionBased()),s=a.createCollider(r.ColliderDesc.capsule(Sh,xh).setFriction(0).setActiveCollisionTypes(r.ActiveCollisionTypes.ALL),o),c=new e(a,o,s,(e,t)=>new r.Capsule(e,t));return c.teleportEye({x:0,y:1.7,z:0}),c}teleportEye(e){let t=Ch[this.stance].eyeFromCenter;this.body.setTranslation({x:e.x,y:e.y-t,z:e.z},!0),this.world.propagateModifiedBodyPositionsToColliders()}eyePosition(){let e=this.body.translation();return{x:e.x,y:e.y+Ch[this.stance].eyeFromCenter,z:e.z}}setStance(e){if(e===this.stance)return!0;let t=Ch[this.stance],n=Ch[e],r=this.body.translation(),i=t.halfHeight+t.radius,a=n.halfHeight+n.radius,o=r.y-i,s={x:r.x,y:o+a,z:r.z},c=this.makeCapsule(n.halfHeight,n.radius);if(a>i){let e=!1;if(this.world.intersectionsWithShape(s,{x:0,y:0,z:0,w:1},c,()=>(e=!0,!1),void 0,void 0,this.collider),e)return!1}return this.collider.setShape(c),this.body.setTranslation(s,!0),this.world.propagateModifiedBodyPositionsToColliders(),this.stance=e,e===`prone`?this.controller.disableAutostep():this.controller.enableAutostep(.42,.22,!1),!0}currentStance(){return this.stance}move(e,t){this.world.timestep=t,this.controller.computeColliderMovement(this.collider,e);let n=this.controller.computedMovement(),r=this.body.translation();this.body.setNextKinematicTranslation({x:r.x+n.x,y:r.y+n.y,z:r.z+n.z}),this.world.step();let i=this.eyePosition(),a=5e-4;return{position:i,grounded:this.controller.computedGrounded(),blockedX:Math.abs(n.x-e.x)>a,blockedY:Math.abs(n.y-e.y)>a,blockedZ:Math.abs(n.z-e.z)>a,appliedDelta:{x:n.x,y:n.y,z:n.z}}}dispose(){this.world.free()}};function Th(e,t,n,r,i){let a=t.clone().sub(e),o=a.length(),s=o>1e-6?a.multiplyScalar(1/o):new z(0,0,-1),c=Math.abs(n-r)+1e-4,l=n+r-1e-4,u=Bt.clamp(o,c,l),d=(n*n-r*r+u*u)/(2*u),f=Math.sqrt(Math.max(0,n*n-d*d)),p=i.clone().sub(s.clone().multiplyScalar(i.dot(s)));return p.lengthSq()<1e-6&&p.crossVectors(s,Math.abs(s.y)<.9?new z(0,1,0):new z(1,0,0)),p.normalize(),e.clone().addScaledVector(s,d).addScaledVector(p,f)}var Eh=[{at:.12,event:`mag-release`},{at:.28,event:`mag-out`},{at:.66,event:`mag-in`},{at:.8,event:`mag-seat`},{at:.9,event:`bolt-release`}],Dh=[{at:.2,event:`shell-insert`},{at:.39,event:`shell-insert`},{at:.58,event:`shell-insert`},{at:.77,event:`shell-insert`},{at:.91,event:`bolt-release`}],Oh=e=>Math.min(1,Math.max(0,e)),kh=(e,t,n)=>{let r=Oh((n-e)/Math.max(1e-4,t-e));return r*r*(3-2*r)};function Ah(e,t,n){let r=Oh(t),i=Oh(n);return i<=r?[]:(e===`scattergun`?Dh:Eh).filter(({at:e})=>e>r&&e<=i).map(({event:e})=>e)}function jh(e,t){let n=Oh(t);if(e===`scattergun`){let e=n*5%1,t=n>=.1&&n<=.82;return{magazineDrop:0,magazineTwist:0,handToReload:kh(.05,.16,n)*(1-kh(.82,.94,n)),shellVisible:t&&e>.12&&e<.78,shellTravel:t?kh(.15,.72,e):0,actionPull:kh(.86,.91,n)*(1-kh(.91,.98,n))}}let r=kh(.1,.34,n),i=kh(.56,.81,n),a=r*(1-i);return{magazineDrop:a*.52+i*(1-kh(.78,.84,n))*.04,magazineTwist:a*.24,handToReload:kh(.06,.2,n)*(1-kh(.82,.94,n)),shellVisible:!1,shellTravel:0,actionPull:kh(.84,.9,n)*(1-kh(.9,.98,n))}}var Mh=class{flattenMaterials;root=new Rn;models=new Map;active=`carbine`;recoil=0;reloadStart=0;reloadDuration=0;reloadLastProgress=0;switchBlend=1;swayX=0;swayY=0;meleeStart=0;grenadeStart=0;muzzleLight;muzzleFlash;casings=[];smokes=[];smokePositions=new Float32Array(24);smokeColors=new Float32Array(24);smokePoints;armRigs=[];brassGeometry=new ma(.018,.018,.085,7);shellGeometry=new ma(.025,.025,.105,8);brassMaterial=new W({color:13149788,roughness:.3,metalness:.78});shellMaterial=new W({color:11812658,roughness:.58,metalness:.18});shotStarted=-1e4;casingCursor=0;smokeCursor=0;pendingScattergunShell=!1;adsBlend=0;sprintBlend=0;constructor(e,t=!1){this.flattenMaterials=t,this.root.name=`original-weapon-view`,this.root.position.set(.36,-.38,-.78),this.root.scale.setScalar(.6),e.add(this.root);let n=new W({color:2505784,roughness:.9}),r=new W({color:1185819,roughness:.94}),i=new Rn;i.name=`first-person-arms`;let a=e=>{let t=e===`left`?-1:1,i=.56,a=.58,o=new Rn;o.name=`${e}-shoulder-joint`,o.position.set(t*.25,e===`right`?-.17:-.12,e===`right`?.52:.45);let s=q(`${e}-upper-arm`,[.19,.19,i],n,.075,3);s.position.z=-.56/2,o.add(s);let c=new Rn;c.name=`${e}-elbow-joint`,c.position.z=-.56,o.add(c);let l=q(`${e}-forearm`,[.18,.18,a],n,.075,3);l.position.z=-.58/2,c.add(l);let u=q(`${e}-glove`,[.17,.15,.22],r,.06,3);u.position.set(t*-.015,-.01,-.58),u.rotation.x=-.12,c.add(u);let d=q(`${e}-thumb`,[.07,.1,.16],r,.028,2);return d.position.set(t*-.1,-.04,-.5599999999999999),d.rotation.z=t*.32,c.add(d),this.armRigs.push({side:e,shoulder:o,elbow:c,upperLength:i,lowerLength:a}),o};i.add(a(`right`),a(`left`)),i.scale.setScalar(.74),i.position.set(0,-.08,.02),this.root.add(i),this.muzzleLight=new Ns(16761706,0,4.5,2),this.muzzleLight.position.set(0,.08,-1.15),this.root.add(this.muzzleLight),this.muzzleFlash=new Rn,this.muzzleFlash.position.set(0,.08,-1.15);let o=new _i({color:16765834,transparent:!0,opacity:.92,depthWrite:!1}),s=new U(new ha(.085,.42,8),o);s.rotation.x=-Math.PI/2,s.position.z=-.2;let c=new U(new No(.34,.34),o.clone());c.rotation.z=Math.PI/4,this.muzzleFlash.add(s,c),this.muzzleFlash.visible=!1,this.root.add(this.muzzleFlash);let l=new Vr;this.smokePositions.fill(0);for(let e=0;e<8;e+=1)this.smokePositions[e*3+1]=-1e4;l.setAttribute(`position`,new Er(this.smokePositions,3)),l.setAttribute(`color`,new Er(this.smokeColors,3)),this.smokePoints=new ia(l,new $i({size:t?.045:.075,vertexColors:!0,transparent:!0,opacity:.58,depthWrite:!1,sizeAttenuation:!0})),this.smokePoints.name=`pooled-muzzle-smoke`,this.smokePoints.visible=!1,this.smokePoints.frustumCulled=!1,this.root.add(this.smokePoints);for(let e=0;e<8;e+=1)this.smokes.push({velocity:new z,life:0,maxLife:0,active:!1});for(let e=0;e<16;e+=1){let t=new U(this.brassGeometry,this.brassMaterial);t.name=`pooled-casing-${e}`,t.visible=!1,t.rotation.z=Math.PI/2,this.root.add(t),this.casings.push({mesh:t,velocity:new z,life:0,active:!1})}}async load(e){let t=[`carbine`,`smg`,`scattergun`];t.forEach((n,r)=>{let i=Pd(n,this.flattenMaterials);i.visible=!1,this.models.set(n,i),this.root.add(i),e?.(r+1,t.length)}),this.setWeapon(this.active,!0)}isReady(){return this.models.size===3}setWeapon(e,t=!1){this.active=e,this.switchBlend=+!!t,this.reloadDuration=0,this.reloadLastProgress=0,this.pendingScattergunShell=!1;for(let[t,n]of this.models)n.visible=t===e;let n=this.models.get(e)?.getObjectByName(`muzzle-socket`);n&&(this.muzzleLight.position.copy(n.position),this.muzzleFlash.position.copy(n.position))}ejectCasing(e){let t=this.casings[this.casingCursor++%this.casings.length];t.mesh.geometry=e?this.shellGeometry:this.brassGeometry,t.mesh.material=e?this.shellMaterial:this.brassMaterial;let n=this.models.get(this.active)?.getObjectByName(`eject-socket`);t.mesh.position.copy(n?.position??new z(.12,.04,-.48)),t.mesh.rotation.set(Math.random()*.4,0,Math.PI/2),t.mesh.visible=!0,t.velocity.set(e?.72:.95+Math.random()*.25,e?.55:.75+Math.random()*.2,e?.16:.1),t.life=e?.62:.42,t.active=!0}fire(e){this.recoil=Math.min(1,this.recoil+.24+e*5.2),this.shotStarted=performance.now(),this.muzzleLight.intensity=this.active===`scattergun`?7.2:4.8,this.muzzleFlash.visible=!0,this.muzzleFlash.scale.setScalar(this.active===`scattergun`?1.45:this.active===`smg`?.78:1),this.muzzleFlash.rotation.z=Math.random()*Math.PI;let t=this.models.get(this.active)?.getObjectByName(`muzzle-socket`),n=this.active===`scattergun`?2:1;for(let e=0;e<n;e+=1){let n=this.smokeCursor++%this.smokes.length,r=this.smokes[n],i=n*3,a=t?.position??new z(0,.08,-1.15);this.smokePositions[i]=a.x+(Math.random()-.5)*.025,this.smokePositions[i+1]=a.y+(Math.random()-.5)*.02,this.smokePositions[i+2]=a.z-.05-e*.035,r.velocity.set((Math.random()-.5)*.055,.1+Math.random()*.06,-.11-Math.random()*.08),r.maxLife=this.active===`scattergun`?.34:.22,r.life=r.maxLife,r.active=!0,this.smokeColors[i]=this.smokeColors[i+1]=this.smokeColors[i+2]=.62}this.smokePoints.visible=!0,this.smokePoints.geometry.getAttribute(`position`).needsUpdate=!0,this.smokePoints.geometry.getAttribute(`color`).needsUpdate=!0,this.active===`scattergun`?this.pendingScattergunShell=!0:this.ejectCasing(!1)}reload(e){this.reloadStart=performance.now(),this.reloadDuration=e*1e3,this.reloadLastProgress=0}cancelReload(){this.reloadDuration=0,this.reloadLastProgress=0}melee(){this.meleeStart=performance.now()}throwGrenade(){this.grenadeStart=performance.now()}addMouseDelta(e,t){this.swayX=Bt.clamp(this.swayX+e*8e-5,-.025,.025),this.swayY=Bt.clamp(this.swayY+t*6e-5,-.02,.02)}solveArms(e,t,n){if(t){this.root.updateMatrixWorld(!0);for(let r of this.armRigs){let i=r.side===`right`?`grip-socket-r`:`support-socket-l`,a=t.getObjectByName(i);if(!a)continue;let o=a.getWorldPosition(new z);if(r.side===`left`&&n.handToReload>0){let e=t.getObjectByName(`reload-socket-l`);e&&o.lerp(e.getWorldPosition(new z),n.handToReload)}let s=e.worldToLocal(o.clone()),c=new z(r.side===`left`?-.48:.48,-1,.22),l=Th(r.shoulder.position,s,r.upperLength,r.lowerLength,c).sub(r.shoulder.position).normalize();r.shoulder.quaternion.setFromUnitVectors(new z(0,0,-1),l),r.elbow.position.set(0,0,-r.upperLength),r.shoulder.updateWorldMatrix(!0,!0);let u=r.shoulder.worldToLocal(o.clone()).sub(r.elbow.position).normalize();r.elbow.quaternion.setFromUnitVectors(new z(0,0,-1),u)}}}update(e){let t=[],n=t=>1-Math.exp(-t*e.dt);this.recoil=Bt.lerp(this.recoil,0,n(16)),this.muzzleLight.intensity=Bt.lerp(this.muzzleLight.intensity,0,n(30)),this.switchBlend=Bt.lerp(this.switchBlend,1,n(10)),this.swayX=Bt.lerp(this.swayX,0,n(7)),this.swayY=Bt.lerp(this.swayY,0,n(7)),this.adsBlend=Bt.lerp(this.adsBlend,+!!e.ads,n(e.ads?18:15)),this.sprintBlend=Bt.lerp(this.sprintBlend,+!!e.sprinting,n(13)),this.muzzleFlash.visible=this.muzzleLight.intensity>.45;let r=this.root.getObjectByName(`first-person-arms`);r&&(r.position.y=Bt.lerp(-.08,-.3,this.adsBlend));for(let t of this.casings)t.active&&(t.life-=e.dt,t.velocity.y-=4.5*e.dt,t.mesh.position.addScaledVector(t.velocity,e.dt),t.mesh.rotation.x+=e.dt*18,t.mesh.rotation.z+=e.dt*11,t.life<=0&&(t.active=!1,t.mesh.visible=!1));let i=0;for(let t=0;t<this.smokes.length;t+=1){let n=this.smokes[t];if(!n.active)continue;let r=t*3;if(n.life-=e.dt,n.life<=0){n.active=!1,this.smokePositions[r+1]=-1e4,this.smokeColors[r]=this.smokeColors[r+1]=this.smokeColors[r+2]=0;continue}i+=1,this.smokePositions[r]+=n.velocity.x*e.dt,this.smokePositions[r+1]+=n.velocity.y*e.dt,this.smokePositions[r+2]+=n.velocity.z*e.dt;let a=Math.min(1,n.life/Math.max(.001,n.maxLife)*1.7)*.62;this.smokeColors[r]=this.smokeColors[r+1]=this.smokeColors[r+2]=a}this.smokePoints.visible=i>0,i>0&&(this.smokePoints.geometry.getAttribute(`position`).needsUpdate=!0,this.smokePoints.geometry.getAttribute(`color`).needsUpdate=!0);let a=this.models.get(this.active),o=performance.now()-this.shotStarted;this.active===`scattergun`&&this.pendingScattergunShell&&o>=230&&(this.ejectCasing(!0),this.pendingScattergunShell=!1);let s=a?.getObjectByName(`bolt-or-slide`);if(s){let e=Number(s.userData.restZ??0),t=this.active===`smg`?44:62,n=Bt.clamp(o/t,0,1);s.position.z=e+Math.sin(n*Math.PI)*(this.active===`smg`?.09:.075)}let c=a?.getObjectByName(`pump`);if(c){let e=Number(c.userData.restZ??-.48),t=Bt.clamp((o-180)/440,0,1);c.position.z=e+Math.sin(t*Math.PI)*.22}let l=e.moving?e.sprinting?1.22:e.ads||e.prone?.12:e.crouched?.32:.56:.05,u=Math.cos(e.phase*.5)*.017*l,d=Math.sin(e.phase)*.019*l,f=Math.sin(performance.now()*.0017)*(e.ads?.0015:.0045),p=this.adsBlend*-.36,m=this.adsBlend*.251,h=this.adsBlend*-.04,g=this.sprintBlend*-.16,_=1-this.adsBlend,v=e.crouched?.035*_:0,y=e.prone?.018*_:0,b=(1-this.switchBlend)*-.34,x=0,S=0,C=0;if(this.reloadDuration>0){C=Bt.clamp((performance.now()-this.reloadStart)/this.reloadDuration,0,1),t.push(...Ah(this.active,this.reloadLastProgress,C)),this.reloadLastProgress=C;let e=Math.sin(Math.PI*C),n=C>.65?Math.sin((C-.65)/.35*Math.PI):0;x=e*.78-n*.12,S=e*-.22+n*.035,C>=1&&(this.reloadDuration=0,this.reloadLastProgress=0)}let w=jh(this.active,C),T=a?.getObjectByName(this.active===`carbine`?`curved-magazine`:`straight-magazine`);T&&(T.userData.restY===void 0&&(T.userData.restY=T.position.y,T.userData.restRotationZ=T.rotation.z),T.position.y=Number(T.userData.restY)-w.magazineDrop,T.rotation.z=Number(T.userData.restRotationZ)+w.magazineTwist);let E=a?.getObjectByName(`reload-shell`);if(E&&(E.visible=w.shellVisible,E.position.set(-.16+w.shellTravel*.13,-.13+w.shellTravel*.035,-.02)),c&&w.actionPull>0){let e=Number(c.userData.restZ??-.48);c.position.z=e+w.actionPull*.16}let D=Bt.clamp((performance.now()-this.meleeStart)/430,0,1),ee=this.meleeStart>0&&D<1?Math.sin(D*Math.PI):0,te=Bt.clamp((performance.now()-this.grenadeStart)/620,0,1),O=this.grenadeStart>0&&te<1?Math.sin(te*Math.PI):0,ne=new z(.36+p+u+this.swayX-e.lateralSpeed*.012-ee*.24+O*.18,-.38+m+d+f+g+v+y+b+S-this.recoil*.08-e.landingImpulse*.075,-.78+h+this.recoil*.13-ee*.32+O*.24);return this.root.position.lerp(ne,n(18)),this.root.rotation.x=Bt.lerp(this.root.rotation.x,this.recoil*.18-this.swayY-O*.42,n(22)),this.root.rotation.y=Bt.lerp(this.root.rotation.y,-this.swayX*2-this.sprintBlend*.38-ee*.65,n(13)),this.root.rotation.z=Bt.lerp(this.root.rotation.z,x-this.sprintBlend*.22-e.lateralSpeed*(e.prone?.01:.025)+ee*.42,n(13)),r&&this.solveArms(r,a,w),t}};window.addEventListener(`error`,e=>{console.error(`[Atomic Acres runtime error]`,e.message||`unknown error`,e.error?.stack||``)}),window.addEventListener(`unhandledrejection`,e=>{let t=e.reason instanceof Error?`${e.reason.message}\n${e.reason.stack??``}`:String(e.reason);console.error(`[Atomic Acres unhandled rejection]`,t)});var Nh=[`carbine`,`smg`,`scattergun`],Ph=Yd.map(([e,t])=>new z(e,0,t));function Fh(){return typeof globalThis.crypto?.randomUUID==`function`?globalThis.crypto.randomUUID():`player-${Date.now().toString(36)}-${Math.random().toString(36).slice(2,10)}`}var Ih=document.querySelector(`#app`);if(!Ih)throw Error(`Missing #app root`);Ih.innerHTML=`
  ...
  <section id="menu" class="panel">
    ...
    <div class="menu-panel" data-menu-panel="kit" hidden>
      ...
      <div class="kit-grid">
        ${sf.map(e=>`<button type="button" class="kit-card" data-kit-id="${e.id}">
          <span>${e.role}</span><strong>${e.title}</strong><b>${Df[e.weapon].name}</b><p>${e.summary}</p>
...
`;function Z(e){let t=document.querySelector(e);if(!t)throw Error(`Missing element ${e}`);return t}var Lh=Z(`#game`),Rh=Z(`#menu`),zh=Z(`#hud`),Bh=Z(`#room-card`),Vh=Z(`#room-code`),Hh=Z(`#network-status`),Uh=Z(`#minimap`),Wh=Uh.getContext(`2d`);if(!Wh)throw Error(`Canvas2D minimap is unavailable`);var Gh=Wh,Kh=new pf,qh=new URLSearchParams(window.location.search).get(`render`)===`compat`;document.documentElement.classList.toggle(`compat-render`,qh);var Jh=new xd({canvas:Lh,antialias:!qh,powerPreference:`high-performance`});Jh.outputColorSpace=Ze,Jh.shadowMap.enabled=!qh,Jh.shadowMap.type=1,Jh.toneMapping=4,Jh.toneMappingExposure=1.14,Jh.setPixelRatio(qh?.2:Math.min(window.devicePixelRatio,1.75));var Yh=new qn;Yh.fog=new Kn(11978177,70,142);var Xh=new js(76,1,.08,180);Xh.rotation.order=`YXZ`,Yh.add(Xh);function Zh(){let e=new U(new Io(150,qh?20:32,qh?12:18),new Ko({side:1,depthWrite:!1,fog:!1,uniforms:{top:{value:new H(2382722)},horizon:{value:new H(12177869)},bottom:{value:new H(14862750)},sunColor:{value:new H(16765850)},cloudColor:{value:new H(15265511)},sunDirection:{value:new z(-.39,.83,.42).normalize()},cloudStrength:{value:qh?0:.035}},vertexShader:`
    ...
    `}));e.name=`procedural-atmosphere-sky`,e.frustumCulled=!1,e.onBeforeRender=()=>e.position.copy(Xh.position),Yh.add(e),Yh.add(new ys(14479359,5070918,1.48)),Yh.add(new Ls(13095892,.38));let t=new Is(16767397,2.8);t.position.set(-32,68,34),t.castShadow=!0,t.shadow.mapSize.set(2048,2048),t.shadow.camera.left=-48,t.shadow.camera.right=48,t.shadow.camera.top=54,t.shadow.camera.bottom=-54,t.shadow.camera.near=10,t.shadow.camera.far=150,t.shadow.bias=-28e-5,t.shadow.normalBias=.025,Yh.add(t)}Zh();var Q=Xf(Yh),Qh=new fp(Yh,qh),$={id:Fh(),name:`Player`,team:0,position:new z,velocity:new z,yaw:0,pitch:0,hp:100,kills:0,deaths:0,weapon:`carbine`,ammo:{carbine:Df.carbine.mag,smg:Df.smg.mag,scattergun:Df.scattergun.mag},reserve:{carbine:Df.carbine.reserve,smg:Df.smg.reserve,scattergun:Df.scattergun.reserve},reloadState:null,switchingUntil:0,lastShotAt:0,nextShotAt:0,sustainedShots:0,stance:`stand`,grenades:1,lastMeleeAt:-1e4,alive:!0,invulnerableUntil:0,seq:0},$h=new Set,eg=new Map,tg=new Map,ng=[],rg=new Set,ig=[],ag=!1,og=`solo`,sg=!1,cg=0,lg=0,ug=0,dg={pitch:0,yaw:0},fg=0,pg=0,mg=0,hg=0,gg=!1,_g=0,vg=0,yg=0,bg=0,xg=-1e4,Sg=-1e4,Cg=0,wg=performance.now(),Tg=0,Eg=new URLSearchParams(window.location.search).get(`renderPaused`)===`1`,Dg=qf(performance.now()),Og=!1,kg=!1,Ag=!1,jg=!1,Mg={x:0,y:0},Ng={yaw:0,pitch:0},Pg=!1,Fg=!0,Ig=!0,Lg=[],Rg=!1,zg=!1,Bg=1,Vg=1,Hg=82,Ug=!1,Wg=!1,Gg=null,Kg=null;function qg(){return ag&&$.alive&&Dg.phase===`active`&&Rh.classList.contains(`hidden`)}function Jg(){return ag&&$.alive&&Dg.phase!==`ended`&&Rh.classList.contains(`hidden`)}function Yg(){$h.clear(),Mg={x:0,y:0},Ng={yaw:0,pitch:0},Pg=!1,Ag=!1,jg=!1,sg=!1,kg=!1,gg=!1,xg=-1e4,$.velocity.x=0,$.velocity.z=0}function Xg(e,t=`ok`){Hh.textContent=e,Hh.dataset.kind=t}function Zg(e){let t=e instanceof Error?e.message:String(e);sg=!1,Xg(`Game paused: ${t}`,`error`),Rh.classList.remove(`hidden`);let n=Z(`#banner`);n.innerHTML=`<strong>SYSTEM PAUSED</strong><span>Reload the page to re-enter the test block.</span>`,n.hidden=!1,console.error(`[Atomic Acres fatal]`,e)}var Qg=typeof window.RTCPeerConnection==`function`;Qg?typeof Lh.requestPointerLock!=`function`&&Xg(`Pointer lock is unavailable; keyboard movement works but mouse aim may not.`,`warn`):(Z(`#host`).disabled=!0,Z(`#join`).disabled=!0,Xg(`This browser lacks WebRTC; solo training is still available.`,`warn`)),Lh.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),Zg(Error(`Graphics context was lost`))}),Lh.addEventListener(`webglcontextrestored`,()=>window.location.reload());var $g=new gh(l_,Xg),e_=new Mh(Xh,qh),t_=df(localStorage.getItem(lf));function n_(e){document.querySelectorAll(`[data-menu-tab]`).forEach(t=>{let n=t.dataset.menuTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,String(n))}),document.querySelectorAll(`[data-menu-panel]`).forEach(t=>{let n=t.dataset.menuPanel===e;t.classList.toggle(`active`,n),t.hidden=!n})}function r_(){let e=uf(t_),t=ag&&$.weapon!==e.weapon;Z(`#selected-kit-summary`).innerHTML=`<span>${t?`QUEUED NEXT DEPLOYMENT`:`ACTIVE FIELD KIT`}</span><strong>${e.title}</strong><b>${Df[e.weapon].name}</b>`,document.querySelectorAll(`[data-kit-id]`).forEach(e=>{let t=e.dataset.kitId===t_;e.classList.toggle(`selected`,t),e.setAttribute(`aria-pressed`,String(t))})}function i_(e){t_=uf(e).id,localStorage.setItem(lf,ff(t_)),ag||($.weapon=uf(t_).weapon,e_.setWeapon($.weapon,!0)),r_()}document.querySelectorAll(`[data-menu-tab]`).forEach(e=>{e.addEventListener(`click`,()=>n_(e.dataset.menuTab))}),document.querySelectorAll(`[data-kit-id]`).forEach(e=>{e.addEventListener(`click`,()=>i_(e.dataset.kitId??`balanced`))}),$.weapon=uf(t_).weapon,r_();var a_=new Ns(14216447,.9,5);a_.position.set(0,.4,.2),Xh.add(a_);function o_(e){return e===`prone`?.5:e===`crouch`?1.16:1.7}function s_(e){let t=new Rn;t.name=`remote-player-world`,t.rotation.order=`YXZ`,t.userData.playerId=e.id;let n=Ud(e.team,`remote-player-model`,qh,e.weapon);n.userData.playerId=e.id,n.traverse(n=>{n.userData.playerId=e.id,n.userData.targetRoot=t}),t.userData.operator=n,t.add(n);let r=document.createElement(`canvas`);r.width=256,r.height=64;let i=r.getContext(`2d`);i.fillStyle=`rgba(10,18,22,.72)`,i.fillRect(0,0,256,64),i.fillStyle=`#f7ecd4`,i.font=`700 30px Arial`,i.textAlign=`center`,i.textBaseline=`middle`,i.fillText(e.name,128,32);let a=new sa(r);a.colorSpace=Ze;let o=new si(new qr({map:a,transparent:!0,depthTest:!0,depthWrite:!1}));return o.visible=e.team===$.team,o.position.y=2.5,o.scale.set(2.4,.6,1),t.add(o),t.position.set(e.x,e.y-o_(e.stance),e.z),Yh.add(t),{root:t,snapshot:e,target:new z(e.x,e.y-o_(e.stance),e.z),targetYaw:e.yaw,lastSeen:performance.now()}}function c_(){return{id:$.id,name:$.name,team:$.team,x:$.position.x,y:$.position.y,z:$.position.z,yaw:$.yaw,pitch:$.pitch,hp:$.hp,kills:$.kills,deaths:$.deaths,weapon:$.weapon,stance:$.stance,seq:++$.seq}}function l_(e){if(e.type===`join`||e.type===`state`){let t=e.player;if(t.id===$.id||!Sf(t,Q.bounds,.44))return;let n=eg.get(t.id);n||(n=s_(t),eg.set(t.id,n),W_(`${t.name} entered the test block`,t.team===0?`aqua`:`coral`),e.type===`join`&&$g.send({type:`state`,player:c_()})),t.seq>=n.snapshot.seq&&(n.snapshot=t,n.target.set(t.x,t.y-o_(t.stance),t.z),n.targetYaw=t.yaw,n.lastSeen=performance.now(),n.root.visible=t.hp>0);return}if(e.type===`shot`){e.by!==$.id&&d_(e);return}if(e.type===`hit`&&e.target===$.id&&!rg.has(e.nonce)){let t=eg.get(e.by);if(!t||!Sf(t.snapshot,Q.bounds,.44))return;let n={x:t.snapshot.x,y:t.snapshot.y,z:t.snapshot.z};if(Q.colliders.some(e=>_f(n,$.position,e)))return;rg.add(e.nonce),p_(e.damage,e.by),u_();return}if(e.type===`death`&&!rg.has(e.nonce)){rg.add(e.nonce),m_(e),u_();return}e.type===`leave`&&h_(e.playerId,`left the block`)}function u_(){rg.size>512&&rg.clear()}function d_(e){let t=new z(...e.origin);if(!Sf(t,Q.bounds,.44))return;let n=new z(...e.direction).normalize(),r=yf(t,n,50,t.clone().addScaledVector(n,50),0,Q.colliders),i=t.clone().addScaledVector(n,r.tracerDistance);H_(t,n,r.tracerDistance,Df[e.weapon].color);let a=eg.get(e.by)?.root.userData.operator;a&&Vd(a),r.blockedByCover&&(V_(i,`concrete`,n.clone().multiplyScalar(-1)),Kh.impact(`concrete`,i.distanceTo(Xh.position))),$.alive&&Kh.nearMiss(of($.position,t,i)),Kh.shot(e.weapon,!0,t.distanceTo(Xh.position))}function f_(e){let t=eg.get(e)?.target??tg.get(e)?.position;if(!t||e===$.id)return;let n=t.x-$.position.x,r=t.z-$.position.z,i=Math.atan2(-n,-r),a=Z(`#damage-direction`);a.style.setProperty(`--damage-angle`,`${wf($.yaw,i)}rad`),a.classList.remove(`pulse`),requestAnimationFrame(()=>a.classList.add(`pulse`))}function p_(e,t){let n=performance.now();if(!(!$.alive||n<$.invulnerableUntil)&&($.hp=Math.max(0,$.hp-Math.min(100,Math.max(1,e))),Sg=n,Kh.damage(),f_(t),Z(`#damage-flash`).classList.remove(`pulse`),requestAnimationFrame(()=>Z(`#damage-flash`).classList.add(`pulse`)),$.hp<=0)){$.alive=!1,$.deaths+=1;let e={type:`death`,killer:t,victim:$.id,nonce:x_()};$g.send(e),m_(e),Z(`#respawn`).hidden=!1,document.exitPointerLock(),setTimeout(y_,1900)}}function m_(e){let t=e.killer===$.id?$.name:eg.get(e.killer)?.snapshot.name??tg.get(e.killer)?.name??`Unknown`,n=e.victim===$.id?$.name:eg.get(e.victim)?.snapshot.name??tg.get(e.victim)?.name??`Unknown`;e.killer===$.id&&e.victim!==$.id&&($.kills+=1,Kh.kill()),W_(`${t} eliminated ${n}`,e.killer===$.id?`gold`:void 0);let r=eg.get(e.victim);r&&(r.root.visible=!1);let i=tg.get(e.victim);i&&(i.root.visible=!1),Y_()}function h_(e,t){let n=eg.get(e);n&&(Yh.remove(n.root),eg.delete(e),W_(`${n.snapshot.name} ${t}`))}function g_(){let e=Q.spawns[$.team],t=og===`client`?Math.min(1,e.length-1):og===`host`?0:$.deaths%e.length,n=[...[...eg.values()].map(e=>new z(e.snapshot.x,e.snapshot.y,e.snapshot.z)),...[...tg.values()].filter(e=>e.alive).map(e=>e.position.clone())],r=[...[...eg.values()].filter(e=>e.snapshot.team!==$.team&&e.snapshot.hp>0).map(e=>new z(e.snapshot.x,e.snapshot.y,e.snapshot.z)),...[...tg.values()].filter(e=>e.team!==$.team&&e.alive).map(e=>e.position.clone().add(new z(0,1.42,0)))],i=e.map((e,t)=>({point:e,index:t})).filter(({point:e})=>{let t={x:e.x,y:0,z:e.z};return Number.isFinite(e.x)&&Number.isFinite(e.y)&&Number.isFinite(e.z)&&Sf(t,Q.bounds,.44)&&!bf(t,Q.colliders,.44)});if(i.length===0)throw Error(`No valid authored player spawn for team ${$.team}`);let a=i.map(({point:e,index:i})=>{let a=r.length===0?0:Math.min(...r.map(t=>t.distanceToSquared(e))),o=r.filter(t=>!Q.colliders.some(n=>_f(t,e,n))).length;return{point:e,index:i,score:Xd({nearestThreatDistanceSq:a,visibleThreats:o,occupied:n.some(t=>t.distanceToSquared(e)<20),preferred:i===t})}});return a.sort((e,t)=>t.score-e.score||e.index-t.index),a[0].point.clone()}function __(){try{let e=Lh.requestPointerLock();e instanceof Promise&&e.catch(()=>void 0)}catch{}}function v_(e){if(!Kg||!$.alive||!Rg)return!1;let t=Mf($.stance,e);if(t===$.stance)return!0;let n=$.stance,r=Kg.eyePosition();if(!Kg.setStance(t))return Xg(`Low clearance — stance change blocked.`,`warn`),!1;let i=Kg.eyePosition();return mg+=r.y-i.y,$.position.set(i.x,i.y,i.z),$.stance=t,_g=performance.now()+(t===`prone`?260:n===`prone`?290:135),gg=!1,!0}function y_(e=!0){$.stance=`stand`,Kg?.setStance(`stand`),$.position.copy(g_()),Kg?.teleportEye($.position),$.velocity.set(0,0,0),$.hp=100,Sg=-1e4,$.grenades=1,$.reloadState=null,$.alive=!0,$.invulnerableUntil=performance.now()+1350,$.yaw=$.team===0?Math.PI:0,$.pitch=0,dg={pitch:0,yaw:0},_g=0,vg=0,yg=0,mg=0,hg=0,xg=-1e4;let t=uf(t_).weapon;$.weapon!==t&&($.weapon=t,$.switchingUntil=0,e_.setWeapon(t,!0)),r_(),Z(`#respawn`).hidden=!0,ag&&e&&__(),$g.send({type:`state`,player:c_()})}function b_(e,t=!0){$.name=hh(Z(`#player-name`).value),$.team=+(Number(Z(`#team`).value)===1),ag=!0,e_.root.visible=!0,og=e,Ug=!1,Dg=qf(performance.now()),Og=!1,Rh.classList.add(`hidden`),zh.hidden=!1,Z(`#connection-pill`).textContent=e===`solo`?`BOT SKIRMISH`:e===`host`?`HOST`:`PEER`,Z(`#room-hud`).textContent=$g.roomCode?`ROOM ${$g.roomCode.slice(0,8).toUpperCase()}`:``,y_(t),e===`solo`&&O_(),Kh.unlock(),W_(`Welcome to Atomic Acres`,`gold`),e!==`solo`&&$g.send({type:`join`,player:c_()})}function x_(){return Math.floor(performance.now()*1e3+Math.random()*1e6)}function S_(e){let t=Nh[e];if(!(!t||t===$.weapon||!$.alive)){if($.reloadState){if(!Bf($.reloadState,performance.now()))return;$.reloadState=null,e_.cancelReload()}$.weapon=t,$.switchingUntil=performance.now()+360,$.sustainedShots=0,e_.setWeapon(t),Kh.weaponSwitch()}}function C_(){if(!$.alive||Dg.phase!==`active`)return;let e=Df[$.weapon],t=$.ammo[$.weapon];$.reloadState||t>=e.mag||$.reserve[$.weapon]<=0||($.reloadState=zf(e,t,$.reserve[$.weapon],performance.now()),ig.length=0,Kh.reload(),e_.reload(e.reload),W_(`Reloading ${e.name}`))}function w_(e){if(!$.reloadState)return;let t=Vf($.reloadState,e,$.ammo[$.weapon],$.reserve[$.weapon]);t.completed&&($.ammo[$.weapon]=t.ammo,$.reserve[$.weapon]=t.reserve,$.reloadState=null)}function T_(e){if(!$.alive||!ag||!Wg&&document.pointerLockElement!==Lh||Dg.phase!==`active`)return;gg&&(gg=!1,vg=Math.max(vg,e+150));let t=Math.max(_g,vg);if(e<t){yg<t&&(yg=t,window.setTimeout(()=>{yg=0,sg&&T_(performance.now())},Math.max(1,t-e+2)));return}yg=0;let n=Df[$.weapon];if(!sg&&n.automatic||e<$.switchingUntil)return;if($.reloadState){if(!Bf($.reloadState,e))return;$.reloadState=null,e_.cancelReload()}let r=6e4/n.rpm;if(e<$.nextShotAt)return;if(($.nextShotAt===0||e-$.nextShotAt>r*2)&&($.nextShotAt=e),$.nextShotAt+=r,$.ammo[$.weapon]<=0){Kh.empty(),C_(),$.lastShotAt=e;return}$.sustainedShots=e-$.lastShotAt<260?$.sustainedShots+1:0,$.lastShotAt=e,--$.ammo[$.weapon];let i=Z(`#ammo`);i.classList.remove(`fired`),requestAnimationFrame(()=>i.classList.add(`fired`));let a=Uf(n,$.sustainedShots,Math.random());dg.pitch=Math.min(.16,dg.pitch+a.pitch),dg.yaw=Bt.clamp(dg.yaw+a.yaw,-.075,.075),ug=Math.min(.24,ug+a.pitch*4.2),e_.fire(a.pitch),Kh.shot($.weapon);let o=Xh.getWorldPosition(new z),s=Xh.getWorldDirection(new z),c=Math.hypot($.velocity.x,$.velocity.z)>1.2,l=If(n,{ads:kg,moving:c,crouched:$.stance===`crouch`,prone:$.stance===`prone`,sustainedShots:$.sustainedShots}),u=new Map,d=!1,f=new z(1,0,0).applyQuaternion(Xh.quaternion),p=new z(0,1,0).applyQuaternion(Xh.quaternion);for(let e=0;e<n.pellets;e+=1){let e=Lf(l,Math.random(),Math.random()),t=s.clone().addScaledVector(f,e.x).addScaledVector(p,e.y).normalize(),r=E_(o,t);if(H_(o,t,r.distance,n.color),!r.playerId&&!r.targetId&&r.distance<89){let e=r.impactPoint??o.clone().addScaledVector(t,r.distance),n=r.impactNormal??t.clone().multiplyScalar(-1),i=r.impactSurface??`concrete`;V_(e,i,n),d||(d=!0,Kh.impact(i,e.distanceTo(Xh.position)))}if(r.playerId){let e=r.hitZone??`body`,t=Rf(n,r.distance,e),i=u.get(r.playerId);u.set(r.playerId,{damage:(i?.damage??0)+t,zone:i?.zone===`head`||e===`head`?`head`:e})}r.targetId&&z_(r.targetId)}for(let[e,t]of u){let n=tg.get(e);if(n)M_(n,Math.min(100,t.damage),t.zone);else{let n=eg.get(e);if(n&&n.snapshot.team!==$.team){let n=x_();$g.send({type:`hit`,by:$.id,target:e,damage:Math.min(100,t.damage),nonce:n}),U_(t.zone===`head`),Kh.hit(t.zone===`head`)}}}let m={type:`shot`,by:$.id,weapon:$.weapon,origin:o.toArray(),direction:s.toArray(),nonce:x_()};$g.send(m),$.ammo[$.weapon]===0&&setTimeout(C_,120)}function E_(e,t){let n=new tc(e,t,.1,110),r=[...eg.values()].filter(e=>e.root.visible).map(e=>e.root),i=[...tg.values()].filter(e=>e.alive&&e.root.visible).map(e=>e.root),a=Q.targets.filter(e=>e.active).map(e=>e.root),o=n.intersectObjects([...Q.raycastMeshes,...r,...i,...a],!0)[0];if(!o)return{distance:90};let s=o.object,c,l,u,d,f=[];for(;s;)c??=s.userData.playerId,l??=s.userData.targetId,u??=s.userData.hitZone,d??=s.userData.impactSurface,s.name&&f.push(s.name),s=s.parent;let p=o.object.userData.targetRoot;l??=p?.userData.targetId;let m=o.object instanceof U?Array.isArray(o.object.material)?o.object.material[0]:o.object.material:void 0,h=m instanceof W?m.metalness:void 0,g=o.face?.normal.clone().transformDirection(o.object.matrixWorld)??t.clone().multiplyScalar(-1);return{distance:Math.min(o.distance,110),playerId:c,targetId:l,hitZone:u,impactPoint:o.point.clone(),impactNormal:g,impactSurface:rf({hint:d,name:f.join(` `),metalness:h})}}function D_(e,t){let n=Q.spawns[e],r=[...$.alive&&$.team!==e?[$.position.clone()]:[],...[...eg.values()].filter(t=>t.snapshot.team!==e&&t.snapshot.hp>0).map(e=>new z(e.snapshot.x,e.snapshot.y,e.snapshot.z))],i=[...[...eg.values()].map(e=>e.target.clone()),...[...tg.values()].filter(e=>e.alive).map(e=>e.position.clone())],a=n.map((e,t)=>({candidate:e,index:t})).filter(({candidate:e})=>{let t={x:e.x,y:0,z:e.z};return Number.isFinite(e.x)&&Number.isFinite(e.z)&&Sf(t,Q.bounds,.44)&&!bf(t,Q.colliders,.44)});if(a.length===0)throw Error(`No valid authored spawn for team ${e}`);let o=a.map(({candidate:e,index:a})=>{let o=r.length===0?0:Math.min(...r.map(t=>t.distanceToSquared(e))),s=r.filter(t=>!Q.colliders.some(n=>_f(e,t,n))).length;return{candidate:e,index:a,score:Xd({nearestThreatDistanceSq:o,visibleThreats:s,occupied:i.some(t=>t.distanceToSquared(e)<20),preferred:a===(t%n.length+n.length)%n.length})}});return o.sort((e,t)=>t.score-e.score||e.index-t.index),o[0].candidate}function O_(){k_();let e=+($.team===0);[`RIVET`].slice(0,1).forEach((t,n)=>{let r=`bot-${n}`,i=Ud(e,`bot-operator`,qh);i.userData.playerId=r,i.traverse(e=>{e.userData.playerId=r,e.userData.targetRoot=i});let a=D_(e,n),o=new z(a.x,a.y-1.7,a.z);i.position.copy(o),Yh.add(i),tg.set(r,{id:r,name:t,team:e,root:i,position:o,velocity:new z,hp:100,alive:!0,kills:0,deaths:0,lastShotAt:0,lastSightAt:0,hasLineOfSight:!1,sightStartedAt:0,burstShots:0,nextDecisionAt:0,strafeSign:n%2==0?1:-1,invulnerableUntil:performance.now()+1e3,respawnAt:0,waypoint:n,blockedSince:0})}),W_(`One hostile operator entered the block`,`coral`)}function k_(){for(let e of tg.values())Yh.remove(e.root);tg.clear()}function A_(e){let t={x:e.position.x,y:e.position.y+1.42,z:e.position.z},n={x:$.position.x,y:$.position.y,z:$.position.z};return!Q.colliders.some(e=>_f(t,n,e))}function j_(e){let t={x:$.position.x,y:$.position.y,z:$.position.z};return Qd(Ph.map((n,r)=>{let i={x:n.x,y:1.42,z:n.z};return{index:r,distanceFromBot:n.distanceTo(e.position),distanceFromPlayer:n.distanceTo($.position),seesPlayer:$.alive&&!Q.colliders.some(e=>_f(i,t,e))}}),e.waypoint,e.deaths+e.kills)}function M_(e,t,n){let r=performance.now();!e.alive||r<e.invulnerableUntil||(e.hp=Math.max(0,e.hp-t),U_(n===`head`),Kh.hit(n===`head`),!(e.hp>0)&&(e.alive=!1,e.deaths+=1,e.respawnAt=r+2200,e.root.visible=!1,$.kills+=1,Kh.kill(),W_(`${$.name} eliminated ${e.name}${n===`head`?` · HEADSHOT`:``}`,`gold`),Y_()))}function N_(e,t){let n=tf(t),r=D_(e.team,e.deaths+e.waypoint);e.position.set(r.x,r.y-1.7,r.z),e.root.position.copy(e.position),e.hp=n.health,e.alive=n.alive,e.invulnerableUntil=n.invulnerableUntil,e.lastShotAt=n.lastShotAt,e.lastSightAt=0,e.hasLineOfSight=!1,e.sightStartedAt=0,e.burstShots=0,e.nextDecisionAt=0,e.blockedSince=0,e.root.visible=!0}function P_(e,t){if(og!==`solo`||Dg.phase!==`active`||Ug)return;let n=0;for(let r of tg.values()){if(n+=1,!r.alive){t>=r.respawnAt&&!Og&&N_(r,t);continue}if(!Sf(r.position,Q.bounds,.44)){let e=D_(r.team,r.waypoint);r.position.set(e.x,e.y-1.7,e.z),r.root.position.copy(r.position),r.hasLineOfSight=!1,r.sightStartedAt=0,r.burstShots=0,r.blockedSince=0,r.lastSightAt=t;continue}let i=$.position.clone().setY(0).sub(r.position.clone().setY(0)),a=i.length(),o=120+n*19;if(t-r.lastSightAt>=o){r.lastSightAt=t;let e=r.hasLineOfSight;r.hasLineOfSight=$.alive&&A_(r),r.hasLineOfSight&&!e&&(r.sightStartedAt=t),r.hasLineOfSight||(e&&(r.waypoint=j_(r)),r.sightStartedAt=0,r.burstShots=0)}let s=r.hasLineOfSight;t>=r.nextDecisionAt&&(r.strafeSign=r.strafeSign===1?-1:1,r.nextDecisionAt=t+850+n*95);let c=Ph[r.waypoint%Ph.length],l=c.clone().sub(r.position).setY(0),u=l.lengthSq()<5.2;u&&(r.waypoint=s?(r.waypoint+1+n)%Ph.length:j_(r));let d=ef({alive:r.alive,distanceToPlayer:a,hasLineOfSight:s,health:r.hp,now:t,lastShotAt:r.lastShotAt,waypointReached:u,random:r.strafeSign===1?.25:.75,lineOfSightSince:r.sightStartedAt,reactionDelay:650,burstShotsRemaining:r.burstShots});d.changeWaypoint&&!u&&(r.waypoint=j_(r)),c=Ph[r.waypoint%Ph.length],l=c.clone().sub(r.position).setY(0);let f=s?i:l,p=f.lengthSq()>.01?f.normalize():new z(0,0,-1),m=new z(-p.z,0,p.x),h=d.movement===`advance`?p:d.movement===`retreat`?p.clone().multiplyScalar(-1):d.movement===`strafe-left`?m.clone().multiplyScalar(-1):d.movement===`strafe-right`?m:new z,g=d.movement.startsWith(`strafe`)?4.05:s?4.65:5.85,_=r.position.clone().addScaledVector(h,g*e),v=xf(r.position,_,Q.colliders,Q.bounds,.44);if(Math.hypot(v.x-r.position.x,v.z-r.position.z)<.002&&h.lengthSq()>0){let n=r.position.clone().addScaledVector(m,r.strafeSign*g*e*1.5);v=xf(r.position,n,Q.colliders,Q.bounds,.44),Math.hypot(v.x-r.position.x,v.z-r.position.z)<.002?r.blockedSince===0?r.blockedSince=t:t-r.blockedSince>=400&&(r.waypoint=j_(r),r.blockedSince=0):r.blockedSince=0}else r.blockedSince=0;r.position.set(v.x,r.position.y,v.z),r.root.position.copy(r.position);let y=s?$.position:c;if(r.root.lookAt(y.x,r.position.y+1.1,y.z),Hd(r.root,`stand`,h.lengthSq()>0?g:0,t*.008+n,Math.min(1,e*12)),Zd(d.fire,t,r.invulnerableUntil)&&$.alive){r.burstShots<=0&&(r.burstShots=2+n%2),--r.burstShots,r.lastShotAt=t,Vd(r.root);let e=r.position.clone().add(new z(0,1.42,0)),i=$.position.clone().sub(e).normalize(),o=$d(a)+r.burstShots*.006;i.x+=(Math.random()-.5)*o,i.y+=(Math.random()-.5)*o,i.z+=(Math.random()-.5)*o,i.normalize();let s=Math.min(a+2,75),c=$.stance===`prone`?.38:$.stance===`crouch`?.48:.55,l=yf(e,i,s,$.position,c,Q.colliders),u=e.clone().addScaledVector(i,l.tracerDistance);H_(e,i,l.tracerDistance,Df.carbine.color),l.blockedByCover?(V_(u,`concrete`,i.clone().multiplyScalar(-1)),Kh.impact(`concrete`,u.distanceTo($.position))):l.hitTarget||Kh.nearMiss(of($.position,e,u)),Kh.shot(`carbine`,!0),l.hitTarget&&(p_(Rf(Df.carbine,a,`body`)*Ef,r.id),$.alive||(r.kills+=1,Y_()))}}}function F_(){let e=performance.now();if(!Kf(2,e,$.lastMeleeAt).hit||!$.alive||Dg.phase!==`active`)return;$.lastMeleeAt=e,e_.melee(),Kh.melee();let t=E_(Xh.getWorldPosition(new z),Xh.getWorldDirection(new z));if(!t.playerId||t.distance>2.25)return;let n=tg.get(t.playerId);n?M_(n,70,t.hitZone??`body`):eg.has(t.playerId)&&$g.send({type:`hit`,by:$.id,target:t.playerId,damage:70,nonce:x_()})}function I_(){if(!$.alive||$.grenades<=0||Dg.phase!==`active`)return;--$.grenades,e_.throwGrenade();let e=Xh.getWorldDirection(new z),t=Xh.getWorldPosition(new z).addScaledVector(e,.7),n=new U(new Io(.16,14,10),new W({color:3424570,roughness:.55,metalness:.48}));n.position.copy(t),n.castShadow=!0,Yh.add(n),ng.push({mesh:n,velocity:e.multiplyScalar(13).add(new z(0,5.2,0)),explodeAt:performance.now()+2300,lastBounceAt:0})}function L_(e){let t=e.mesh.position.clone();Yh.remove(e.mesh),Kh.explosion();let n=new U(new Io(1,20,14),new _i({color:16757324,transparent:!0,opacity:.72}));n.position.copy(t),n.scale.setScalar(.2),Yh.add(n);let r=new Ns(16743214,12,18,2);r.position.copy(t),Yh.add(r);let i=performance.now(),a=()=>{let e=(performance.now()-i)/420;if(e>=1){Yh.remove(n,r);return}n.scale.setScalar(.2+e*5.5),n.material.opacity=.72*(1-e),r.intensity=12*(1-e),requestAnimationFrame(a)};a();for(let e of tg.values()){let n=e.position.clone().add(new z(0,1.1,0)),r=Q.colliders.some(e=>_f(t,n,e))?0:Gf(e.position.distanceTo(t));r>0&&M_(e,r,`body`)}for(let e of eg.values()){let n=e.target.clone().add(new z(0,1.1,0));if(Q.colliders.some(e=>_f(t,n,e)))continue;let r=Gf(n.distanceTo(t));r>0&&$g.send({type:`hit`,by:$.id,target:e.snapshot.id,damage:r,nonce:x_()})}let o=Q.colliders.some(e=>_f(t,$.position,e))?0:Gf($.position.distanceTo(t))*.35;o>0&&p_(o,$.id)}function R_(e,t){for(let n=ng.length-1;n>=0;--n){let r=ng[n];r.velocity.y-=18*e;let i=r.mesh.position.clone(),a=r.velocity.clone().multiplyScalar(e),o=mf(i,a,Q.colliders);if(o){let e=new z(o.normal.x,o.normal.y,o.normal.z);r.mesh.position.copy(i).addScaledVector(a,o.time).addScaledVector(e,.025);let n=r.velocity.dot(e);r.velocity.addScaledVector(e,-(1.38*n)),r.velocity.multiplyScalar(.76),Math.abs(n)>1.8&&t-r.lastBounceAt>90&&(r.lastBounceAt=t,Kh.grenadeBounce(Math.abs(n)))}else r.mesh.position.add(a);if(!Sf(r.mesh.position,Q.bounds,.16)){let e=Cf(r.mesh.position,Q.bounds,.16);r.mesh.position.set(e.x,e.y,e.z),V_(r.mesh.position.clone()),Kh.coverImpact(r.mesh.position.distanceTo($.position)),Yh.remove(r.mesh),r.mesh.geometry.dispose(),r.mesh.material.dispose(),ng.splice(n,1);continue}if(r.mesh.rotation.x+=e*8,r.mesh.rotation.z+=e*11,r.mesh.position.y<.18){let e=Math.abs(r.velocity.y);e>1.8&&t-r.lastBounceAt>90&&(r.lastBounceAt=t,Kh.grenadeBounce(e)),r.mesh.position.y=.18,r.velocity.y=Math.abs(r.velocity.y)*.42,r.velocity.x*=.72,r.velocity.z*=.72}t>=r.explodeAt&&(ng.splice(n,1),L_(r))}}function z_(e){let t=Q.targets.find(t=>t.id===e);!t||!t.active||(t.active=!1,t.root.visible=!1,t.respawnAt=performance.now()+3200,cg+=1,U_(),Kh.hit(),W_(`+1 test mannequin`,`gold`))}function B_(e){for(let t of Q.targets){if(og===`solo`){t.root.visible=!1;continue}!t.active&&e>=t.respawnAt&&(t.active=!0,t.root.visible=!0)}}function V_(e,t=`concrete`,n=new z(0,1,0)){Qh.impact(e,n.normalize(),t)}function H_(e,t,n,r){let i=new Vr().setFromPoints([e.clone(),e.clone().addScaledVector(t,n)]),a=new Ji(i,new Bi({color:r,transparent:!0,opacity:.72}));Yh.add(a),setTimeout(()=>{Yh.remove(a),i.dispose(),a.material.dispose()},55)}function U_(e=!1){let t=Z(`#hitmarker`);t.classList.remove(`show`,`headshot`),e&&t.classList.add(`headshot`),requestAnimationFrame(()=>t.classList.add(`show`))}function W_(e,t){let n=Z(`#killfeed`),r=document.createElement(`div`);for(r.textContent=e,t&&r.classList.add(t),n.prepend(r);n.children.length>6;)n.lastElementChild?.remove();setTimeout(()=>r.classList.add(`fade`),4200),setTimeout(()=>r.remove(),5e3)}function G_(e){if(!Jg()||!Kg)return;let t=new z(-Math.sin($.yaw),0,-Math.cos($.yaw)),n=new z(Math.cos($.yaw),0,-Math.sin($.yaw)),r=Bt.clamp(Number($h.has(`KeyW`))-Number($h.has(`KeyS`))-Mg.y,-1,1),i=Bt.clamp(Number($h.has(`KeyD`))-Number($h.has(`KeyA`))+Mg.x,-1,1),a=t.clone().multiplyScalar(r).addScaledVector(n,i);a.lengthSq()>1&&a.normalize();let o=performance.now(),s=$.stance===`crouch`,c=$.stance===`prone`,l=($h.has(`ShiftLeft`)||Pg)&&a.lengthSq()>0&&Rg,u=jf(r,i,kg,!1,!1);l&&u&&$.stance!==`stand`&&v_(`stand`),gg=l&&!sg&&!$.reloadState&&o>=$.switchingUntil&&o-$.lastMeleeAt>500&&jf(r,i,kg,s,c);let d=Of({crouched:s,prone:c,ads:kg,sprinting:gg,grounded:Rg}),f=Af({x:$.velocity.x,z:$.velocity.z},{x:a.x,z:a.z},d,e);$.velocity.x=f.x,$.velocity.z=f.z,$.hp<100&&o-Sg>=5e3&&($.hp=Math.min(100,$.hp+18*e)),Rg&&(bg=o);let p=o-xg<=125,m=Rg||o-bg<=95;p&&m&&!kg&&$.stance===`stand`&&Dg.phase===`active`?($.velocity.y=d.jumpVelocity,Rg=!1,xg=-1e4):($.velocity.y-=24.5*e,Rg&&($.velocity.y=Math.max(0,$.velocity.y)));let h=$.velocity.y,g=Kg.move({x:$.velocity.x*e,y:$.velocity.y*e,z:$.velocity.z*e},e);$.position.set(g.position.x,g.position.y,g.position.z),Rg=g.grounded,Rg&&(bg=o),Rg&&!zg&&h<-5&&(fg=Math.min(1,Math.abs(h)/14),Kh.land(Math.abs(h))),zg=Rg,g.blockedX&&($.velocity.x=g.appliedDelta.x/Math.max(e,.001)),g.blockedY&&$.velocity.y<0&&($.velocity.y=0),g.blockedZ&&($.velocity.z=g.appliedDelta.z/Math.max(e,.001));let _=a.lengthSq()>0&&Rg,v=gg?300:c?760:s?575:405;_&&o-Cg>=v&&(Cg=o,Kh.footstep(gg,s||c)),pg+=e*(gg?15:c?3.6:s?7:10)*(_?1:.25),ug=Hf(ug,Df[$.weapon],e),dg=Wf(dg,Df[$.weapon],e),fg=Tf(fg,0,10,e),mg=Tf(mg,0,c?9:15,e);let y=$.velocity.dot(n)/Math.max(1,d.maxSpeed);hg=Tf(hg,-y*(kg?.006:.016),11,e);let b=e_.update({dt:e,moving:_,sprinting:gg,crouched:s,prone:c,ads:kg,phase:pg,landingImpulse:fg,lateralSpeed:y});for(let e of b)Kh.weaponAction($.weapon,e),ig.push(e);ig.length>16&&ig.splice(0,ig.length-16),Xh.fov=Tf(Xh.fov,kg?Math.max(55,Hg-20):gg?Hg+4.5:Hg,10,e),Xh.updateProjectionMatrix(),Xh.position.copy($.position),Xh.position.y+=mg-fg*.035,Xh.rotation.y=$.yaw+dg.yaw,Xh.rotation.x=Bt.clamp($.pitch-dg.pitch,-1.42,1.42),Xh.rotation.z=hg}function K_(e,t){for(let[n,r]of eg){if(t-r.lastSeen>12e3){h_(n,`timed out`);continue}let i=1-Math.exp(-13*e),a=r.root.position.distanceTo(r.target);r.root.position.lerp(r.target,i),r.root.rotation.y+=wf(r.root.rotation.y,r.targetYaw)*i;let o=r.snapshot.stance??`stand`,s=r.root.userData.operator;Bd(s,r.snapshot.weapon,qh),Hd(s,o,a/Math.max(e,.001),t*.008,i,r.snapshot.pitch)}}function q_(){let e=$.team===0?$.kills:0,t=$.team===1?$.kills:0;for(let n of eg.values())n.snapshot.team===0?e+=n.snapshot.kills:t+=n.snapshot.kills;for(let n of tg.values())n.team===0?e+=n.kills:t+=n.kills;return[e,t]}function J_(e){let t=Dg.phase,n=q_();if(Dg=Jf(Dg,e,n),t===Dg.phase)return;let r=Z(`#banner`);if(Dg.phase===`active`){r.innerHTML=`<strong>ENGAGE</strong><span>First squad to 25</span>`,r.hidden=!1,window.setTimeout(()=>{Dg.phase===`active`&&(r.hidden=!0)},900);return}if(Dg.phase===`ended`){Og=!0;let e=Dg.winner===$.team;r.innerHTML=`<strong>${Dg.winner===`draw`?`DRAW`:e?`VICTORY`:`DEFEAT`}</strong><span>${n[0]} — ${n[1]} · CLICK BOT SKIRMISH FOR REMATCH</span>`,r.hidden=!1,document.exitPointerLock()}}function Y_(){J_(performance.now())}function X_(e){let t=Gh,n=Uh.width,r=Uh.height,i=Q.bounds,a=(e,t)=>Zf(e,t,i,n,r);t.clearRect(0,0,n,r),t.fillStyle=`rgba(7, 15, 18, .78)`,t.fillRect(0,0,n,r),t.strokeStyle=`rgba(244, 196, 79, .5)`,t.lineWidth=2,t.strokeRect(2,2,n-4,r-4);let[o]=a(-10.25,0),[s]=a(10.25,0);t.fillStyle=`rgba(126, 137, 132, .18)`,t.fillRect(o,2,s-o,r-4);for(let[e,o,s]of[[-11,-34,0],[11,34,1]]){let[c,l]=a(e,o),u=16.4/(i.maxX-i.minX)*n,d=15/(i.maxZ-i.minZ)*r;t.fillStyle=s===0?`rgba(88, 227, 220, .2)`:`rgba(255, 118, 95, .2)`,t.fillRect(c-u/2,l-d/2,u,d)}for(let e of eg.values()){let n=e.snapshot.team===$.team;if(!n&&e.target.distanceTo($.position)>15)continue;let[r,i]=a(e.target.x,e.target.z);t.fillStyle=n?`#58e3dc`:`#ff765f`,t.beginPath(),t.arc(r,i,3.5,0,Math.PI*2),t.fill()}for(let n of tg.values()){if(!n.alive||!Qf(n.position.distanceTo($.position),e,n.lastShotAt))continue;let[r,i]=a(n.position.x,n.position.z);t.fillStyle=`#ff765f`,t.beginPath(),t.arc(r,i,3.5,0,Math.PI*2),t.fill()}let[c,l]=a($.position.x,$.position.z);t.save(),t.translate(c,l),t.rotate(-$.yaw),t.fillStyle=$.team===0?`#58e3dc`:`#ff765f`,t.beginPath(),t.moveTo(0,-7),t.lineTo(5,6),t.lineTo(-5,6),t.closePath(),t.fill(),t.restore()}function Z_(e){if(e-Tg<100)return;Tg=e,ag&&J_(e);let t=Df[$.weapon],n=Math.hypot($.velocity.x,$.velocity.z),r=If(t,{ads:kg,moving:n>1.2,crouched:$.stance===`crouch`,prone:$.stance===`prone`,sustainedShots:$.sustainedShots}),i=Bt.clamp(5+r*320,5,23),a=Z(`#crosshair`);a.style.setProperty(`--spread`,`${i}px`),a.classList.toggle(`ads`,kg);let[o,s]=q_();Z(`#health`).textContent=String(Math.ceil($.hp)),Z(`#health-fill`).style.width=`${$.hp}%`,Z(`#weapon-name`).textContent=t.name.toUpperCase(),Z(`#ammo`).textContent=String($.ammo[$.weapon]),Z(`#reserve`).textContent=String($.reserve[$.weapon]),Z(`#aqua-score`).textContent=String(o),Z(`#coral-score`).textContent=String(s);let c=Math.max(0,Dg.endsAt-e),l=Dg.phase===`warmup`?Math.ceil(c/1e3):Math.floor(c/1e3);Z(`#timer`).textContent=Dg.phase===`warmup`?`00:0${Math.min(9,l)}`:`${String(Math.floor(l/60)).padStart(2,`0`)}:${String(l%60).padStart(2,`0`)}`,Z(`#objective`).textContent=Dg.phase===`warmup`?`MATCH STARTS IN ${l}`:`ATOMIC ACRES · FIRST TO 25`,Z(`#reload-state`).textContent=$.reloadState?`RELOADING ${Math.max(0,($.reloadState.endsAt-e)/1e3).toFixed(1)}s`:og===`solo`?`${$.kills} K / ${$.deaths} D · ${cg} TARGETS`:`${$.kills} K / ${$.deaths} D`,Z(`#stance`).textContent=$.stance.toUpperCase(),Z(`#grenades`).textContent=`FRAG ×${$.grenades}`,Z(`#health-block`).classList.toggle(`critical`,$.hp<=30),X_(e),Z(`#roster`).hidden||Q_()}function Q_(){let e=[c_(),...[...eg.values()].map(e=>e.snapshot),...[...tg.values()].map(e=>({id:e.id,name:e.name,team:e.team,x:e.position.x,y:e.position.y,z:e.position.z,yaw:e.root.rotation.y,pitch:0,hp:e.hp,kills:e.kills,deaths:e.deaths,weapon:`carbine`,seq:0}))].sort((e,t)=>t.kills-e.kills||e.deaths-t.deaths);Z(`#roster-list`).innerHTML=e.map(e=>`<div><span class="${e.team===0?`aqua`:`coral`}">${$_(e.name)}</span><b>${e.kills}</b><i>${e.deaths}</i><em>${e.hp>0?Math.ceil(e.hp)+` HP`:`DOWN`}</em></div>`).join(``)}function $_(e){return e.replace(/[&<>'"]/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,"'":`&#39;`,'"':`&quot;`})[e])}function ev(){let e=window.innerWidth,t=window.innerHeight;Jh.setSize(e,t,!1),Xh.aspect=e/Math.max(1,t),Xh.updateProjectionMatrix()}window.addEventListener(`resize`,ev),ev();var tv=new URLSearchParams(window.location.search),nv=tv.get(`room`)?.trim()??``;nv&&(Z(`#room-input`).value=nv);var rv=tv.get(`name`);rv&&(Z(`#player-name`).value=hh(rv)),tv.get(`team`)===`1`&&(Z(`#team`).value=`1`);var iv=Z(`#sensitivity`),av=Z(`#controller-sensitivity`),ov=Z(`#field-of-view`),sv=(e,t,n,r)=>{let i=Number(localStorage.getItem(e));return Number.isFinite(i)&&i>=n&&i<=r?i:t};Bg=sv(`atomic-acres-sensitivity`,Number(iv.value),.6,2),Vg=sv(`atomic-acres-controller-sensitivity`,Number(av.value),.5,1.8),Hg=sv(`atomic-acres-fov`,Number(ov.value),70,100),iv.value=String(Bg),av.value=String(Vg),ov.value=String(Hg),iv.addEventListener(`input`,()=>{Bg=Number(iv.value),localStorage.setItem(`atomic-acres-sensitivity`,String(Bg))}),av.addEventListener(`input`,()=>{Vg=Number(av.value),localStorage.setItem(`atomic-acres-controller-sensitivity`,String(Vg))}),ov.addEventListener(`input`,()=>{Hg=Number(ov.value),localStorage.setItem(`atomic-acres-fov`,String(Hg))});function cv(e){let t=navigator.getGamepads?.().find(e=>!!(e&&e.connected));if(!t){Mg={x:0,y:0},Ng={yaw:0,pitch:0},Pg=!1,Lg=[],sg=Ag,kg=Gg??jg;return}let n=Pf(t.axes[0]??0,t.axes[1]??0,.14,1.6),r=Pf(t.axes[2]??0,t.axes[3]??0,.1,1.6),i=t.buttons.map(e=>e.pressed||e.value>.55),a=e=>i[e]&&!Lg[e],o=!!i[6]||(t.buttons[6]?.value??0)>.22,s=!!i[7]||(t.buttons[7]?.value??0)>.22,c=qg();s?c||(Fg=!1):Fg=!0,o?c||(Ig=!1):Ig=!0;let l=c&&s&&Fg,u=c&&o&&Ig;Pg=c&&!!i[10],kg=Gg??(jg||u),sg=Ag||l,Mg=c?n:{x:0,y:0},Ng=Ff(Ng,c?r:{x:0,y:0},e,kg,Vg),c&&($.yaw-=Ng.yaw*e,$.pitch=Bt.clamp($.pitch-Ng.pitch*e,-1.42,1.42),a(0)&&($.stance!==`stand`&&v_(`stand`),xg=performance.now()),a(1)&&v_(`toggle-crouch`),a(13)&&v_(`toggle-prone`),a(2)&&C_(),a(3)&&S_((Nh.indexOf($.weapon)+1)%Nh.length),a(4)&&I_(),a(5)&&F_()),Lg=i}window.addEventListener(`keydown`,e=>{if(qg())$h.add(e.code);else if(e.code!==`Tab`)return;e.code===`Space`&&!e.repeat&&($.stance!==`stand`&&v_(`stand`),xg=performance.now()),e.code===`KeyC`&&!e.repeat&&v_(`toggle-crouch`),(e.code===`KeyZ`||e.code===`ControlLeft`)&&!e.repeat&&v_(`toggle-prone`),e.code===`Digit1`&&S_(0),e.code===`Digit2`&&S_(1),e.code===`Digit3`&&S_(2),e.code===`KeyR`&&C_(),e.code===`KeyV`&&!e.repeat&&F_(),e.code===`KeyG`&&!e.repeat&&I_(),e.code===`Tab`&&(e.preventDefault(),Q_(),Z(`#roster`).hidden=!1)}),window.addEventListener(`keyup`,e=>{$h.delete(e.code),e.code===`Tab`&&(Z(`#roster`).hidden=!0)}),window.addEventListener(`blur`,()=>{Yg()}),window.addEventListener(`mousemove`,e=>{if(document.pointerLockElement!==Lh||!$.alive)return;let t=Nf(kg,gg);$.yaw-=e.movementX*.00215*Bg*t,$.pitch=Math.max(-1.42,Math.min(1.42,$.pitch-e.movementY*.0019*Bg*t)),e_.addMouseDelta(e.movementX,e.movementY)}),Lh.addEventListener(`contextmenu`,e=>e.preventDefault()),Lh.addEventListener(`mousedown`,e=>{if(document.pointerLockElement!==Lh){__();return}if(e.button===2){jg=!0,kg=!0;return}e.button===0&&(Ag=!0,sg=!0,T_(performance.now()))}),window.addEventListener(`mouseup`,e=>{e.button===0&&(Ag=!1),e.button===2&&(jg=!1),sg=Ag,kg=jg}),document.addEventListener(`pointerlockchange`,()=>{document.pointerLockElement===Lh?(Z(`#resume`).hidden=!0,Rh.classList.add(`hidden`)):(Yg(),ag&&$.alive&&(Z(`#resume`).hidden=Og,Rh.classList.remove(`hidden`)))});function lv(){$.kills=0,$.deaths=0,$.hp=100,$.grenades=1,$.reloadState=null,$.sustainedShots=0,$.stance=`stand`,Kg?.setStance(`stand`),cg=0,k_();for(let e of ng)Yh.remove(e.mesh);ng.length=0;for(let e of eg.keys())h_(e,`cleared`);Z(`#banner`).hidden=!0,$.weapon=uf(t_).weapon,$.switchingUntil=0,e_.setWeapon($.weapon,!0),r_(),$.ammo={carbine:Df.carbine.mag,smg:Df.smg.mag,scattergun:Df.scattergun.mag},$.reserve={carbine:Df.carbine.reserve,smg:Df.smg.reserve,scattergun:Df.scattergun.reserve}}Z(`#resume`).addEventListener(`click`,()=>{ag&&$.alive&&!Og&&__()}),Z(`#solo`).addEventListener(`click`,()=>{$g.close(),lv(),b_(`solo`)}),Z(`#host`).addEventListener(`click`,()=>{lv(),$g.host(()=>{Bh.hidden=!1,Vh.textContent=$g.roomCode,b_(`host`)})}),Z(`#join`).addEventListener(`click`,()=>{lv();let e=Z(`#room-input`).value.trim();$g.join(e,()=>b_(`client`))}),Z(`#copy-room`).addEventListener(`click`,async()=>{let e=`${window.location.origin}${window.location.pathname}?room=${encodeURIComponent($g.roomCode)}`;try{await navigator.clipboard.writeText(e),Xg(`Invite link copied`,`ok`)}catch{Z(`#room-input`).value=$g.roomCode,Xg(`Clipboard blocked — code placed in join field`,`warn`)}}),nv&&tv.get(`autojoin`)===`1`&&window.setTimeout(()=>Z(`#join`).click(),100),setInterval(()=>{ag&&$g.role!==`offline`&&$.alive&&$g.send({type:`state`,player:c_()})},60),window.addEventListener(`beforeunload`,()=>{$g.role!==`offline`&&$g.send({type:`leave`,playerId:$.id}),$g.close()});function uv(e){try{let t=Math.min(.05,Math.max(0,(e-wg)/1e3));wg=e,cv(t),lg+=t;let n=1/120,r=0;for(;lg>=n&&r<6;)G_(n),lg-=n,r+=1;sg&&Df[$.weapon].automatic&&T_(e),w_(e),B_(e),P_(t,e),R_(t,e),Qh.update(t),K_(t,e),Z_(e),Eg||Jh.render(Yh,Xh),requestAnimationFrame(uv)}catch(e){Zg(e)}}var dv=window;dv.__ATOMIC_ACRES_DEBUG__={snapshot:()=>({gameStarted:ag,gameMode:og,matchPhase:Dg.phase,player:{hp:$.hp,kills:$.kills,deaths:$.deaths,weapon:$.weapon,ammo:$.ammo[$.weapon],reserve:$.reserve[$.weapon],stance:$.stance,crouched:$.stance===`crouch`,prone:$.stance===`prone`,sprinting:gg,grenades:$.grenades,position:$.position.toArray()},bots:[...tg.values()].map(e=>({id:e.id,hp:e.hp,alive:e.alive,kills:e.kills,position:e.position.toArray(),waypoint:e.waypoint,blockedSince:e.blockedSince,hasLineOfSight:e.hasLineOfSight})),remotes:eg.size,remotePlayers:[...eg.values()].map(e=>({id:e.snapshot.id,stance:e.snapshot.stance??`stand`,position:e.target.toArray()})),grenades:ng.length,activeImpactParticles:Qh.activeParticles(),originalArtLoaded:Yh.getObjectByName(`original-arena-art`)!==void 0,weaponReady:e_.isReady(),weaponActionHistory:[...ig],menuVisible:!Rh.classList.contains(`hidden`),render:{calls:Jh.info.render.calls,triangles:Jh.info.render.triangles,points:Jh.info.render.points,lines:Jh.info.render.lines,sceneObjects:Yh.children.length,reducedMode:qh}}),startSolo:()=>{$g.close(),lv(),b_(`solo`,!1)},setBotsFrozen:e=>{Ug=e},setRenderPaused:e=>{Eg=e},openMenu:()=>{Yg(),Rh.classList.remove(`hidden`)},fireOnce:()=>{Wg=!0,sg=!0,T_(performance.now()),sg=!1,Wg=!1},throwGrenade:()=>I_(),switchWeapon:e=>S_(e),reload:()=>C_(),melee:()=>F_(),setAds:e=>{Gg=e,kg=e},setStance:e=>{e!==$.stance&&v_(e===`stand`?`stand`:e===`prone`?`toggle-prone`:`toggle-crouch`)},damage:e=>{$.invulnerableUntil=0,p_(e,tg.keys().next().value??$.id)}};function fv(e,t){let n=new Set;e.traverse(e=>{if(!(e instanceof U)||t.getObjectById(e.id))return;let r=Array.isArray(e.material)?e.material:[e.material];for(let e of r){if(n.has(e)||!(e instanceof W))continue;n.add(e);let{r:t,g:r,b:i}=e.color;Math.max(t,r,i)<.16&&e.color.lerp(new H(5989988),.24)}})}async function pv(){let e=Z(`#solo`),t=Z(`#host`),n=Z(`#join`);e.disabled=!0,t.disabled=!0,n.disabled=!0,Xg(`Loading authored arena art, weapons and advanced collision…`);let r=wh.create(Q.colliders,Q.bounds),i=e_.load((e,t)=>{Xg(`Loading authored weapons ${e}/${t}…`)}),a=cp(Yh,(e,t)=>{Xg(`Loading authored arena models ${e}/${t}…`)},qh),[o,,s]=await Promise.all([r,i,a]);Kg=o;let c=Q.raycastMeshes.filter(e=>e.visible||e.userData.collisionProxy===!0);Q.raycastMeshes.splice(0,Q.raycastMeshes.length,...c),s.root.traverse(e=>{e instanceof U&&e.userData.blocksShots===!0&&Q.raycastMeshes.push(e)});let l=Yh.getObjectByName(`Atomic Acres arena`);l&&Ad(l,Yh,()=>``,qh),Ad(s.root,Yh,()=>``,qh),fv(Yh,e_.root),e_.setWeapon($.weapon,!0),y_(),e_.root.visible=!1,Xh.position.set(0,30,-22),Xh.lookAt(0,.8,4),Xh.fov=65,Xh.updateProjectionMatrix(),e.disabled=!1,t.disabled=!Qg,n.disabled=!Qg,Xg(`Pass 06 ready — procedural atmosphere, tuned controller look and tactical one-bot routing active.`),requestAnimationFrame(uv)}pv().catch(Zg);