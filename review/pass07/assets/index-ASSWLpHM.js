...
s=-\r
t=0 0\r
`},n.getDirection=function(e,t){let r=n.splitLines(e);for(let e=0;e<r.length;e++)switch(r[e]){case`a=sendrecv`:case`a=sendonly`:case`a=recvonly`:case`a=inactive`:return r[e].substring(2);default:}return t?n.getDirection(t):`sendrecv`},n.getKind=function(e){return n.splitLines(e)[0].split(` `)[0].substring(2)},n.isRejected=function(e){return e.split(` `,2)[1]===`0`},n.parseMLine=function(e){let t=n.splitLines(e)[0].substring(2).split(` `);return{kind:t[0],port:parseInt(t[1],10),protocol:t[2],fmt:t.slice(3).join(` `)}},n.parseOLine=function(e){let t=n.matchPrefix(e,`o=`)[0].substring(2).split(` `);return{username:t[0],sessionId:t[1],sessionVersion:parseInt(t[2],10),netType:t[3],addressType:t[4],address:t[5]}},n.isValidSDP=function(e){if(typeof e!=`string`||e.length===0)return!1;let t=n.splitLines(e);for(let e=0;e<t.length;e++)if(t[e].length<2||t[e].charAt(1)!==`=`)return!1;return!0},typeof t==`object`&&(t.exports=n)})),Nm=s({removeExtmapAllowMixed:()=>Bm,shimAddIceCandidateNullOrEmpty:()=>Vm,shimConnectionState:()=>zm,shimMaxMessageSize:()=>Lm,shimParameterlessSetLocalDescription:()=>Hm,shimRTCIceCandidate:()=>Fm,shimRTCIceCandidateRelayProtocol:()=>Im,shimSendThrowTypeError:()=>Rm}),Pm=l(Mm());function Fm(e){if(!e.RTCIceCandidate||e.RTCIceCandidate&&`foundation`in e.RTCIceCandidate.prototype)return;let t=e.RTCIceCandidate;e.RTCIceCandidate=function(e){if(typeof e==`object`&&e.candidate&&e.candidate.indexOf(`a=`)===0&&(e=JSON.parse(JSON.stringify(e)),e.candidate=e.candidate.substring(2)),e.candidate&&e.candidate.length){let n=new t(e),r=Pm.default.parseCandidate(e.candidate);for(let e in r)e in n||Object.defineProperty(n,e,{value:r[e]});return n.toJSON=function(){return{candidate:n.candidate,sdpMid:n.sdpMid,sdpMLineIndex:n.sdpMLineIndex,usernameFragment:n.usernameFragment}},n}return new t(e)},e.RTCIceCandidate.prototype=t.prototype,Vp(e,`icecandidate`,t=>(t.candidate&&Object.defineProperty(t,"candidate",{value:new e.RTCIceCandidate(t.candidate),writable:`false`}),t))}function Im(e){!e.RTCIceCandidate||e.RTCIceCandidate&&`relayProtocol`in e.RTCIceCandidate.prototype||Vp(e,`icecandidate`,e=>{if(e.candidate){let t=Pm.default.parseCandidate(e.candidate.candidate);t.type===`relay`&&(e.candidate.relayProtocol={0:`tls`,1:`tcp`,2:`udp`}[t.priority>>24])}return e})}function Lm(e,t){if(!e.RTCPeerConnection||t.browser===`chrome`&&t.version>102||t.browser===`firefox`&&t.version>=113)return;`sctp`in e.RTCPeerConnection.prototype||Object.defineProperty(e.RTCPeerConnection.prototype,"sctp",{get(){return this._sctp===void 0?null:this._sctp}});let n=function(e){if(!e||!e.sdp)return!1;let t=Pm.default.splitSections(e.sdp);return t.shift(),t.some(e=>{let t=Pm.default.parseMLine(e);return t&&t.kind===`application`&&t.protocol.indexOf(`SCTP`)!==-1})},r=function(e){let t=e.sdp.match(/mozilla...THIS_IS_SDPARTA-(\d+)/);if(t===null||t.length<2)return-1;let n=parseInt(t[1],10);return n===n?n:-1},i=function(e){let n=65536;return t.browser===`firefox`&&(n=t.version<57?e===-1?16384:2147483637:t.version<60?t.version===57?65535:65536:2147483637),n},a=function(e,n){let r=65536;t.browser===`firefox`&&t.version===57&&(r=65535);let i=Pm.default.matchPrefix(e.sdp,`a=max-message-size:`);return i.length>0?r=parseInt(i[0].substring(19),10):t.browser===`firefox`&&n!==-1&&(r=2147483637),r},o=e.RTCPeerConnection.prototype.setRemoteDescription;e.RTCPeerConnection.prototype.setRemoteDescription=function(){if(this._sctp=null,t.browser===`chrome`&&t.version>=76){let{sdpSemantics:e}=this.getConfiguration();e===`plan-b`&&Object.defineProperty(this,"sctp",{get(){return this._sctp===void 0?null:this._sctp},enumerable:!0,configurable:!0})}if(n(arguments[0])){let e=r(arguments[0]),t=i(e),n=a(arguments[0],e),o;o=t===0&&n===0?1/0:t===0||n===0?Math.max(t,n):Math.min(t,n);let s={};Object.defineProperty(s,"maxMessageSize",{get(){return o}}),this._sctp=s}return o.apply(this,arguments)}}function Rm(e,t){if(!(e.RTCPeerConnection&&`createDataChannel`in e.RTCPeerConnection.prototype)||t.browser===`chrome`&&t.version>=149||t.browser===`firefox`&&t.version>60)return;function n(e,t){let n=e.send;e.send=function(){let r=arguments[0],i=r.length||r.size||r.byteLength;if(e.readyState===`open`&&t.sctp&&i>t.sctp.maxMessageSize)throw TypeError(`Message too large (can send a maximum of `+t.sctp.maxMessageSize+` bytes)`);return n.apply(e,arguments)}}let r=e.RTCPeerConnection.prototype.createDataChannel;e.RTCPeerConnection.prototype.createDataChannel=function(){let e=r.apply(this,arguments);return n(e,this),e},Vp(e,`datachannel`,e=>(n(e.channel,e.target),e))}function zm(e){if(!e.RTCPeerConnection||`connectionState`in e.RTCPeerConnection.prototype)return;let t=e.RTCPeerConnection.prototype;Object.defineProperty(t,"connectionState",{get(){return{completed:`connected`,checking:`connecting`}[this.iceConnectionState]||this.iceConnectionState},enumerable:!0,configurable:!0}),Object.defineProperty(t,"onconnectionstatechange",{get(){return this._onconnectionstatechange||null},set(e){this._onconnectionstatechange&&(this.removeEventListener(`connectionstatechange`,this._onconnectionstatechange),delete this._onconnectionstatechange),e&&this.addEventListener(`connectionstatechange`,this._onconnectionstatechange=e)},enumerable:!0,configurable:!0}),[`setLocalDescription`,`setRemoteDescription`].forEach(e=>{let n=t[e];t[e]=function(){return this._connectionstatechangepoly||(this._connectionstatechangepoly=e=>{let t=e.target;if(t._lastConnectionState!==t.connectionState){t._lastConnectionState=t.connectionState;let n=new Event(`connectionstatechange`,e);t.dispatchEvent(n)}return e},this.addEventListener(`iceconnectionstatechange`,this._connectionstatechangepoly)),n.apply(this,arguments)}})}function Bm(e,t){if(!e.RTCPeerConnection||t.browser===`chrome`&&t.version>=71||t.browser===`safari`&&t._safariVersion>=13.1)return;let n=e.RTCPeerConnection.prototype.setRemoteDescription;e.RTCPeerConnection.prototype.setRemoteDescription=function(t){if(t&&t.sdp&&t.sdp.indexOf(`
a=extmap-allow-mixed`)!==-1){let n=t.sdp.split(`
`).filter(e=>e.trim()!==`a=extmap-allow-mixed`).join(`
`);e.RTCSessionDescription&&t instanceof e.RTCSessionDescription?arguments[0]=new e.RTCSessionDescription({type:t.type,sdp:n}):t.sdp=n}return n.apply(this,arguments)}}function Vm(e,t){if(!(e.RTCPeerConnection&&e.RTCPeerConnection.prototype))return;let n=e.RTCPeerConnection.prototype.addIceCandidate;!n||n.length===0||(e.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?(t.browser===`chrome`&&t.version<78||t.browser===`firefox`&&t.version<68||t.browser===`safari`)&&arguments[0]&&arguments[0].candidate===``?Promise.resolve():n.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())})}function Hm(e,t){if(!(e.RTCPeerConnection&&e.RTCPeerConnection.prototype))return;let n=e.RTCPeerConnection.prototype.setLocalDescription;!n||n.length===0||(e.RTCPeerConnection.prototype.setLocalDescription=function(){let e=arguments[0]||{};if(typeof e!=`object`||e.type&&e.sdp)return n.apply(this,arguments);if(e={type:e.type,sdp:e.sdp},!e.type)switch(this.signalingState){case`stable`:case`have-local-offer`:case`have-remote-pranswer`:e.type=`offer`;break;default:e.type=`answer`;break}return e.sdp||e.type!==`offer`&&e.type!==`answer`?n.apply(this,[e]):(e.type===`offer`?this.createOffer:this.createAnswer).apply(this).then(e=>n.apply(this,[e]))})}function Um({window:e}={},t={shimChrome:!0,shimFirefox:!0,shimSafari:!0}){let n=Wp,r=Kp(e),i={browserDetails:r,commonShim:Nm,extractVersion:Bp,disableLog:Hp,disableWarnings:Up,sdp:Pm};switch(r.browser){case`chrome`:if(!$p||!om||!t.shimChrome)return n(`Chrome shim is not included in this adapter release.`),i;if(r.version===null)return n(`Chrome shim can not determine version, not shimming.`),i;n(`adapter.js shimming chrome.`),i.browserShim=$p,Vm(e,r),Hm(e,r),Qp(e,r),em(e,r),om(e,r),tm(e,r),am(e,r),nm(e,r),rm(e,r),sm(e,r),Fm(e,r),Im(e,r),zm(e,r),Lm(e,r),Rm(e,r),Bm(e,r);break;case`firefox`:if(!um||!fm||!t.shimFirefox)return n(`Firefox shim is not included in this adapter release.`),i;n(`adapter.js shimming firefox.`),i.browserShim=um,Vm(e,r),Hm(e,r),cm(e,r),fm(e,r),pm(e,r),dm(e,r),gm(e,r),mm(e,r),hm(e,r),_m(e,r),vm(e,r),ym(e,r),bm(e,r),xm(e,r),Fm(e,r),zm(e,r),Lm(e,r),Rm(e,r);break;case`safari`:if(!Sm||!t.shimSafari)return n(`Safari shim is not included in this adapter release.`),i;n(`adapter.js shimming safari.`),i.browserShim=Sm,Vm(e,r),Hm(e,r),Om(e,r),Am(e,r),Tm(e,r),Cm(e,r),wm(e,r),km(e,r),Em(e,r),jm(e,r),Fm(e,r),Im(e,r),Lm(e,r),Rm(e,r),Bm(e,r);break;default:n(`Unsupported browser!`);break}return i}var Wm=Um({window:typeof window>`u`?void 0:window});function Gm(e,t,n,r){Object.defineProperty(e,t,{get:n,set:r,enumerable:!0,configurable:!0})}var Km=class{constructor(){this.chunkedMTU=16300,this._dataCount=1,this.chunk=e=>{let t=[],n=e.byteLength,r=Math.ceil(n/this.chunkedMTU),i=0,a=0;for(;a<n;){let o=Math.min(n,a+this.chunkedMTU),s=e.slice(a,o),c={__peerData:this._dataCount,n:i,data:s,total:r};t.push(c),a=o,i++}return this._dataCount++,t}}};function qm(e){let t=0;for(let n of e)t+=n.byteLength;let n=new Uint8Array(t),r=0;for(let t of e)n.set(t,r),r+=t.byteLength;return n}var Jm=Wm.default||Wm,Ym=new class{isWebRTCSupported(){return typeof RTCPeerConnection<`u`}isBrowserSupported(){let e=this.getBrowser(),t=this.getVersion();return this.supportedBrowsers.includes(e)?e===`chrome`?t>=this.minChromeVersion:e===`firefox`?t>=this.minFirefoxVersion:e===`safari`?!this.isIOS&&t>=this.minSafariVersion:!1:!1}getBrowser(){return Jm.browserDetails.browser}getVersion(){return Jm.browserDetails.version||0}isUnifiedPlanSupported(){let e=this.getBrowser(),t=Jm.browserDetails.version||0;if(e===`chrome`&&t<this.minChromeVersion)return!1;if(e===`firefox`&&t>=this.minFirefoxVersion)return!0;if(!window.RTCRtpTransceiver||!(`currentDirection`in RTCRtpTransceiver.prototype))return!1;let n,r=!1;try{n=new RTCPeerConnection,n.addTransceiver(`audio`),r=!0}catch{}finally{n&&n.close()}return r}toString(){return`Supports:
    browser:${this.getBrowser()}
    version:${this.getVersion()}
    isIOS:${this.isIOS}
    isWebRTCSupported:${this.isWebRTCSupported()}
    isBrowserSupported:${this.isBrowserSupported()}
    isUnifiedPlanSupported:${this.isUnifiedPlanSupported()}`}constructor(){this.isIOS=typeof navigator<`u`?[`iPad`,`iPhone`,`iPod`].includes(navigator.platform):!1,this.supportedBrowsers=[`firefox`,`chrome`,`safari`],this.minFirefoxVersion=59,this.minChromeVersion=72,this.minSafariVersion=605}},Xm=e=>!e||/^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(e),Zm=()=>Math.random().toString(36).slice(2),Qm={iceServers:[{urls:`stun:stun.l.google.com:19302`},{urls:[`turn:eu-0.turn.peerjs.com:3478`,`turn:us-0.turn.peerjs.com:3478`],username:`peerjs`,credential:`peerjsp`}],sdpSemantics:`unified-plan`},$m=new class extends Km{noop(){}blobToArrayBuffer(e,t){let n=new FileReader;return n.onload=function(e){e.target&&t(e.target.result)},n.readAsArrayBuffer(e),n}binaryStringToArrayBuffer(e){let t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n)&255;return t.buffer}isSecure(){return location.protocol===`https:`}constructor(...e){super(...e),this.CLOUD_HOST=`0.peerjs.com`,this.CLOUD_PORT=443,this.chunkedBrowsers={Chrome:1,chrome:1},this.defaultConfig=Qm,this.browser=Ym.getBrowser(),this.browserVersion=Ym.getVersion(),this.pack=Fp,this.unpack=Pp,this.supports=function(){let e={browser:Ym.isBrowserSupported(),webRTC:Ym.isWebRTCSupported(),audioVideo:!1,data:!1,binaryBlob:!1,reliable:!1};if(!e.webRTC)return e;let t;try{t=new RTCPeerConnection(Qm),e.audioVideo=!0;let n;try{n=t.createDataChannel(`_PEERJSTEST`,{ordered:!0}),e.data=!0,e.reliable=!!n.ordered;try{n.binaryType=`blob`,e.binaryBlob=!Ym.isIOS}catch{}}catch{}finally{n&&n.close()}}catch{}finally{t&&t.close()}return e}(),this.validateId=Xm,this.randomToken=Zm}},eh=`PeerJS: `,X=new class{get logLevel(){return this._logLevel}set logLevel(e){this._logLevel=e}log(...e){this._logLevel>=3&&this._print(3,...e)}warn(...e){this._logLevel>=2&&this._print(2,...e)}error(...e){this._logLevel>=1&&this._print(1,...e)}setLogFunction(e){this._print=e}_print(e,...t){let n=[eh,...t];for(let e in n)n[e]instanceof Error&&(n[e]=`(`+n[e].name+`) `+n[e].message);e>=3?console.log(...n):e>=2?console.warn(`WARNING`,...n):e>=1&&console.error(`ERROR`,...n)}constructor(){this._logLevel=0}},th={},nh=Object.prototype.hasOwnProperty,rh=`~`;function ih(){}Object.create&&(ih.prototype=Object.create(null),new ih().__proto__||(rh=!1));function ah(e,t,n){this.fn=e,this.context=t,this.once=n||!1}function oh(e,t,n,r,i){if(typeof n!=`function`)throw TypeError(`The listener must be a function`);var a=new ah(n,r||e,i),o=rh?rh+t:t;return e._events[o]?e._events[o].fn?e._events[o]=[e._events[o],a]:e._events[o].push(a):(e._events[o]=a,e._eventsCount++),e}function sh(e,t){--e._eventsCount===0?e._events=new ih:delete e._events[t]}function ch(){this._events=new ih,this._eventsCount=0}ch.prototype.eventNames=function(){var e=[],t,n;if(this._eventsCount===0)return e;for(n in t=this._events)nh.call(t,n)&&e.push(rh?n.slice(1):n);return Object.getOwnPropertySymbols?e.concat(Object.getOwnPropertySymbols(t)):e},ch.prototype.listeners=function(e){var t=rh?rh+e:e,n=this._events[t];if(!n)return[];if(n.fn)return[n.fn];for(var r=0,i=n.length,a=Array(i);r<i;r++)a[r]=n[r].fn;return a},ch.prototype.listenerCount=function(e){var t=rh?rh+e:e,n=this._events[t];return n?n.fn?1:n.length:0},ch.prototype.emit=function(e,t,n,r,i,a){var o=rh?rh+e:e;if(!this._events[o])return!1;var s=this._events[o],c=arguments.length,l,u;if(s.fn){switch(s.once&&this.removeListener(e,s.fn,void 0,!0),c){case 1:return s.fn.call(s.context),!0;case 2:return s.fn.call(s.context,t),!0;case 3:return s.fn.call(s.context,t,n),!0;case 4:return s.fn.call(s.context,t,n,r),!0;case 5:return s.fn.call(s.context,t,n,r,i),!0;case 6:return s.fn.call(s.context,t,n,r,i,a),!0}for(u=1,l=Array(c-1);u<c;u++)l[u-1]=arguments[u];s.fn.apply(s.context,l)}else{var d=s.length,f;for(u=0;u<d;u++)switch(s[u].once&&this.removeListener(e,s[u].fn,void 0,!0),c){case 1:s[u].fn.call(s[u].context);break;case 2:s[u].fn.call(s[u].context,t);break;case 3:s[u].fn.call(s[u].context,t,n);break;case 4:s[u].fn.call(s[u].context,t,n,r);break;default:if(!l)for(f=1,l=Array(c-1);f<c;f++)l[f-1]=arguments[f];s[u].fn.apply(s[u].context,l)}}return!0},ch.prototype.on=function(e,t,n){return oh(this,e,t,n,!1)},ch.prototype.once=function(e,t,n){return oh(this,e,t,n,!0)},ch.prototype.removeListener=function(e,t,n,r){var i=rh?rh+e:e;if(!this._events[i])return this;if(!t)return sh(this,i),this;var a=this._events[i];if(a.fn)a.fn===t&&(!r||a.once)&&(!n||a.context===n)&&sh(this,i);else{for(var o=0,s=[],c=a.length;o<c;o++)(a[o].fn!==t||r&&!a[o].once||n&&a[o].context!==n)&&s.push(a[o]);s.length?this._events[i]=s.length===1?s[0]:s:sh(this,i)}return this},ch.prototype.removeAllListeners=function(e){var t;return e?(t=rh?rh+e:e,this._events[t]&&sh(this,t)):(this._events=new ih,this._eventsCount=0),this},ch.prototype.off=ch.prototype.removeListener,ch.prototype.addListener=ch.prototype.on,ch.prefixed=rh,ch.EventEmitter=ch,th=ch;var lh={};Gm(lh,`ConnectionType`,()=>uh),Gm(lh,`PeerErrorType`,()=>dh),Gm(lh,`BaseConnectionErrorType`,()=>fh),Gm(lh,`DataConnectionErrorType`,()=>ph),Gm(lh,`SerializationType`,()=>mh),Gm(lh,`SocketEventType`,()=>hh),Gm(lh,`ServerMessageType`,()=>gh);var uh=function(e){return e.Data=`data`,e.Media=`media`,e}({}),dh=function(e){return e.BrowserIncompatible=`browser-incompatible`,e.Disconnected=`disconnected`,e.InvalidID=`invalid-id`,e.InvalidKey=`invalid-key`,e.Network=`network`,e.PeerUnavailable=`peer-unavailable`,e.SslUnavailable=`ssl-unavailable`,e.ServerError=`server-error`,e.SocketError=`socket-error`,e.SocketClosed=`socket-closed`,e.UnavailableID=`unavailable-id`,e.WebRTC=`webrtc`,e}({}),fh=function(e){return e.NegotiationFailed=`negotiation-failed`,e.ConnectionClosed=`connection-closed`,e}({}),ph=function(e){return e.NotOpenYet=`not-open-yet`,e.MessageToBig=`message-too-big`,e}({}),mh=function(e){return e.Binary=`binary`,e.BinaryUTF8=`binary-utf8`,e.JSON=`json`,e.None=`raw`,e}({}),hh=function(e){return e.Message=`message`,e.Disconnected=`disconnected`,e.Error=`error`,e.Close=`close`,e}({}),gh=function(e){return e.Heartbeat=`HEARTBEAT`,e.Candidate=`CANDIDATE`,e.Offer=`OFFER`,e.Answer=`ANSWER`,e.Open=`OPEN`,e.Error=`ERROR`,e.IdTaken=`ID-TAKEN`,e.InvalidKey=`INVALID-KEY`,e.Leave=`LEAVE`,e.Expire=`EXPIRE`,e}({}),_h=`1.5.5`,vh=class extends th.EventEmitter{constructor(e,t,n,r,i,a=5e3){super(),this.pingInterval=a,this._disconnected=!0,this._messagesQueue=[];let o=e?`wss://`:`ws://`;this._baseUrl=o+t+`:`+n+r+`peerjs?key=`+i}start(e,t){this._id=e;let n=`${this._baseUrl}&id=${e}&token=${t}`;this._socket||!this._disconnected||(this._socket=new WebSocket(n+`&version=1.5.5`),this._disconnected=!1,this._socket.onmessage=e=>{let t;try{t=JSON.parse(e.data),X.log(`Server message received:`,t)}catch{X.log(`Invalid server message`,e.data);return}this.emit(hh.Message,t)},this._socket.onclose=e=>{this._disconnected||(X.log(`Socket closed.`,e),this._cleanup(),this._disconnected=!0,this.emit(hh.Disconnected))},this._socket.onopen=()=>{this._disconnected||(this._sendQueuedMessages(),X.log(`Socket open`),this._scheduleHeartbeat())})}_scheduleHeartbeat(){this._wsPingTimer=setTimeout(()=>{this._sendHeartbeat()},this.pingInterval)}_sendHeartbeat(){if(!this._wsOpen()){X.log(`Cannot send heartbeat, because socket closed`);return}let e=JSON.stringify({type:gh.Heartbeat});this._socket.send(e),this._scheduleHeartbeat()}_wsOpen(){return!!this._socket&&this._socket.readyState===1}_sendQueuedMessages(){let e=[...this._messagesQueue];this._messagesQueue=[];for(let t of e)this.send(t)}send(e){if(this._disconnected)return;if(!this._id){this._messagesQueue.push(e);return}if(!e.type){this.emit(hh.Error,`Invalid message`);return}if(!this._wsOpen())return;let t=JSON.stringify(e);this._socket.send(t)}close(){this._disconnected||=(this._cleanup(),!0)}_cleanup(){this._socket&&=(this._socket.onopen=this._socket.onmessage=this._socket.onclose=null,this._socket.close(),void 0),clearTimeout(this._wsPingTimer)}},yh=class{constructor(e){this.connection=e}startConnection(e){let t=this._startPeerConnection();if(this.connection.peerConnection=t,this.connection.type===uh.Media&&e._stream&&this._addTracksToConnection(e._stream,t),e.originator){let n=this.connection,r={ordered:!!e.reliable},i=t.createDataChannel(n.label,r);n._initializeDataChannel(i),this._makeOffer()}else this.handleSDP(`OFFER`,e.sdp)}_startPeerConnection(){X.log(`Creating RTCPeerConnection.`);let e=new RTCPeerConnection(this.connection.provider.options.config);return this._setupListeners(e),e}_setupListeners(e){let t=this.connection.peer,n=this.connection.connectionId,r=this.connection.type,i=this.connection.provider;X.log(`Listening for ICE candidates.`),e.onicecandidate=e=>{!e.candidate||!e.candidate.candidate||(X.log(`Received ICE candidates for ${t}:`,e.candidate),i.socket.send({type:gh.Candidate,payload:{candidate:e.candidate,type:r,connectionId:n},dst:t}))},e.oniceconnectionstatechange=()=>{switch(e.iceConnectionState){case`failed`:X.log(`iceConnectionState is failed, closing connections to `+t),this.connection.emitError(fh.NegotiationFailed,`Negotiation of connection to `+t+` failed.`),this.connection.close();break;case`closed`:X.log(`iceConnectionState is closed, closing connections to `+t),this.connection.emitError(fh.ConnectionClosed,`Connection to `+t+` closed.`),this.connection.close();break;case`disconnected`:X.log(`iceConnectionState changed to disconnected on the connection with `+t);break;case`completed`:e.onicecandidate=()=>{};break}this.connection.emit(`iceStateChanged`,e.iceConnectionState)},X.log(`Listening for data channel`),e.ondatachannel=e=>{X.log(`Received data channel`);let r=e.channel;i.getConnection(t,n)._initializeDataChannel(r)},X.log(`Listening for remote stream`),e.ontrack=e=>{X.log(`Received remote stream`);let r=e.streams[0],a=i.getConnection(t,n);if(a.type===uh.Media){let e=a;this._addStreamToMediaConnection(r,e)}}}cleanup(){X.log(`Cleaning up PeerConnection to `+this.connection.peer);let e=this.connection.peerConnection;if(!e)return;this.connection.peerConnection=null,e.onicecandidate=e.oniceconnectionstatechange=e.ondatachannel=e.ontrack=()=>{};let t=e.signalingState!==`closed`,n=!1,r=this.connection.dataChannel;r&&(n=!!r.readyState&&r.readyState!==`closed`),(t||n)&&e.close()}async _makeOffer(){let e=this.connection.peerConnection,t=this.connection.provider;try{let n=await e.createOffer(this.connection.options.constraints);X.log(`Created offer.`),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform==`function`&&(n.sdp=this.connection.options.sdpTransform(n.sdp)||n.sdp);try{await e.setLocalDescription(n),X.log(`Set localDescription:`,n,`for:${this.connection.peer}`);let r={sdp:n,type:this.connection.type,connectionId:this.connection.connectionId,metadata:this.connection.metadata};if(this.connection.type===uh.Data){let e=this.connection;r={...r,label:e.label,reliable:e.reliable,serialization:e.serialization}}t.socket.send({type:gh.Offer,payload:r,dst:this.connection.peer})}catch(e){e!=`OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer`&&(t.emitError(dh.WebRTC,e),X.log(`Failed to setLocalDescription, `,e))}}catch(e){t.emitError(dh.WebRTC,e),X.log(`Failed to createOffer, `,e)}}async _makeAnswer(){let e=this.connection.peerConnection,t=this.connection.provider;try{let n=await e.createAnswer();X.log(`Created answer.`),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform==`function`&&(n.sdp=this.connection.options.sdpTransform(n.sdp)||n.sdp);try{await e.setLocalDescription(n),X.log(`Set localDescription:`,n,`for:${this.connection.peer}`),t.socket.send({type:gh.Answer,payload:{sdp:n,type:this.connection.type,connectionId:this.connection.connectionId},dst:this.connection.peer})}catch(e){t.emitError(dh.WebRTC,e),X.log(`Failed to setLocalDescription, `,e)}}catch(e){t.emitError(dh.WebRTC,e),X.log(`Failed to create answer, `,e)}}async handleSDP(e,t){t=new RTCSessionDescription(t);let n=this.connection.peerConnection,r=this.connection.provider;X.log(`Setting remote description`,t);let i=this;try{await n.setRemoteDescription(t),X.log(`Set remoteDescription:${e} for:${this.connection.peer}`),e===`OFFER`&&await i._makeAnswer()}catch(e){r.emitError(dh.WebRTC,e),X.log(`Failed to setRemoteDescription, `,e)}}async handleCandidate(e){X.log(`handleCandidate:`,e);try{await this.connection.peerConnection.addIceCandidate(e),X.log(`Added ICE candidate for:${this.connection.peer}`)}catch(e){this.connection.provider.emitError(dh.WebRTC,e),X.log(`Failed to handleCandidate, `,e)}}_addTracksToConnection(e,t){if(X.log(`add tracks from stream ${e.id} to peer connection`),!t.addTrack)return X.error(`Your browser does't support RTCPeerConnection#addTrack. Ignored.`);e.getTracks().forEach(n=>{t.addTrack(n,e)})}_addStreamToMediaConnection(e,t){X.log(`add stream ${e.id} to media connection ${t.connectionId}`),t.addStream(e)}},bh=class extends th.EventEmitter{emitError(e,t){X.error(`Error:`,t),this.emit(`error`,new xh(`${e}`,t))}},xh=class extends Error{constructor(e,t){typeof t==`string`?super(t):(super(),Object.assign(this,t)),this.type=e}},Sh=class extends bh{get open(){return this._open}constructor(e,t,n){super(),this.peer=e,this.provider=t,this.options=n,this._open=!1,this.metadata=n.metadata}},Ch=class e extends Sh{static#e=this.ID_PREFIX=`mc_`;get type(){return uh.Media}get localStream(){return this._localStream}get remoteStream(){return this._remoteStream}constructor(t,n,r){super(t,n,r),this._localStream=this.options._stream,this.connectionId=this.options.connectionId||e.ID_PREFIX+$m.randomToken(),this._negotiator=new yh(this),this._localStream&&this._negotiator.startConnection({_stream:this._localStream,originator:!0})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{X.log(`DC#${this.connectionId} dc connection success`),this.emit(`willCloseOnRemote`)},this.dataChannel.onclose=()=>{X.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}addStream(e){X.log(`Receiving stream`,e),this._remoteStream=e,super.emit(`stream`,e)}handleMessage(e){let t=e.type,n=e.payload;switch(e.type){case gh.Answer:this._negotiator.handleSDP(t,n.sdp),this._open=!0;break;case gh.Candidate:this._negotiator.handleCandidate(n.candidate);break;default:X.warn(`Unrecognized message type:${t} from peer:${this.peer}`);break}}answer(e,t={}){if(this._localStream){X.warn(`Local stream already exists on this MediaConnection. Are you answering a call twice?`);return}this._localStream=e,t&&t.sdpTransform&&(this.options.sdpTransform=t.sdpTransform),this._negotiator.startConnection({...this.options._payload,_stream:e});let n=this.provider._getMessages(this.connectionId);for(let e of n)this.handleMessage(e);this._open=!0}close(){this._negotiator&&=(this._negotiator.cleanup(),null),this._localStream=null,this._remoteStream=null,this.provider&&=(this.provider._removeConnection(this),null),this.options&&this.options._stream&&(this.options._stream=null),this.open&&(this._open=!1,super.emit(`close`))}},wh=class{constructor(e){this._options=e}_buildRequest(e){let t=this._options.secure?`https`:`http`,{host:n,port:r,path:i,key:a}=this._options,o=new URL(`${t}://${n}:${r}${i}${a}/${e}`);return o.searchParams.set(`ts`,`${Date.now()}${Math.random()}`),o.searchParams.set(`version`,_h),fetch(o.href,{referrerPolicy:this._options.referrerPolicy})}async retrieveId(){try{let e=await this._buildRequest(`id`);if(e.status!==200)throw Error(`Error. Status:${e.status}`);return e.text()}catch(e){X.error(`Error retrieving ID`,e);let t=``;throw this._options.path===`/`&&this._options.host!==$m.CLOUD_HOST&&(t=" If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."),Error(`Could not get an ID from the server.`+t)}}async listAllPeers(){try{let e=await this._buildRequest(`peers`);if(e.status!==200){if(e.status===401){let e=``;throw e=this._options.host===$m.CLOUD_HOST?`It looks like you're using the cloud server. You can email team@peerjs.com to enable peer listing for your API key.`:"You need to enable `allow_discovery` on your self-hosted PeerServer to use this feature.",Error(`It doesn't look like you have permission to list peers IDs. `+e)}throw Error(`Error. Status:${e.status}`)}return e.json()}catch(e){throw X.error(`Error retrieving list peers`,e),Error(`Could not get list peers from the server.`+e)}}},Th=class e extends Sh{static#e=this.ID_PREFIX=`dc_`;static#t=this.MAX_BUFFERED_AMOUNT=8388608;get type(){return uh.Data}constructor(t,n,r){super(t,n,r),this.connectionId=this.options.connectionId||e.ID_PREFIX+Zm(),this.label=this.options.label||this.connectionId,this.reliable=!!this.options.reliable,this._negotiator=new yh(this),this._negotiator.startConnection(this.options._payload||{originator:!0,reliable:this.reliable})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{X.log(`DC#${this.connectionId} dc connection success`),this._open=!0,this.emit(`open`)},this.dataChannel.onmessage=e=>{X.log(`DC#${this.connectionId} dc onmessage:`,e.data)},this.dataChannel.onclose=()=>{X.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}close(e){if(e?.flush){this.send({__peerData:{type:`close`}});return}this._negotiator&&=(this._negotiator.cleanup(),null),this.provider&&=(this.provider._removeConnection(this),null),this.dataChannel&&=(this.dataChannel.onopen=null,this.dataChannel.onmessage=null,this.dataChannel.onclose=null,null),this.open&&(this._open=!1,super.emit(`close`))}send(e,t=!1){if(!this.open){this.emitError(ph.NotOpenYet,"Connection is not open. You should listen for the `open` event before sending messages.");return}return this._send(e,t)}async handleMessage(e){let t=e.payload;switch(e.type){case gh.Answer:await this._negotiator.handleSDP(e.type,t.sdp);break;case gh.Candidate:await this._negotiator.handleCandidate(t.candidate);break;default:X.warn(`Unrecognized message type:`,e.type,`from peer:`,this.peer);break}}},Eh=class extends Th{get bufferSize(){return this._bufferSize}_initializeDataChannel(e){super._initializeDataChannel(e),this.dataChannel.binaryType=`arraybuffer`,this.dataChannel.addEventListener(`message`,e=>this._handleDataMessage(e))}_bufferedSend(e){(this._buffering||!this._trySend(e))&&(this._buffer.push(e),this._bufferSize=this._buffer.length)}_trySend(e){if(!this.open)return!1;if(this.dataChannel.bufferedAmount>Th.MAX_BUFFERED_AMOUNT)return this._buffering=!0,setTimeout(()=>{this._buffering=!1,this._tryBuffer()},50),!1;try{this.dataChannel.send(e)}catch(e){return X.error(`DC#:${this.connectionId} Error when sending:`,e),this._buffering=!0,this.close(),!1}return!0}_tryBuffer(){if(!this.open||this._buffer.length===0)return;let e=this._buffer[0];this._trySend(e)&&(this._buffer.shift(),this._bufferSize=this._buffer.length,this._tryBuffer())}close(e){if(e?.flush){this.send({__peerData:{type:`close`}});return}this._buffer=[],this._bufferSize=0,super.close()}constructor(...e){super(...e),this._buffer=[],this._bufferSize=0,this._buffering=!1}},Dh=class extends Eh{close(e){super.close(e),this._chunkedData={}}constructor(e,t,n){super(e,t,n),this.chunker=new Km,this.serialization=mh.Binary,this._chunkedData={}}_handleDataMessage({data:e}){let t=Pp(e),n=t.__peerData;if(n){if(n.type===`close`){this.close();return}this._handleChunk(t);return}this.emit(`data`,t)}_handleChunk(e){let t=e.__peerData,n=this._chunkedData[t]||{data:[],count:0,total:e.total};if(n.data[e.n]=new Uint8Array(e.data),n.count++,this._chunkedData[t]=n,n.total===n.count){delete this._chunkedData[t];let e=qm(n.data);this._handleDataMessage({data:e})}}_send(e,t){let n=Fp(e);if(n instanceof Promise)return this._send_blob(n);if(!t&&n.byteLength>this.chunker.chunkedMTU){this._sendChunks(n);return}this._bufferedSend(n)}async _send_blob(e){let t=await e;if(t.byteLength>this.chunker.chunkedMTU){this._sendChunks(t);return}this._bufferedSend(t)}_sendChunks(e){let t=this.chunker.chunk(e);X.log(`DC#${this.connectionId} Try to send ${t.length} chunks...`);for(let e of t)this.send(e,!0)}},Oh=class extends Eh{_handleDataMessage({data:e}){super.emit(`data`,e)}_send(e,t){this._bufferedSend(e)}constructor(...e){super(...e),this.serialization=mh.None}},kh=class extends Eh{_handleDataMessage({data:e}){let t=this.parse(this.decoder.decode(e)),n=t.__peerData;if(n&&n.type===`close`){this.close();return}this.emit(`data`,t)}_send(e,t){let n=this.encoder.encode(this.stringify(e));if(n.byteLength>=$m.chunkedMTU){this.emitError(ph.MessageToBig,`Message too big for JSON channel`);return}this._bufferedSend(n)}constructor(...e){super(...e),this.serialization=mh.JSON,this.encoder=new TextEncoder,this.decoder=new TextDecoder,this.stringify=JSON.stringify,this.parse=JSON.parse}},Ah=class e extends bh{static#e=this.DEFAULT_KEY=`peerjs`;get id(){return this._id}get options(){return this._options}get open(){return this._open}get socket(){return this._socket}get connections(){let e=Object.create(null);for(let[t,n]of this._connections)e[t]=n;return e}get destroyed(){return this._destroyed}get disconnected(){return this._disconnected}constructor(t,n){super(),this._serializers={raw:Oh,json:kh,binary:Dh,"binary-utf8":Dh,default:Dh},this._id=null,this._lastServerId=null,this._destroyed=!1,this._disconnected=!1,this._open=!1,this._connections=new Map,this._lostMessages=new Map;let r;if(t&&t.constructor==Object?n=t:t&&(r=t.toString()),n={debug:0,host:$m.CLOUD_HOST,port:$m.CLOUD_PORT,path:`/`,key:e.DEFAULT_KEY,token:$m.randomToken(),config:$m.defaultConfig,referrerPolicy:`strict-origin-when-cross-origin`,serializers:{},...n},this._options=n,this._serializers={...this._serializers,...this.options.serializers},this._options.host===`/`&&(this._options.host=window.location.hostname),this._options.path&&(this._options.path[0]!==`/`&&(this._options.path=`/`+this._options.path),this._options.path[this._options.path.length-1]!==`/`&&(this._options.path+=`/`)),this._options.secure===void 0&&this._options.host!==$m.CLOUD_HOST?this._options.secure=$m.isSecure():this._options.host==$m.CLOUD_HOST&&(this._options.secure=!0),this._options.logFunction&&X.setLogFunction(this._options.logFunction),X.logLevel=this._options.debug||0,this._api=new wh(n),this._socket=this._createServerConnection(),!$m.supports.audioVideo&&!$m.supports.data){this._delayedAbort(dh.BrowserIncompatible,`The current browser does not support WebRTC`);return}if(r&&!$m.validateId(r)){this._delayedAbort(dh.InvalidID,`ID "${r}" is invalid`);return}r?this._initialize(r):this._api.retrieveId().then(e=>this._initialize(e)).catch(e=>this._abort(dh.ServerError,e))}_createServerConnection(){let e=new vh(this._options.secure,this._options.host,this._options.port,this._options.path,this._options.key,this._options.pingInterval);return e.on(hh.Message,e=>{this._handleMessage(e)}),e.on(hh.Error,e=>{this._abort(dh.SocketError,e)}),e.on(hh.Disconnected,()=>{this.disconnected||(this.emitError(dh.Network,`Lost connection to server.`),this.disconnect())}),e.on(hh.Close,()=>{this.disconnected||this._abort(dh.SocketClosed,`Underlying socket is already closed.`)}),e}_initialize(e){this._id=e,this.socket.start(e,this._options.token)}_handleMessage(e){let t=e.type,n=e.payload,r=e.src;switch(t){case gh.Open:this._lastServerId=this.id,this._open=!0,this.emit(`open`,this.id);break;case gh.Error:this._abort(dh.ServerError,n.msg);break;case gh.IdTaken:this._abort(dh.UnavailableID,`ID "${this.id}" is taken`);break;case gh.InvalidKey:this._abort(dh.InvalidKey,`API KEY "${this._options.key}" is invalid`);break;case gh.Leave:X.log(`Received leave message from ${r}`),this._cleanupPeer(r),this._connections.delete(r);break;case gh.Expire:this.emitError(dh.PeerUnavailable,`Could not connect to peer ${r}`);break;case gh.Offer:{let e=n.connectionId,t=this.getConnection(r,e);if(t&&(t.close(),X.warn(`Offer received for existing Connection ID:${e}`)),n.type===uh.Media){let i=new Ch(r,this,{connectionId:e,_payload:n,metadata:n.metadata});t=i,this._addConnection(r,t),this.emit(`call`,i)}else if(n.type===uh.Data){let i=new this._serializers[n.serialization](r,this,{connectionId:e,_payload:n,metadata:n.metadata,label:n.label,serialization:n.serialization,reliable:n.reliable});t=i,this._addConnection(r,t),this.emit(`connection`,i)}else{X.warn(`Received malformed connection type:${n.type}`);return}let i=this._getMessages(e);for(let e of i)t.handleMessage(e);break}default:{if(!n){X.warn(`You received a malformed message from ${r} of type ${t}`);return}let i=n.connectionId,a=this.getConnection(r,i);a&&a.peerConnection?a.handleMessage(e):i?this._storeMessage(i,e):X.warn(`You received an unrecognized message:`,e);break}}}_storeMessage(e,t){this._lostMessages.has(e)||this._lostMessages.set(e,[]),this._lostMessages.get(e).push(t)}_getMessages(e){let t=this._lostMessages.get(e);return t?(this._lostMessages.delete(e),t):[]}connect(e,t={}){if(t={serialization:`default`,...t},this.disconnected){X.warn(`You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect, or call reconnect on this peer if you believe its ID to still be available.`),this.emitError(dh.Disconnected,`Cannot connect to new Peer after disconnecting from server.`);return}let n=new this._serializers[t.serialization](e,this,t);return this._addConnection(e,n),n}call(e,t,n={}){if(this.disconnected){X.warn(`You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect.`),this.emitError(dh.Disconnected,`Cannot connect to new Peer after disconnecting from server.`);return}if(!t){X.error("To call a peer, you must provide a stream from your browser's `getUserMedia`.");return}let r=new Ch(e,this,{...n,_stream:t});return this._addConnection(e,r),r}_addConnection(e,t){X.log(`add connection ${t.type}:${t.connectionId} to peerId:${e}`),this._connections.has(e)||this._connections.set(e,[]),this._connections.get(e).push(t)}_removeConnection(e){let t=this._connections.get(e.peer);if(t){let n=t.indexOf(e);n!==-1&&t.splice(n,1)}this._lostMessages.delete(e.connectionId)}getConnection(e,t){let n=this._connections.get(e);if(!n)return null;for(let e of n)if(e.connectionId===t)return e;return null}_delayedAbort(e,t){setTimeout(()=>{this._abort(e,t)},0)}_abort(e,t){X.error(`Aborting!`),this.emitError(e,t),this._lastServerId?this.disconnect():this.destroy()}destroy(){this.destroyed||(X.log(`Destroy peer with ID:${this.id}`),this.disconnect(),this._cleanup(),this._destroyed=!0,this.emit(`close`))}_cleanup(){for(let e of this._connections.keys())this._cleanupPeer(e),this._connections.delete(e);this.socket.removeAllListeners()}_cleanupPeer(e){let t=this._connections.get(e);if(t)for(let e of t)e.close()}disconnect(){if(this.disconnected)return;let e=this.id;X.log(`Disconnect peer with ID:${e}`),this._disconnected=!0,this._open=!1,this.socket.close(),this._lastServerId=e,this._id=null,this.emit(`disconnected`,e)}reconnect(){if(this.disconnected&&!this.destroyed)X.log(`Attempting reconnection to server with ID ${this._lastServerId}`),this._disconnected=!1,this._initialize(this._lastServerId);else if(this.destroyed)throw Error(`This peer cannot reconnect to the server. It has already been destroyed.`);else if(!this.disconnected&&!this.open)X.error(`In a hurry? We're still trying to make the initial connection!`);else throw Error(`Peer ${this.id} cannot reconnect because it is not disconnected from the server!`)}listAllPeers(e=e=>{}){this._api.listAllPeers().then(t=>e(t)).catch(e=>this._abort(dh.ServerError,e))}},jh=new Set([`carbine`,`smg`,`scattergun`]);function Mh(e){if(!e||typeof e!=`object`)return!1;let t=e;return typeof t.id==`string`&&t.id.length>0&&t.id.length<=80&&typeof t.name==`string`&&t.name.length>0&&t.name.length<=20&&(t.team===0||t.team===1)&&[`x`,`y`,`z`,`yaw`,`pitch`,`hp`,`kills`,`deaths`,`seq`].every(e=>Number.isFinite(t[e]))&&(t.stance===void 0||t.stance===`stand`||t.stance===`crouch`||t.stance===`prone`)&&jh.has(t.weapon)}function Nh(e){if(!e||typeof e!=`object`)return!1;let t=e;switch(t.type){case`join`:case`state`:return Mh(t.player);case`shot`:return typeof t.by==`string`&&jh.has(t.weapon)&&Array.isArray(t.origin)&&t.origin.length===3&&t.origin.every(Number.isFinite)&&Array.isArray(t.direction)&&t.direction.length===3&&t.direction.every(Number.isFinite)&&Number.isFinite(t.nonce);case`hit`:return typeof t.by==`string`&&typeof t.target==`string`&&Number.isFinite(t.damage)&&Number(t.damage)>0&&Number(t.damage)<=100&&Number.isFinite(t.nonce);case`death`:return typeof t.killer==`string`&&typeof t.victim==`string`&&Number.isFinite(t.nonce);case`leave`:return typeof t.playerId==`string`;case`chat`:return typeof t.by==`string`&&typeof t.text==`string`&&t.text.length<=160;default:return!1}}function Ph(e,t){if(!t)return!1;switch(e.type){case`join`:case`state`:return e.player.id===t;case`shot`:case`hit`:case`chat`:return e.by===t;case`death`:return e.victim===t;case`leave`:return e.playerId===t}}function Fh(e){return e.replace(/[^a-zA-Z0-9 _-]/g,``).trim().slice(0,16)||`Player${Math.floor(Math.random()*900+100)}`}var Ih=class{role=`offline`;roomCode=``;peer=null;hostConnection=null;guests=new Set;onMessage;onStatus;onReady=null;constructor(e,t){this.onMessage=e,this.onStatus=t}host(e){this.close(),this.role=`host`,this.onReady=e,this.onStatus(`Opening a secure peer lobby…`);let t=new Ah;this.peer=t,t.on(`open`,t=>{this.roomCode=t,this.onStatus(`Lobby ready — share the room code`,`ok`),e()}),t.on(`connection`,e=>this.wireGuest(e)),t.on(`error`,e=>this.onStatus(this.describeError(e),`error`)),t.on(`disconnected`,()=>this.onStatus(`Signalling disconnected; existing peers may continue`,`warn`))}join(e,t){if(this.close(),this.role=`client`,this.roomCode=e.trim(),this.onReady=t,!this.roomCode){this.onStatus(`Enter a room code first`,`error`);return}this.onStatus(`Connecting to peer lobby…`);let n=new Ah;this.peer=n,n.on(`open`,()=>{let e=n.connect(this.roomCode,{reliable:!0,serialization:`json`});this.hostConnection=e,this.wireHost(e)}),n.on(`error`,e=>this.onStatus(this.describeError(e),`error`)),n.on(`disconnected`,()=>this.onStatus(`Signalling disconnected; attempting to preserve session`,`warn`))}send(e){Nh(e)&&(this.role===`host`?this.broadcast(e):this.role===`client`&&this.hostConnection?.open&&this.hostConnection.send(e))}close(){if(this.hostConnection)try{this.hostConnection.close()}catch{}for(let e of this.guests)try{e.close()}catch{}if(this.guests.clear(),this.hostConnection=null,this.peer)try{this.peer.destroy()}catch{}this.peer=null,this.roomCode=``,this.role=`offline`,this.onReady=null}wireGuest(e){this.guests.add(e);let t=``;e.on(`open`,()=>this.onStatus(`${this.guests.size} guest connection${this.guests.size===1?``:`s`}`,`ok`)),e.on(`data`,n=>{if(Nh(n)){if(!t){if(n.type!==`join`)return;t=n.player.id}Ph(n,t)&&(this.onMessage(n),this.broadcast(n,e))}}),e.on(`close`,()=>{if(this.guests.delete(e),t){let e={type:`leave`,playerId:t};this.onMessage(e),this.broadcast(e)}this.onStatus(`A guest left the lobby`,`warn`)}),e.on(`error`,()=>this.onStatus(`Guest data channel failed`,`error`))}wireHost(e){e.on(`open`,()=>{this.onStatus(`Connected to host`,`ok`),this.onReady?.()}),e.on(`data`,e=>{Nh(e)&&this.onMessage(e)}),e.on(`close`,()=>this.onStatus(`Host connection closed`,`error`)),e.on(`error`,()=>this.onStatus(`Could not establish peer data channel`,`error`))}broadcast(e,t){for(let n of this.guests)n!==t&&n.open&&n.send(e)}describeError(e){let t=e instanceof Error?e.message:String(e);return/peer-unavailable/i.test(t)?`Room not found. Check the code and try again.`:/network|server/i.test(t)?`Peer signalling is unavailable. Check the connection and retry.`:`Network error: ${t.slice(0,120)}`}};function Lh(){return{lastAcceptedAt:-1e4,recentNonces:[]}}function Rh(e,t,n,r){let i=e=>({accepted:!1,reason:e,nextState:r});if(!t||t.id!==e.by)return i(`unknown-sender`);if(t.weapon!==e.weapon)return i(`weapon-mismatch`);if(r.recentNonces.includes(e.nonce))return i(`duplicate`);let a=Math.hypot(...e.direction);if(!Number.isFinite(a)||a<.96||a>1.04)return i(`invalid-direction`);let o=Math.hypot(e.origin[0]-t.x,e.origin[1]-t.y,e.origin[2]-t.z);if(!Number.isFinite(o)||o>2.25)return i(`origin-mismatch`);let s=6e4/Uf[e.weapon].rpm;return n-r.lastAcceptedAt<s*.45?i(`cadence`):{accepted:!0,reason:`accepted`,nextState:{lastAcceptedAt:n,recentNonces:[...r.recentNonces.slice(-15),e.nonce]}}}var zh=`modulepreload`,Bh=function(e,t){return new URL(e,t).href},Vh={},Hh=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,new URL(`../../../src/node/plugins/importAnalysisBuild.ts`,import.meta.url)).href}r=o(t.map(t=>{if(t=Bh(t,n),t=s(t),t in Vh)return;Vh[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:zh,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},Uh=.38,Wh=.53,Gh={stand:{halfHeight:Wh,radius:Uh,eyeFromCenter:.79},crouch:{halfHeight:.22,radius:.36,eyeFromCenter:.58},prone:{halfHeight:.04,radius:.31,eyeFromCenter:.15}},Kh=class e{makeCapsule;world;body;collider;controller;stance=`stand`;constructor(e,t,n,r){this.makeCapsule=r,this.world=e,this.body=t,this.collider=n,this.controller=e.createCharacterController(.025),this.controller.setSlideEnabled(!0),this.controller.enableAutostep(.42,.22,!1),this.controller.enableSnapToGround(.24),this.controller.setMaxSlopeClimbAngle(50*Math.PI/180),this.controller.setMinSlopeSlideAngle(55*Math.PI/180)}static async create(t,n){let{default:r}=await Hh(async()=>{let{default:e}=await import(`./rapier-B45baom8.js`);return{default:e}},[],import.meta.url),i=console.warn;console.warn=(...e)=>{e.length===1&&e[0]===`using deprecated parameters for the initialization function; pass a single object instead`||i(...e)};try{await r.init()}finally{console.warn=i}let a=new r.World({x:0,y:-22,z:0});a.timestep=1/120,a.createCollider(r.ColliderDesc.cuboid((n.maxX-n.minX)/2,.1,(n.maxZ-n.minZ)/2).setTranslation((n.minX+n.maxX)/2,-.1,(n.minZ+n.maxZ)/2));for(let e of t){let t=e.minY??0,n=e.maxY??8,i=Math.max(.01,(e.maxX-e.minX)/2),o=Math.max(.01,(n-t)/2),s=Math.max(.01,(e.maxZ-e.minZ)/2);a.createCollider(r.ColliderDesc.cuboid(i,o,s).setTranslation((e.minX+e.maxX)/2,(t+n)/2,(e.minZ+e.maxZ)/2))}let o=a.createRigidBody(r.RigidBodyDesc.kinematicPositionBased()),s=a.createCollider(r.ColliderDesc.capsule(Wh,Uh).setFriction(0).setActiveCollisionTypes(r.ActiveCollisionTypes.ALL),o),c=new e(a,o,s,(e,t)=>new r.Capsule(e,t));return c.teleportEye({x:0,y:1.7,z:0}),c}teleportEye(e){let t=Gh[this.stance].eyeFromCenter;this.body.setTranslation({x:e.x,y:e.y-t,z:e.z},!0),this.world.propagateModifiedBodyPositionsToColliders()}eyePosition(){let e=this.body.translation();return{x:e.x,y:e.y+Gh[this.stance].eyeFromCenter,z:e.z}}setStance(e){if(e===this.stance)return!0;let t=Gh[this.stance],n=Gh[e],r=this.body.translation(),i=t.halfHeight+t.radius,a=n.halfHeight+n.radius,o=r.y-i,s={x:r.x,y:o+a,z:r.z},c=this.makeCapsule(n.halfHeight,n.radius);if(a>i){let e=!1;if(this.world.intersectionsWithShape(s,{x:0,y:0,z:0,w:1},c,()=>(e=!0,!1),void 0,void 0,this.collider),e)return!1}return this.collider.setShape(c),this.body.setTranslation(s,!0),this.world.propagateModifiedBodyPositionsToColliders(),this.stance=e,e===`prone`?this.controller.disableAutostep():this.controller.enableAutostep(.42,.22,!1),!0}currentStance(){return this.stance}move(e,t){this.world.timestep=t,this.controller.computeColliderMovement(this.collider,e);let n=this.controller.computedMovement(),r=this.body.translation();this.body.setNextKinematicTranslation({x:r.x+n.x,y:r.y+n.y,z:r.z+n.z}),this.world.step();let i=this.eyePosition(),a=5e-4;return{position:i,grounded:this.controller.computedGrounded(),blockedX:Math.abs(n.x-e.x)>a,blockedY:Math.abs(n.y-e.y)>a,blockedZ:Math.abs(n.z-e.z)>a,appliedDelta:{x:n.x,y:n.y,z:n.z}}}dispose(){this.world.free()}},qh=class{lines;positions=new Float32Array(108);colors=new Float32Array(108);life=new Float32Array(18);cursor=0;constructor(e){let t=new Vr;t.setAttribute(`position`,new Er(this.positions,3)),t.setAttribute(`color`,new Er(this.colors,3));let n=new Yi({vertexColors:!0,transparent:!0,opacity:.72,depthWrite:!1,blending:2});this.lines=new sa(t,n),this.lines.name=`pooled-combat-tracers`,this.lines.frustumCulled=!1,this.lines.visible=!1,e.add(this.lines)}emit(e,t,n,r=.055){if(![e.x,e.y,e.z,t.x,t.y,t.z,r].every(Number.isFinite))return;let i=this.cursor++%18,a=i*6;this.positions.set([e.x,e.y,e.z,t.x,t.y,t.z],a);let o=new H(n);this.colors.set([o.r,o.g,o.b,o.r,o.g,o.b],a),this.life[i]=Bt.clamp(r,.016,.12),this.lines.visible=!0,this.markDirty()}update(e){let t=!1;for(let n=0;n<18;n+=1)this.life[n]<=0||(this.life[n]-=Math.max(0,e),this.life[n]<=0&&(this.positions.fill(0,n*6,n*6+6),t=!0));t&&this.markDirty(),this.lines.visible=this.activeCount()>0}activeCount(){return this.life.reduce((e,t)=>e+Number(t>0),0)}markDirty(){this.lines.geometry.getAttribute(`position`).needsUpdate=!0,this.lines.geometry.getAttribute(`color`).needsUpdate=!0}};function Jh(e,t,n,r,i){let a=t.clone().sub(e),o=a.length(),s=o>1e-6?a.multiplyScalar(1/o):new z(0,0,-1),c=Math.abs(n-r)+1e-4,l=n+r-1e-4,u=Bt.clamp(o,c,l),d=(n*n-r*r+u*u)/(2*u),f=Math.sqrt(Math.max(0,n*n-d*d)),p=i.clone().sub(s.clone().multiplyScalar(i.dot(s)));return p.lengthSq()<1e-6&&p.crossVectors(s,Math.abs(s.y)<.9?new z(0,1,0):new z(1,0,0)),p.normalize(),e.clone().addScaledVector(s,d).addScaledVector(p,f)}var Yh=[{at:.12,event:`mag-release`},{at:.28,event:`mag-out`},{at:.66,event:`mag-in`},{at:.8,event:`mag-seat`},{at:.9,event:`bolt-release`}],Xh=[{at:.2,event:`shell-insert`},{at:.39,event:`shell-insert`},{at:.58,event:`shell-insert`},{at:.77,event:`shell-insert`},{at:.91,event:`bolt-release`}],Zh=e=>Math.min(1,Math.max(0,e)),Qh=(e,t,n)=>{let r=Zh((n-e)/Math.max(1e-4,t-e));return r*r*(3-2*r)};function $h(e,t,n){let r=Zh(t),i=Zh(n);return i<=r?[]:(e===`scattergun`?Xh:Yh).filter(({at:e})=>e>r&&e<=i).map(({event:e})=>e)}function eg(e,t){let n=Zh(t);if(e===`scattergun`){let e=n*5%1,t=n>=.1&&n<=.82;return{magazineDrop:0,magazineTwist:0,magazineForward:0,magazineLateral:0,handToReload:Qh(.05,.16,n)*(1-Qh(.82,.94,n)),shellVisible:t&&e>.12&&e<.78,shellTravel:t?Qh(.15,.72,e):0,actionPull:Qh(.86,.91,n)*(1-Qh(.91,.98,n))}}let r=Qh(.1,.34,n),i=Qh(.56,.81,n),a=r*(1-i);return{magazineDrop:a*.52+i*(1-Qh(.78,.84,n))*.04,magazineTwist:a*.24,magazineForward:a*(e===`carbine`?.17:.1),magazineLateral:a*(e===`carbine`?-.075:-.045),handToReload:Qh(.06,.2,n)*(1-Qh(.82,.94,n)),shellVisible:!1,shellTravel:0,actionPull:Qh(.84,.9,n)*(1-Qh(.9,.98,n))}}var tg=class{flattenMaterials;root=new Rn;models=new Map;active=`carbine`;recoil=0;reloadStart=0;reloadDuration=0;reloadLastProgress=0;switchBlend=1;swayX=0;swayY=0;meleeStart=0;grenadeStart=0;muzzleLight;muzzleFlash;casings=[];smokes=[];smokePositions=new Float32Array(24);smokeColors=new Float32Array(24);smokePoints;armRigs=[];brassGeometry=new Ca(.018,.018,.085,7);shellGeometry=new Ca(.025,.025,.105,8);brassMaterial=new W({color:13149788,roughness:.3,metalness:.78});shellMaterial=new W({color:11812658,roughness:.58,metalness:.18});shotStarted=-1e4;casingCursor=0;smokeCursor=0;pendingScattergunShell=!1;pendingCasing=!1;adsBlend=0;sprintBlend=0;weaponHeat=0;shotsPresented=0;constructor(e,t=!1){this.flattenMaterials=t,this.root.name=`original-weapon-view`,this.root.position.set(.36,-.38,-.78),this.root.scale.setScalar(.6),e.add(this.root);let n=new W({color:3232847,roughness:.84}),r=new W({color:12162623,roughness:.62,metalness:.12}),i=new W({color:2436398,roughness:.88}),a=new Rn;a.name=`first-person-arms`;let o=e=>{let a=e===`left`?-1:1,o=.56,s=.58,c=new Rn;c.name=`${e}-shoulder-joint`,c.position.set(a*.25,e===`right`?-.17:-.12,e===`right`?.52:.45);let l=new U(new xa(.095,o-.19,5,9),n);l.name=`${e}-upper-arm`,l.rotation.x=-Math.PI/2,l.position.z=-.56/2,l.castShadow=!0,c.add(l);let u=new Rn;u.name=`${e}-elbow-joint`,u.position.z=-.56,c.add(u);let d=new U(new xa(.09,s-.18,5,9),n);d.name=`${e}-forearm`,d.rotation.x=-Math.PI/2,d.position.z=-.58/2,d.castShadow=!0,u.add(d);let f=q(`${e}-glove-cuff`,[.205,.195,.14],r,.045,2);f.position.z=-.505,u.add(f);let p=q(`${e}-glove`,[.18,.155,.235],i,.055,3);p.position.set(a*-.015,-.01,-.635),p.rotation.x=-.12,u.add(p);let m=q(`${e}-thumb`,[.075,.1,.17],i,.028,2);m.position.set(a*-.105,-.04,-.615),m.rotation.z=a*.32,u.add(m);let h=t?1:3;for(let t=0;t<h;t+=1){let n=q(`${e}-finger-${t}`,[.036,.025,.14],i,.01,1);n.position.set(a*(.052-t*.052),-.09,-.6799999999999999),n.rotation.x=-.18,u.add(n)}let g=q(`${e}-sleeve-band`,[.202,.202,.055],r,.016,2);return g.position.z=-.56*.72,c.add(g),this.armRigs.push({side:e,shoulder:c,elbow:u,upperLength:o,lowerLength:s}),c};a.add(o(`right`),o(`left`)),a.scale.setScalar(.74),a.position.set(0,-.08,.02),this.root.add(a),this.muzzleLight=new Hs(16761706,0,4.5,2),this.muzzleLight.position.set(0,.08,-1.15),t||this.root.add(this.muzzleLight),this.muzzleFlash=new Rn,this.muzzleFlash.position.set(0,.08,-1.15);let s=new _i({color:16765834,transparent:!0,opacity:.92,depthWrite:!1,blending:2,side:2}),c=new U(new wa(.06,.46,7),s);c.name=`muzzle-flash-core`,c.rotation.x=-Math.PI/2,c.position.z=-.22;let l=new U(new wa(.14,.24,6),s.clone());l.name=`muzzle-flash-crown`,l.rotation.x=-Math.PI/2,l.position.z=-.1;let u=new U(new Ho(.38,.38),s.clone());u.name=`muzzle-flash-flare`,u.rotation.z=Math.PI/4,this.muzzleFlash.add(c,l,u),this.muzzleFlash.visible=!1,this.root.add(this.muzzleFlash);let d=new Vr;this.smokePositions.fill(0);for(let e=0;e<8;e+=1)this.smokePositions[e*3+1]=-1e4;d.setAttribute(`position`,new Er(this.smokePositions,3)),d.setAttribute(`color`,new Er(this.smokeColors,3)),this.smokePoints=new pa(d,new ca({size:t?.045:.075,vertexColors:!0,transparent:!0,opacity:.58,depthWrite:!1,sizeAttenuation:!0})),this.smokePoints.name=`pooled-muzzle-smoke`,this.smokePoints.visible=!1,this.smokePoints.frustumCulled=!1,this.root.add(this.smokePoints);for(let e=0;e<8;e+=1)this.smokes.push({velocity:new z,life:0,maxLife:0,active:!1});for(let e=0;e<16;e+=1){let t=new U(this.brassGeometry,this.brassMaterial);t.name=`pooled-casing-${e}`,t.visible=!1,t.rotation.z=Math.PI/2,this.root.add(t),this.casings.push({mesh:t,velocity:new z,life:0,active:!1})}}async load(e){let t=[`carbine`,`smg`,`scattergun`];t.forEach((n,r)=>{let i=Jd(n,this.flattenMaterials);if(n===`carbine`){i.traverse(e=>{(e.name===`stock-shoulder-pad`||e.name===`stock-cheek-rest`||e.name===`stock-support-rod`)&&(e.visible=!1)});let e=i.getObjectByName(`optic-reticle`);e instanceof U&&e.material instanceof _i&&(e.material=e.material.clone(),e.material.depthTest=!1,e.material.depthWrite=!1,e.renderOrder=1e3)}i.visible=!1,this.models.set(n,i),this.root.add(i),e?.(r+1,t.length)}),this.setWeapon(this.active,!0)}isReady(){return this.models.size===3}setWeapon(e,t=!1){this.active=e,this.switchBlend=+!!t,this.reloadDuration=0,this.reloadLastProgress=0,this.pendingScattergunShell=!1,this.pendingCasing=!1;for(let[t,n]of this.models)n.visible=t===e;let n=this.models.get(e)?.getObjectByName(`muzzle-socket`);n&&(this.muzzleLight.position.copy(n.position),this.muzzleFlash.position.copy(n.position))}ejectCasing(e){let t=this.casings[this.casingCursor++%this.casings.length];t.mesh.geometry=e?this.shellGeometry:this.brassGeometry,t.mesh.material=e?this.shellMaterial:this.brassMaterial;let n=this.models.get(this.active)?.getObjectByName(`eject-socket`);t.mesh.position.copy(n?.position??new z(.12,.04,-.48)),t.mesh.rotation.set(Math.random()*.4,0,Math.PI/2),t.mesh.visible=!0,t.velocity.set(e?.72:.95+Math.random()*.25,e?.55:.75+Math.random()*.2,e?.16:.1),t.life=e?.62:.42,t.active=!0}fire(e){this.weaponHeat=Rd(this.weaponHeat,!0,0,this.active),this.shotsPresented+=1,this.recoil=Math.min(1,this.recoil+.24+e*5.2),this.shotStarted=performance.now(),this.muzzleLight.intensity=this.flattenMaterials?0:this.active===`scattergun`?7.2:4.8,this.muzzleFlash.visible=!0,this.muzzleFlash.scale.setScalar(this.active===`scattergun`?1.45:this.active===`smg`?.78:1),this.muzzleFlash.rotation.z=Math.random()*Math.PI;let t=this.models.get(this.active)?.getObjectByName(`muzzle-socket`),n=this.active===`scattergun`?3:this.weaponHeat>.56?2:1,r=zd(this.active,0,this.weaponHeat);for(let e=0;e<n;e+=1){let n=this.smokeCursor++%this.smokes.length,i=this.smokes[n],a=n*3,o=t?.position??new z(0,.08,-1.15);this.smokePositions[a]=o.x+(Math.random()-.5)*.025,this.smokePositions[a+1]=o.y+(Math.random()-.5)*.02,this.smokePositions[a+2]=o.z-.05-e*.035,i.velocity.set((Math.random()-.5)*.055*r.smokeScale,(.1+Math.random()*.06)*r.smokeScale,(-.11-Math.random()*.08)*r.smokeScale),i.maxLife=this.active===`scattergun`?.38:.2+this.weaponHeat*.12,i.life=i.maxLife,i.active=!0,this.smokeColors[a]=this.smokeColors[a+1]=this.smokeColors[a+2]=.62}this.smokePoints.visible=!0,this.smokePoints.geometry.getAttribute(`position`).needsUpdate=!0,this.smokePoints.geometry.getAttribute(`color`).needsUpdate=!0,this.active===`scattergun`?this.pendingScattergunShell=!0:this.pendingCasing=!0}reload(e){this.reloadStart=performance.now(),this.reloadDuration=e*1e3,this.reloadLastProgress=0}cancelReload(){this.reloadDuration=0,this.reloadLastProgress=0}melee(){this.meleeStart=performance.now()}throwGrenade(){this.grenadeStart=performance.now()}addMouseDelta(e,t){this.swayX=Bt.clamp(this.swayX+e*8e-5,-.025,.025),this.swayY=Bt.clamp(this.swayY+t*6e-5,-.02,.02)}muzzleWorldPosition(e=new z){let t=this.models.get(this.active)?.getObjectByName(`muzzle-socket`);return t?t.getWorldPosition(e):null}adsProgress(){return this.adsBlend}presentationState(){let e=this.models.get(this.active),t=this.active===`carbine`?[`optic-lens`,`stock-cheek-rest`,`charging-handle`,`magazine-rib`]:[`muzzle-socket`,`grip-socket-r`,`support-socket-l`];return{weapon:this.active,heat:this.weaponHeat,shotsPresented:this.shotsPresented,activeCasings:this.casings.filter(e=>e.active).length,activeSmoke:this.smokes.reduce((e,t)=>e+Number(t.active),0),detailsReady:t.every(t=>e?.getObjectByName(t)!==void 0),adsProgress:this.adsBlend}}solveArms(e,t,n){if(t){this.root.updateMatrixWorld(!0);for(let r of this.armRigs){let i=r.side===`right`?`grip-socket-r`:`support-socket-l`,a=t.getObjectByName(i);if(!a)continue;let o=a.getWorldPosition(new z);if(r.side===`left`&&n.handToReload>0){let e=t.getObjectByName(`reload-socket-l`);e&&o.lerp(e.getWorldPosition(new z),n.handToReload)}let s=e.worldToLocal(o.clone()),c=new z(r.side===`left`?-.48:.48,-1,.22),l=Jh(r.shoulder.position,s,r.upperLength,r.lowerLength,c).sub(r.shoulder.position).normalize();r.shoulder.quaternion.setFromUnitVectors(new z(0,0,-1),l),r.elbow.position.set(0,0,-r.upperLength),r.shoulder.updateWorldMatrix(!0,!0);let u=r.shoulder.worldToLocal(o.clone()).sub(r.elbow.position).normalize();r.elbow.quaternion.setFromUnitVectors(new z(0,0,-1),u)}}}update(e){let t=[],n=t=>1-Math.exp(-t*e.dt);this.weaponHeat=Rd(this.weaponHeat,!1,e.dt,this.active),this.recoil=Bt.lerp(this.recoil,0,n(16)),this.muzzleLight.intensity=Bt.lerp(this.muzzleLight.intensity,0,n(30)),this.switchBlend=Bt.lerp(this.switchBlend,1,n(10)),this.swayX=Bt.lerp(this.swayX,0,n(7)),this.swayY=Bt.lerp(this.swayY,0,n(7)),this.adsBlend=Bt.lerp(this.adsBlend,+!!e.ads,n(e.ads?18:15)),this.sprintBlend=Bt.lerp(this.sprintBlend,+!!e.sprinting,n(13)),this.muzzleFlash.visible=this.muzzleLight.intensity>.45;let r=this.root.getObjectByName(`first-person-arms`);r&&(r.position.y=Bt.lerp(-.08,-.3,this.adsBlend));for(let t of this.casings)t.active&&(t.life-=e.dt,t.velocity.y-=4.5*e.dt,t.mesh.position.addScaledVector(t.velocity,e.dt),t.mesh.rotation.x+=e.dt*18,t.mesh.rotation.z+=e.dt*11,t.life<=0&&(t.active=!1,t.mesh.visible=!1));let i=0;for(let t=0;t<this.smokes.length;t+=1){let n=this.smokes[t];if(!n.active)continue;let r=t*3;if(n.life-=e.dt,n.life<=0){n.active=!1,this.smokePositions[r+1]=-1e4,this.smokeColors[r]=this.smokeColors[r+1]=this.smokeColors[r+2]=0;continue}i+=1,this.smokePositions[r]+=n.velocity.x*e.dt,this.smokePositions[r+1]+=n.velocity.y*e.dt,this.smokePositions[r+2]+=n.velocity.z*e.dt;let a=Math.min(1,n.life/Math.max(.001,n.maxLife)*1.7)*.62;this.smokeColors[r]=this.smokeColors[r+1]=this.smokeColors[r+2]=a}this.smokePoints.visible=i>0,i>0&&(this.smokePoints.geometry.getAttribute(`position`).needsUpdate=!0,this.smokePoints.geometry.getAttribute(`color`).needsUpdate=!0);let a=this.models.get(this.active),o=performance.now()-this.shotStarted,s=zd(this.active,o,this.weaponHeat);if(this.muzzleFlash.visible=s.flash>.015,this.muzzleFlash.visible){let e=this.active===`scattergun`?1.45:this.active===`smg`?.78:1;this.muzzleFlash.scale.setScalar(e*(.72+s.flash*.38))}this.active===`scattergun`&&this.pendingScattergunShell&&s.casingReady?(this.ejectCasing(!0),this.pendingScattergunShell=!1):this.active!==`scattergun`&&this.pendingCasing&&s.casingReady&&(this.ejectCasing(!1),this.pendingCasing=!1);let c=a?.getObjectByName(`bolt-or-slide`);if(c){let e=Number(c.userData.restZ??0);c.position.z=e+s.boltTravel*(this.active===`smg`?.09:.075)}let l=a?.getObjectByName(`pump`);if(l){let e=Number(l.userData.restZ??-.48);l.position.z=e+s.boltTravel*.22}let u=e.moving?e.sprinting?1.22:e.ads||e.prone?.12:e.crouched?.32:.56:.05,d=Math.cos(e.phase*.5)*.017*u,f=Math.sin(e.phase)*.019*u,p=Math.sin(performance.now()*.0017)*(e.ads?.0015:.0045),m=this.adsBlend*-.36,h=this.adsBlend*.251,g=this.adsBlend*-.04,_=this.sprintBlend*-.16,v=1-this.adsBlend,y=e.crouched?.035*v:0,b=e.prone?.018*v:0,x=(1-this.switchBlend)*-.34,S=0,C=0,w=0;if(this.reloadDuration>0){w=Bt.clamp((performance.now()-this.reloadStart)/this.reloadDuration,0,1),t.push(...$h(this.active,this.reloadLastProgress,w)),this.reloadLastProgress=w;let e=Math.sin(Math.PI*w),n=w>.65?Math.sin((w-.65)/.35*Math.PI):0;S=e*.78-n*.12,C=e*-.22+n*.035,w>=1&&(this.reloadDuration=0,this.reloadLastProgress=0)}let T=eg(this.active,w),E=a?.getObjectByName(this.active===`carbine`?`curved-magazine`:`straight-magazine`);E&&(E.userData.restY===void 0&&(E.userData.restX=E.position.x,E.userData.restY=E.position.y,E.userData.restZ=E.position.z,E.userData.restRotationZ=E.rotation.z),E.position.x=Number(E.userData.restX)+T.magazineLateral,E.position.y=Number(E.userData.restY)-T.magazineDrop,E.position.z=Number(E.userData.restZ)+T.magazineForward,E.rotation.z=Number(E.userData.restRotationZ)+T.magazineTwist);let D=a?.getObjectByName(`reload-shell`);if(D&&(D.visible=T.shellVisible,D.position.set(-.16+T.shellTravel*.13,-.13+T.shellTravel*.035,-.02)),l&&T.actionPull>0){let e=Number(l.userData.restZ??-.48);l.position.z=e+T.actionPull*.16}if(c&&T.actionPull>0){let e=Number(c.userData.restZ??0);c.position.z=e+T.actionPull*(this.active===`smg`?.1:.12)}let ee=Bt.clamp((performance.now()-this.meleeStart)/430,0,1),te=this.meleeStart>0&&ee<1?Math.sin(ee*Math.PI):0,O=Bt.clamp((performance.now()-this.grenadeStart)/620,0,1),ne=this.grenadeStart>0&&O<1?Math.sin(O*Math.PI):0,re=new z(.36+m+d+this.swayX-e.lateralSpeed*.012-te*.24+ne*.18,-.38+h+f+p+_+y+b+x+C-this.recoil*.08-e.landingImpulse*.075,-.78+g+this.recoil*.13-te*.32+ne*.24);return this.root.position.lerp(re,n(18)),this.root.rotation.x=Bt.lerp(this.root.rotation.x,this.recoil*.18-this.swayY-ne*.42,n(22)),this.root.rotation.y=Bt.lerp(this.root.rotation.y,-this.swayX*2-this.sprintBlend*.38-te*.65,n(13)),this.root.rotation.z=Bt.lerp(this.root.rotation.z,S-this.sprintBlend*.22-e.lateralSpeed*(e.prone?.01:.025)+te*.42,n(13)),r&&this.solveArms(r,a,T),t}};window.addEventListener(`error`,e=>{console.error(`[Atomic Acres runtime error]`,e.message||`unknown error`,e.error?.stack||``)}),window.addEventListener(`unhandledrejection`,e=>{let t=e.reason instanceof Error?`${e.reason.message}\n${e.reason.stack??``}`:String(e.reason);console.error(`[Atomic Acres unhandled rejection]`,t)});var ng=[`carbine`,`smg`,`scattergun`],rg=df.map(([e,t])=>new z(e,0,t));function ig(){return typeof globalThis.crypto?.randomUUID==`function`?globalThis.crypto.randomUUID():`player-${Date.now().toString(36)}-${Math.random().toString(36).slice(2,10)}`}var ag=document.querySelector(`#app`);if(!ag)throw Error(`Missing #app root`);ag.innerHTML=`
  ...
  <section id="menu" class="panel">
    ...
    <div class="menu-panel" data-menu-panel="kit" hidden>
      ...
      <div class="kit-grid">
        ${Cf.map(e=>`<button type="button" class="kit-card" data-kit-id="${e.id}">
          <span>${e.role}</span><strong>${e.title}</strong><b>${Uf[e.weapon].name}</b><p>${e.summary}</p>
...
`;function Z(e){let t=document.querySelector(e);if(!t)throw Error(`Missing element ${e}`);return t}var og=Z(`#game`),sg=Z(`#menu`),cg=Z(`#hud`),lg=Z(`#room-card`),ug=Z(`#room-code`),dg=Z(`#network-status`),fg=Z(`#minimap`),pg=fg.getContext(`2d`);if(!pg)throw Error(`Canvas2D minimap is unavailable`);var mg=pg,hg=new kf,gg=new URLSearchParams(window.location.search).get(`render`)===`compat`;document.documentElement.classList.toggle(`compat-render`,gg);var _g=new Ad({canvas:og,antialias:!gg,powerPreference:`high-performance`});_g.outputColorSpace=Ze,_g.shadowMap.enabled=!gg,_g.shadowMap.type=1,_g.toneMapping=4,_g.toneMappingExposure=1.14,_g.setPixelRatio(gg?.2:Math.min(window.devicePixelRatio,1.75));var vg=new qn;vg.fog=new Kn(11978177,70,142);var yg=new Bs(76,1,.08,180);yg.rotation.order=`YXZ`,vg.add(yg);function bg(){let e=new U(new Go(150,gg?20:32,gg?12:18),new ts({side:1,depthWrite:!1,fog:!1,uniforms:{top:{value:new H(2382722)},horizon:{value:new H(12177869)},bottom:{value:new H(14862750)},sunColor:{value:new H(16765850)},cloudColor:{value:new H(15265511)},sunDirection:{value:new z(-.39,.83,.42).normalize()},cloudStrength:{value:gg?0:.035}},vertexShader:`
    ...
    `}));e.name=`procedural-atmosphere-sky`,e.frustumCulled=!1,e.onBeforeRender=()=>e.position.copy(yg.position),vg.add(e),vg.add(new Os(14479359,5070918,1.48)),vg.add(new Ks(13095892,.38));let t=new Gs(16767397,2.8);t.position.set(-32,68,34),t.castShadow=!0,t.shadow.mapSize.set(2048,2048),t.shadow.camera.left=-48,t.shadow.camera.right=48,t.shadow.camera.top=54,t.shadow.camera.bottom=-54,t.shadow.camera.near=10,t.shadow.camera.far=150,t.shadow.bias=-28e-5,t.shadow.normalBias=.025,vg.add(t)}bg();var Q=fp(vg),xg=new kp(vg,gg),Sg=new qh(vg),$={id:ig(),name:`Player`,team:0,position:new z,velocity:new z,yaw:0,pitch:0,hp:100,kills:0,deaths:0,weapon:`carbine`,ammo:{carbine:Uf.carbine.mag,smg:Uf.smg.mag,scattergun:Uf.scattergun.mag},reserve:{carbine:Uf.carbine.reserve,smg:Uf.smg.reserve,scattergun:Uf.scattergun.reserve},reloadState:null,switchingUntil:0,lastShotAt:0,nextShotAt:0,sustainedShots:0,stance:`stand`,grenades:1,lastMeleeAt:-1e4,alive:!0,invulnerableUntil:0,seq:0},Cg=new Set,wg=new Map,Tg=new Map,Eg=[],Dg=new Set,Og=new Map,kg=[],Ag=!1,jg=`solo`,Mg=!1,Ng=0,Pg=0,Fg=0,Ig={pitch:0,yaw:0},Lg=0,Rg=0,zg=0,Bg=0,Vg=!1,Hg=0,Ug=0,Wg=0,Gg=0,Kg=-1e4,qg=-1e4,Jg={distance:0,side:0},Yg=performance.now(),Xg=0,Zg=new URLSearchParams(window.location.search).get(`renderPaused`)===`1`,Qg=lp(performance.now()),$g=!1,e_=!1,t_=!1,n_=!1,r_={x:0,y:0},i_={yaw:0,pitch:0},a_=!1,o_=!0,s_=!0,c_=[],l_=!1,u_=!1,d_=1,f_=1,p_=82,m_=!1,h_=!1,g_=null,__=null;function v_(){return Ag&&$.alive&&Qg.phase===`active`&&sg.classList.contains(`hidden`)}function y_(){return Ag&&$.alive&&Qg.phase!==`ended`&&sg.classList.contains(`hidden`)}function b_(e=!1,t=performance.now()){if(!$.reloadState){E_.cancelReload();return}(e||np($.reloadState,t))&&($.reloadState=null,E_.cancelReload())}function x_(){b_(!1),Cg.clear(),r_={x:0,y:0},i_={yaw:0,pitch:0},a_=!1,t_=!1,n_=!1,Mg=!1,e_=!1,Vg=!1,Kg=-1e4,$.velocity.x=0,$.velocity.z=0}function S_(e,t=`ok`){dg.textContent=e,dg.dataset.kind=t}function C_(e){let t=e instanceof Error?e.message:String(e);Mg=!1,S_(`Game paused: ${t}`,`error`),sg.classList.remove(`hidden`);let n=Z(`#banner`);n.innerHTML=`<strong>SYSTEM PAUSED</strong><span>Reload the page to re-enter the test block.</span>`,n.hidden=!1,console.error(`[Atomic Acres fatal]`,e)}var w_=typeof window.RTCPeerConnection==`function`;w_?typeof og.requestPointerLock!=`function`&&S_(`Pointer lock is unavailable; keyboard movement works but mouse aim may not.`,`warn`):(Z(`#host`).disabled=!0,Z(`#join`).disabled=!0,S_(`This browser lacks WebRTC; solo training is still available.`,`warn`)),og.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),C_(Error(`Graphics context was lost`))}),og.addEventListener(`webglcontextrestored`,()=>window.location.reload());var T_=new Ih(F_,S_),E_=new tg(yg,gg),D_=Df(localStorage.getItem(Tf));function O_(e){document.querySelectorAll(`[data-menu-tab]`).forEach(t=>{let n=t.dataset.menuTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,String(n))}),document.querySelectorAll(`[data-menu-panel]`).forEach(t=>{let n=t.dataset.menuPanel===e;t.classList.toggle(`active`,n),t.hidden=!n})}function k_(){let e=Ef(D_),t=Ag&&$.weapon!==e.weapon;Z(`#selected-kit-summary`).innerHTML=`<span>${t?`QUEUED NEXT DEPLOYMENT`:`ACTIVE FIELD KIT`}</span><strong>${e.title}</strong><b>${Uf[e.weapon].name}</b>`,document.querySelectorAll(`[data-kit-id]`).forEach(e=>{let t=e.dataset.kitId===D_;e.classList.toggle(`selected`,t),e.setAttribute(`aria-pressed`,String(t))})}function A_(e){D_=Ef(e).id,localStorage.setItem(Tf,Of(D_)),Ag||($.weapon=Ef(D_).weapon,E_.setWeapon($.weapon,!0)),k_()}document.querySelectorAll(`[data-menu-tab]`).forEach(e=>{e.addEventListener(`click`,()=>O_(e.dataset.menuTab))}),document.querySelectorAll(`[data-kit-id]`).forEach(e=>{e.addEventListener(`click`,()=>A_(e.dataset.kitId??`balanced`))}),$.weapon=Ef(D_).weapon,k_();var j_=new Hs(14938623,1.35,5);j_.position.set(0,.4,.2),yg.add(j_);function M_(e){return e===`prone`?.5:e===`crouch`?1.16:1.7}function N_(e){let t=new Rn;t.name=`remote-player-world`,t.rotation.order=`YXZ`,t.userData.playerId=e.id;let n=af(e.team,`remote-player-model`,gg,e.weapon);n.userData.playerId=e.id,n.traverse(n=>{n.userData.playerId=e.id,n.userData.targetRoot=t}),t.userData.operator=n,t.add(n);let r=document.createElement(`canvas`);r.width=256,r.height=64;let i=r.getContext(`2d`);i.fillStyle=`rgba(10,18,22,.72)`,i.fillRect(0,0,256,64),i.fillStyle=`#f7ecd4`,i.font=`700 30px Arial`,i.textAlign=`center`,i.textBaseline=`middle`,i.fillText(e.name,128,32);let a=new ga(r);a.colorSpace=Ze;let o=new si(new qr({map:a,transparent:!0,depthTest:!0,depthWrite:!1}));return o.visible=e.team===$.team,o.position.y=2.5,o.scale.set(2.4,.6,1),t.add(o),t.position.set(e.x,e.y-M_(e.stance),e.z),vg.add(t),{root:t,snapshot:e,target:new z(e.x,e.y-M_(e.stance),e.z),targetYaw:e.yaw,lastSeen:performance.now()}}function P_(){return{id:$.id,name:$.name,team:$.team,x:$.position.x,y:$.position.y,z:$.position.z,yaw:$.yaw,pitch:$.pitch,hp:$.hp,kills:$.kills,deaths:$.deaths,weapon:$.weapon,stance:$.stance,seq:++$.seq}}function F_(e){if(e.type===`join`||e.type===`state`){let t=e.player;if(t.id===$.id||!Rf(t,Q.bounds,.44))return;let n=wg.get(t.id);n||(n=N_(t),wg.set(t.id,n),gv(`${t.name} entered the test block`,t.team===0?`aqua`:`coral`),e.type===`join`&&T_.send({type:`state`,player:P_()})),t.seq>=n.snapshot.seq&&(n.snapshot=t,n.target.set(t.x,t.y-M_(t.stance),t.z),n.targetYaw=t.yaw,n.lastSeen=performance.now(),n.root.visible=t.hp>0);return}if(e.type===`shot`){if(e.by===$.id)return;let t=wg.get(e.by),n=Og.get(e.by)??Lh(),r=Rh(e,t?.snapshot,performance.now(),n);if(!r.accepted)return;Og.set(e.by,r.nextState),L_(e);return}if(e.type===`hit`&&e.target===$.id&&!Dg.has(e.nonce)){let t=wg.get(e.by);if(!t||!Rf(t.snapshot,Q.bounds,.44))return;let n={x:t.snapshot.x,y:t.snapshot.y,z:t.snapshot.z};if(Q.colliders.some(e=>Nf(n,$.position,e)))return;Dg.add(e.nonce),z_(e.damage,e.by),I_();return}if(e.type===`death`&&!Dg.has(e.nonce)){Dg.add(e.nonce),B_(e),I_();return}e.type===`leave`&&V_(e.playerId,`left the block`)}function I_(){Dg.size>512&&Dg.clear()}function L_(e){let t=new z(...e.origin);if(!Rf(t,Q.bounds,.44))return;let n=new z(...e.direction).normalize(),r=Ff(t,n,50,t.clone().addScaledVector(n,50),0,Q.colliders),i=t.clone().addScaledVector(n,r.tracerDistance),a=wg.get(e.by)?.root.userData.operator,o=a?.getObjectByName(`muzzle-socket`)?.getWorldPosition(new z);mv(o??t,i,Uf[e.weapon].color),a&&tf(a),r.blockedByCover&&(pv(i,`concrete`,n.clone().multiplyScalar(-1)),hg.impact(`concrete`,i.distanceTo(yg.position))),$.alive&&hg.nearMiss(xf($.position,t,i)),hg.shot(e.weapon,!0,t.distanceTo(yg.position))}function R_(e){let t=wg.get(e)?.target??Tg.get(e)?.position;if(!t||e===$.id)return;let n=t.x-$.position.x,r=t.z-$.position.z,i=Math.atan2(-n,-r),a=Z(`#damage-direction`);a.style.setProperty(`--damage-angle`,`${Bf($.yaw,i)}rad`),a.classList.remove(`pulse`),requestAnimationFrame(()=>a.classList.add(`pulse`))}function z_(e,t){let n=performance.now();if(!(!$.alive||n<$.invulnerableUntil)&&($.hp=Math.max(0,$.hp-Math.min(100,Math.max(1,e))),qg=n,hg.damage(),R_(t),Z(`#damage-flash`).classList.remove(`pulse`),requestAnimationFrame(()=>Z(`#damage-flash`).classList.add(`pulse`)),$.hp<=0)){b_(!0,n),$.alive=!1,$.deaths+=1;let e={type:`death`,killer:t,victim:$.id,nonce:q_()};T_.send(e),B_(e),Z(`#respawn`).hidden=!1,document.exitPointerLock(),setTimeout(G_,1900)}}function B_(e){let t=e.killer===$.id?$.name:wg.get(e.killer)?.snapshot.name??Tg.get(e.killer)?.name??`Unknown`,n=e.victim===$.id?$.name:wg.get(e.victim)?.snapshot.name??Tg.get(e.victim)?.name??`Unknown`;e.killer===$.id&&e.victim!==$.id&&($.kills+=1,hg.kill()),gv(`${t} eliminated ${n}`,e.killer===$.id?`gold`:void 0);let r=wg.get(e.victim);r&&(r.root.visible=!1);let i=Tg.get(e.victim);i&&(i.root.visible=!1),xv()}function V_(e,t){let n=wg.get(e);n&&(vg.remove(n.root),wg.delete(e),Og.delete(e),gv(`${n.snapshot.name} ${t}`))}function H_(){let e=Q.spawns[$.team],t=jg===`client`?Math.min(1,e.length-1):jg===`host`?0:$.deaths%e.length,n=[...[...wg.values()].map(e=>new z(e.snapshot.x,e.snapshot.y,e.snapshot.z)),...[...Tg.values()].filter(e=>e.alive).map(e=>e.position.clone())],r=[...[...wg.values()].filter(e=>e.snapshot.team!==$.team&&e.snapshot.hp>0).map(e=>new z(e.snapshot.x,e.snapshot.y,e.snapshot.z)),...[...Tg.values()].filter(e=>e.team!==$.team&&e.alive).map(e=>e.position.clone().add(new z(0,1.42,0)))],i=e.map((e,t)=>({point:e,index:t})).filter(({point:e})=>{let t={x:e.x,y:0,z:e.z};return Number.isFinite(e.x)&&Number.isFinite(e.y)&&Number.isFinite(e.z)&&Rf(t,Q.bounds,.44)&&!If(t,Q.colliders,.44)});if(i.length===0)throw Error(`No valid authored player spawn for team ${$.team}`);let a=i.map(({point:e,index:i})=>{let a=r.length===0?0:Math.min(...r.map(t=>t.distanceToSquared(e))),o=r.filter(t=>!Q.colliders.some(n=>Nf(t,e,n))).length;return{point:e,index:i,score:ff({nearestThreatDistanceSq:a,visibleThreats:o,occupied:n.some(t=>t.distanceToSquared(e)<20),preferred:i===t})}});return a.sort((e,t)=>t.score-e.score||e.index-t.index),a[0].point.clone()}function U_(){try{let e=og.requestPointerLock();e instanceof Promise&&e.catch(()=>void 0)}catch{}}function W_(e){if(!__||!$.alive||!l_)return!1;let t=Jf($.stance,e);if(t===$.stance)return!0;let n=$.stance,r=__.eyePosition();if(!__.setStance(t))return S_(`Low clearance — stance change blocked.`,`warn`),!1;let i=__.eyePosition();return zg+=r.y-i.y,$.position.set(i.x,i.y,i.z),$.stance=t,Hg=performance.now()+(t===`prone`?260:n===`prone`?290:135),Vg=!1,!0}function G_(e=!0){b_(!0),$.stance=`stand`,__?.setStance(`stand`),$.position.copy(H_()),__?.teleportEye($.position),$.velocity.set(0,0,0),$.hp=100,qg=-1e4,$.grenades=1,$.reloadState=null,$.alive=!0,$.invulnerableUntil=performance.now()+1350,$.yaw=$.team===0?Math.PI:0,$.pitch=0,Ig={pitch:0,yaw:0},Hg=0,Ug=0,Wg=0,zg=0,Bg=0,Kg=-1e4,Jg={distance:0,side:0};let t=Ef(D_).weapon;$.weapon!==t&&($.weapon=t,$.switchingUntil=0,E_.setWeapon(t,!0)),k_(),Z(`#respawn`).hidden=!0,Ag&&e&&U_(),T_.send({type:`state`,player:P_()})}function K_(e,t=!0){$.name=Fh(Z(`#player-name`).value),$.team=+(Number(Z(`#team`).value)===1),Ag=!0,E_.root.visible=!0,jg=e,m_=!1,Qg=lp(performance.now()),$g=!1,sg.classList.add(`hidden`),cg.hidden=!1,Z(`#connection-pill`).textContent=e===`solo`?`BOT SKIRMISH`:e===`host`?`HOST`:`PEER`,Z(`#room-hud`).textContent=T_.roomCode?`ROOM ${T_.roomCode.slice(0,8).toUpperCase()}`:``,G_(t),e===`solo`&&ev(),hg.unlock(),gv(`Welcome to Atomic Acres`,`gold`),e!==`solo`&&T_.send({type:`join`,player:P_()})}function q_(){return Math.floor(performance.now()*1e3+Math.random()*1e6)}function J_(e){let t=ng[e];if(!(!t||t===$.weapon||!$.alive)){if($.reloadState){if(!np($.reloadState,performance.now()))return;$.reloadState=null,E_.cancelReload()}$.weapon=t,$.switchingUntil=performance.now()+360,$.sustainedShots=0,E_.setWeapon(t),hg.weaponSwitch()}}function Y_(){if(!$.alive||Qg.phase!==`active`)return;let e=Uf[$.weapon],t=$.ammo[$.weapon];$.reloadState||t>=e.mag||$.reserve[$.weapon]<=0||($.reloadState=tp(e,t,$.reserve[$.weapon],performance.now()),kg.length=0,hg.reload(),E_.reload(e.reload),gv(`Reloading ${e.name}`))}function X_(e){if(!$.reloadState)return;let t=rp($.reloadState,e,$.ammo[$.weapon],$.reserve[$.weapon]);t.completed&&($.ammo[$.weapon]=t.ammo,$.reserve[$.weapon]=t.reserve,$.reloadState=null,E_.cancelReload())}function Z_(e){if(!$.alive||!Ag||!h_&&document.pointerLockElement!==og||Qg.phase!==`active`)return;Vg&&(Vg=!1,Ug=Math.max(Ug,e+150));let t=Math.max(Hg,Ug);if(e<t){Wg<t&&(Wg=t,window.setTimeout(()=>{Wg=0,Mg&&Z_(performance.now())},Math.max(1,t-e+2)));return}Wg=0;let n=Uf[$.weapon];if(!Mg&&n.automatic||e<$.switchingUntil)return;if($.reloadState){if(!np($.reloadState,e))return;$.reloadState=null,E_.cancelReload()}let r=6e4/n.rpm;if(e<$.nextShotAt)return;if(($.nextShotAt===0||e-$.nextShotAt>r*2)&&($.nextShotAt=e),$.nextShotAt+=r,$.ammo[$.weapon]<=0){hg.empty(),Y_(),$.lastShotAt=e;return}$.sustainedShots=e-$.lastShotAt<260?$.sustainedShots+1:0,$.lastShotAt=e,--$.ammo[$.weapon];let i=Z(`#ammo`);i.classList.remove(`fired`),requestAnimationFrame(()=>i.classList.add(`fired`));let a=ap(n,$.sustainedShots,Math.random());Ig.pitch=Math.min(.16,Ig.pitch+a.pitch),Ig.yaw=Bt.clamp(Ig.yaw+a.yaw,-.075,.075),Fg=Math.min(.24,Fg+a.pitch*4.2),E_.fire(a.pitch),hg.shot($.weapon);let o=yg.getWorldPosition(new z),s=yg.getWorldDirection(new z),c=Math.hypot($.velocity.x,$.velocity.z)>1.2,l=Qf(n,{ads:e_&&E_.adsProgress()>=.9,moving:c,crouched:$.stance===`crouch`,prone:$.stance===`prone`,sustainedShots:$.sustainedShots}),u=new Map,d=!1,f=new z(1,0,0).applyQuaternion(yg.quaternion),p=new z(0,1,0).applyQuaternion(yg.quaternion);for(let e=0;e<n.pellets;e+=1){let e=$f(l,Math.random(),Math.random()),t=s.clone().addScaledVector(f,e.x).addScaledVector(p,e.y).normalize(),r=Q_(o,t),i=o.clone().addScaledVector(t,r.distance);if(mv(E_.muzzleWorldPosition(new z)??o,i,n.color),!r.playerId&&!r.targetId&&r.distance<89){let e=r.impactPoint??o.clone().addScaledVector(t,r.distance),n=r.impactNormal??t.clone().multiplyScalar(-1),i=r.impactSurface??`concrete`;pv(e,i,n),d||(d=!0,hg.impact(i,e.distanceTo(yg.position)))}if(r.playerId){let e=r.hitZone??`body`,t=ep(n,r.distance,e),i=u.get(r.playerId);u.set(r.playerId,{damage:(i?.damage??0)+t,zone:i?.zone===`head`||e===`head`?`head`:e})}r.targetId&&dv(r.targetId)}for(let[e,t]of u){let n=Tg.get(e);if(n)iv(n,Math.min(100,t.damage),t.zone);else{let n=wg.get(e);if(n&&n.snapshot.team!==$.team){let r=n.root.userData.operator;r&&nf(r,t.zone);let i=q_();T_.send({type:`hit`,by:$.id,target:e,damage:Math.min(100,t.damage),nonce:i}),hv(t.zone===`head`),hg.hit(t.zone===`head`)}}}let m={type:`shot`,by:$.id,weapon:$.weapon,origin:o.toArray(),direction:s.toArray(),nonce:q_()};T_.send(m),$.ammo[$.weapon]===0&&setTimeout(Y_,120)}function Q_(e,t){let n=new uc(e,t,.1,110),r=[...wg.values()].filter(e=>e.root.visible).map(e=>e.root),i=[...Tg.values()].filter(e=>e.alive&&e.root.visible).map(e=>e.root),a=Q.targets.filter(e=>e.active).map(e=>e.root),o=n.intersectObjects([...Q.raycastMeshes,...r,...i,...a],!0)[0];if(!o)return{distance:90};let s=o.object,c,l,u,d,f=[];for(;s;)c??=s.userData.playerId,l??=s.userData.targetId,u??=s.userData.hitZone,d??=s.userData.impactSurface,s.name&&f.push(s.name),s=s.parent;let p=o.object.userData.targetRoot;l??=p?.userData.targetId;let m=o.object instanceof U?Array.isArray(o.object.material)?o.object.material[0]:o.object.material:void 0,h=m instanceof W?m.metalness:void 0,g=o.face?.normal.clone().transformDirection(o.object.matrixWorld)??t.clone().multiplyScalar(-1);return{distance:Math.min(o.distance,110),playerId:c,targetId:l,hitZone:u,impactPoint:o.point.clone(),impactNormal:g,impactSurface:yf({hint:d,name:f.join(` `),metalness:h})}}function $_(e,t){let n=Q.spawns[e],r=[...$.alive&&$.team!==e?[$.position.clone()]:[],...[...wg.values()].filter(t=>t.snapshot.team!==e&&t.snapshot.hp>0).map(e=>new z(e.snapshot.x,e.snapshot.y,e.snapshot.z))],i=[...[...wg.values()].map(e=>e.target.clone()),...[...Tg.values()].filter(e=>e.alive).map(e=>e.position.clone())],a=n.map((e,t)=>({candidate:e,index:t})).filter(({candidate:e})=>{let t={x:e.x,y:0,z:e.z};return Number.isFinite(e.x)&&Number.isFinite(e.z)&&Rf(t,Q.bounds,.44)&&!If(t,Q.colliders,.44)});if(a.length===0)throw Error(`No valid authored spawn for team ${e}`);let o=a.map(({candidate:e,index:a})=>{let o=r.length===0?0:Math.min(...r.map(t=>t.distanceToSquared(e))),s=r.filter(t=>!Q.colliders.some(n=>Nf(e,t,n))).length;return{candidate:e,index:a,score:ff({nearestThreatDistanceSq:o,visibleThreats:s,occupied:i.some(t=>t.distanceToSquared(e)<20),preferred:a===(t%n.length+n.length)%n.length})}});return o.sort((e,t)=>t.score-e.score||e.index-t.index),o[0].candidate}function ev(){tv();let e=+($.team===0);[`RIVET`].slice(0,1).forEach((t,n)=>{let r=`bot-${n}`,i=af(e,`bot-operator`,gg);i.userData.playerId=r,i.traverse(e=>{e.userData.playerId=r,e.userData.targetRoot=i});let a=$_(e,n),o=new z(a.x,a.y-1.7,a.z);i.position.copy(o),vg.add(i),Tg.set(r,{id:r,name:t,team:e,root:i,position:o,velocity:new z,hp:100,alive:!0,kills:0,deaths:0,lastShotAt:0,lastSightAt:0,hasLineOfSight:!1,sightStartedAt:0,burstShots:0,nextDecisionAt:0,strafeSign:n%2==0?1:-1,invulnerableUntil:performance.now()+1e3,respawnAt:0,waypoint:n,blockedSince:0})}),gv(`One hostile operator entered the block`,`coral`)}function tv(){for(let e of Tg.values())vg.remove(e.root);Tg.clear()}function nv(e){let t={x:e.position.x,y:e.position.y+1.42,z:e.position.z},n={x:$.position.x,y:$.position.y,z:$.position.z};return!Q.colliders.some(e=>Nf(t,n,e))}function rv(e){let t={x:$.position.x,y:$.position.y,z:$.position.z};return mf(rg.map((n,r)=>{let i={x:n.x,y:1.42,z:n.z};return{index:r,distanceFromBot:n.distanceTo(e.position),distanceFromPlayer:n.distanceTo($.position),seesPlayer:$.alive&&!Q.colliders.some(e=>Nf(i,t,e))}}),e.waypoint,e.deaths+e.kills)}function iv(e,t,n){let r=performance.now();!e.alive||r<e.invulnerableUntil||(nf(e.root,n),e.hp=Math.max(0,e.hp-t),hv(n===`head`),hg.hit(n===`head`),!(e.hp>0)&&(e.alive=!1,e.deaths+=1,e.respawnAt=r+2200,e.root.visible=!1,$.kills+=1,hg.kill(),gv(`${$.name} eliminated ${e.name}${n===`head`?` · HEADSHOT`:``}`,`gold`),xv()))}function av(e,t){let n=_f(t),r=$_(e.team,e.deaths+e.waypoint);e.position.set(r.x,r.y-1.7,r.z),e.root.position.copy(e.position),e.hp=n.health,e.alive=n.alive,e.invulnerableUntil=n.invulnerableUntil,e.lastShotAt=n.lastShotAt,e.lastSightAt=0,e.hasLineOfSight=!1,e.sightStartedAt=0,e.burstShots=0,e.nextDecisionAt=0,e.blockedSince=0,e.root.visible=!0}function ov(e,t){if(jg!==`solo`||Qg.phase!==`active`||m_)return;let n=0;for(let r of Tg.values()){if(n+=1,!r.alive){t>=r.respawnAt&&!$g&&av(r,t);continue}if(!Rf(r.position,Q.bounds,.44)){let e=$_(r.team,r.waypoint);r.position.set(e.x,e.y-1.7,e.z),r.root.position.copy(r.position),r.hasLineOfSight=!1,r.sightStartedAt=0,r.burstShots=0,r.blockedSince=0,r.lastSightAt=t;continue}let i=$.position.clone().setY(0).sub(r.position.clone().setY(0)),a=i.length(),o=120+n*19;if(t-r.lastSightAt>=o){r.lastSightAt=t;let e=r.hasLineOfSight;r.hasLineOfSight=$.alive&&nv(r),r.hasLineOfSight&&!e&&(r.sightStartedAt=t),r.hasLineOfSight||(e&&(r.waypoint=rv(r)),r.sightStartedAt=0,r.burstShots=0)}let s=r.hasLineOfSight;t>=r.nextDecisionAt&&(r.strafeSign=r.strafeSign===1?-1:1,r.nextDecisionAt=t+850+n*95);let c=rg[r.waypoint%rg.length],l=c.clone().sub(r.position).setY(0),u=l.lengthSq()<5.2;u&&(r.waypoint=s?(r.waypoint+1+n)%rg.length:rv(r));let d=gf({alive:r.alive,distanceToPlayer:a,hasLineOfSight:s,health:r.hp,now:t,lastShotAt:r.lastShotAt,waypointReached:u,random:r.strafeSign===1?.25:.75,lineOfSightSince:r.sightStartedAt,reactionDelay:650,burstShotsRemaining:r.burstShots});d.changeWaypoint&&!u&&(r.waypoint=rv(r)),c=rg[r.waypoint%rg.length],l=c.clone().sub(r.position).setY(0);let f=s?i:l,p=f.lengthSq()>.01?f.normalize():new z(0,0,-1),m=new z(-p.z,0,p.x),h=d.movement===`advance`?p:d.movement===`retreat`?p.clone().multiplyScalar(-1):d.movement===`strafe-left`?m.clone().multiplyScalar(-1):d.movement===`strafe-right`?m:new z,g=d.movement.startsWith(`strafe`)?4.05:s?4.65:5.85,_=r.position.clone().addScaledVector(h,g*e),v=Lf(r.position,_,Q.colliders,Q.bounds,.44);if(Math.hypot(v.x-r.position.x,v.z-r.position.z)<.002&&h.lengthSq()>0){let n=r.position.clone().addScaledVector(m,r.strafeSign*g*e*1.5);v=Lf(r.position,n,Q.colliders,Q.bounds,.44),Math.hypot(v.x-r.position.x,v.z-r.position.z)<.002?r.blockedSince===0?r.blockedSince=t:t-r.blockedSince>=400&&(r.waypoint=rv(r),r.blockedSince=0):r.blockedSince=0}else r.blockedSince=0;r.position.set(v.x,r.position.y,v.z),r.root.position.copy(r.position);let y=s?$.position:c;if(r.root.lookAt(y.x,r.position.y+1.1,y.z),rf(r.root,`stand`,h.lengthSq()>0?g:0,t*.008+n,Math.min(1,e*12)),pf(d.fire,t,r.invulnerableUntil)&&$.alive){r.burstShots<=0&&(r.burstShots=2+n%2),--r.burstShots,r.lastShotAt=t,tf(r.root);let e=r.position.clone().add(new z(0,1.42,0)),i=$.position.clone().sub(e).normalize(),o=hf(a)+r.burstShots*.006;i.x+=(Math.random()-.5)*o,i.y+=(Math.random()-.5)*o,i.z+=(Math.random()-.5)*o,i.normalize();let s=Math.min(a+2,75),c=$.stance===`prone`?.38:$.stance===`crouch`?.48:.55,l=Ff(e,i,s,$.position,c,Q.colliders),u=e.clone().addScaledVector(i,l.tracerDistance),d=r.root.getObjectByName(`muzzle-socket`)?.getWorldPosition(new z);mv(d??e,u,Uf.carbine.color),l.blockedByCover?(pv(u,`concrete`,i.clone().multiplyScalar(-1)),hg.impact(`concrete`,u.distanceTo($.position))):l.hitTarget||hg.nearMiss(xf($.position,e,u)),hg.shot(`carbine`,!0),l.hitTarget&&(z_(ep(Uf.carbine,a,`body`)*Hf,r.id),$.alive||(r.kills+=1,xv()))}}}function sv(){let e=performance.now();if(!cp(2,e,$.lastMeleeAt).hit||!$.alive||Qg.phase!==`active`)return;$.lastMeleeAt=e,E_.melee(),hg.melee();let t=Q_(yg.getWorldPosition(new z),yg.getWorldDirection(new z));if(!t.playerId||t.distance>2.25)return;let n=Tg.get(t.playerId);n?iv(n,70,t.hitZone??`body`):wg.has(t.playerId)&&T_.send({type:`hit`,by:$.id,target:t.playerId,damage:70,nonce:q_()})}function cv(){if(!$.alive||$.grenades<=0||Qg.phase!==`active`)return;--$.grenades,E_.throwGrenade();let e=yg.getWorldDirection(new z),t=yg.getWorldPosition(new z).addScaledVector(e,.7),n=new U(new Go(.16,14,10),new W({color:3424570,roughness:.55,metalness:.48}));n.position.copy(t),n.castShadow=!0,vg.add(n),Eg.push({mesh:n,velocity:e.multiplyScalar(13).add(new z(0,5.2,0)),explodeAt:performance.now()+2300,lastBounceAt:0})}function lv(e){let t=e.mesh.position.clone();vg.remove(e.mesh),hg.explosion();let n=new U(new Go(1,20,14),new _i({color:16757324,transparent:!0,opacity:.72}));n.position.copy(t),n.scale.setScalar(.2),vg.add(n);let r=new Hs(16743214,12,18,2);r.position.copy(t),vg.add(r);let i=performance.now(),a=()=>{let e=(performance.now()-i)/420;if(e>=1){vg.remove(n,r);return}n.scale.setScalar(.2+e*5.5),n.material.opacity=.72*(1-e),r.intensity=12*(1-e),requestAnimationFrame(a)};a();for(let e of Tg.values()){let n=e.position.clone().add(new z(0,1.1,0)),r=Q.colliders.some(e=>Nf(t,n,e))?0:sp(e.position.distanceTo(t));r>0&&iv(e,r,`body`)}for(let e of wg.values()){let n=e.target.clone().add(new z(0,1.1,0));if(Q.colliders.some(e=>Nf(t,n,e)))continue;let r=sp(n.distanceTo(t));r>0&&T_.send({type:`hit`,by:$.id,target:e.snapshot.id,damage:r,nonce:q_()})}let o=Q.colliders.some(e=>Nf(t,$.position,e))?0:sp($.position.distanceTo(t))*.35;o>0&&z_(o,$.id)}function uv(e,t){for(let n=Eg.length-1;n>=0;--n){let r=Eg[n];r.velocity.y-=18*e;let i=r.mesh.position.clone(),a=r.velocity.clone().multiplyScalar(e),o=Af(i,a,Q.colliders);if(o){let e=new z(o.normal.x,o.normal.y,o.normal.z);r.mesh.position.copy(i).addScaledVector(a,o.time).addScaledVector(e,.025);let n=r.velocity.dot(e);r.velocity.addScaledVector(e,-(1.38*n)),r.velocity.multiplyScalar(.76),Math.abs(n)>1.8&&t-r.lastBounceAt>90&&(r.lastBounceAt=t,hg.grenadeBounce(Math.abs(n)))}else r.mesh.position.add(a);if(!Rf(r.mesh.position,Q.bounds,.16)){let e=zf(r.mesh.position,Q.bounds,.16);r.mesh.position.set(e.x,e.y,e.z),pv(r.mesh.position.clone()),hg.coverImpact(r.mesh.position.distanceTo($.position)),vg.remove(r.mesh),r.mesh.geometry.dispose(),r.mesh.material.dispose(),Eg.splice(n,1);continue}if(r.mesh.rotation.x+=e*8,r.mesh.rotation.z+=e*11,r.mesh.position.y<.18){let e=Math.abs(r.velocity.y);e>1.8&&t-r.lastBounceAt>90&&(r.lastBounceAt=t,hg.grenadeBounce(e)),r.mesh.position.y=.18,r.velocity.y=Math.abs(r.velocity.y)*.42,r.velocity.x*=.72,r.velocity.z*=.72}t>=r.explodeAt&&(Eg.splice(n,1),lv(r))}}function dv(e){let t=Q.targets.find(t=>t.id===e);!t||!t.active||(t.active=!1,t.root.visible=!1,t.respawnAt=performance.now()+3200,Ng+=1,hv(),hg.hit(),gv(`+1 test mannequin`,`gold`))}function fv(e){for(let t of Q.targets){if(jg===`solo`){t.root.visible=!1;continue}!t.active&&e>=t.respawnAt&&(t.active=!0,t.root.visible=!0)}}function pv(e,t=`concrete`,n=new z(0,1,0)){xg.impact(e,n.normalize(),t)}function mv(e,t,n){Sg.emit(e,t,n)}function hv(e=!1){let t=Z(`#hitmarker`);t.classList.remove(`show`,`headshot`),e&&t.classList.add(`headshot`),requestAnimationFrame(()=>t.classList.add(`show`))}function gv(e,t){let n=Z(`#killfeed`),r=document.createElement(`div`);for(r.textContent=e,t&&r.classList.add(t),n.prepend(r);n.children.length>6;)n.lastElementChild?.remove();setTimeout(()=>r.classList.add(`fade`),4200),setTimeout(()=>r.remove(),5e3)}function _v(e){if(!y_()||!__)return;let t=new z(-Math.sin($.yaw),0,-Math.cos($.yaw)),n=new z(Math.cos($.yaw),0,-Math.sin($.yaw)),r=Bt.clamp(Number(Cg.has(`KeyW`))-Number(Cg.has(`KeyS`))-r_.y,-1,1),i=Bt.clamp(Number(Cg.has(`KeyD`))-Number(Cg.has(`KeyA`))+r_.x,-1,1),a=t.clone().multiplyScalar(r).addScaledVector(n,i);a.lengthSq()>1&&a.normalize();let o=performance.now(),s=$.stance===`crouch`,c=$.stance===`prone`,l=(Cg.has(`ShiftLeft`)||a_)&&a.lengthSq()>0&&l_,u=qf(r,i,e_,!1,!1);l&&u&&$.stance!==`stand`&&W_(`stand`),Vg=l&&!Mg&&!$.reloadState&&o>=$.switchingUntil&&o-$.lastMeleeAt>500&&qf(r,i,e_,s,c);let d=Wf({crouched:s,prone:c,ads:e_,sprinting:Vg,grounded:l_}),f=Kf({x:$.velocity.x,z:$.velocity.z},{x:a.x,z:a.z},d,e);$.velocity.x=f.x,$.velocity.z=f.z,$.hp<100&&o-qg>=5e3&&($.hp=Math.min(100,$.hp+18*e)),l_&&(Gg=o);let p=o-Kg<=125,m=l_||o-Gg<=95;p&&m&&!e_&&$.stance===`stand`&&Qg.phase===`active`?($.velocity.y=d.jumpVelocity,l_=!1,Kg=-1e4):($.velocity.y-=24.5*e,l_&&($.velocity.y=Math.max(0,$.velocity.y)));let h=$.velocity.y,g=__.move({x:$.velocity.x*e,y:$.velocity.y*e,z:$.velocity.z*e},e);$.position.set(g.position.x,g.position.y,g.position.z),l_=g.grounded,l_&&(Gg=o),l_&&!u_&&h<-5&&(Lg=Math.min(1,Math.abs(h)/14),hg.land(Math.abs(h))),u_=l_,g.blockedX&&($.velocity.x=g.appliedDelta.x/Math.max(e,.001)),g.blockedY&&$.velocity.y<0&&($.velocity.y=0),g.blockedZ&&($.velocity.z=g.appliedDelta.z/Math.max(e,.001));let _=a.lengthSq()>0&&l_,v=l_?Math.hypot(g.appliedDelta.x,g.appliedDelta.z):0,y=jp(Jg,v,Ap($.stance,Vg));Jg=y.state;for(let e=0;e<y.emitted;e+=1)hg.footstep(Sf($.position),Vg,s||c);Rg+=e*(Vg?15:c?3.6:s?7:10)*(_?1:.25),Fg=ip(Fg,Uf[$.weapon],e),Ig=op(Ig,Uf[$.weapon],e),Lg=Vf(Lg,0,10,e),zg=Vf(zg,0,c?9:15,e);let b=$.velocity.dot(n)/Math.max(1,d.maxSpeed);Bg=Vf(Bg,-b*(e_?.006:.016),11,e);let x=E_.update({dt:e,moving:_,sprinting:Vg,crouched:s,prone:c,ads:e_,phase:Rg,landingImpulse:Lg,lateralSpeed:b});for(let e of x)hg.weaponAction($.weapon,e),kg.push(e);kg.length>16&&kg.splice(0,kg.length-16),yg.fov=Vf(yg.fov,e_?Math.max(55,p_-20):Vg?p_+4.5:p_,10,e),yg.updateProjectionMatrix(),yg.position.copy($.position),yg.position.y+=zg-Lg*.035,yg.rotation.y=$.yaw+Ig.yaw,yg.rotation.x=Bt.clamp($.pitch-Ig.pitch,-1.42,1.42),yg.rotation.z=Bg}function vv(e,t){for(let[n,r]of wg){if(t-r.lastSeen>12e3){V_(n,`timed out`);continue}let i=1-Math.exp(-13*e),a=r.root.position.distanceTo(r.target);r.root.position.lerp(r.target,i),r.root.rotation.y+=Bf(r.root.rotation.y,r.targetYaw)*i;let o=r.snapshot.stance??`stand`,s=r.root.userData.operator;ef(s,r.snapshot.weapon,gg),rf(s,o,a/Math.max(e,.001),t*.008,i,r.snapshot.pitch)}}function yv(){let e=$.team===0?$.kills:0,t=$.team===1?$.kills:0;for(let n of wg.values())n.snapshot.team===0?e+=n.snapshot.kills:t+=n.snapshot.kills;for(let n of Tg.values())n.team===0?e+=n.kills:t+=n.kills;return[e,t]}function bv(e){let t=Qg.phase,n=yv();if(Qg=up(Qg,e,n),t===Qg.phase)return;let r=Z(`#banner`);if(Qg.phase===`active`){r.innerHTML=`<strong>ENGAGE</strong><span>First squad to 25</span>`,r.hidden=!1,window.setTimeout(()=>{Qg.phase===`active`&&(r.hidden=!0)},900);return}if(Qg.phase===`ended`){$g=!0;let e=Qg.winner===$.team;r.innerHTML=`<strong>${Qg.winner===`draw`?`DRAW`:e?`VICTORY`:`DEFEAT`}</strong><span>${n[0]} — ${n[1]} · CLICK BOT SKIRMISH FOR REMATCH</span>`,r.hidden=!1,document.exitPointerLock()}}function xv(){bv(performance.now())}function Sv(e){let t=mg,n=fg.width,r=fg.height,i=Q.bounds,a=(e,t)=>pp(e,t,i,n,r);t.clearRect(0,0,n,r),t.fillStyle=`rgba(7, 15, 18, .78)`,t.fillRect(0,0,n,r),t.strokeStyle=`rgba(244, 196, 79, .5)`,t.lineWidth=2,t.strokeRect(2,2,n-4,r-4);let[o]=a(-10.25,0),[s]=a(10.25,0);t.fillStyle=`rgba(126, 137, 132, .18)`,t.fillRect(o,2,s-o,r-4);for(let[e,o,s]of[[-11,-34,0],[11,34,1]]){let[c,l]=a(e,o),u=16.4/(i.maxX-i.minX)*n,d=15/(i.maxZ-i.minZ)*r;t.fillStyle=s===0?`rgba(88, 227, 220, .2)`:`rgba(255, 118, 95, .2)`,t.fillRect(c-u/2,l-d/2,u,d)}for(let e of wg.values()){let n=e.snapshot.team===$.team;if(!n&&e.target.distanceTo($.position)>15)continue;let[r,i]=a(e.target.x,e.target.z);t.fillStyle=n?`#58e3dc`:`#ff765f`,t.beginPath(),t.arc(r,i,3.5,0,Math.PI*2),t.fill()}for(let n of Tg.values()){if(!n.alive||!mp(n.position.distanceTo($.position),e,n.lastShotAt))continue;let[r,i]=a(n.position.x,n.position.z);t.fillStyle=`#ff765f`,t.beginPath(),t.arc(r,i,3.5,0,Math.PI*2),t.fill()}let[c,l]=a($.position.x,$.position.z);t.save(),t.translate(c,l),t.rotate(-$.yaw),t.fillStyle=$.team===0?`#58e3dc`:`#ff765f`,t.beginPath(),t.moveTo(0,-7),t.lineTo(5,6),t.lineTo(-5,6),t.closePath(),t.fill(),t.restore()}function Cv(e){if(e-Xg<100)return;Xg=e,Ag&&bv(e);let t=Uf[$.weapon],n=Math.hypot($.velocity.x,$.velocity.z),r=e_&&E_.adsProgress()>=.9,i=Qf(t,{ads:r,moving:n>1.2,crouched:$.stance===`crouch`,prone:$.stance===`prone`,sustainedShots:$.sustainedShots}),a=Bt.clamp(5+i*320,5,23),o=Z(`#crosshair`);o.style.setProperty(`--spread`,`${a}px`),o.classList.toggle(`ads`,r);let[s,c]=yv();Z(`#health`).textContent=String(Math.ceil($.hp)),Z(`#health-fill`).style.width=`${$.hp}%`,Z(`#weapon-name`).textContent=t.name.toUpperCase(),Z(`#ammo`).textContent=String($.ammo[$.weapon]),Z(`#reserve`).textContent=String($.reserve[$.weapon]),Z(`#aqua-score`).textContent=String(s),Z(`#coral-score`).textContent=String(c);let l=Math.max(0,Qg.endsAt-e),u=Qg.phase===`warmup`?Math.ceil(l/1e3):Math.floor(l/1e3);Z(`#timer`).textContent=Qg.phase===`warmup`?`00:0${Math.min(9,u)}`:`${String(Math.floor(u/60)).padStart(2,`0`)}:${String(u%60).padStart(2,`0`)}`,Z(`#objective`).textContent=Qg.phase===`warmup`?`MATCH STARTS IN ${u}`:`ATOMIC ACRES · FIRST TO 25`,Z(`#reload-state`).textContent=$.reloadState?`RELOADING ${Math.max(0,($.reloadState.endsAt-e)/1e3).toFixed(1)}s`:jg===`solo`?`${$.kills} K / ${$.deaths} D · ${Ng} TARGETS`:`${$.kills} K / ${$.deaths} D`,Z(`#stance`).textContent=$.stance.toUpperCase(),Z(`#grenades`).textContent=`FRAG ×${$.grenades}`,Z(`#health-block`).classList.toggle(`critical`,$.hp<=30),Sv(e),Z(`#roster`).hidden||wv()}function wv(){let e=[P_(),...[...wg.values()].map(e=>e.snapshot),...[...Tg.values()].map(e=>({id:e.id,name:e.name,team:e.team,x:e.position.x,y:e.position.y,z:e.position.z,yaw:e.root.rotation.y,pitch:0,hp:e.hp,kills:e.kills,deaths:e.deaths,weapon:`carbine`,seq:0}))].sort((e,t)=>t.kills-e.kills||e.deaths-t.deaths);Z(`#roster-list`).innerHTML=e.map(e=>`<div><span class="${e.team===0?`aqua`:`coral`}">${Tv(e.name)}</span><b>${e.kills}</b><i>${e.deaths}</i><em>${e.hp>0?Math.ceil(e.hp)+` HP`:`DOWN`}</em></div>`).join(``)}function Tv(e){return e.replace(/[&<>'"]/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,"'":`&#39;`,'"':`&quot;`})[e])}function Ev(){let e=window.innerWidth,t=window.innerHeight;_g.setSize(e,t,!1),yg.aspect=e/Math.max(1,t),yg.updateProjectionMatrix()}window.addEventListener(`resize`,Ev),Ev();var Dv=new URLSearchParams(window.location.search),Ov=Dv.get(`room`)?.trim()??``;Ov&&(Z(`#room-input`).value=Ov);var kv=Dv.get(`name`);kv&&(Z(`#player-name`).value=Fh(kv)),Dv.get(`team`)===`1`&&(Z(`#team`).value=`1`);var Av=Z(`#sensitivity`),jv=Z(`#controller-sensitivity`),Mv=Z(`#field-of-view`),Nv=(e,t,n,r)=>{let i=Number(localStorage.getItem(e));return Number.isFinite(i)&&i>=n&&i<=r?i:t};d_=Nv(`atomic-acres-sensitivity`,Number(Av.value),.6,2),f_=Nv(`atomic-acres-controller-sensitivity`,Number(jv.value),.5,1.8),p_=Nv(`atomic-acres-fov`,Number(Mv.value),70,100),Av.value=String(d_),jv.value=String(f_),Mv.value=String(p_),Av.addEventListener(`input`,()=>{d_=Number(Av.value),localStorage.setItem(`atomic-acres-sensitivity`,String(d_))}),jv.addEventListener(`input`,()=>{f_=Number(jv.value),localStorage.setItem(`atomic-acres-controller-sensitivity`,String(f_))}),Mv.addEventListener(`input`,()=>{p_=Number(Mv.value),localStorage.setItem(`atomic-acres-fov`,String(p_))});function Pv(e){let t=navigator.getGamepads?.().find(e=>!!(e&&e.connected));if(!t){r_={x:0,y:0},i_={yaw:0,pitch:0},a_=!1,c_=[],Mg=t_,e_=g_??n_;return}let n=Xf(t.axes[0]??0,t.axes[1]??0,.14,1.6),r=Xf(t.axes[2]??0,t.axes[3]??0,.1,1.6),i=t.buttons.map(e=>e.pressed||e.value>.55),a=e=>i[e]&&!c_[e],o=!!i[6]||(t.buttons[6]?.value??0)>.22,s=!!i[7]||(t.buttons[7]?.value??0)>.22,c=v_();s?c||(o_=!1):o_=!0,o?c||(s_=!1):s_=!0;let l=c&&s&&o_,u=c&&o&&s_;a_=c&&!!i[10],e_=g_??(n_||u),Mg=t_||l,r_=c?n:{x:0,y:0},i_=Zf(i_,c?r:{x:0,y:0},e,e_,f_),c&&($.yaw-=i_.yaw*e,$.pitch=Bt.clamp($.pitch-i_.pitch*e,-1.42,1.42),a(0)&&($.stance!==`stand`&&W_(`stand`),Kg=performance.now()),a(1)&&W_(`toggle-crouch`),a(13)&&W_(`toggle-prone`),a(2)&&Y_(),a(3)&&J_((ng.indexOf($.weapon)+1)%ng.length),a(4)&&cv(),a(5)&&sv()),c_=i}window.addEventListener(`keydown`,e=>{if(v_())Cg.add(e.code);else if(e.code!==`Tab`)return;e.code===`Space`&&!e.repeat&&($.stance!==`stand`&&W_(`stand`),Kg=performance.now()),e.code===`KeyC`&&!e.repeat&&W_(`toggle-crouch`),(e.code===`KeyZ`||e.code===`ControlLeft`)&&!e.repeat&&W_(`toggle-prone`),e.code===`Digit1`&&J_(0),e.code===`Digit2`&&J_(1),e.code===`Digit3`&&J_(2),e.code===`KeyR`&&Y_(),e.code===`KeyV`&&!e.repeat&&sv(),e.code===`KeyG`&&!e.repeat&&cv(),e.code===`Tab`&&(e.preventDefault(),wv(),Z(`#roster`).hidden=!1)}),window.addEventListener(`keyup`,e=>{Cg.delete(e.code),e.code===`Tab`&&(Z(`#roster`).hidden=!0)}),window.addEventListener(`blur`,()=>{x_()}),window.addEventListener(`mousemove`,e=>{if(document.pointerLockElement!==og||!$.alive)return;let t=Yf(e_,Vg);$.yaw-=e.movementX*.00215*d_*t,$.pitch=Math.max(-1.42,Math.min(1.42,$.pitch-e.movementY*.0019*d_*t)),E_.addMouseDelta(e.movementX,e.movementY)}),og.addEventListener(`contextmenu`,e=>e.preventDefault()),og.addEventListener(`mousedown`,e=>{if(document.pointerLockElement!==og){U_();return}if(e.button===2){n_=!0,e_=!0;return}e.button===0&&(t_=!0,Mg=!0,Z_(performance.now()))}),window.addEventListener(`mouseup`,e=>{e.button===0&&(t_=!1),e.button===2&&(n_=!1),Mg=t_,e_=n_}),document.addEventListener(`pointerlockchange`,()=>{document.pointerLockElement===og?(Z(`#resume`).hidden=!0,sg.classList.add(`hidden`)):(x_(),Ag&&$.alive&&(Z(`#resume`).hidden=$g,sg.classList.remove(`hidden`)))});function Fv(){b_(!0),$.kills=0,$.deaths=0,$.hp=100,$.grenades=1,$.reloadState=null,$.sustainedShots=0,$.stance=`stand`,__?.setStance(`stand`),Ng=0,tv();for(let e of Eg)vg.remove(e.mesh);Eg.length=0;for(let e of wg.keys())V_(e,`cleared`);Z(`#banner`).hidden=!0,$.weapon=Ef(D_).weapon,$.switchingUntil=0,E_.setWeapon($.weapon,!0),k_(),$.ammo={carbine:Uf.carbine.mag,smg:Uf.smg.mag,scattergun:Uf.scattergun.mag},$.reserve={carbine:Uf.carbine.reserve,smg:Uf.smg.reserve,scattergun:Uf.scattergun.reserve}}Z(`#resume`).addEventListener(`click`,()=>{Ag&&$.alive&&!$g&&U_()}),Z(`#solo`).addEventListener(`click`,()=>{T_.close(),Fv(),K_(`solo`)}),Z(`#host`).addEventListener(`click`,()=>{Fv(),T_.host(()=>{lg.hidden=!1,ug.textContent=T_.roomCode,K_(`host`)})}),Z(`#join`).addEventListener(`click`,()=>{Fv();let e=Z(`#room-input`).value.trim();T_.join(e,()=>K_(`client`))}),Z(`#copy-room`).addEventListener(`click`,async()=>{let e=`${window.location.origin}${window.location.pathname}?room=${encodeURIComponent(T_.roomCode)}`;try{await navigator.clipboard.writeText(e),S_(`Invite link copied`,`ok`)}catch{Z(`#room-input`).value=T_.roomCode,S_(`Clipboard blocked — code placed in join field`,`warn`)}}),Ov&&Dv.get(`autojoin`)===`1`&&window.setTimeout(()=>Z(`#join`).click(),100),setInterval(()=>{Ag&&T_.role!==`offline`&&$.alive&&T_.send({type:`state`,player:P_()})},60),window.addEventListener(`beforeunload`,()=>{T_.role!==`offline`&&T_.send({type:`leave`,playerId:$.id}),T_.close()});function Iv(e){try{let t=Math.min(.05,Math.max(0,(e-Yg)/1e3));Yg=e,Pv(t),Pg+=t;let n=1/120,r=0;for(;Pg>=n&&r<6;)_v(n),Pg-=n,r+=1;Mg&&Uf[$.weapon].automatic&&Z_(e),X_(e),fv(e),ov(t,e),uv(t,e),xg.update(t),Sg.update(t),vv(t,e),Cv(e),Zg||_g.render(vg,yg),requestAnimationFrame(Iv)}catch(e){C_(e)}}var Lv=window;Lv.__ATOMIC_ACRES_DEBUG__={snapshot:()=>({gameStarted:Ag,gameMode:jg,matchPhase:Qg.phase,player:{hp:$.hp,kills:$.kills,deaths:$.deaths,weapon:$.weapon,ammo:$.ammo[$.weapon],reserve:$.reserve[$.weapon],reloading:$.reloadState!==null,stance:$.stance,crouched:$.stance===`crouch`,prone:$.stance===`prone`,sprinting:Vg,grenades:$.grenades,position:$.position.toArray()},bots:[...Tg.values()].map(e=>({id:e.id,hp:e.hp,alive:e.alive,kills:e.kills,position:e.position.toArray(),waypoint:e.waypoint,blockedSince:e.blockedSince,hasLineOfSight:e.hasLineOfSight,presentationReady:[`presentation-reaction-gear`,`field-radio-pack`,`asymmetric-shoulder-plate`,`team-radio-antenna`].every(t=>e.root.getObjectByName(t)!==void 0),presentationWeaponSafe:(()=>{let t=e.root.getObjectByName(`operator-${e.root.userData.operatorRig?.weaponId??`carbine`}`);if(!t)return!1;let n=!0;return t.traverse(e=>{e instanceof U&&e.userData.presentationOnly!==!0&&(n=!1)}),n})()})),remotes:wg.size,remotePlayers:[...wg.values()].map(e=>({id:e.snapshot.id,stance:e.snapshot.stance??`stand`,position:e.target.toArray()})),grenades:Eg.length,activeImpactParticles:xg.activeParticles(),activeImpactMarks:xg.activeMarks(),activeTracers:Sg.activeCount(),originalArtLoaded:vg.getObjectByName(`original-arena-art`)!==void 0,weaponReady:E_.isReady(),weaponPresentation:E_.presentationState(),weaponActionHistory:[...kg],menuVisible:!sg.classList.contains(`hidden`),render:{calls:_g.info.render.calls,triangles:_g.info.render.triangles,points:_g.info.render.points,lines:_g.info.render.lines,sceneObjects:vg.children.length,reducedMode:gg}}),startSolo:()=>{T_.close(),Fv(),K_(`solo`,!1)},setBotsFrozen:e=>{m_=e},setRenderPaused:e=>{Zg=e},openMenu:()=>{x_(),sg.classList.remove(`hidden`)},fireOnce:()=>{h_=!0,Mg=!0,Z_(performance.now()),Mg=!1,h_=!1},throwGrenade:()=>cv(),switchWeapon:e=>J_(e),reload:()=>Y_(),melee:()=>sv(),setAds:e=>{g_=e,e_=e},setStance:e=>{e!==$.stance&&W_(e===`stand`?`stand`:e===`prone`?`toggle-prone`:`toggle-crouch`)},damage:e=>{$.invulnerableUntil=0,z_(e,Tg.keys().next().value??$.id)}};function Rv(e,t){let n=new Set;e.traverse(e=>{if(!(e instanceof U)||t.getObjectById(e.id))return;let r=Array.isArray(e.material)?e.material:[e.material];for(let e of r){if(n.has(e)||!(e instanceof W))continue;n.add(e);let{r:t,g:r,b:i}=e.color;Math.max(t,r,i)<.16&&e.color.lerp(new H(5989988),.24)}})}async function zv(){let e=Z(`#solo`),t=Z(`#host`),n=Z(`#join`);e.disabled=!0,t.disabled=!0,n.disabled=!0,S_(`Loading authored arena art, weapons and advanced collision…`);let r=Kh.create(Q.colliders,Q.bounds),i=E_.load((e,t)=>{S_(`Loading authored weapons ${e}/${t}…`)}),a=wp(vg,(e,t)=>{S_(`Loading authored arena models ${e}/${t}…`)},gg),[o,,s]=await Promise.all([r,i,a]);__=o;let c=Q.raycastMeshes.filter(e=>e.visible||e.userData.collisionProxy===!0);Q.raycastMeshes.splice(0,Q.raycastMeshes.length,...c),s.root.traverse(e=>{e instanceof U&&e.userData.blocksShots===!0&&Q.raycastMeshes.push(e)});let l=vg.getObjectByName(`Atomic Acres arena`);l&&Wd(l,vg,()=>``,gg),Wd(s.root,vg,()=>``,gg),Rv(vg,E_.root),E_.setWeapon($.weapon,!0),G_(),E_.root.visible=!1,yg.position.set(0,30,-22),yg.lookAt(0,.8,4),yg.fov=65,yg.updateProjectionMatrix(),e.disabled=!1,t.disabled=!w_,n.disabled=!w_,S_(`Pass 06 ready — procedural atmosphere, tuned controller look and tactical one-bot routing active.`),requestAnimationFrame(Iv)}zv().catch(C_);