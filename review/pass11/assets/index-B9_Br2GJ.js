...
s=-\r
t=0 0\r
`},n.getDirection=function(e,t){let r=n.splitLines(e);for(let e=0;e<r.length;e++)switch(r[e]){case`a=sendrecv`:case`a=sendonly`:case`a=recvonly`:case`a=inactive`:return r[e].substring(2);default:}return t?n.getDirection(t):`sendrecv`},n.getKind=function(e){return n.splitLines(e)[0].split(` `)[0].substring(2)},n.isRejected=function(e){return e.split(` `,2)[1]===`0`},n.parseMLine=function(e){let t=n.splitLines(e)[0].substring(2).split(` `);return{kind:t[0],port:parseInt(t[1],10),protocol:t[2],fmt:t.slice(3).join(` `)}},n.parseOLine=function(e){let t=n.matchPrefix(e,`o=`)[0].substring(2).split(` `);return{username:t[0],sessionId:t[1],sessionVersion:parseInt(t[2],10),netType:t[3],addressType:t[4],address:t[5]}},n.isValidSDP=function(e){if(typeof e!=`string`||e.length===0)return!1;let t=n.splitLines(e);for(let e=0;e<t.length;e++)if(t[e].length<2||t[e].charAt(1)!==`=`)return!1;return!0},typeof t==`object`&&(t.exports=n)})),Vm=s({removeExtmapAllowMixed:()=>Jm,shimAddIceCandidateNullOrEmpty:()=>Ym,shimConnectionState:()=>qm,shimMaxMessageSize:()=>Gm,shimParameterlessSetLocalDescription:()=>Xm,shimRTCIceCandidate:()=>Um,shimRTCIceCandidateRelayProtocol:()=>Wm,shimSendThrowTypeError:()=>Km}),Hm=l(Bm());function Um(e){if(!e.RTCIceCandidate||e.RTCIceCandidate&&`foundation`in e.RTCIceCandidate.prototype)return;let t=e.RTCIceCandidate;e.RTCIceCandidate=function(e){if(typeof e==`object`&&e.candidate&&e.candidate.indexOf(`a=`)===0&&(e=JSON.parse(JSON.stringify(e)),e.candidate=e.candidate.substring(2)),e.candidate&&e.candidate.length){let n=new t(e),r=Hm.default.parseCandidate(e.candidate);for(let e in r)e in n||Object.defineProperty(n,e,{value:r[e]});return n.toJSON=function(){return{candidate:n.candidate,sdpMid:n.sdpMid,sdpMLineIndex:n.sdpMLineIndex,usernameFragment:n.usernameFragment}},n}return new t(e)},e.RTCIceCandidate.prototype=t.prototype,Yp(e,`icecandidate`,t=>(t.candidate&&Object.defineProperty(t,"candidate",{value:new e.RTCIceCandidate(t.candidate),writable:`false`}),t))}function Wm(e){!e.RTCIceCandidate||e.RTCIceCandidate&&`relayProtocol`in e.RTCIceCandidate.prototype||Yp(e,`icecandidate`,e=>{if(e.candidate){let t=Hm.default.parseCandidate(e.candidate.candidate);t.type===`relay`&&(e.candidate.relayProtocol={0:`tls`,1:`tcp`,2:`udp`}[t.priority>>24])}return e})}function Gm(e,t){if(!e.RTCPeerConnection||t.browser===`chrome`&&t.version>102||t.browser===`firefox`&&t.version>=113)return;`sctp`in e.RTCPeerConnection.prototype||Object.defineProperty(e.RTCPeerConnection.prototype,"sctp",{get(){return this._sctp===void 0?null:this._sctp}});let n=function(e){if(!e||!e.sdp)return!1;let t=Hm.default.splitSections(e.sdp);return t.shift(),t.some(e=>{let t=Hm.default.parseMLine(e);return t&&t.kind===`application`&&t.protocol.indexOf(`SCTP`)!==-1})},r=function(e){let t=e.sdp.match(/mozilla...THIS_IS_SDPARTA-(\d+)/);if(t===null||t.length<2)return-1;let n=parseInt(t[1],10);return n===n?n:-1},i=function(e){let n=65536;return t.browser===`firefox`&&(n=t.version<57?e===-1?16384:2147483637:t.version<60?t.version===57?65535:65536:2147483637),n},a=function(e,n){let r=65536;t.browser===`firefox`&&t.version===57&&(r=65535);let i=Hm.default.matchPrefix(e.sdp,`a=max-message-size:`);return i.length>0?r=parseInt(i[0].substring(19),10):t.browser===`firefox`&&n!==-1&&(r=2147483637),r},o=e.RTCPeerConnection.prototype.setRemoteDescription;e.RTCPeerConnection.prototype.setRemoteDescription=function(){if(this._sctp=null,t.browser===`chrome`&&t.version>=76){let{sdpSemantics:e}=this.getConfiguration();e===`plan-b`&&Object.defineProperty(this,"sctp",{get(){return this._sctp===void 0?null:this._sctp},enumerable:!0,configurable:!0})}if(n(arguments[0])){let e=r(arguments[0]),t=i(e),n=a(arguments[0],e),o;o=t===0&&n===0?1/0:t===0||n===0?Math.max(t,n):Math.min(t,n);let s={};Object.defineProperty(s,"maxMessageSize",{get(){return o}}),this._sctp=s}return o.apply(this,arguments)}}function Km(e,t){if(!(e.RTCPeerConnection&&`createDataChannel`in e.RTCPeerConnection.prototype)||t.browser===`chrome`&&t.version>=149||t.browser===`firefox`&&t.version>60)return;function n(e,t){let n=e.send;e.send=function(){let r=arguments[0],i=r.length||r.size||r.byteLength;if(e.readyState===`open`&&t.sctp&&i>t.sctp.maxMessageSize)throw TypeError(`Message too large (can send a maximum of `+t.sctp.maxMessageSize+` bytes)`);return n.apply(e,arguments)}}let r=e.RTCPeerConnection.prototype.createDataChannel;e.RTCPeerConnection.prototype.createDataChannel=function(){let e=r.apply(this,arguments);return n(e,this),e},Yp(e,`datachannel`,e=>(n(e.channel,e.target),e))}function qm(e){if(!e.RTCPeerConnection||`connectionState`in e.RTCPeerConnection.prototype)return;let t=e.RTCPeerConnection.prototype;Object.defineProperty(t,"connectionState",{get(){return{completed:`connected`,checking:`connecting`}[this.iceConnectionState]||this.iceConnectionState},enumerable:!0,configurable:!0}),Object.defineProperty(t,"onconnectionstatechange",{get(){return this._onconnectionstatechange||null},set(e){this._onconnectionstatechange&&(this.removeEventListener(`connectionstatechange`,this._onconnectionstatechange),delete this._onconnectionstatechange),e&&this.addEventListener(`connectionstatechange`,this._onconnectionstatechange=e)},enumerable:!0,configurable:!0}),[`setLocalDescription`,`setRemoteDescription`].forEach(e=>{let n=t[e];t[e]=function(){return this._connectionstatechangepoly||(this._connectionstatechangepoly=e=>{let t=e.target;if(t._lastConnectionState!==t.connectionState){t._lastConnectionState=t.connectionState;let n=new Event(`connectionstatechange`,e);t.dispatchEvent(n)}return e},this.addEventListener(`iceconnectionstatechange`,this._connectionstatechangepoly)),n.apply(this,arguments)}})}function Jm(e,t){if(!e.RTCPeerConnection||t.browser===`chrome`&&t.version>=71||t.browser===`safari`&&t._safariVersion>=13.1)return;let n=e.RTCPeerConnection.prototype.setRemoteDescription;e.RTCPeerConnection.prototype.setRemoteDescription=function(t){if(t&&t.sdp&&t.sdp.indexOf(`
a=extmap-allow-mixed`)!==-1){let n=t.sdp.split(`
`).filter(e=>e.trim()!==`a=extmap-allow-mixed`).join(`
`);e.RTCSessionDescription&&t instanceof e.RTCSessionDescription?arguments[0]=new e.RTCSessionDescription({type:t.type,sdp:n}):t.sdp=n}return n.apply(this,arguments)}}function Ym(e,t){if(!(e.RTCPeerConnection&&e.RTCPeerConnection.prototype))return;let n=e.RTCPeerConnection.prototype.addIceCandidate;!n||n.length===0||(e.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?(t.browser===`chrome`&&t.version<78||t.browser===`firefox`&&t.version<68||t.browser===`safari`)&&arguments[0]&&arguments[0].candidate===``?Promise.resolve():n.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())})}function Xm(e,t){if(!(e.RTCPeerConnection&&e.RTCPeerConnection.prototype))return;let n=e.RTCPeerConnection.prototype.setLocalDescription;!n||n.length===0||(e.RTCPeerConnection.prototype.setLocalDescription=function(){let e=arguments[0]||{};if(typeof e!=`object`||e.type&&e.sdp)return n.apply(this,arguments);if(e={type:e.type,sdp:e.sdp},!e.type)switch(this.signalingState){case`stable`:case`have-local-offer`:case`have-remote-pranswer`:e.type=`offer`;break;default:e.type=`answer`;break}return e.sdp||e.type!==`offer`&&e.type!==`answer`?n.apply(this,[e]):(e.type===`offer`?this.createOffer:this.createAnswer).apply(this).then(e=>n.apply(this,[e]))})}function Zm({window:e}={},t={shimChrome:!0,shimFirefox:!0,shimSafari:!0}){let n=Qp,r=em(e),i={browserDetails:r,commonShim:Vm,extractVersion:Jp,disableLog:Xp,disableWarnings:Zp,sdp:Hm};switch(r.browser){case`chrome`:if(!sm||!mm||!t.shimChrome)return n(`Chrome shim is not included in this adapter release.`),i;if(r.version===null)return n(`Chrome shim can not determine version, not shimming.`),i;n(`adapter.js shimming chrome.`),i.browserShim=sm,Ym(e,r),Xm(e,r),om(e,r),cm(e,r),mm(e,r),lm(e,r),pm(e,r),um(e,r),dm(e,r),hm(e,r),Um(e,r),Wm(e,r),qm(e,r),Gm(e,r),Km(e,r),Jm(e,r);break;case`firefox`:if(!vm||!bm||!t.shimFirefox)return n(`Firefox shim is not included in this adapter release.`),i;n(`adapter.js shimming firefox.`),i.browserShim=vm,Ym(e,r),Xm(e,r),gm(e,r),bm(e,r),xm(e,r),ym(e,r),wm(e,r),Sm(e,r),Cm(e,r),Tm(e,r),Em(e,r),Dm(e,r),Om(e,r),km(e,r),Um(e,r),qm(e,r),Gm(e,r),Km(e,r);break;case`safari`:if(!Am||!t.shimSafari)return n(`Safari shim is not included in this adapter release.`),i;n(`adapter.js shimming safari.`),i.browserShim=Am,Ym(e,r),Xm(e,r),Im(e,r),Rm(e,r),Nm(e,r),jm(e,r),Mm(e,r),Lm(e,r),Pm(e,r),zm(e,r),Um(e,r),Wm(e,r),Gm(e,r),Km(e,r),Jm(e,r);break;default:n(`Unsupported browser!`);break}return i}var Qm=Zm({window:typeof window>`u`?void 0:window});function $m(e,t,n,r){Object.defineProperty(e,t,{get:n,set:r,enumerable:!0,configurable:!0})}var eh=class{constructor(){this.chunkedMTU=16300,this._dataCount=1,this.chunk=e=>{let t=[],n=e.byteLength,r=Math.ceil(n/this.chunkedMTU),i=0,a=0;for(;a<n;){let o=Math.min(n,a+this.chunkedMTU),s=e.slice(a,o),c={__peerData:this._dataCount,n:i,data:s,total:r};t.push(c),a=o,i++}return this._dataCount++,t}}};function th(e){let t=0;for(let n of e)t+=n.byteLength;let n=new Uint8Array(t),r=0;for(let t of e)n.set(t,r),r+=t.byteLength;return n}var nh=Qm.default||Qm,rh=new class{isWebRTCSupported(){return typeof RTCPeerConnection<`u`}isBrowserSupported(){let e=this.getBrowser(),t=this.getVersion();return this.supportedBrowsers.includes(e)?e===`chrome`?t>=this.minChromeVersion:e===`firefox`?t>=this.minFirefoxVersion:e===`safari`?!this.isIOS&&t>=this.minSafariVersion:!1:!1}getBrowser(){return nh.browserDetails.browser}getVersion(){return nh.browserDetails.version||0}isUnifiedPlanSupported(){let e=this.getBrowser(),t=nh.browserDetails.version||0;if(e===`chrome`&&t<this.minChromeVersion)return!1;if(e===`firefox`&&t>=this.minFirefoxVersion)return!0;if(!window.RTCRtpTransceiver||!(`currentDirection`in RTCRtpTransceiver.prototype))return!1;let n,r=!1;try{n=new RTCPeerConnection,n.addTransceiver(`audio`),r=!0}catch{}finally{n&&n.close()}return r}toString(){return`Supports:
    browser:${this.getBrowser()}
    version:${this.getVersion()}
    isIOS:${this.isIOS}
    isWebRTCSupported:${this.isWebRTCSupported()}
    isBrowserSupported:${this.isBrowserSupported()}
    isUnifiedPlanSupported:${this.isUnifiedPlanSupported()}`}constructor(){this.isIOS=typeof navigator<`u`?[`iPad`,`iPhone`,`iPod`].includes(navigator.platform):!1,this.supportedBrowsers=[`firefox`,`chrome`,`safari`],this.minFirefoxVersion=59,this.minChromeVersion=72,this.minSafariVersion=605}},ih=e=>!e||/^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(e),ah=()=>Math.random().toString(36).slice(2),oh={iceServers:[{urls:`stun:stun.l.google.com:19302`},{urls:[`turn:eu-0.turn.peerjs.com:3478`,`turn:us-0.turn.peerjs.com:3478`],username:`peerjs`,credential:`peerjsp`}],sdpSemantics:`unified-plan`},sh=new class extends eh{noop(){}blobToArrayBuffer(e,t){let n=new FileReader;return n.onload=function(e){e.target&&t(e.target.result)},n.readAsArrayBuffer(e),n}binaryStringToArrayBuffer(e){let t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n)&255;return t.buffer}isSecure(){return location.protocol===`https:`}constructor(...e){super(...e),this.CLOUD_HOST=`0.peerjs.com`,this.CLOUD_PORT=443,this.chunkedBrowsers={Chrome:1,chrome:1},this.defaultConfig=oh,this.browser=rh.getBrowser(),this.browserVersion=rh.getVersion(),this.pack=Up,this.unpack=Hp,this.supports=function(){let e={browser:rh.isBrowserSupported(),webRTC:rh.isWebRTCSupported(),audioVideo:!1,data:!1,binaryBlob:!1,reliable:!1};if(!e.webRTC)return e;let t;try{t=new RTCPeerConnection(oh),e.audioVideo=!0;let n;try{n=t.createDataChannel(`_PEERJSTEST`,{ordered:!0}),e.data=!0,e.reliable=!!n.ordered;try{n.binaryType=`blob`,e.binaryBlob=!rh.isIOS}catch{}}catch{}finally{n&&n.close()}}catch{}finally{t&&t.close()}return e}(),this.validateId=ih,this.randomToken=ah}},ch=`PeerJS: `,X=new class{get logLevel(){return this._logLevel}set logLevel(e){this._logLevel=e}log(...e){this._logLevel>=3&&this._print(3,...e)}warn(...e){this._logLevel>=2&&this._print(2,...e)}error(...e){this._logLevel>=1&&this._print(1,...e)}setLogFunction(e){this._print=e}_print(e,...t){let n=[ch,...t];for(let e in n)n[e]instanceof Error&&(n[e]=`(`+n[e].name+`) `+n[e].message);e>=3?console.log(...n):e>=2?console.warn(`WARNING`,...n):e>=1&&console.error(`ERROR`,...n)}constructor(){this._logLevel=0}},lh={},uh=Object.prototype.hasOwnProperty,dh=`~`;function fh(){}Object.create&&(fh.prototype=Object.create(null),new fh().__proto__||(dh=!1));function ph(e,t,n){this.fn=e,this.context=t,this.once=n||!1}function mh(e,t,n,r,i){if(typeof n!=`function`)throw TypeError(`The listener must be a function`);var a=new ph(n,r||e,i),o=dh?dh+t:t;return e._events[o]?e._events[o].fn?e._events[o]=[e._events[o],a]:e._events[o].push(a):(e._events[o]=a,e._eventsCount++),e}function hh(e,t){--e._eventsCount===0?e._events=new fh:delete e._events[t]}function gh(){this._events=new fh,this._eventsCount=0}gh.prototype.eventNames=function(){var e=[],t,n;if(this._eventsCount===0)return e;for(n in t=this._events)uh.call(t,n)&&e.push(dh?n.slice(1):n);return Object.getOwnPropertySymbols?e.concat(Object.getOwnPropertySymbols(t)):e},gh.prototype.listeners=function(e){var t=dh?dh+e:e,n=this._events[t];if(!n)return[];if(n.fn)return[n.fn];for(var r=0,i=n.length,a=Array(i);r<i;r++)a[r]=n[r].fn;return a},gh.prototype.listenerCount=function(e){var t=dh?dh+e:e,n=this._events[t];return n?n.fn?1:n.length:0},gh.prototype.emit=function(e,t,n,r,i,a){var o=dh?dh+e:e;if(!this._events[o])return!1;var s=this._events[o],c=arguments.length,l,u;if(s.fn){switch(s.once&&this.removeListener(e,s.fn,void 0,!0),c){case 1:return s.fn.call(s.context),!0;case 2:return s.fn.call(s.context,t),!0;case 3:return s.fn.call(s.context,t,n),!0;case 4:return s.fn.call(s.context,t,n,r),!0;case 5:return s.fn.call(s.context,t,n,r,i),!0;case 6:return s.fn.call(s.context,t,n,r,i,a),!0}for(u=1,l=Array(c-1);u<c;u++)l[u-1]=arguments[u];s.fn.apply(s.context,l)}else{var d=s.length,f;for(u=0;u<d;u++)switch(s[u].once&&this.removeListener(e,s[u].fn,void 0,!0),c){case 1:s[u].fn.call(s[u].context);break;case 2:s[u].fn.call(s[u].context,t);break;case 3:s[u].fn.call(s[u].context,t,n);break;case 4:s[u].fn.call(s[u].context,t,n,r);break;default:if(!l)for(f=1,l=Array(c-1);f<c;f++)l[f-1]=arguments[f];s[u].fn.apply(s[u].context,l)}}return!0},gh.prototype.on=function(e,t,n){return mh(this,e,t,n,!1)},gh.prototype.once=function(e,t,n){return mh(this,e,t,n,!0)},gh.prototype.removeListener=function(e,t,n,r){var i=dh?dh+e:e;if(!this._events[i])return this;if(!t)return hh(this,i),this;var a=this._events[i];if(a.fn)a.fn===t&&(!r||a.once)&&(!n||a.context===n)&&hh(this,i);else{for(var o=0,s=[],c=a.length;o<c;o++)(a[o].fn!==t||r&&!a[o].once||n&&a[o].context!==n)&&s.push(a[o]);s.length?this._events[i]=s.length===1?s[0]:s:hh(this,i)}return this},gh.prototype.removeAllListeners=function(e){var t;return e?(t=dh?dh+e:e,this._events[t]&&hh(this,t)):(this._events=new fh,this._eventsCount=0),this},gh.prototype.off=gh.prototype.removeListener,gh.prototype.addListener=gh.prototype.on,gh.prefixed=dh,gh.EventEmitter=gh,lh=gh;var _h={};$m(_h,`ConnectionType`,()=>vh),$m(_h,`PeerErrorType`,()=>yh),$m(_h,`BaseConnectionErrorType`,()=>bh),$m(_h,`DataConnectionErrorType`,()=>xh),$m(_h,`SerializationType`,()=>Sh),$m(_h,`SocketEventType`,()=>Ch),$m(_h,`ServerMessageType`,()=>wh);var vh=function(e){return e.Data=`data`,e.Media=`media`,e}({}),yh=function(e){return e.BrowserIncompatible=`browser-incompatible`,e.Disconnected=`disconnected`,e.InvalidID=`invalid-id`,e.InvalidKey=`invalid-key`,e.Network=`network`,e.PeerUnavailable=`peer-unavailable`,e.SslUnavailable=`ssl-unavailable`,e.ServerError=`server-error`,e.SocketError=`socket-error`,e.SocketClosed=`socket-closed`,e.UnavailableID=`unavailable-id`,e.WebRTC=`webrtc`,e}({}),bh=function(e){return e.NegotiationFailed=`negotiation-failed`,e.ConnectionClosed=`connection-closed`,e}({}),xh=function(e){return e.NotOpenYet=`not-open-yet`,e.MessageToBig=`message-too-big`,e}({}),Sh=function(e){return e.Binary=`binary`,e.BinaryUTF8=`binary-utf8`,e.JSON=`json`,e.None=`raw`,e}({}),Ch=function(e){return e.Message=`message`,e.Disconnected=`disconnected`,e.Error=`error`,e.Close=`close`,e}({}),wh=function(e){return e.Heartbeat=`HEARTBEAT`,e.Candidate=`CANDIDATE`,e.Offer=`OFFER`,e.Answer=`ANSWER`,e.Open=`OPEN`,e.Error=`ERROR`,e.IdTaken=`ID-TAKEN`,e.InvalidKey=`INVALID-KEY`,e.Leave=`LEAVE`,e.Expire=`EXPIRE`,e}({}),Th=`1.5.5`,Eh=class extends lh.EventEmitter{constructor(e,t,n,r,i,a=5e3){super(),this.pingInterval=a,this._disconnected=!0,this._messagesQueue=[];let o=e?`wss://`:`ws://`;this._baseUrl=o+t+`:`+n+r+`peerjs?key=`+i}start(e,t){this._id=e;let n=`${this._baseUrl}&id=${e}&token=${t}`;this._socket||!this._disconnected||(this._socket=new WebSocket(n+`&version=1.5.5`),this._disconnected=!1,this._socket.onmessage=e=>{let t;try{t=JSON.parse(e.data),X.log(`Server message received:`,t)}catch{X.log(`Invalid server message`,e.data);return}this.emit(Ch.Message,t)},this._socket.onclose=e=>{this._disconnected||(X.log(`Socket closed.`,e),this._cleanup(),this._disconnected=!0,this.emit(Ch.Disconnected))},this._socket.onopen=()=>{this._disconnected||(this._sendQueuedMessages(),X.log(`Socket open`),this._scheduleHeartbeat())})}_scheduleHeartbeat(){this._wsPingTimer=setTimeout(()=>{this._sendHeartbeat()},this.pingInterval)}_sendHeartbeat(){if(!this._wsOpen()){X.log(`Cannot send heartbeat, because socket closed`);return}let e=JSON.stringify({type:wh.Heartbeat});this._socket.send(e),this._scheduleHeartbeat()}_wsOpen(){return!!this._socket&&this._socket.readyState===1}_sendQueuedMessages(){let e=[...this._messagesQueue];this._messagesQueue=[];for(let t of e)this.send(t)}send(e){if(this._disconnected)return;if(!this._id){this._messagesQueue.push(e);return}if(!e.type){this.emit(Ch.Error,`Invalid message`);return}if(!this._wsOpen())return;let t=JSON.stringify(e);this._socket.send(t)}close(){this._disconnected||=(this._cleanup(),!0)}_cleanup(){this._socket&&=(this._socket.onopen=this._socket.onmessage=this._socket.onclose=null,this._socket.close(),void 0),clearTimeout(this._wsPingTimer)}},Dh=class{constructor(e){this.connection=e}startConnection(e){let t=this._startPeerConnection();if(this.connection.peerConnection=t,this.connection.type===vh.Media&&e._stream&&this._addTracksToConnection(e._stream,t),e.originator){let n=this.connection,r={ordered:!!e.reliable},i=t.createDataChannel(n.label,r);n._initializeDataChannel(i),this._makeOffer()}else this.handleSDP(`OFFER`,e.sdp)}_startPeerConnection(){X.log(`Creating RTCPeerConnection.`);let e=new RTCPeerConnection(this.connection.provider.options.config);return this._setupListeners(e),e}_setupListeners(e){let t=this.connection.peer,n=this.connection.connectionId,r=this.connection.type,i=this.connection.provider;X.log(`Listening for ICE candidates.`),e.onicecandidate=e=>{!e.candidate||!e.candidate.candidate||(X.log(`Received ICE candidates for ${t}:`,e.candidate),i.socket.send({type:wh.Candidate,payload:{candidate:e.candidate,type:r,connectionId:n},dst:t}))},e.oniceconnectionstatechange=()=>{switch(e.iceConnectionState){case`failed`:X.log(`iceConnectionState is failed, closing connections to `+t),this.connection.emitError(bh.NegotiationFailed,`Negotiation of connection to `+t+` failed.`),this.connection.close();break;case`closed`:X.log(`iceConnectionState is closed, closing connections to `+t),this.connection.emitError(bh.ConnectionClosed,`Connection to `+t+` closed.`),this.connection.close();break;case`disconnected`:X.log(`iceConnectionState changed to disconnected on the connection with `+t);break;case`completed`:e.onicecandidate=()=>{};break}this.connection.emit(`iceStateChanged`,e.iceConnectionState)},X.log(`Listening for data channel`),e.ondatachannel=e=>{X.log(`Received data channel`);let r=e.channel;i.getConnection(t,n)._initializeDataChannel(r)},X.log(`Listening for remote stream`),e.ontrack=e=>{X.log(`Received remote stream`);let r=e.streams[0],a=i.getConnection(t,n);if(a.type===vh.Media){let e=a;this._addStreamToMediaConnection(r,e)}}}cleanup(){X.log(`Cleaning up PeerConnection to `+this.connection.peer);let e=this.connection.peerConnection;if(!e)return;this.connection.peerConnection=null,e.onicecandidate=e.oniceconnectionstatechange=e.ondatachannel=e.ontrack=()=>{};let t=e.signalingState!==`closed`,n=!1,r=this.connection.dataChannel;r&&(n=!!r.readyState&&r.readyState!==`closed`),(t||n)&&e.close()}async _makeOffer(){let e=this.connection.peerConnection,t=this.connection.provider;try{let n=await e.createOffer(this.connection.options.constraints);X.log(`Created offer.`),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform==`function`&&(n.sdp=this.connection.options.sdpTransform(n.sdp)||n.sdp);try{await e.setLocalDescription(n),X.log(`Set localDescription:`,n,`for:${this.connection.peer}`);let r={sdp:n,type:this.connection.type,connectionId:this.connection.connectionId,metadata:this.connection.metadata};if(this.connection.type===vh.Data){let e=this.connection;r={...r,label:e.label,reliable:e.reliable,serialization:e.serialization}}t.socket.send({type:wh.Offer,payload:r,dst:this.connection.peer})}catch(e){e!=`OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer`&&(t.emitError(yh.WebRTC,e),X.log(`Failed to setLocalDescription, `,e))}}catch(e){t.emitError(yh.WebRTC,e),X.log(`Failed to createOffer, `,e)}}async _makeAnswer(){let e=this.connection.peerConnection,t=this.connection.provider;try{let n=await e.createAnswer();X.log(`Created answer.`),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform==`function`&&(n.sdp=this.connection.options.sdpTransform(n.sdp)||n.sdp);try{await e.setLocalDescription(n),X.log(`Set localDescription:`,n,`for:${this.connection.peer}`),t.socket.send({type:wh.Answer,payload:{sdp:n,type:this.connection.type,connectionId:this.connection.connectionId},dst:this.connection.peer})}catch(e){t.emitError(yh.WebRTC,e),X.log(`Failed to setLocalDescription, `,e)}}catch(e){t.emitError(yh.WebRTC,e),X.log(`Failed to create answer, `,e)}}async handleSDP(e,t){t=new RTCSessionDescription(t);let n=this.connection.peerConnection,r=this.connection.provider;X.log(`Setting remote description`,t);let i=this;try{await n.setRemoteDescription(t),X.log(`Set remoteDescription:${e} for:${this.connection.peer}`),e===`OFFER`&&await i._makeAnswer()}catch(e){r.emitError(yh.WebRTC,e),X.log(`Failed to setRemoteDescription, `,e)}}async handleCandidate(e){X.log(`handleCandidate:`,e);try{await this.connection.peerConnection.addIceCandidate(e),X.log(`Added ICE candidate for:${this.connection.peer}`)}catch(e){this.connection.provider.emitError(yh.WebRTC,e),X.log(`Failed to handleCandidate, `,e)}}_addTracksToConnection(e,t){if(X.log(`add tracks from stream ${e.id} to peer connection`),!t.addTrack)return X.error(`Your browser does't support RTCPeerConnection#addTrack. Ignored.`);e.getTracks().forEach(n=>{t.addTrack(n,e)})}_addStreamToMediaConnection(e,t){X.log(`add stream ${e.id} to media connection ${t.connectionId}`),t.addStream(e)}},Oh=class extends lh.EventEmitter{emitError(e,t){X.error(`Error:`,t),this.emit(`error`,new kh(`${e}`,t))}},kh=class extends Error{constructor(e,t){typeof t==`string`?super(t):(super(),Object.assign(this,t)),this.type=e}},Ah=class extends Oh{get open(){return this._open}constructor(e,t,n){super(),this.peer=e,this.provider=t,this.options=n,this._open=!1,this.metadata=n.metadata}},jh=class e extends Ah{static#e=this.ID_PREFIX=`mc_`;get type(){return vh.Media}get localStream(){return this._localStream}get remoteStream(){return this._remoteStream}constructor(t,n,r){super(t,n,r),this._localStream=this.options._stream,this.connectionId=this.options.connectionId||e.ID_PREFIX+sh.randomToken(),this._negotiator=new Dh(this),this._localStream&&this._negotiator.startConnection({_stream:this._localStream,originator:!0})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{X.log(`DC#${this.connectionId} dc connection success`),this.emit(`willCloseOnRemote`)},this.dataChannel.onclose=()=>{X.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}addStream(e){X.log(`Receiving stream`,e),this._remoteStream=e,super.emit(`stream`,e)}handleMessage(e){let t=e.type,n=e.payload;switch(e.type){case wh.Answer:this._negotiator.handleSDP(t,n.sdp),this._open=!0;break;case wh.Candidate:this._negotiator.handleCandidate(n.candidate);break;default:X.warn(`Unrecognized message type:${t} from peer:${this.peer}`);break}}answer(e,t={}){if(this._localStream){X.warn(`Local stream already exists on this MediaConnection. Are you answering a call twice?`);return}this._localStream=e,t&&t.sdpTransform&&(this.options.sdpTransform=t.sdpTransform),this._negotiator.startConnection({...this.options._payload,_stream:e});let n=this.provider._getMessages(this.connectionId);for(let e of n)this.handleMessage(e);this._open=!0}close(){this._negotiator&&=(this._negotiator.cleanup(),null),this._localStream=null,this._remoteStream=null,this.provider&&=(this.provider._removeConnection(this),null),this.options&&this.options._stream&&(this.options._stream=null),this.open&&(this._open=!1,super.emit(`close`))}},Mh=class{constructor(e){this._options=e}_buildRequest(e){let t=this._options.secure?`https`:`http`,{host:n,port:r,path:i,key:a}=this._options,o=new URL(`${t}://${n}:${r}${i}${a}/${e}`);return o.searchParams.set(`ts`,`${Date.now()}${Math.random()}`),o.searchParams.set(`version`,Th),fetch(o.href,{referrerPolicy:this._options.referrerPolicy})}async retrieveId(){try{let e=await this._buildRequest(`id`);if(e.status!==200)throw Error(`Error. Status:${e.status}`);return e.text()}catch(e){X.error(`Error retrieving ID`,e);let t=``;throw this._options.path===`/`&&this._options.host!==sh.CLOUD_HOST&&(t=" If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."),Error(`Could not get an ID from the server.`+t)}}async listAllPeers(){try{let e=await this._buildRequest(`peers`);if(e.status!==200){if(e.status===401){let e=``;throw e=this._options.host===sh.CLOUD_HOST?`It looks like you're using the cloud server. You can email team@peerjs.com to enable peer listing for your API key.`:"You need to enable `allow_discovery` on your self-hosted PeerServer to use this feature.",Error(`It doesn't look like you have permission to list peers IDs. `+e)}throw Error(`Error. Status:${e.status}`)}return e.json()}catch(e){throw X.error(`Error retrieving list peers`,e),Error(`Could not get list peers from the server.`+e)}}},Nh=class e extends Ah{static#e=this.ID_PREFIX=`dc_`;static#t=this.MAX_BUFFERED_AMOUNT=8388608;get type(){return vh.Data}constructor(t,n,r){super(t,n,r),this.connectionId=this.options.connectionId||e.ID_PREFIX+ah(),this.label=this.options.label||this.connectionId,this.reliable=!!this.options.reliable,this._negotiator=new Dh(this),this._negotiator.startConnection(this.options._payload||{originator:!0,reliable:this.reliable})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{X.log(`DC#${this.connectionId} dc connection success`),this._open=!0,this.emit(`open`)},this.dataChannel.onmessage=e=>{X.log(`DC#${this.connectionId} dc onmessage:`,e.data)},this.dataChannel.onclose=()=>{X.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}close(e){if(e?.flush){this.send({__peerData:{type:`close`}});return}this._negotiator&&=(this._negotiator.cleanup(),null),this.provider&&=(this.provider._removeConnection(this),null),this.dataChannel&&=(this.dataChannel.onopen=null,this.dataChannel.onmessage=null,this.dataChannel.onclose=null,null),this.open&&(this._open=!1,super.emit(`close`))}send(e,t=!1){if(!this.open){this.emitError(xh.NotOpenYet,"Connection is not open. You should listen for the `open` event before sending messages.");return}return this._send(e,t)}async handleMessage(e){let t=e.payload;switch(e.type){case wh.Answer:await this._negotiator.handleSDP(e.type,t.sdp);break;case wh.Candidate:await this._negotiator.handleCandidate(t.candidate);break;default:X.warn(`Unrecognized message type:`,e.type,`from peer:`,this.peer);break}}},Ph=class extends Nh{get bufferSize(){return this._bufferSize}_initializeDataChannel(e){super._initializeDataChannel(e),this.dataChannel.binaryType=`arraybuffer`,this.dataChannel.addEventListener(`message`,e=>this._handleDataMessage(e))}_bufferedSend(e){(this._buffering||!this._trySend(e))&&(this._buffer.push(e),this._bufferSize=this._buffer.length)}_trySend(e){if(!this.open)return!1;if(this.dataChannel.bufferedAmount>Nh.MAX_BUFFERED_AMOUNT)return this._buffering=!0,setTimeout(()=>{this._buffering=!1,this._tryBuffer()},50),!1;try{this.dataChannel.send(e)}catch(e){return X.error(`DC#:${this.connectionId} Error when sending:`,e),this._buffering=!0,this.close(),!1}return!0}_tryBuffer(){if(!this.open||this._buffer.length===0)return;let e=this._buffer[0];this._trySend(e)&&(this._buffer.shift(),this._bufferSize=this._buffer.length,this._tryBuffer())}close(e){if(e?.flush){this.send({__peerData:{type:`close`}});return}this._buffer=[],this._bufferSize=0,super.close()}constructor(...e){super(...e),this._buffer=[],this._bufferSize=0,this._buffering=!1}},Fh=class extends Ph{close(e){super.close(e),this._chunkedData={}}constructor(e,t,n){super(e,t,n),this.chunker=new eh,this.serialization=Sh.Binary,this._chunkedData={}}_handleDataMessage({data:e}){let t=Hp(e),n=t.__peerData;if(n){if(n.type===`close`){this.close();return}this._handleChunk(t);return}this.emit(`data`,t)}_handleChunk(e){let t=e.__peerData,n=this._chunkedData[t]||{data:[],count:0,total:e.total};if(n.data[e.n]=new Uint8Array(e.data),n.count++,this._chunkedData[t]=n,n.total===n.count){delete this._chunkedData[t];let e=th(n.data);this._handleDataMessage({data:e})}}_send(e,t){let n=Up(e);if(n instanceof Promise)return this._send_blob(n);if(!t&&n.byteLength>this.chunker.chunkedMTU){this._sendChunks(n);return}this._bufferedSend(n)}async _send_blob(e){let t=await e;if(t.byteLength>this.chunker.chunkedMTU){this._sendChunks(t);return}this._bufferedSend(t)}_sendChunks(e){let t=this.chunker.chunk(e);X.log(`DC#${this.connectionId} Try to send ${t.length} chunks...`);for(let e of t)this.send(e,!0)}},Ih=class extends Ph{_handleDataMessage({data:e}){super.emit(`data`,e)}_send(e,t){this._bufferedSend(e)}constructor(...e){super(...e),this.serialization=Sh.None}},Lh=class extends Ph{_handleDataMessage({data:e}){let t=this.parse(this.decoder.decode(e)),n=t.__peerData;if(n&&n.type===`close`){this.close();return}this.emit(`data`,t)}_send(e,t){let n=this.encoder.encode(this.stringify(e));if(n.byteLength>=sh.chunkedMTU){this.emitError(xh.MessageToBig,`Message too big for JSON channel`);return}this._bufferedSend(n)}constructor(...e){super(...e),this.serialization=Sh.JSON,this.encoder=new TextEncoder,this.decoder=new TextDecoder,this.stringify=JSON.stringify,this.parse=JSON.parse}},Rh=class e extends Oh{static#e=this.DEFAULT_KEY=`peerjs`;get id(){return this._id}get options(){return this._options}get open(){return this._open}get socket(){return this._socket}get connections(){let e=Object.create(null);for(let[t,n]of this._connections)e[t]=n;return e}get destroyed(){return this._destroyed}get disconnected(){return this._disconnected}constructor(t,n){super(),this._serializers={raw:Ih,json:Lh,binary:Fh,"binary-utf8":Fh,default:Fh},this._id=null,this._lastServerId=null,this._destroyed=!1,this._disconnected=!1,this._open=!1,this._connections=new Map,this._lostMessages=new Map;let r;if(t&&t.constructor==Object?n=t:t&&(r=t.toString()),n={debug:0,host:sh.CLOUD_HOST,port:sh.CLOUD_PORT,path:`/`,key:e.DEFAULT_KEY,token:sh.randomToken(),config:sh.defaultConfig,referrerPolicy:`strict-origin-when-cross-origin`,serializers:{},...n},this._options=n,this._serializers={...this._serializers,...this.options.serializers},this._options.host===`/`&&(this._options.host=window.location.hostname),this._options.path&&(this._options.path[0]!==`/`&&(this._options.path=`/`+this._options.path),this._options.path[this._options.path.length-1]!==`/`&&(this._options.path+=`/`)),this._options.secure===void 0&&this._options.host!==sh.CLOUD_HOST?this._options.secure=sh.isSecure():this._options.host==sh.CLOUD_HOST&&(this._options.secure=!0),this._options.logFunction&&X.setLogFunction(this._options.logFunction),X.logLevel=this._options.debug||0,this._api=new Mh(n),this._socket=this._createServerConnection(),!sh.supports.audioVideo&&!sh.supports.data){this._delayedAbort(yh.BrowserIncompatible,`The current browser does not support WebRTC`);return}if(r&&!sh.validateId(r)){this._delayedAbort(yh.InvalidID,`ID "${r}" is invalid`);return}r?this._initialize(r):this._api.retrieveId().then(e=>this._initialize(e)).catch(e=>this._abort(yh.ServerError,e))}_createServerConnection(){let e=new Eh(this._options.secure,this._options.host,this._options.port,this._options.path,this._options.key,this._options.pingInterval);return e.on(Ch.Message,e=>{this._handleMessage(e)}),e.on(Ch.Error,e=>{this._abort(yh.SocketError,e)}),e.on(Ch.Disconnected,()=>{this.disconnected||(this.emitError(yh.Network,`Lost connection to server.`),this.disconnect())}),e.on(Ch.Close,()=>{this.disconnected||this._abort(yh.SocketClosed,`Underlying socket is already closed.`)}),e}_initialize(e){this._id=e,this.socket.start(e,this._options.token)}_handleMessage(e){let t=e.type,n=e.payload,r=e.src;switch(t){case wh.Open:this._lastServerId=this.id,this._open=!0,this.emit(`open`,this.id);break;case wh.Error:this._abort(yh.ServerError,n.msg);break;case wh.IdTaken:this._abort(yh.UnavailableID,`ID "${this.id}" is taken`);break;case wh.InvalidKey:this._abort(yh.InvalidKey,`API KEY "${this._options.key}" is invalid`);break;case wh.Leave:X.log(`Received leave message from ${r}`),this._cleanupPeer(r),this._connections.delete(r);break;case wh.Expire:this.emitError(yh.PeerUnavailable,`Could not connect to peer ${r}`);break;case wh.Offer:{let e=n.connectionId,t=this.getConnection(r,e);if(t&&(t.close(),X.warn(`Offer received for existing Connection ID:${e}`)),n.type===vh.Media){let i=new jh(r,this,{connectionId:e,_payload:n,metadata:n.metadata});t=i,this._addConnection(r,t),this.emit(`call`,i)}else if(n.type===vh.Data){let i=new this._serializers[n.serialization](r,this,{connectionId:e,_payload:n,metadata:n.metadata,label:n.label,serialization:n.serialization,reliable:n.reliable});t=i,this._addConnection(r,t),this.emit(`connection`,i)}else{X.warn(`Received malformed connection type:${n.type}`);return}let i=this._getMessages(e);for(let e of i)t.handleMessage(e);break}default:{if(!n){X.warn(`You received a malformed message from ${r} of type ${t}`);return}let i=n.connectionId,a=this.getConnection(r,i);a&&a.peerConnection?a.handleMessage(e):i?this._storeMessage(i,e):X.warn(`You received an unrecognized message:`,e);break}}}_storeMessage(e,t){this._lostMessages.has(e)||this._lostMessages.set(e,[]),this._lostMessages.get(e).push(t)}_getMessages(e){let t=this._lostMessages.get(e);return t?(this._lostMessages.delete(e),t):[]}connect(e,t={}){if(t={serialization:`default`,...t},this.disconnected){X.warn(`You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect, or call reconnect on this peer if you believe its ID to still be available.`),this.emitError(yh.Disconnected,`Cannot connect to new Peer after disconnecting from server.`);return}let n=new this._serializers[t.serialization](e,this,t);return this._addConnection(e,n),n}call(e,t,n={}){if(this.disconnected){X.warn(`You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect.`),this.emitError(yh.Disconnected,`Cannot connect to new Peer after disconnecting from server.`);return}if(!t){X.error("To call a peer, you must provide a stream from your browser's `getUserMedia`.");return}let r=new jh(e,this,{...n,_stream:t});return this._addConnection(e,r),r}_addConnection(e,t){X.log(`add connection ${t.type}:${t.connectionId} to peerId:${e}`),this._connections.has(e)||this._connections.set(e,[]),this._connections.get(e).push(t)}_removeConnection(e){let t=this._connections.get(e.peer);if(t){let n=t.indexOf(e);n!==-1&&t.splice(n,1)}this._lostMessages.delete(e.connectionId)}getConnection(e,t){let n=this._connections.get(e);if(!n)return null;for(let e of n)if(e.connectionId===t)return e;return null}_delayedAbort(e,t){setTimeout(()=>{this._abort(e,t)},0)}_abort(e,t){X.error(`Aborting!`),this.emitError(e,t),this._lastServerId?this.disconnect():this.destroy()}destroy(){this.destroyed||(X.log(`Destroy peer with ID:${this.id}`),this.disconnect(),this._cleanup(),this._destroyed=!0,this.emit(`close`))}_cleanup(){for(let e of this._connections.keys())this._cleanupPeer(e),this._connections.delete(e);this.socket.removeAllListeners()}_cleanupPeer(e){let t=this._connections.get(e);if(t)for(let e of t)e.close()}disconnect(){if(this.disconnected)return;let e=this.id;X.log(`Disconnect peer with ID:${e}`),this._disconnected=!0,this._open=!1,this.socket.close(),this._lastServerId=e,this._id=null,this.emit(`disconnected`,e)}reconnect(){if(this.disconnected&&!this.destroyed)X.log(`Attempting reconnection to server with ID ${this._lastServerId}`),this._disconnected=!1,this._initialize(this._lastServerId);else if(this.destroyed)throw Error(`This peer cannot reconnect to the server. It has already been destroyed.`);else if(!this.disconnected&&!this.open)X.error(`In a hurry? We're still trying to make the initial connection!`);else throw Error(`Peer ${this.id} cannot reconnect because it is not disconnected from the server!`)}listAllPeers(e=e=>{}){this._api.listAllPeers().then(t=>e(t)).catch(e=>this._abort(yh.ServerError,e))}},zh=new Set([`carbine`,`smg`,`scattergun`]);function Bh(e){if(!e||typeof e!=`object`)return!1;let t=e;return typeof t.id==`string`&&t.id.length>0&&t.id.length<=80&&typeof t.name==`string`&&t.name.length>0&&t.name.length<=20&&(t.team===0||t.team===1)&&[`x`,`y`,`z`,`yaw`,`pitch`,`hp`,`kills`,`deaths`,`seq`].every(e=>Number.isFinite(t[e]))&&(t.stance===void 0||t.stance===`stand`||t.stance===`crouch`||t.stance===`prone`)&&zh.has(t.weapon)}function Vh(e){if(!e||typeof e!=`object`)return!1;let t=e;switch(t.type){case`join`:case`state`:return Bh(t.player);case`shot`:return typeof t.by==`string`&&zh.has(t.weapon)&&Array.isArray(t.origin)&&t.origin.length===3&&t.origin.every(Number.isFinite)&&Array.isArray(t.direction)&&t.direction.length===3&&t.direction.every(Number.isFinite)&&Number.isFinite(t.nonce);case`hit`:return typeof t.by==`string`&&typeof t.target==`string`&&Number.isFinite(t.damage)&&Number(t.damage)>0&&Number(t.damage)<=100&&Number.isFinite(t.nonce);case`death`:return typeof t.killer==`string`&&typeof t.victim==`string`&&Number.isFinite(t.nonce);case`leave`:return typeof t.playerId==`string`;case`chat`:return typeof t.by==`string`&&typeof t.text==`string`&&t.text.length<=160;default:return!1}}function Hh(e,t){if(!t)return!1;switch(e.type){case`join`:case`state`:return e.player.id===t;case`shot`:case`hit`:case`chat`:return e.by===t;case`death`:return e.victim===t;case`leave`:return e.playerId===t}}function Uh(e){return e.replace(/[^a-zA-Z0-9 _-]/g,``).trim().slice(0,16)||`Player${Math.floor(Math.random()*900+100)}`}var Wh=class{role=`offline`;roomCode=``;peer=null;hostConnection=null;guests=new Set;onMessage;onStatus;onReady=null;constructor(e,t){this.onMessage=e,this.onStatus=t}host(e){this.close(),this.role=`host`,this.onReady=e,this.onStatus(`Opening a secure peer lobby…`);let t=new Rh;this.peer=t,t.on(`open`,t=>{this.roomCode=t,this.onStatus(`Lobby ready — share the room code`,`ok`),e()}),t.on(`connection`,e=>this.wireGuest(e)),t.on(`error`,e=>this.onStatus(this.describeError(e),`error`)),t.on(`disconnected`,()=>this.onStatus(`Signalling disconnected; existing peers may continue`,`warn`))}join(e,t){if(this.close(),this.role=`client`,this.roomCode=e.trim(),this.onReady=t,!this.roomCode){this.onStatus(`Enter a room code first`,`error`);return}this.onStatus(`Connecting to peer lobby…`);let n=new Rh;this.peer=n,n.on(`open`,()=>{let e=n.connect(this.roomCode,{reliable:!0,serialization:`json`});this.hostConnection=e,this.wireHost(e)}),n.on(`error`,e=>this.onStatus(this.describeError(e),`error`)),n.on(`disconnected`,()=>this.onStatus(`Signalling disconnected; attempting to preserve session`,`warn`))}send(e){Vh(e)&&(this.role===`host`?this.broadcast(e):this.role===`client`&&this.hostConnection?.open&&this.hostConnection.send(e))}close(){if(this.hostConnection)try{this.hostConnection.close()}catch{}for(let e of this.guests)try{e.close()}catch{}if(this.guests.clear(),this.hostConnection=null,this.peer)try{this.peer.destroy()}catch{}this.peer=null,this.roomCode=``,this.role=`offline`,this.onReady=null}wireGuest(e){this.guests.add(e);let t=``;e.on(`open`,()=>this.onStatus(`${this.guests.size} guest connection${this.guests.size===1?``:`s`}`,`ok`)),e.on(`data`,n=>{if(Vh(n)){if(!t){if(n.type!==`join`)return;t=n.player.id}Hh(n,t)&&(this.onMessage(n),this.broadcast(n,e))}}),e.on(`close`,()=>{if(this.guests.delete(e),t){let e={type:`leave`,playerId:t};this.onMessage(e),this.broadcast(e)}this.onStatus(`A guest left the lobby`,`warn`)}),e.on(`error`,()=>this.onStatus(`Guest data channel failed`,`error`))}wireHost(e){e.on(`open`,()=>{this.onStatus(`Connected to host`,`ok`),this.onReady?.()}),e.on(`data`,e=>{Vh(e)&&this.onMessage(e)}),e.on(`close`,()=>this.onStatus(`Host connection closed`,`error`)),e.on(`error`,()=>this.onStatus(`Could not establish peer data channel`,`error`))}broadcast(e,t){for(let n of this.guests)n!==t&&n.open&&n.send(e)}describeError(e){let t=e instanceof Error?e.message:String(e);return/peer-unavailable/i.test(t)?`Room not found. Check the code and try again.`:/network|server/i.test(t)?`Peer signalling is unavailable. Check the connection and retry.`:`Network error: ${t.slice(0,120)}`}};function Gh(){return{lastAcceptedAt:-1e4,recentNonces:[]}}function Kh(e,t,n,r){let i=e=>({accepted:!1,reason:e,nextState:r});if(!t||t.id!==e.by)return i(`unknown-sender`);if(t.weapon!==e.weapon)return i(`weapon-mismatch`);if(r.recentNonces.includes(e.nonce))return i(`duplicate`);let a=Math.hypot(...e.direction);if(!Number.isFinite(a)||a<.96||a>1.04)return i(`invalid-direction`);let o=Math.hypot(e.origin[0]-t.x,e.origin[1]-t.y,e.origin[2]-t.z);if(!Number.isFinite(o)||o>2.25)return i(`origin-mismatch`);let s=6e4/Uf[e.weapon].rpm;return n-r.lastAcceptedAt<s*.45?i(`cadence`):{accepted:!0,reason:`accepted`,nextState:{lastAcceptedAt:n,recentNonces:[...r.recentNonces.slice(-15),e.nonce]}}}var qh=`modulepreload`,Jh=function(e,t){return new URL(e,t).href},Yh={},Xh=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,new URL(`../../../src/node/plugins/importAnalysisBuild.ts`,import.meta.url)).href}r=o(t.map(t=>{if(t=Jh(t,n),t=s(t),t in Yh)return;Yh[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:qh,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},Zh=.38,Qh=.53,$h={stand:{halfHeight:Qh,radius:Zh,eyeFromCenter:.79},crouch:{halfHeight:.22,radius:.36,eyeFromCenter:.58},prone:{halfHeight:.04,radius:.31,eyeFromCenter:.15}},eg=class e{makeCapsule;world;body;collider;controller;stance=`stand`;constructor(e,t,n,r){this.makeCapsule=r,this.world=e,this.body=t,this.collider=n,this.controller=e.createCharacterController(.025),this.controller.setSlideEnabled(!0),this.controller.enableAutostep(.42,.22,!1),this.controller.enableSnapToGround(.24),this.controller.setMaxSlopeClimbAngle(50*Math.PI/180),this.controller.setMinSlopeSlideAngle(55*Math.PI/180)}static async create(t,n){let{default:r}=await Xh(async()=>{let{default:e}=await import(`./rapier-B45baom8.js`);return{default:e}},[],import.meta.url),i=console.warn;console.warn=(...e)=>{e.length===1&&e[0]===`using deprecated parameters for the initialization function; pass a single object instead`||i(...e)};try{await r.init()}finally{console.warn=i}let a=new r.World({x:0,y:-22,z:0});a.timestep=1/120,a.createCollider(r.ColliderDesc.cuboid((n.maxX-n.minX)/2,.1,(n.maxZ-n.minZ)/2).setTranslation((n.minX+n.maxX)/2,-.1,(n.minZ+n.maxZ)/2));for(let e of t){let t=e.minY??0,n=e.maxY??8,i=Math.max(.01,(e.maxX-e.minX)/2),o=Math.max(.01,(n-t)/2),s=Math.max(.01,(e.maxZ-e.minZ)/2);a.createCollider(r.ColliderDesc.cuboid(i,o,s).setTranslation((e.minX+e.maxX)/2,(t+n)/2,(e.minZ+e.maxZ)/2))}let o=a.createRigidBody(r.RigidBodyDesc.kinematicPositionBased()),s=a.createCollider(r.ColliderDesc.capsule(Qh,Zh).setFriction(0).setActiveCollisionTypes(r.ActiveCollisionTypes.ALL),o),c=new e(a,o,s,(e,t)=>new r.Capsule(e,t));return c.teleportEye({x:0,y:1.7,z:0}),c}teleportEye(e){let t=$h[this.stance].eyeFromCenter;this.body.setTranslation({x:e.x,y:e.y-t,z:e.z},!0),this.world.propagateModifiedBodyPositionsToColliders()}eyePosition(){let e=this.body.translation();return{x:e.x,y:e.y+$h[this.stance].eyeFromCenter,z:e.z}}setStance(e){if(e===this.stance)return!0;let t=$h[this.stance],n=$h[e],r=this.body.translation(),i=t.halfHeight+t.radius,a=n.halfHeight+n.radius,o=r.y-i,s={x:r.x,y:o+a,z:r.z},c=this.makeCapsule(n.halfHeight,n.radius);if(a>i){let e=!1;if(this.world.intersectionsWithShape(s,{x:0,y:0,z:0,w:1},c,()=>(e=!0,!1),void 0,void 0,this.collider),e)return!1}return this.collider.setShape(c),this.body.setTranslation(s,!0),this.world.propagateModifiedBodyPositionsToColliders(),this.stance=e,e===`prone`?this.controller.disableAutostep():this.controller.enableAutostep(.42,.22,!1),!0}currentStance(){return this.stance}move(e,t){this.world.timestep=t,this.controller.computeColliderMovement(this.collider,e);let n=this.controller.computedMovement(),r=this.body.translation();this.body.setNextKinematicTranslation({x:r.x+n.x,y:r.y+n.y,z:r.z+n.z}),this.world.step();let i=this.eyePosition(),a=5e-4;return{position:i,grounded:this.controller.computedGrounded(),blockedX:Math.abs(n.x-e.x)>a,blockedY:Math.abs(n.y-e.y)>a,blockedZ:Math.abs(n.z-e.z)>a,appliedDelta:{x:n.x,y:n.y,z:n.z}}}dispose(){this.world.free()}},tg=class{lines;positions=new Float32Array(108);colors=new Float32Array(108);life=new Float32Array(18);cursor=0;constructor(e){let t=new Vr;t.setAttribute(`position`,new Er(this.positions,3)),t.setAttribute(`color`,new Er(this.colors,3));let n=new Yi({vertexColors:!0,transparent:!0,opacity:.72,depthWrite:!1,blending:2});this.lines=new sa(t,n),this.lines.name=`pooled-combat-tracers`,this.lines.frustumCulled=!1,this.lines.visible=!1,e.add(this.lines)}emit(e,t,n,r=.055){if(![e.x,e.y,e.z,t.x,t.y,t.z,r].every(Number.isFinite))return;let i=this.cursor++%18,a=i*6;this.positions.set([e.x,e.y,e.z,t.x,t.y,t.z],a);let o=new H(n);this.colors.set([o.r,o.g,o.b,o.r,o.g,o.b],a),this.life[i]=Bt.clamp(r,.016,.12),this.lines.visible=!0,this.markDirty()}update(e){let t=!1;for(let n=0;n<18;n+=1)this.life[n]<=0||(this.life[n]-=Math.max(0,e),this.life[n]<=0&&(this.positions.fill(0,n*6,n*6+6),t=!0));t&&this.markDirty(),this.lines.visible=this.activeCount()>0}activeCount(){return this.life.reduce((e,t)=>e+Number(t>0),0)}markDirty(){this.lines.geometry.getAttribute(`position`).needsUpdate=!0,this.lines.geometry.getAttribute(`color`).needsUpdate=!0}};function ng(e,t,n,r,i){let a=t.clone().sub(e),o=a.length(),s=o>1e-6?a.multiplyScalar(1/o):new z(0,0,-1),c=Math.abs(n-r)+1e-4,l=n+r-1e-4,u=Bt.clamp(o,c,l),d=(n*n-r*r+u*u)/(2*u),f=Math.sqrt(Math.max(0,n*n-d*d)),p=i.clone().sub(s.clone().multiplyScalar(i.dot(s)));return p.lengthSq()<1e-6&&p.crossVectors(s,Math.abs(s.y)<.9?new z(0,1,0):new z(1,0,0)),p.normalize(),e.clone().addScaledVector(s,d).addScaledVector(p,f)}var rg=[{at:.12,event:`mag-release`},{at:.28,event:`mag-out`},{at:.66,event:`mag-in`},{at:.8,event:`mag-seat`},{at:.9,event:`bolt-release`}],ig=[{at:.2,event:`shell-insert`},{at:.39,event:`shell-insert`},{at:.58,event:`shell-insert`},{at:.77,event:`shell-insert`},{at:.91,event:`bolt-release`}],ag=e=>Math.min(1,Math.max(0,e)),og=(e,t,n)=>{let r=ag((n-e)/Math.max(1e-4,t-e));return r*r*(3-2*r)};function sg(e,t,n){let r=ag(t),i=ag(n);return i<=r?[]:(e===`scattergun`?ig:rg).filter(({at:e})=>e>r&&e<=i).map(({event:e})=>e)}function cg(e,t){let n=ag(t);if(e===`scattergun`){let e=n*5%1,t=n>=.1&&n<=.82;return{magazineDrop:0,magazineTwist:0,magazineForward:0,magazineLateral:0,handToReload:og(.05,.16,n)*(1-og(.82,.94,n)),shellVisible:t&&e>.12&&e<.78,shellTravel:t?og(.15,.72,e):0,actionPull:og(.86,.91,n)*(1-og(.91,.98,n))}}let r=og(.1,.34,n),i=og(.56,.81,n),a=r*(1-i);return{magazineDrop:a*.52+i*(1-og(.78,.84,n))*.04,magazineTwist:a*.24,magazineForward:a*(e===`carbine`?.17:.1),magazineLateral:a*(e===`carbine`?-.075:-.045),handToReload:og(.06,.2,n)*(1-og(.82,.94,n)),shellVisible:!1,shellTravel:0,actionPull:og(.84,.9,n)*(1-og(.9,.98,n))}}var lg={carbine:{sightHeight:.215,adsX:-.36,adsY:.251,adsZ:-.04,projectionCorrection:0,flashScale:1,recoilTranslation:.13,recoilRotation:.18,actionTravel:.075,smokeBase:1,requiredDetails:[`optic-lens`,`optic-reticle`,`stock-cheek-rest`,`charging-handle`,`magazine-rib`]},smg:{sightHeight:.24,adsX:-.36,adsY:.135,adsZ:-.025,projectionCorrection:.101,flashScale:.78,recoilTranslation:.095,recoilRotation:.135,actionTravel:.09,smokeBase:1,requiredDetails:[`smg-aperture`,`smg-front-post`,`magazine-witness`,`muzzle-brake`,`charging-tab`]},scattergun:{sightHeight:.2,adsX:-.36,adsY:.159,adsZ:.015,projectionCorrection:.101,flashScale:1.45,recoilTranslation:.19,recoilRotation:.24,actionTravel:.22,smokeBase:3,requiredDetails:[`ghost-ring`,`front-bead`,`loading-port`,`shell-saddle`,`pump-rib`]}};function ug(e){return lg[e]}var dg=class{camera;flattenMaterials;root=new Rn;models=new Map;active=`carbine`;recoil=0;reloadStart=0;reloadDuration=0;reloadLastProgress=0;switchBlend=1;swayX=0;swayY=0;meleeStart=0;grenadeStart=0;muzzleLight;muzzleFlash;casings=[];smokes=[];smokePositions=new Float32Array(24);smokeColors=new Float32Array(24);smokePoints;armRigs=[];brassGeometry=new Ca(.018,.018,.085,7);shellGeometry=new Ca(.025,.025,.105,8);brassMaterial=new W({color:13149788,roughness:.3,metalness:.78});shellMaterial=new W({color:11812658,roughness:.58,metalness:.18});shotStarted=-1e4;casingCursor=0;smokeCursor=0;pendingScattergunShell=!1;pendingCasing=!1;adsBlend=0;sprintBlend=0;weaponHeat=0;shotsPresented=0;constructor(e,t=!1){this.camera=e,this.flattenMaterials=t,this.root.name=`original-weapon-view`,this.root.position.set(.36,-.38,-.78),this.root.scale.setScalar(.6),e.add(this.root);let n=new W({color:3232847,roughness:.84}),r=new W({color:12162623,roughness:.62,metalness:.12}),i=new W({color:2436398,roughness:.88}),a=new Rn;a.name=`first-person-arms`;let o=e=>{let a=e===`left`?-1:1,o=.56,s=.58,c=new Rn;c.name=`${e}-shoulder-joint`,c.position.set(a*.25,e===`right`?-.17:-.12,e===`right`?.52:.45);let l=new U(new xa(.095,o-.19,5,9),n);l.name=`${e}-upper-arm`,l.rotation.x=-Math.PI/2,l.position.z=-.56/2,l.castShadow=!0,c.add(l);let u=new Rn;u.name=`${e}-elbow-joint`,u.position.z=-.56,c.add(u);let d=new U(new xa(.09,s-.18,5,9),n);d.name=`${e}-forearm`,d.rotation.x=-Math.PI/2,d.position.z=-.58/2,d.castShadow=!0,u.add(d);let f=q(`${e}-glove-cuff`,[.205,.195,.14],r,.045,2);f.position.z=-.505,u.add(f);let p=q(`${e}-glove`,[.18,.155,.235],i,.055,3);p.position.set(a*-.015,-.01,-.635),p.rotation.x=-.12,u.add(p);let m=q(`${e}-thumb`,[.075,.1,.17],i,.028,2);m.position.set(a*-.105,-.04,-.615),m.rotation.z=a*.32,u.add(m);let h=t?1:3;for(let t=0;t<h;t+=1){let n=q(`${e}-finger-${t}`,[.036,.025,.14],i,.01,1);n.position.set(a*(.052-t*.052),-.09,-.6799999999999999),n.rotation.x=-.18,u.add(n)}let g=q(`${e}-sleeve-band`,[.202,.202,.055],r,.016,2);return g.position.z=-.56*.72,c.add(g),this.armRigs.push({side:e,shoulder:c,elbow:u,upperLength:o,lowerLength:s}),c};a.add(o(`right`),o(`left`)),a.scale.setScalar(.74),a.position.set(0,-.08,.02),this.root.add(a),this.muzzleLight=new Hs(16761706,0,4.5,2),this.muzzleLight.position.set(0,.08,-1.15),t||this.root.add(this.muzzleLight),this.muzzleFlash=new Rn,this.muzzleFlash.position.set(0,.08,-1.15);let s=new _i({color:16765834,transparent:!0,opacity:.92,depthWrite:!1,blending:2,side:2}),c=new U(new wa(.06,.46,7),s);c.name=`muzzle-flash-core`,c.rotation.x=-Math.PI/2,c.position.z=-.22;let l=new U(new wa(.14,.24,6),s.clone());l.name=`muzzle-flash-crown`,l.rotation.x=-Math.PI/2,l.position.z=-.1;let u=new U(new Ho(.38,.38),s.clone());u.name=`muzzle-flash-flare`,u.rotation.z=Math.PI/4,this.muzzleFlash.add(c,l,u),this.muzzleFlash.visible=!1,this.root.add(this.muzzleFlash);let d=new Vr;this.smokePositions.fill(0);for(let e=0;e<8;e+=1)this.smokePositions[e*3+1]=-1e4;d.setAttribute(`position`,new Er(this.smokePositions,3)),d.setAttribute(`color`,new Er(this.smokeColors,3)),this.smokePoints=new pa(d,new ca({size:t?.045:.075,vertexColors:!0,transparent:!0,opacity:.58,depthWrite:!1,sizeAttenuation:!0})),this.smokePoints.name=`pooled-muzzle-smoke`,this.smokePoints.visible=!1,this.smokePoints.frustumCulled=!1,this.root.add(this.smokePoints);for(let e=0;e<8;e+=1)this.smokes.push({velocity:new z,life:0,maxLife:0,active:!1});for(let e=0;e<16;e+=1){let t=new U(this.brassGeometry,this.brassMaterial);t.name=`pooled-casing-${e}`,t.visible=!1,t.rotation.z=Math.PI/2,this.root.add(t),this.casings.push({mesh:t,velocity:new z,life:0,active:!1})}}async load(e){let t=[`carbine`,`smg`,`scattergun`];t.forEach((n,r)=>{let i=Jd(n,this.flattenMaterials);if(n===`carbine`){i.traverse(e=>{(e.name===`stock-shoulder-pad`||e.name===`stock-cheek-rest`||e.name===`stock-support-rod`)&&(e.visible=!1)});let e=i.getObjectByName(`optic-reticle`);e instanceof U&&e.material instanceof _i&&(e.material=e.material.clone(),e.material.depthTest=!1,e.material.depthWrite=!1,e.renderOrder=1e3)}i.visible=!1,this.models.set(n,i),this.root.add(i),e?.(r+1,t.length)}),this.setWeapon(this.active,!0)}isReady(){return this.models.size===3}setWeapon(e,t=!1){this.active=e,this.switchBlend=+!!t,this.reloadDuration=0,this.reloadLastProgress=0,this.pendingScattergunShell=!1,this.pendingCasing=!1;for(let[t,n]of this.models)n.visible=t===e;let n=this.models.get(e)?.getObjectByName(`muzzle-socket`);n&&(this.muzzleLight.position.copy(n.position),this.muzzleFlash.position.copy(n.position))}ejectCasing(e){let t=this.casings[this.casingCursor++%this.casings.length];t.mesh.geometry=e?this.shellGeometry:this.brassGeometry,t.mesh.material=e?this.shellMaterial:this.brassMaterial;let n=this.models.get(this.active)?.getObjectByName(`eject-socket`);t.mesh.position.copy(n?.position??new z(.12,.04,-.48)),t.mesh.rotation.set(Math.random()*.4,0,Math.PI/2),t.mesh.visible=!0,t.velocity.set(e?.72:.95+Math.random()*.25,e?.55:.75+Math.random()*.2,e?.16:.1),t.life=e?.62:.42,t.active=!0}fire(e){let t=ug(this.active);this.weaponHeat=Rd(this.weaponHeat,!0,0,this.active),this.shotsPresented+=1,this.recoil=Math.min(1,this.recoil+.24+e*5.2),this.shotStarted=performance.now(),this.muzzleLight.intensity=this.flattenMaterials?0:this.active===`scattergun`?7.2:4.8,this.muzzleFlash.visible=!0,this.muzzleFlash.scale.setScalar(t.flashScale),this.muzzleFlash.rotation.z=Math.random()*Math.PI;let n=this.models.get(this.active)?.getObjectByName(`muzzle-socket`),r=Math.min(this.smokes.length,t.smokeBase+ +(this.weaponHeat>.56)),i=zd(this.active,0,this.weaponHeat);for(let e=0;e<r;e+=1){let t=this.smokeCursor++%this.smokes.length,r=this.smokes[t],a=t*3,o=n?.position??new z(0,.08,-1.15);this.smokePositions[a]=o.x+(Math.random()-.5)*.025,this.smokePositions[a+1]=o.y+(Math.random()-.5)*.02,this.smokePositions[a+2]=o.z-.05-e*.035,r.velocity.set((Math.random()-.5)*.055*i.smokeScale,(.1+Math.random()*.06)*i.smokeScale,(-.11-Math.random()*.08)*i.smokeScale),r.maxLife=this.active===`scattergun`?.38:.2+this.weaponHeat*.12,r.life=r.maxLife,r.active=!0,this.smokeColors[a]=this.smokeColors[a+1]=this.smokeColors[a+2]=.62}this.smokePoints.visible=!0,this.smokePoints.geometry.getAttribute(`position`).needsUpdate=!0,this.smokePoints.geometry.getAttribute(`color`).needsUpdate=!0,this.active===`scattergun`?this.pendingScattergunShell=!0:this.pendingCasing=!0}reload(e){this.reloadStart=performance.now(),this.reloadDuration=e*1e3,this.reloadLastProgress=0}cancelReload(){this.reloadDuration=0,this.reloadLastProgress=0}melee(){this.meleeStart=performance.now()}throwGrenade(){this.grenadeStart=performance.now()}addMouseDelta(e,t){this.swayX=Bt.clamp(this.swayX+e*8e-5,-.025,.025),this.swayY=Bt.clamp(this.swayY+t*6e-5,-.02,.02)}muzzleWorldPosition(e=new z){let t=this.models.get(this.active)?.getObjectByName(`muzzle-socket`);return t?t.getWorldPosition(e):null}adsProgress(){return this.adsBlend}presentationState(){let e=this.models.get(this.active),t=ug(this.active).requiredDetails,n=this.active===`carbine`?`optic-reticle`:this.active===`smg`?`smg-aperture`:`ghost-ring`,r=e?.getObjectByName(n);this.camera.updateMatrixWorld(!0),r?.updateWorldMatrix(!0,!1);let i=r?.getWorldPosition(new z).project(this.camera);return{weapon:this.active,heat:this.weaponHeat,shotsPresented:this.shotsPresented,activeCasings:this.casings.filter(e=>e.active).length,activeSmoke:this.smokes.reduce((e,t)=>e+Number(t.active),0),detailsReady:t.every(t=>e?.getObjectByName(t)!==void 0),adsProgress:this.adsBlend,sightOffset:i?[i.x,i.y]:null}}solveArms(e,t,n){if(t){this.root.updateMatrixWorld(!0);for(let r of this.armRigs){let i=r.side===`right`?`grip-socket-r`:`support-socket-l`,a=t.getObjectByName(i);if(!a)continue;let o=a.getWorldPosition(new z);if(r.side===`left`&&n.handToReload>0){let e=t.getObjectByName(`reload-socket-l`);e&&o.lerp(e.getWorldPosition(new z),n.handToReload)}let s=e.worldToLocal(o.clone()),c=new z(r.side===`left`?-.48:.48,-1,.22),l=ng(r.shoulder.position,s,r.upperLength,r.lowerLength,c).sub(r.shoulder.position).normalize();r.shoulder.quaternion.setFromUnitVectors(new z(0,0,-1),l),r.elbow.position.set(0,0,-r.upperLength),r.shoulder.updateWorldMatrix(!0,!0);let u=r.shoulder.worldToLocal(o.clone()).sub(r.elbow.position).normalize();r.elbow.quaternion.setFromUnitVectors(new z(0,0,-1),u)}}}update(e){let t=[],n=t=>1-Math.exp(-t*e.dt);this.weaponHeat=Rd(this.weaponHeat,!1,e.dt,this.active),this.recoil=Bt.lerp(this.recoil,0,n(16)),this.muzzleLight.intensity=Bt.lerp(this.muzzleLight.intensity,0,n(30)),this.switchBlend=Bt.lerp(this.switchBlend,1,n(10)),this.swayX=Bt.lerp(this.swayX,0,n(7)),this.swayY=Bt.lerp(this.swayY,0,n(7)),this.adsBlend=Bt.lerp(this.adsBlend,+!!e.ads,n(e.ads?18:15)),this.sprintBlend=Bt.lerp(this.sprintBlend,+!!e.sprinting,n(13)),this.muzzleFlash.visible=this.muzzleLight.intensity>.45;let r=this.root.getObjectByName(`first-person-arms`);r&&(r.position.y=Bt.lerp(-.08,-.3,this.adsBlend));for(let t of this.casings)t.active&&(t.life-=e.dt,t.velocity.y-=4.5*e.dt,t.mesh.position.addScaledVector(t.velocity,e.dt),t.mesh.rotation.x+=e.dt*18,t.mesh.rotation.z+=e.dt*11,t.life<=0&&(t.active=!1,t.mesh.visible=!1));let i=0;for(let t=0;t<this.smokes.length;t+=1){let n=this.smokes[t];if(!n.active)continue;let r=t*3;if(n.life-=e.dt,n.life<=0){n.active=!1,this.smokePositions[r+1]=-1e4,this.smokeColors[r]=this.smokeColors[r+1]=this.smokeColors[r+2]=0;continue}i+=1,this.smokePositions[r]+=n.velocity.x*e.dt,this.smokePositions[r+1]+=n.velocity.y*e.dt,this.smokePositions[r+2]+=n.velocity.z*e.dt;let a=Math.min(1,n.life/Math.max(.001,n.maxLife)*1.7)*.62;this.smokeColors[r]=this.smokeColors[r+1]=this.smokeColors[r+2]=a}this.smokePoints.visible=i>0,i>0&&(this.smokePoints.geometry.getAttribute(`position`).needsUpdate=!0,this.smokePoints.geometry.getAttribute(`color`).needsUpdate=!0);let a=this.models.get(this.active),o=ug(this.active),s=performance.now()-this.shotStarted,c=zd(this.active,s,this.weaponHeat);this.muzzleFlash.visible=c.flash>.015,this.muzzleFlash.visible&&this.muzzleFlash.scale.setScalar(o.flashScale*(.72+c.flash*.38)),this.active===`scattergun`&&this.pendingScattergunShell&&c.casingReady?(this.ejectCasing(!0),this.pendingScattergunShell=!1):this.active!==`scattergun`&&this.pendingCasing&&c.casingReady&&(this.ejectCasing(!1),this.pendingCasing=!1);let l=a?.getObjectByName(`bolt-or-slide`);if(l){let e=Number(l.userData.restZ??0);l.position.z=e+c.boltTravel*o.actionTravel}let u=a?.getObjectByName(`pump`);if(u){let e=Number(u.userData.restZ??-.48);u.position.z=e+c.boltTravel*o.actionTravel}let d=e.moving?e.sprinting?1.22:e.ads||e.prone?.12:e.crouched?.32:.56:.05,f=Math.cos(e.phase*.5)*.017*d,p=Math.sin(e.phase)*.019*d,m=Math.sin(performance.now()*.0017)*(e.ads?.0015:.0045),h=this.adsBlend*o.adsX,g=this.adsBlend*o.adsY,_=this.adsBlend*o.adsZ,v=this.sprintBlend*-.16,y=1-this.adsBlend,b=e.crouched?.035*y:0,x=e.prone?.018*y:0,S=(1-this.switchBlend)*-.34,C=0,w=0,T=0;if(this.reloadDuration>0){T=Bt.clamp((performance.now()-this.reloadStart)/this.reloadDuration,0,1),t.push(...sg(this.active,this.reloadLastProgress,T)),this.reloadLastProgress=T;let e=Math.sin(Math.PI*T),n=T>.65?Math.sin((T-.65)/.35*Math.PI):0;C=e*.78-n*.12,w=e*-.22+n*.035,T>=1&&(this.reloadDuration=0,this.reloadLastProgress=0)}let E=cg(this.active,T),D=a?.getObjectByName(this.active===`carbine`?`curved-magazine`:`straight-magazine`);D&&(D.userData.restY===void 0&&(D.userData.restX=D.position.x,D.userData.restY=D.position.y,D.userData.restZ=D.position.z,D.userData.restRotationZ=D.rotation.z),D.position.x=Number(D.userData.restX)+E.magazineLateral,D.position.y=Number(D.userData.restY)-E.magazineDrop,D.position.z=Number(D.userData.restZ)+E.magazineForward,D.rotation.z=Number(D.userData.restRotationZ)+E.magazineTwist);let ee=a?.getObjectByName(`reload-shell`);if(ee&&(ee.visible=E.shellVisible,ee.position.set(-.16+E.shellTravel*.13,-.13+E.shellTravel*.035,-.02)),u&&E.actionPull>0){let e=Number(u.userData.restZ??-.48);u.position.z=e+E.actionPull*.16}if(l&&E.actionPull>0){let e=Number(l.userData.restZ??0);l.position.z=e+E.actionPull*(this.active===`smg`?.1:.12)}let te=Bt.clamp((performance.now()-this.meleeStart)/430,0,1),O=this.meleeStart>0&&te<1?Math.sin(te*Math.PI):0,ne=Bt.clamp((performance.now()-this.grenadeStart)/620,0,1),re=this.grenadeStart>0&&ne<1?Math.sin(ne*Math.PI):0,k=new z(.36+h+f+this.swayX-e.lateralSpeed*.012-O*.24+re*.18,-.38+g+p+m+v+b+x+S+w-this.recoil*.08-e.landingImpulse*.075,-.78+_+this.recoil*o.recoilTranslation-O*.32+re*.24);return this.root.position.lerp(k,n(18)),this.root.rotation.x=Bt.lerp(this.root.rotation.x,this.recoil*o.recoilRotation-this.swayY-re*.42,n(22)),this.root.rotation.y=Bt.lerp(this.root.rotation.y,-this.swayX*2-this.sprintBlend*.38-O*.65,n(13)),this.root.rotation.z=Bt.lerp(this.root.rotation.z,C-this.sprintBlend*.22-e.lateralSpeed*(e.prone?.01:.025)+O*.42,n(13)),r&&this.solveArms(r,a,E),t}},fg=`atomic-acres-render-profile`,pg=new Set([`balanced`,`quality`,`compat`]);function mg(e,t){let n=new URLSearchParams(e).get(`render`);return n===`performance`?`balanced`:n&&pg.has(n)?n:t&&pg.has(t)?t:`balanced`}function hg(e){return e===`compat`?{profile:e,reducedRepresentation:!0,antialias:!1,shadows:!1,shadowMode:`off`,pixelRatioCap:.2,shadowMapSize:0}:e===`quality`?{profile:e,reducedRepresentation:!1,antialias:!0,shadows:!0,shadowMode:`dynamic`,pixelRatioCap:1.5,shadowMapSize:1024}:{profile:e,reducedRepresentation:!1,antialias:!0,shadows:!0,shadowMode:`static`,pixelRatioCap:1,shadowMapSize:1024}}window.addEventListener(`error`,e=>{console.error(`[Atomic Acres runtime error]`,e.message||`unknown error`,e.error?.stack||``)}),window.addEventListener(`unhandledrejection`,e=>{let t=e.reason instanceof Error?`${e.reason.message}\n${e.reason.stack??``}`:String(e.reason);console.error(`[Atomic Acres unhandled rejection]`,t)});var gg=[`carbine`,`smg`,`scattergun`],_g=df.map(([e,t])=>new z(e,0,t));function vg(){return typeof globalThis.crypto?.randomUUID==`function`?globalThis.crypto.randomUUID():`player-${Date.now().toString(36)}-${Math.random().toString(36).slice(2,10)}`}var yg=document.querySelector(`#app`);if(!yg)throw Error(`Missing #app root`);yg.innerHTML=`
...
`;function Z(e){let t=document.querySelector(e);if(!t)throw Error(`Missing element ${e}`);return t}var bg=Z(`#game`),xg=Z(`#menu`),Sg=Z(`#hud`),Cg=Z(`#room-card`),wg=Z(`#room-code`),Tg=Z(`#network-status`),Eg=Z(`#minimap`),Dg=Eg.getContext(`2d`);if(!Dg)throw Error(`Canvas2D minimap is unavailable`);var Og=Dg,kg=new kf,Ag=mg(window.location.search,localStorage.getItem(fg)),jg=hg(Ag),Mg=jg.reducedRepresentation;document.documentElement.classList.toggle(`compat-render`,Mg),document.documentElement.dataset.renderProfile=Ag;var Ng=new Ad({canvas:bg,antialias:jg.antialias,powerPreference:`high-performance`});Ng.outputColorSpace=Ze,Ng.shadowMap.enabled=jg.shadows,Ng.shadowMap.type=1,Ng.shadowMap.autoUpdate=jg.shadowMode===`dynamic`,Ng.shadowMap.needsUpdate=jg.shadowMode===`static`,Ng.toneMapping=4,Ng.toneMappingExposure=1.14,Ng.setPixelRatio(Math.min(window.devicePixelRatio,jg.pixelRatioCap));var Pg=new qn;Pg.fog=new Kn(11978177,70,142);var Fg=new Bs(76,1,.08,180);Fg.rotation.order=`YXZ`,Pg.add(Fg);function Ig(){let e=new U(new Go(150,Mg?20:32,Mg?12:18),new ts({side:1,depthWrite:!1,fog:!1,uniforms:{top:{value:new H(2382722)},horizon:{value:new H(12177869)},bottom:{value:new H(14862750)},sunColor:{value:new H(16765850)},cloudColor:{value:new H(15265511)},sunDirection:{value:new z(-.39,.83,.42).normalize()},cloudStrength:{value:Mg?0:.035}},vertexShader:`
    ...
    `}));e.name=`procedural-atmosphere-sky`,e.frustumCulled=!1,e.onBeforeRender=()=>e.position.copy(Fg.position),Pg.add(e),Pg.add(new Os(14479359,5070918,1.48)),Pg.add(new Ks(13095892,.38));let t=new Gs(16767397,2.8);t.position.set(-32,68,34),t.castShadow=jg.shadows,jg.shadows&&t.shadow.mapSize.set(jg.shadowMapSize,jg.shadowMapSize),t.shadow.camera.left=-48,t.shadow.camera.right=48,t.shadow.camera.top=54,t.shadow.camera.bottom=-54,t.shadow.camera.near=10,t.shadow.camera.far=150,t.shadow.bias=-28e-5,t.shadow.normalBias=.025,Pg.add(t)}Ig();var Q=fp(Pg),Lg=new Lp(Pg,Mg),Rg=new tg(Pg),zg=null,$={id:vg(),name:`Player`,team:0,position:new z,velocity:new z,yaw:0,pitch:0,hp:100,kills:0,deaths:0,weapon:`carbine`,ammo:{carbine:Uf.carbine.mag,smg:Uf.smg.mag,scattergun:Uf.scattergun.mag},reserve:{carbine:Uf.carbine.reserve,smg:Uf.smg.reserve,scattergun:Uf.scattergun.reserve},reloadState:null,switchingUntil:0,lastShotAt:0,nextShotAt:0,sustainedShots:0,stance:`stand`,grenades:1,lastMeleeAt:-1e4,alive:!0,invulnerableUntil:0,seq:0},Bg=new Set,Vg=new Map,Hg=new Map,Ug=[],Wg=new Set,Gg=new Map,Kg=[],qg=!1,Jg=`solo`,Yg=!1,Xg=0,Zg=0,Qg=0,$g={pitch:0,yaw:0},e_=0,t_=0,n_=0,r_=0,i_=!1,a_=0,o_=0,s_=0,c_=0,l_=-1e4,u_=-1e4,d_={distance:0,side:0},f_=performance.now(),p_=0,m_=new URLSearchParams(window.location.search).get(`renderPaused`)===`1`,h_=lp(performance.now()),g_=!1,__=0,v_=[0,0],y_=!1,b_=!1,x_=!1,S_={x:0,y:0},C_={yaw:0,pitch:0},w_=!1,T_=!0,E_=!0,D_=[],O_=!1,k_=!1,A_=1,j_=1,M_=82,N_=!1,P_=!1,F_=null,I_=null;function L_(){return qg&&$.alive&&h_.phase===`active`&&xg.classList.contains(`hidden`)}function R_(){return qg&&$.alive&&h_.phase!==`ended`&&xg.classList.contains(`hidden`)}function z_(e=!1,t=performance.now()){if(!$.reloadState){G_.cancelReload();return}(e||np($.reloadState,t))&&($.reloadState=null,G_.cancelReload())}function B_(){z_(!1),Bg.clear(),S_={x:0,y:0},C_={yaw:0,pitch:0},w_=!1,b_=!1,x_=!1,Yg=!1,y_=!1,i_=!1,l_=-1e4,$.velocity.x=0,$.velocity.z=0}function V_(e,t=`ok`){Tg.textContent=e,Tg.dataset.kind=t}function H_(e){let t=e instanceof Error?e.message:String(e);Yg=!1,V_(`Game paused: ${t}`,`error`),xg.classList.remove(`hidden`);let n=Z(`#banner`);n.innerHTML=`<strong>SYSTEM PAUSED</strong><span>Reload the page to re-enter the test block.</span>`,n.hidden=!1,console.error(`[Atomic Acres fatal]`,e)}var U_=typeof window.RTCPeerConnection==`function`;U_?typeof bg.requestPointerLock!=`function`&&V_(`Pointer lock is unavailable; keyboard movement works but mouse aim may not.`,`warn`):(Z(`#host`).disabled=!0,Z(`#join`).disabled=!0,V_(`This browser lacks WebRTC; solo training is still available.`,`warn`)),bg.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),H_(Error(`Graphics context was lost`))}),bg.addEventListener(`webglcontextrestored`,()=>window.location.reload());var W_=new Wh(ev,V_),G_=new dg(Fg,Mg),K_=Df(localStorage.getItem(Tf));function q_(e){document.querySelectorAll(`[data-menu-tab]`).forEach(t=>{let n=t.dataset.menuTab===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-selected`,String(n))}),document.querySelectorAll(`[data-menu-panel]`).forEach(t=>{let n=t.dataset.menuPanel===e;t.classList.toggle(`active`,n),t.hidden=!n})}function J_(){let e=Ef(K_),t=qg&&$.weapon!==e.weapon;Z(`#selected-kit-summary`).innerHTML=`<span>${t?`QUEUED NEXT DEPLOYMENT`:`ACTIVE FIELD KIT`}</span><strong>${e.title}</strong><b>${Uf[e.weapon].name}</b>`,document.querySelectorAll(`[data-kit-id]`).forEach(e=>{let t=e.dataset.kitId===K_;e.classList.toggle(`selected`,t),e.setAttribute(`aria-pressed`,String(t))})}function Y_(e){K_=Ef(e).id,localStorage.setItem(Tf,Of(K_)),qg||($.weapon=Ef(K_).weapon,G_.setWeapon($.weapon,!0)),J_()}document.querySelectorAll(`[data-menu-tab]`).forEach(e=>{e.addEventListener(`click`,()=>q_(e.dataset.menuTab))}),document.querySelectorAll(`[data-kit-id]`).forEach(e=>{e.addEventListener(`click`,()=>Y_(e.dataset.kitId??`balanced`))}),$.weapon=Ef(K_).weapon,J_();var X_=new Hs(14938623,1.35,5);X_.position.set(0,.4,.2),Fg.add(X_);function Z_(e){return e===`prone`?.5:e===`crouch`?1.16:1.7}function Q_(e){let t=new Rn;t.name=`remote-player-world`,t.rotation.order=`YXZ`,t.userData.playerId=e.id;let n=af(e.team,`remote-player-model`,Mg,e.weapon);n.userData.playerId=e.id,n.traverse(n=>{n.userData.playerId=e.id,n.userData.targetRoot=t}),t.userData.operator=n,t.add(n);let r=document.createElement(`canvas`);r.width=256,r.height=64;let i=r.getContext(`2d`);i.fillStyle=`rgba(10,18,22,.72)`,i.fillRect(0,0,256,64),i.fillStyle=`#f7ecd4`,i.font=`700 30px Arial`,i.textAlign=`center`,i.textBaseline=`middle`,i.fillText(e.name,128,32);let a=new ga(r);a.colorSpace=Ze;let o=new si(new qr({map:a,transparent:!0,depthTest:!0,depthWrite:!1}));return o.visible=e.team===$.team,o.position.y=2.5,o.scale.set(2.4,.6,1),t.add(o),t.position.set(e.x,e.y-Z_(e.stance),e.z),Pg.add(t),{root:t,snapshot:e,target:new z(e.x,e.y-Z_(e.stance),e.z),targetYaw:e.yaw,lastSeen:performance.now()}}function $_(){return{id:$.id,name:$.name,team:$.team,x:$.position.x,y:$.position.y,z:$.position.z,yaw:$.yaw,pitch:$.pitch,hp:$.hp,kills:$.kills,deaths:$.deaths,weapon:$.weapon,stance:$.stance,seq:++$.seq}}function ev(e){if(e.type===`join`||e.type===`state`){let t=e.player;if(t.id===$.id||!Rf(t,Q.bounds,.44))return;let n=Vg.get(t.id);n||(n=Q_(t),Vg.set(t.id,n),Fv(`${t.name} entered the test block`,t.team===0?`aqua`:`coral`),e.type===`join`&&W_.send({type:`state`,player:$_()})),t.seq>=n.snapshot.seq&&(n.snapshot=t,n.target.set(t.x,t.y-Z_(t.stance),t.z),n.targetYaw=t.yaw,n.lastSeen=performance.now(),n.root.visible=t.hp>0);return}if(e.type===`shot`){if(e.by===$.id)return;let t=Vg.get(e.by),n=Gg.get(e.by)??Gh(),r=Kh(e,t?.snapshot,performance.now(),n);if(!r.accepted)return;Gg.set(e.by,r.nextState),nv(e);return}if(e.type===`hit`&&e.target===$.id&&!Wg.has(e.nonce)){let t=Vg.get(e.by);if(!t||!Rf(t.snapshot,Q.bounds,.44))return;let n={x:t.snapshot.x,y:t.snapshot.y,z:t.snapshot.z};if(Q.colliders.some(e=>Nf(n,$.position,e)))return;Wg.add(e.nonce),iv(e.damage,e.by),tv();return}if(e.type===`death`&&!Wg.has(e.nonce)){Wg.add(e.nonce),av(e),tv();return}e.type===`leave`&&ov(e.playerId,`left the block`)}function tv(){Wg.size>512&&Wg.clear()}function nv(e){let t=new z(...e.origin);if(!Rf(t,Q.bounds,.44))return;let n=new z(...e.direction).normalize(),r=Ff(t,n,50,t.clone().addScaledVector(n,50),0,Q.colliders),i=t.clone().addScaledVector(n,r.tracerDistance),a=Vg.get(e.by)?.root.userData.operator,o=a?.getObjectByName(`muzzle-socket`)?.getWorldPosition(new z);Nv(o??t,i,Uf[e.weapon].color),a&&tf(a),r.blockedByCover&&(Mv(i,`concrete`,n.clone().multiplyScalar(-1)),kg.impact(`concrete`,i.distanceTo(Fg.position))),$.alive&&kg.nearMiss(xf($.position,t,i)),kg.shot(e.weapon,!0,t.distanceTo(Fg.position))}function rv(e){let t=Vg.get(e)?.target??Hg.get(e)?.position;if(!t||e===$.id)return;let n=t.x-$.position.x,r=t.z-$.position.z,i=Math.atan2(-n,-r),a=Z(`#damage-direction`);a.style.setProperty(`--damage-angle`,`${Bf($.yaw,i)}rad`),a.classList.remove(`pulse`),requestAnimationFrame(()=>a.classList.add(`pulse`))}function iv(e,t){let n=performance.now();if(!(!$.alive||n<$.invulnerableUntil)&&($.hp=Math.max(0,$.hp-Math.min(100,Math.max(1,e))),u_=n,kg.damage(),rv(t),Z(`#damage-flash`).classList.remove(`pulse`),requestAnimationFrame(()=>Z(`#damage-flash`).classList.add(`pulse`)),$.hp<=0)){z_(!0,n),$.alive=!1,$.deaths+=1;let e={type:`death`,killer:t,victim:$.id,nonce:fv()};W_.send(e),av(e),Z(`#respawn`).hidden=!1,__=n+1900,document.exitPointerLock(),setTimeout(uv,1900)}}function av(e){let t=e.killer===$.id?$.name:Vg.get(e.killer)?.snapshot.name??Hg.get(e.killer)?.name??`Unknown`,n=e.victim===$.id?$.name:Vg.get(e.victim)?.snapshot.name??Hg.get(e.victim)?.name??`Unknown`;e.killer===$.id&&e.victim!==$.id&&($.kills+=1,kg.kill()),Fv(`${t} eliminated ${n}`,e.killer===$.id?`gold`:void 0);let r=Vg.get(e.victim);r&&(r.root.visible=!1);let i=Hg.get(e.victim);i&&(i.root.visible=!1),Bv()}function ov(e,t){let n=Vg.get(e);n&&(Pg.remove(n.root),Vg.delete(e),Gg.delete(e),Fv(`${n.snapshot.name} ${t}`))}function sv(){let e=Q.spawns[$.team],t=Jg===`client`?Math.min(1,e.length-1):Jg===`host`?0:$.deaths%e.length,n=[...[...Vg.values()].map(e=>new z(e.snapshot.x,e.snapshot.y,e.snapshot.z)),...[...Hg.values()].filter(e=>e.alive).map(e=>e.position.clone())],r=[...[...Vg.values()].filter(e=>e.snapshot.team!==$.team&&e.snapshot.hp>0).map(e=>new z(e.snapshot.x,e.snapshot.y,e.snapshot.z)),...[...Hg.values()].filter(e=>e.team!==$.team&&e.alive).map(e=>e.position.clone().add(new z(0,1.42,0)))],i=e.map((e,t)=>({point:e,index:t})).filter(({point:e})=>{let t={x:e.x,y:0,z:e.z};return Number.isFinite(e.x)&&Number.isFinite(e.y)&&Number.isFinite(e.z)&&Rf(t,Q.bounds,.44)&&!If(t,Q.colliders,.44)});if(i.length===0)throw Error(`No valid authored player spawn for team ${$.team}`);let a=i.map(({point:e,index:i})=>{let a=r.length===0?0:Math.min(...r.map(t=>t.distanceToSquared(e))),o=r.filter(t=>!Q.colliders.some(n=>Nf(t,e,n))).length;return{point:e,index:i,score:ff({nearestThreatDistanceSq:a,visibleThreats:o,occupied:n.some(t=>t.distanceToSquared(e)<20),preferred:i===t})}});return a.sort((e,t)=>t.score-e.score||e.index-t.index),a[0].point.clone()}function cv(){try{let e=bg.requestPointerLock();e instanceof Promise&&e.catch(()=>void 0)}catch{}}function lv(e){if(!I_||!$.alive||!O_)return!1;let t=Jf($.stance,e);if(t===$.stance)return!0;let n=$.stance,r=I_.eyePosition();if(!I_.setStance(t))return V_(`Low clearance — stance change blocked.`,`warn`),!1;let i=I_.eyePosition();return n_+=r.y-i.y,$.position.set(i.x,i.y,i.z),$.stance=t,a_=performance.now()+(t===`prone`?260:n===`prone`?290:135),i_=!1,!0}function uv(e=!0){z_(!0),$.stance=`stand`,I_?.setStance(`stand`),$.position.copy(sv()),I_?.teleportEye($.position),$.velocity.set(0,0,0),$.hp=100,u_=-1e4,$.grenades=1,$.reloadState=null,$.alive=!0,__=0,$.invulnerableUntil=performance.now()+1350,$.yaw=$.team===0?Math.PI:0,$.pitch=0,$g={pitch:0,yaw:0},a_=0,o_=0,s_=0,n_=0,r_=0,l_=-1e4,d_={distance:0,side:0};let t=Ef(K_).weapon;$.weapon!==t&&($.weapon=t,$.switchingUntil=0,G_.setWeapon(t,!0)),J_(),Z(`#respawn`).hidden=!0,qg&&e&&cv(),W_.send({type:`state`,player:$_()})}function dv(e,t=!0){$.name=Uh(Z(`#player-name`).value),$.team=+(Number(Z(`#team`).value)===1),qg=!0,G_.root.visible=!0,Jg=e,N_=!1,h_=lp(performance.now()),g_=!1,v_=[0,0],__=0,xg.classList.add(`hidden`),Sg.hidden=!1,Z(`#connection-pill`).textContent=e===`solo`?`BOT SKIRMISH`:e===`host`?`HOST`:`PEER`,Z(`#room-hud`).textContent=W_.roomCode?`ROOM ${W_.roomCode.slice(0,8).toUpperCase()}`:``,uv(t),e===`solo`&&yv(),kg.unlock(),Fv(`Welcome to Atomic Acres`,`gold`),e!==`solo`&&W_.send({type:`join`,player:$_()})}function fv(){return Math.floor(performance.now()*1e3+Math.random()*1e6)}function pv(e){let t=gg[e];if(!(!t||t===$.weapon||!$.alive)){if($.reloadState){if(!np($.reloadState,performance.now()))return;$.reloadState=null,G_.cancelReload()}$.weapon=t,$.switchingUntil=performance.now()+360,$.sustainedShots=0,G_.setWeapon(t),kg.weaponSwitch()}}function mv(){if(!$.alive||h_.phase!==`active`)return;let e=Uf[$.weapon],t=$.ammo[$.weapon];$.reloadState||t>=e.mag||$.reserve[$.weapon]<=0||($.reloadState=tp(e,t,$.reserve[$.weapon],performance.now()),Kg.length=0,kg.reload(),G_.reload(e.reload),Fv(`Reloading ${e.name}`))}function hv(e){if(!$.reloadState)return;let t=rp($.reloadState,e,$.ammo[$.weapon],$.reserve[$.weapon]);t.completed&&($.ammo[$.weapon]=t.ammo,$.reserve[$.weapon]=t.reserve,$.reloadState=null,G_.cancelReload())}function gv(e){if(!$.alive||!qg||!P_&&document.pointerLockElement!==bg||h_.phase!==`active`)return;i_&&(i_=!1,o_=Math.max(o_,e+150));let t=Math.max(a_,o_);if(e<t){s_<t&&(s_=t,window.setTimeout(()=>{s_=0,Yg&&gv(performance.now())},Math.max(1,t-e+2)));return}s_=0;let n=Uf[$.weapon];if(!Yg&&n.automatic||e<$.switchingUntil)return;if($.reloadState){if(!np($.reloadState,e))return;$.reloadState=null,G_.cancelReload()}let r=6e4/n.rpm;if(e<$.nextShotAt)return;if(($.nextShotAt===0||e-$.nextShotAt>r*2)&&($.nextShotAt=e),$.nextShotAt+=r,$.ammo[$.weapon]<=0){kg.empty(),mv(),$.lastShotAt=e;return}$.sustainedShots=e-$.lastShotAt<260?$.sustainedShots+1:0,$.lastShotAt=e,--$.ammo[$.weapon];let i=Z(`#ammo`);i.classList.remove(`fired`),requestAnimationFrame(()=>i.classList.add(`fired`));let a=ap(n,$.sustainedShots,Math.random());$g.pitch=Math.min(.16,$g.pitch+a.pitch),$g.yaw=Bt.clamp($g.yaw+a.yaw,-.075,.075),Qg=Math.min(.24,Qg+a.pitch*4.2),G_.fire(a.pitch),kg.shot($.weapon);let o=Fg.getWorldPosition(new z),s=Fg.getWorldDirection(new z),c=Math.hypot($.velocity.x,$.velocity.z)>1.2,l=Qf(n,{ads:y_&&G_.adsProgress()>=.9,moving:c,crouched:$.stance===`crouch`,prone:$.stance===`prone`,sustainedShots:$.sustainedShots}),u=new Map,d=!1,f=new z(1,0,0).applyQuaternion(Fg.quaternion),p=new z(0,1,0).applyQuaternion(Fg.quaternion);for(let e=0;e<n.pellets;e+=1){let e=$f(l,Math.random(),Math.random()),t=s.clone().addScaledVector(f,e.x).addScaledVector(p,e.y).normalize(),r=_v(o,t),i=o.clone().addScaledVector(t,r.distance);if(Nv(G_.muzzleWorldPosition(new z)??o,i,n.color),!r.playerId&&!r.targetId&&r.distance<89){let e=r.impactPoint??o.clone().addScaledVector(t,r.distance),n=r.impactNormal??t.clone().multiplyScalar(-1),i=r.impactSurface??`concrete`;Mv(e,i,n),d||(d=!0,kg.impact(i,e.distanceTo(Fg.position)))}if(r.playerId){let e=r.hitZone??`body`,t=ep(n,r.distance,e),i=u.get(r.playerId);u.set(r.playerId,{damage:(i?.damage??0)+t,zone:i?.zone===`head`||e===`head`?`head`:e})}r.targetId&&Av(r.targetId)}for(let[e,t]of u){let n=Hg.get(e);if(n)Cv(n,Math.min(100,t.damage),t.zone);else{let n=Vg.get(e);if(n&&n.snapshot.team!==$.team){let r=n.root.userData.operator;r&&nf(r,t.zone);let i=fv();W_.send({type:`hit`,by:$.id,target:e,damage:Math.min(100,t.damage),nonce:i}),Pv(t.zone===`head`),kg.hit(t.zone===`head`)}}}let m={type:`shot`,by:$.id,weapon:$.weapon,origin:o.toArray(),direction:s.toArray(),nonce:fv()};W_.send(m),$.ammo[$.weapon]===0&&setTimeout(mv,120)}function _v(e,t){let n=new uc(e,t,.1,110),r=[...Vg.values()].filter(e=>e.root.visible).map(e=>e.root),i=[...Hg.values()].filter(e=>e.alive&&e.root.visible).map(e=>e.root),a=Q.targets.filter(e=>e.active).map(e=>e.root),o=n.intersectObjects([...Q.raycastMeshes,...r,...i,...a],!0)[0];if(!o)return{distance:90};let s=o.object,c,l,u,d,f=[];for(;s;)c??=s.userData.playerId,l??=s.userData.targetId,u??=s.userData.hitZone,d??=s.userData.impactSurface,s.name&&f.push(s.name),s=s.parent;let p=o.object.userData.targetRoot;l??=p?.userData.targetId;let m=o.object instanceof U?Array.isArray(o.object.material)?o.object.material[0]:o.object.material:void 0,h=m instanceof W?m.metalness:void 0,g=o.face?.normal.clone().transformDirection(o.object.matrixWorld)??t.clone().multiplyScalar(-1);return{distance:Math.min(o.distance,110),playerId:c,targetId:l,hitZone:u,impactPoint:o.point.clone(),impactNormal:g,impactSurface:yf({hint:d,name:f.join(` `),metalness:h})}}function vv(e,t){let n=Q.spawns[e],r=[...$.alive&&$.team!==e?[$.position.clone()]:[],...[...Vg.values()].filter(t=>t.snapshot.team!==e&&t.snapshot.hp>0).map(e=>new z(e.snapshot.x,e.snapshot.y,e.snapshot.z))],i=[...[...Vg.values()].map(e=>e.target.clone()),...[...Hg.values()].filter(e=>e.alive).map(e=>e.position.clone())],a=n.map((e,t)=>({candidate:e,index:t})).filter(({candidate:e})=>{let t={x:e.x,y:0,z:e.z};return Number.isFinite(e.x)&&Number.isFinite(e.z)&&Rf(t,Q.bounds,.44)&&!If(t,Q.colliders,.44)});if(a.length===0)throw Error(`No valid authored spawn for team ${e}`);let o=a.map(({candidate:e,index:a})=>{let o=r.length===0?0:Math.min(...r.map(t=>t.distanceToSquared(e))),s=r.filter(t=>!Q.colliders.some(n=>Nf(e,t,n))).length;return{candidate:e,index:a,score:ff({nearestThreatDistanceSq:o,visibleThreats:s,occupied:i.some(t=>t.distanceToSquared(e)<20),preferred:a===(t%n.length+n.length)%n.length})}});return o.sort((e,t)=>t.score-e.score||e.index-t.index),o[0].candidate}function yv(){bv();let e=+($.team===0);[`RIVET`].slice(0,1).forEach((t,n)=>{let r=`bot-${n}`,i=af(e,`bot-operator`,Mg);i.userData.playerId=r,i.traverse(e=>{e.userData.playerId=r,e.userData.targetRoot=i});let a=vv(e,n),o=new z(a.x,a.y-1.7,a.z);i.position.copy(o),Pg.add(i),Hg.set(r,{id:r,name:t,team:e,root:i,position:o,velocity:new z,hp:100,alive:!0,kills:0,deaths:0,lastShotAt:0,lastSightAt:0,hasLineOfSight:!1,sightStartedAt:0,burstShots:0,nextDecisionAt:0,strafeSign:n%2==0?1:-1,invulnerableUntil:performance.now()+1e3,respawnAt:0,waypoint:n,blockedSince:0})}),Fv(`One hostile operator entered the block`,`coral`)}function bv(){for(let e of Hg.values())Pg.remove(e.root);Hg.clear()}function xv(e){let t={x:e.position.x,y:e.position.y+1.42,z:e.position.z},n={x:$.position.x,y:$.position.y,z:$.position.z};return!Q.colliders.some(e=>Nf(t,n,e))}function Sv(e){let t={x:$.position.x,y:$.position.y,z:$.position.z};return mf(_g.map((n,r)=>{let i={x:n.x,y:1.42,z:n.z};return{index:r,distanceFromBot:n.distanceTo(e.position),distanceFromPlayer:n.distanceTo($.position),seesPlayer:$.alive&&!Q.colliders.some(e=>Nf(i,t,e))}}),e.waypoint,e.deaths+e.kills)}function Cv(e,t,n){let r=performance.now();!e.alive||r<e.invulnerableUntil||(nf(e.root,n),e.hp=Math.max(0,e.hp-t),Pv(n===`head`),kg.hit(n===`head`),!(e.hp>0)&&(e.alive=!1,e.deaths+=1,e.respawnAt=r+2200,e.root.visible=!1,$.kills+=1,kg.kill(),Fv(`${$.name} eliminated ${e.name}${n===`head`?` · HEADSHOT`:``}`,`gold`),Bv()))}function wv(e,t){let n=_f(t),r=vv(e.team,e.deaths+e.waypoint);e.position.set(r.x,r.y-1.7,r.z),e.root.position.copy(e.position),e.hp=n.health,e.alive=n.alive,e.invulnerableUntil=n.invulnerableUntil,e.lastShotAt=n.lastShotAt,e.lastSightAt=0,e.hasLineOfSight=!1,e.sightStartedAt=0,e.burstShots=0,e.nextDecisionAt=0,e.blockedSince=0,e.root.visible=!0}function Tv(e,t){if(Jg!==`solo`||h_.phase!==`active`||N_)return;let n=0;for(let r of Hg.values()){if(n+=1,!r.alive){t>=r.respawnAt&&!g_&&wv(r,t);continue}if(!Rf(r.position,Q.bounds,.44)){let e=vv(r.team,r.waypoint);r.position.set(e.x,e.y-1.7,e.z),r.root.position.copy(r.position),r.hasLineOfSight=!1,r.sightStartedAt=0,r.burstShots=0,r.blockedSince=0,r.lastSightAt=t;continue}let i=$.position.clone().setY(0).sub(r.position.clone().setY(0)),a=i.length(),o=120+n*19;if(t-r.lastSightAt>=o){r.lastSightAt=t;let e=r.hasLineOfSight;r.hasLineOfSight=$.alive&&xv(r),r.hasLineOfSight&&!e&&(r.sightStartedAt=t),r.hasLineOfSight||(e&&(r.waypoint=Sv(r)),r.sightStartedAt=0,r.burstShots=0)}let s=r.hasLineOfSight;t>=r.nextDecisionAt&&(r.strafeSign=r.strafeSign===1?-1:1,r.nextDecisionAt=t+850+n*95);let c=_g[r.waypoint%_g.length],l=c.clone().sub(r.position).setY(0),u=l.lengthSq()<5.2;u&&(r.waypoint=s?(r.waypoint+1+n)%_g.length:Sv(r));let d=gf({alive:r.alive,distanceToPlayer:a,hasLineOfSight:s,health:r.hp,now:t,lastShotAt:r.lastShotAt,waypointReached:u,random:r.strafeSign===1?.25:.75,lineOfSightSince:r.sightStartedAt,reactionDelay:650,burstShotsRemaining:r.burstShots});d.changeWaypoint&&!u&&(r.waypoint=Sv(r)),c=_g[r.waypoint%_g.length],l=c.clone().sub(r.position).setY(0);let f=s?i:l,p=f.lengthSq()>.01?f.normalize():new z(0,0,-1),m=new z(-p.z,0,p.x),h=d.movement===`advance`?p:d.movement===`retreat`?p.clone().multiplyScalar(-1):d.movement===`strafe-left`?m.clone().multiplyScalar(-1):d.movement===`strafe-right`?m:new z,g=d.movement.startsWith(`strafe`)?4.05:s?4.65:5.85,_=r.position.clone().addScaledVector(h,g*e),v=Lf(r.position,_,Q.colliders,Q.bounds,.44);if(Math.hypot(v.x-r.position.x,v.z-r.position.z)<.002&&h.lengthSq()>0){let n=r.position.clone().addScaledVector(m,r.strafeSign*g*e*1.5);v=Lf(r.position,n,Q.colliders,Q.bounds,.44),Math.hypot(v.x-r.position.x,v.z-r.position.z)<.002?r.blockedSince===0?r.blockedSince=t:t-r.blockedSince>=400&&(r.waypoint=Sv(r),r.blockedSince=0):r.blockedSince=0}else r.blockedSince=0;r.position.set(v.x,r.position.y,v.z),r.root.position.copy(r.position);let y=s?$.position:c;if(r.root.lookAt(y.x,r.position.y+1.1,y.z),rf(r.root,`stand`,h.lengthSq()>0?g:0,t*.008+n,Math.min(1,e*12)),pf(d.fire,t,r.invulnerableUntil)&&$.alive){r.burstShots<=0&&(r.burstShots=2+n%2),--r.burstShots,r.lastShotAt=t,tf(r.root);let e=r.position.clone().add(new z(0,1.42,0)),i=$.position.clone().sub(e).normalize(),o=hf(a)+r.burstShots*.006;i.x+=(Math.random()-.5)*o,i.y+=(Math.random()-.5)*o,i.z+=(Math.random()-.5)*o,i.normalize();let s=Math.min(a+2,75),c=$.stance===`prone`?.38:$.stance===`crouch`?.48:.55,l=Ff(e,i,s,$.position,c,Q.colliders),u=e.clone().addScaledVector(i,l.tracerDistance),d=r.root.getObjectByName(`muzzle-socket`)?.getWorldPosition(new z);Nv(d??e,u,Uf.carbine.color),l.blockedByCover?(Mv(u,`concrete`,i.clone().multiplyScalar(-1)),kg.impact(`concrete`,u.distanceTo($.position))):l.hitTarget||kg.nearMiss(xf($.position,e,u)),kg.shot(`carbine`,!0),l.hitTarget&&(iv(ep(Uf.carbine,a,`body`)*Hf,r.id),$.alive||(r.kills+=1,Bv()))}}}function Ev(){let e=performance.now();if(!cp(2,e,$.lastMeleeAt).hit||!$.alive||h_.phase!==`active`)return;$.lastMeleeAt=e,G_.melee(),kg.melee();let t=_v(Fg.getWorldPosition(new z),Fg.getWorldDirection(new z));if(!t.playerId||t.distance>2.25)return;let n=Hg.get(t.playerId);n?Cv(n,70,t.hitZone??`body`):Vg.has(t.playerId)&&W_.send({type:`hit`,by:$.id,target:t.playerId,damage:70,nonce:fv()})}function Dv(){if(!$.alive||$.grenades<=0||h_.phase!==`active`)return;--$.grenades,G_.throwGrenade();let e=Fg.getWorldDirection(new z),t=Fg.getWorldPosition(new z).addScaledVector(e,.7),n=new U(new Go(.16,14,10),new W({color:3424570,roughness:.55,metalness:.48}));n.position.copy(t),n.castShadow=!0,Pg.add(n),Ug.push({mesh:n,velocity:e.multiplyScalar(13).add(new z(0,5.2,0)),explodeAt:performance.now()+2300,lastBounceAt:0})}function Ov(e){let t=e.mesh.position.clone();Pg.remove(e.mesh),kg.explosion();let n=new U(new Go(1,20,14),new _i({color:16757324,transparent:!0,opacity:.72}));n.position.copy(t),n.scale.setScalar(.2),Pg.add(n);let r=new Hs(16743214,12,18,2);r.position.copy(t),Pg.add(r);let i=performance.now(),a=()=>{let e=(performance.now()-i)/420;if(e>=1){Pg.remove(n,r);return}n.scale.setScalar(.2+e*5.5),n.material.opacity=.72*(1-e),r.intensity=12*(1-e),requestAnimationFrame(a)};a();for(let e of Hg.values()){let n=e.position.clone().add(new z(0,1.1,0)),r=Q.colliders.some(e=>Nf(t,n,e))?0:sp(e.position.distanceTo(t));r>0&&Cv(e,r,`body`)}for(let e of Vg.values()){let n=e.target.clone().add(new z(0,1.1,0));if(Q.colliders.some(e=>Nf(t,n,e)))continue;let r=sp(n.distanceTo(t));r>0&&W_.send({type:`hit`,by:$.id,target:e.snapshot.id,damage:r,nonce:fv()})}let o=Q.colliders.some(e=>Nf(t,$.position,e))?0:sp($.position.distanceTo(t))*.35;o>0&&iv(o,$.id)}function kv(e,t){for(let n=Ug.length-1;n>=0;--n){let r=Ug[n];r.velocity.y-=18*e;let i=r.mesh.position.clone(),a=r.velocity.clone().multiplyScalar(e),o=Af(i,a,Q.colliders);if(o){let e=new z(o.normal.x,o.normal.y,o.normal.z);r.mesh.position.copy(i).addScaledVector(a,o.time).addScaledVector(e,.025);let n=r.velocity.dot(e);r.velocity.addScaledVector(e,-(1.38*n)),r.velocity.multiplyScalar(.76),Math.abs(n)>1.8&&t-r.lastBounceAt>90&&(r.lastBounceAt=t,kg.grenadeBounce(Math.abs(n)))}else r.mesh.position.add(a);if(!Rf(r.mesh.position,Q.bounds,.16)){let e=zf(r.mesh.position,Q.bounds,.16);r.mesh.position.set(e.x,e.y,e.z),Mv(r.mesh.position.clone()),kg.coverImpact(r.mesh.position.distanceTo($.position)),Pg.remove(r.mesh),r.mesh.geometry.dispose(),r.mesh.material.dispose(),Ug.splice(n,1);continue}if(r.mesh.rotation.x+=e*8,r.mesh.rotation.z+=e*11,r.mesh.position.y<.18){let e=Math.abs(r.velocity.y);e>1.8&&t-r.lastBounceAt>90&&(r.lastBounceAt=t,kg.grenadeBounce(e)),r.mesh.position.y=.18,r.velocity.y=Math.abs(r.velocity.y)*.42,r.velocity.x*=.72,r.velocity.z*=.72}t>=r.explodeAt&&(Ug.splice(n,1),Ov(r))}}function Av(e){let t=Q.targets.find(t=>t.id===e);!t||!t.active||(t.active=!1,t.root.visible=!1,t.respawnAt=performance.now()+3200,Xg+=1,Pv(),kg.hit(),Fv(`+1 test mannequin`,`gold`))}function jv(e){for(let t of Q.targets){if(Jg===`solo`){t.root.visible=!1;continue}!t.active&&e>=t.respawnAt&&(t.active=!0,t.root.visible=!0)}}function Mv(e,t=`concrete`,n=new z(0,1,0)){Lg.impact(e,n.normalize(),t)}function Nv(e,t,n){Rg.emit(e,t,n)}function Pv(e=!1){let t=Z(`#hitmarker`);t.classList.remove(`show`,`headshot`),e&&t.classList.add(`headshot`),requestAnimationFrame(()=>t.classList.add(`show`))}function Fv(e,t){let n=Z(`#killfeed`),r=document.createElement(`div`);for(r.textContent=e,t&&r.classList.add(t),n.prepend(r);n.children.length>6;)n.lastElementChild?.remove();setTimeout(()=>r.classList.add(`fade`),4200),setTimeout(()=>r.remove(),5e3)}function Iv(e){if(!R_()||!I_)return;let t=new z(-Math.sin($.yaw),0,-Math.cos($.yaw)),n=new z(Math.cos($.yaw),0,-Math.sin($.yaw)),r=Bt.clamp(Number(Bg.has(`KeyW`))-Number(Bg.has(`KeyS`))-S_.y,-1,1),i=Bt.clamp(Number(Bg.has(`KeyD`))-Number(Bg.has(`KeyA`))+S_.x,-1,1),a=t.clone().multiplyScalar(r).addScaledVector(n,i);a.lengthSq()>1&&a.normalize();let o=performance.now(),s=$.stance===`crouch`,c=$.stance===`prone`,l=(Bg.has(`ShiftLeft`)||w_)&&a.lengthSq()>0&&O_,u=qf(r,i,y_,!1,!1);l&&u&&$.stance!==`stand`&&lv(`stand`),i_=l&&!Yg&&!$.reloadState&&o>=$.switchingUntil&&o-$.lastMeleeAt>500&&qf(r,i,y_,s,c);let d=Wf({crouched:s,prone:c,ads:y_,sprinting:i_,grounded:O_}),f=Kf({x:$.velocity.x,z:$.velocity.z},{x:a.x,z:a.z},d,e);$.velocity.x=f.x,$.velocity.z=f.z,$.hp<100&&o-u_>=5e3&&($.hp=Math.min(100,$.hp+18*e)),O_&&(c_=o);let p=o-l_<=125,m=O_||o-c_<=95;p&&m&&!y_&&$.stance===`stand`&&h_.phase===`active`?($.velocity.y=d.jumpVelocity,O_=!1,l_=-1e4):($.velocity.y-=24.5*e,O_&&($.velocity.y=Math.max(0,$.velocity.y)));let h=$.velocity.y,g=I_.move({x:$.velocity.x*e,y:$.velocity.y*e,z:$.velocity.z*e},e);$.position.set(g.position.x,g.position.y,g.position.z),O_=g.grounded,O_&&(c_=o),O_&&!k_&&h<-5&&(e_=Math.min(1,Math.abs(h)/14),kg.land(Math.abs(h))),k_=O_,g.blockedX&&($.velocity.x=g.appliedDelta.x/Math.max(e,.001)),g.blockedY&&$.velocity.y<0&&($.velocity.y=0),g.blockedZ&&($.velocity.z=g.appliedDelta.z/Math.max(e,.001));let _=a.lengthSq()>0&&O_,v=O_?Math.hypot(g.appliedDelta.x,g.appliedDelta.z):0,y=zp(d_,v,Rp($.stance,i_));d_=y.state;for(let e=0;e<y.emitted;e+=1)kg.footstep(Sf($.position),i_,s||c);t_+=e*(i_?15:c?3.6:s?7:10)*(_?1:.25),Qg=ip(Qg,Uf[$.weapon],e),$g=op($g,Uf[$.weapon],e),e_=Vf(e_,0,10,e),n_=Vf(n_,0,c?9:15,e);let b=$.velocity.dot(n)/Math.max(1,d.maxSpeed);r_=Vf(r_,-b*(y_?.006:.016),11,e);let x=G_.update({dt:e,moving:_,sprinting:i_,crouched:s,prone:c,ads:y_,phase:t_,landingImpulse:e_,lateralSpeed:b});for(let e of x)kg.weaponAction($.weapon,e),Kg.push(e);Kg.length>16&&Kg.splice(0,Kg.length-16),Fg.fov=Vf(Fg.fov,y_?Math.max(55,M_-20):i_?M_+4.5:M_,10,e),Fg.updateProjectionMatrix(),Fg.position.copy($.position),Fg.position.y+=n_-e_*.035,Fg.rotation.y=$.yaw+$g.yaw,Fg.rotation.x=Bt.clamp($.pitch-$g.pitch,-1.42,1.42),Fg.rotation.z=r_}function Lv(e,t){for(let[n,r]of Vg){if(t-r.lastSeen>12e3){ov(n,`timed out`);continue}let i=1-Math.exp(-13*e),a=r.root.position.distanceTo(r.target);r.root.position.lerp(r.target,i),r.root.rotation.y+=Bf(r.root.rotation.y,r.targetYaw)*i;let o=r.snapshot.stance??`stand`,s=r.root.userData.operator;ef(s,r.snapshot.weapon,Mg),rf(s,o,a/Math.max(e,.001),t*.008,i,r.snapshot.pitch)}}function Rv(){let e=$.team===0?$.kills:0,t=$.team===1?$.kills:0;for(let n of Vg.values())n.snapshot.team===0?e+=n.snapshot.kills:t+=n.snapshot.kills;for(let n of Hg.values())n.team===0?e+=n.kills:t+=n.kills;return[e,t]}function zv(e){let t=h_.phase,n=Rv();h_=up(h_,e,n);let r=yp(h_,e,n,$.team),i=Z(`#countdown`);if(h_.phase===`warmup`?(i.textContent=r.headline??``,i.hidden=!1):i.hidden=!0,t===h_.phase)return;let a=Z(`#banner`);if(h_.phase===`active`){a.innerHTML=`<strong>ENGAGE</strong><span>First squad to 25</span>`,a.hidden=!1,window.setTimeout(()=>{h_.phase===`active`&&(a.hidden=!0)},900);return}h_.phase===`ended`&&(g_=!0,a.innerHTML=`<strong>${r.headline}</strong><span>${r.subline} · ${r.objective}</span><button id="rematch" type="button">REMATCH</button>`,a.hidden=!1,Z(`#rematch`).addEventListener(`click`,()=>{W_.close(),ty(),dv(`solo`,!1)},{once:!0}),document.exitPointerLock())}function Bv(){zv(performance.now())}function Vv(e){let t=Og,n=Eg.width,r=Eg.height,i=Q.bounds,a=(e,t)=>pp(e,t,i,n,r);t.clearRect(0,0,n,r),t.fillStyle=`rgba(7, 15, 18, .78)`,t.fillRect(0,0,n,r),t.strokeStyle=`rgba(244, 196, 79, .5)`,t.lineWidth=2,t.strokeRect(2,2,n-4,r-4);let[o]=a(-10.25,0),[s]=a(10.25,0);t.fillStyle=`rgba(126, 137, 132, .18)`,t.fillRect(o,2,s-o,r-4);for(let[e,o,s]of[[-11,-34,0],[11,34,1]]){let[c,l]=a(e,o),u=16.4/(i.maxX-i.minX)*n,d=15/(i.maxZ-i.minZ)*r;t.fillStyle=s===0?`rgba(88, 227, 220, .2)`:`rgba(255, 118, 95, .2)`,t.fillRect(c-u/2,l-d/2,u,d)}for(let e of Vg.values()){let n=e.snapshot.team===$.team;if(!n&&e.target.distanceTo($.position)>15)continue;let[r,i]=a(e.target.x,e.target.z);t.fillStyle=n?`#58e3dc`:`#ff765f`,t.beginPath(),t.arc(r,i,3.5,0,Math.PI*2),t.fill()}for(let n of Hg.values()){if(!n.alive||!mp(n.position.distanceTo($.position),e,n.lastShotAt))continue;let[r,i]=a(n.position.x,n.position.z);t.fillStyle=`#ff765f`,t.beginPath(),t.arc(r,i,3.5,0,Math.PI*2),t.fill()}let[c,l]=a($.position.x,$.position.z);t.save(),t.translate(c,l),t.rotate(-$.yaw),t.fillStyle=$.team===0?`#58e3dc`:`#ff765f`,t.beginPath(),t.moveTo(0,-7),t.lineTo(5,6),t.lineTo(-5,6),t.closePath(),t.fill(),t.restore()}function Hv(e){if(e-p_<100)return;p_=e,qg&&zv(e);let t=Uf[$.weapon],n=Math.hypot($.velocity.x,$.velocity.z),r=y_&&G_.adsProgress()>=.9,i=Qf(t,{ads:r,moving:n>1.2,crouched:$.stance===`crouch`,prone:$.stance===`prone`,sustainedShots:$.sustainedShots}),a=Bt.clamp(5+i*320,5,23),o=Z(`#crosshair`);o.style.setProperty(`--spread`,`${a}px`),o.classList.toggle(`ads`,r);let[s,c]=Rv(),l=[s,c],u=yp(h_,e,l,$.team),d=hp($.position.x,$.position.z);Z(`#location-label`).textContent=gp(d),kg.setArenaZone(d),Z(`#health`).textContent=String(Math.ceil($.hp)),Z(`#health-fill`).style.width=`${$.hp}%`,Z(`#weapon-name`).textContent=t.name.toUpperCase(),Z(`#ammo`).textContent=String($.ammo[$.weapon]),Z(`#reserve`).textContent=String($.reserve[$.weapon]);let f=Z(`#aqua-score`),p=Z(`#coral-score`);f.textContent=String(s),p.textContent=String(c),l.forEach((e,t)=>{if(e===v_[t])return;let n=t===0?f:p;n.classList.remove(`score-pulse`),requestAnimationFrame(()=>n.classList.add(`score-pulse`))}),v_=l,Z(`#timer`).textContent=u.timer,Z(`#objective`).textContent=u.objective,!$.alive&&__>0&&(Z(`#respawn-countdown`).textContent=bp(__,e)),Z(`#reload-state`).textContent=$.reloadState?`RELOADING ${Math.max(0,($.reloadState.endsAt-e)/1e3).toFixed(1)}s`:Jg===`solo`?`${$.kills} K / ${$.deaths} D · ${Xg} TARGETS`:`${$.kills} K / ${$.deaths} D`,Z(`#stance`).textContent=$.stance.toUpperCase(),Z(`#grenades`).textContent=`FRAG ×${$.grenades}`,Z(`#health-block`).classList.toggle(`critical`,$.hp<=30),Vv(e),Z(`#roster`).hidden||Uv()}function Uv(){let e=[$_(),...[...Vg.values()].map(e=>e.snapshot),...[...Hg.values()].map(e=>({id:e.id,name:e.name,team:e.team,x:e.position.x,y:e.position.y,z:e.position.z,yaw:e.root.rotation.y,pitch:0,hp:e.hp,kills:e.kills,deaths:e.deaths,weapon:`carbine`,seq:0}))].sort((e,t)=>t.kills-e.kills||e.deaths-t.deaths);Z(`#roster-list`).innerHTML=e.map(e=>`<div><span class="${e.team===0?`aqua`:`coral`}">${Wv(e.name)}</span><b>${e.kills}</b><i>${e.deaths}</i><em>${e.hp>0?Math.ceil(e.hp)+` HP`:`DOWN`}</em></div>`).join(``)}function Wv(e){return e.replace(/[&<>'"]/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,"'":`&#39;`,'"':`&quot;`})[e])}function Gv(){let e=window.innerWidth,t=window.innerHeight;Ng.setSize(e,t,!1),Fg.aspect=e/Math.max(1,t),Fg.updateProjectionMatrix()}window.addEventListener(`resize`,Gv),Gv();var Kv=new URLSearchParams(window.location.search),qv=Kv.get(`room`)?.trim()??``;qv&&(Z(`#room-input`).value=qv);var Jv=Kv.get(`name`);Jv&&(Z(`#player-name`).value=Uh(Jv)),Kv.get(`team`)===`1`&&(Z(`#team`).value=`1`);var Yv=Z(`#sensitivity`),Xv=Z(`#controller-sensitivity`),Zv=Z(`#field-of-view`),Qv=Z(`#graphics-profile`),$v=(e,t,n,r)=>{let i=Number(localStorage.getItem(e));return Number.isFinite(i)&&i>=n&&i<=r?i:t};A_=$v(`atomic-acres-sensitivity`,Number(Yv.value),.6,2),j_=$v(`atomic-acres-controller-sensitivity`,Number(Xv.value),.5,1.8),M_=$v(`atomic-acres-fov`,Number(Zv.value),70,100),Yv.value=String(A_),Xv.value=String(j_),Zv.value=String(M_),Qv.value=Ag,Yv.addEventListener(`input`,()=>{A_=Number(Yv.value),localStorage.setItem(`atomic-acres-sensitivity`,String(A_))}),Xv.addEventListener(`input`,()=>{j_=Number(Xv.value),localStorage.setItem(`atomic-acres-controller-sensitivity`,String(j_))}),Zv.addEventListener(`input`,()=>{M_=Number(Zv.value),localStorage.setItem(`atomic-acres-fov`,String(M_))}),Qv.addEventListener(`change`,()=>{let e=Qv.value;localStorage.setItem(fg,e);let t=new URL(window.location.href);e===`balanced`?t.searchParams.delete(`render`):t.searchParams.set(`render`,e),window.location.assign(t)});function ey(e){let t=navigator.getGamepads?.().find(e=>!!(e&&e.connected));if(!t){S_={x:0,y:0},C_={yaw:0,pitch:0},w_=!1,D_=[],Yg=b_,y_=F_??x_;return}let n=Xf(t.axes[0]??0,t.axes[1]??0,.14,1.6),r=Xf(t.axes[2]??0,t.axes[3]??0,.1,1.6),i=t.buttons.map(e=>e.pressed||e.value>.55),a=e=>i[e]&&!D_[e],o=!!i[6]||(t.buttons[6]?.value??0)>.22,s=!!i[7]||(t.buttons[7]?.value??0)>.22,c=L_();s?c||(T_=!1):T_=!0,o?c||(E_=!1):E_=!0;let l=c&&s&&T_,u=c&&o&&E_;w_=c&&!!i[10],y_=F_??(x_||u),Yg=b_||l,S_=c?n:{x:0,y:0},C_=Zf(C_,c?r:{x:0,y:0},e,y_,j_),c&&($.yaw-=C_.yaw*e,$.pitch=Bt.clamp($.pitch-C_.pitch*e,-1.42,1.42),a(0)&&($.stance!==`stand`&&lv(`stand`),l_=performance.now()),a(1)&&lv(`toggle-crouch`),a(13)&&lv(`toggle-prone`),a(2)&&mv(),a(3)&&pv((gg.indexOf($.weapon)+1)%gg.length),a(4)&&Dv(),a(5)&&Ev()),D_=i}window.addEventListener(`keydown`,e=>{if(L_())Bg.add(e.code);else if(e.code!==`Tab`)return;e.code===`Space`&&!e.repeat&&($.stance!==`stand`&&lv(`stand`),l_=performance.now()),e.code===`KeyC`&&!e.repeat&&lv(`toggle-crouch`),(e.code===`KeyZ`||e.code===`ControlLeft`)&&!e.repeat&&lv(`toggle-prone`),e.code===`Digit1`&&pv(0),e.code===`Digit2`&&pv(1),e.code===`Digit3`&&pv(2),e.code===`KeyR`&&mv(),e.code===`KeyV`&&!e.repeat&&Ev(),e.code===`KeyG`&&!e.repeat&&Dv(),e.code===`Tab`&&(e.preventDefault(),Uv(),Z(`#roster`).hidden=!1)}),window.addEventListener(`keyup`,e=>{Bg.delete(e.code),e.code===`Tab`&&(Z(`#roster`).hidden=!0)}),window.addEventListener(`blur`,()=>{B_()}),window.addEventListener(`mousemove`,e=>{if(document.pointerLockElement!==bg||!$.alive)return;let t=Yf(y_,i_);$.yaw-=e.movementX*.00215*A_*t,$.pitch=Math.max(-1.42,Math.min(1.42,$.pitch-e.movementY*.0019*A_*t)),G_.addMouseDelta(e.movementX,e.movementY)}),bg.addEventListener(`contextmenu`,e=>e.preventDefault()),bg.addEventListener(`mousedown`,e=>{if(document.pointerLockElement!==bg){cv();return}if(e.button===2){x_=!0,y_=!0;return}e.button===0&&(b_=!0,Yg=!0,gv(performance.now()))}),window.addEventListener(`mouseup`,e=>{e.button===0&&(b_=!1),e.button===2&&(x_=!1),Yg=b_,y_=x_}),document.addEventListener(`pointerlockchange`,()=>{document.pointerLockElement===bg?(Z(`#resume`).hidden=!0,xg.classList.add(`hidden`)):(B_(),qg&&$.alive&&!g_&&(Z(`#resume`).hidden=g_,xg.classList.remove(`hidden`)))});function ty(){z_(!0),$.kills=0,$.deaths=0,$.hp=100,$.grenades=1,$.reloadState=null,$.sustainedShots=0,$.stance=`stand`,I_?.setStance(`stand`),Xg=0,v_=[0,0],__=0,bv();for(let e of Ug)Pg.remove(e.mesh);Ug.length=0;for(let e of Vg.keys())ov(e,`cleared`);Z(`#banner`).hidden=!0,Z(`#countdown`).hidden=!0,Z(`#respawn`).hidden=!0,$.weapon=Ef(K_).weapon,$.switchingUntil=0,G_.setWeapon($.weapon,!0),J_(),$.ammo={carbine:Uf.carbine.mag,smg:Uf.smg.mag,scattergun:Uf.scattergun.mag},$.reserve={carbine:Uf.carbine.reserve,smg:Uf.smg.reserve,scattergun:Uf.scattergun.reserve}}Z(`#resume`).addEventListener(`click`,()=>{qg&&$.alive&&!g_&&cv()}),Z(`#solo`).addEventListener(`click`,()=>{W_.close(),ty(),dv(`solo`)}),Z(`#host`).addEventListener(`click`,()=>{ty(),W_.host(()=>{Cg.hidden=!1,wg.textContent=W_.roomCode,dv(`host`)})}),Z(`#join`).addEventListener(`click`,()=>{ty();let e=Z(`#room-input`).value.trim();W_.join(e,()=>dv(`client`))}),Z(`#copy-room`).addEventListener(`click`,async()=>{let e=`${window.location.origin}${window.location.pathname}?room=${encodeURIComponent(W_.roomCode)}`;try{await navigator.clipboard.writeText(e),V_(`Invite link copied`,`ok`)}catch{Z(`#room-input`).value=W_.roomCode,V_(`Clipboard blocked — code placed in join field`,`warn`)}}),qv&&Kv.get(`autojoin`)===`1`&&window.setTimeout(()=>Z(`#join`).click(),100),setInterval(()=>{qg&&W_.role!==`offline`&&$.alive&&W_.send({type:`state`,player:$_()})},60),window.addEventListener(`beforeunload`,()=>{W_.role!==`offline`&&W_.send({type:`leave`,playerId:$.id}),W_.close()});function ny(e){try{let t=Math.min(.05,Math.max(0,(e-f_)/1e3));f_=e,ey(t),Zg+=t;let n=1/120,r=0;for(;Zg>=n&&r<6;)Iv(n),Zg-=n,r+=1;Yg&&Uf[$.weapon].automatic&&gv(e),hv(e),jv(e),Tv(t,e),kv(t,e),Lg.update(t),Rg.update(t),Lv(t,e),zg&&Ap(zg,e),Hv(e),m_||Ng.render(Pg,Fg),requestAnimationFrame(ny)}catch(e){H_(e)}}var ry=window;ry.__ATOMIC_ACRES_DEBUG__={snapshot:()=>({gameStarted:qg,gameMode:Jg,matchPhase:h_.phase,matchEndReason:h_.endReason??null,scores:Rv(),player:{hp:$.hp,kills:$.kills,deaths:$.deaths,weapon:$.weapon,ammo:$.ammo[$.weapon],reserve:$.reserve[$.weapon],reloading:$.reloadState!==null,stance:$.stance,crouched:$.stance===`crouch`,prone:$.stance===`prone`,sprinting:i_,grenades:$.grenades,position:$.position.toArray()},bots:[...Hg.values()].map(e=>({id:e.id,hp:e.hp,alive:e.alive,kills:e.kills,position:e.position.toArray(),waypoint:e.waypoint,blockedSince:e.blockedSince,hasLineOfSight:e.hasLineOfSight,presentationReady:[`presentation-reaction-gear`,`field-radio-pack`,`asymmetric-shoulder-plate`,`team-radio-antenna`].every(t=>e.root.getObjectByName(t)!==void 0),presentationWeaponSafe:(()=>{let t=e.root.getObjectByName(`operator-${e.root.userData.operatorRig?.weaponId??`carbine`}`);if(!t)return!1;let n=!0;return t.traverse(e=>{e instanceof U&&e.userData.presentationOnly!==!0&&(n=!1)}),n})()})),remotes:Vg.size,remotePlayers:[...Vg.values()].map(e=>({id:e.snapshot.id,stance:e.snapshot.stance??`stand`,position:e.target.toArray()})),grenades:Ug.length,activeImpactParticles:Lg.activeParticles(),activeImpactMarks:Lg.activeMarks(),activeTracers:Rg.activeCount(),originalArtLoaded:Pg.getObjectByName(`original-arena-art`)!==void 0,arenaZone:hp($.position.x,$.position.z),arenaStoryReady:[`route-marker-skyline-garden`,`route-marker-atom-liner-crossing`,`route-marker-solar-service`].every(e=>Pg.getObjectByName(e)!==void 0),weaponReady:G_.isReady(),weaponPresentation:G_.presentationState(),weaponActionHistory:[...Kg],menuVisible:!xg.classList.contains(`hidden`),render:{profile:Ag,calls:Ng.info.render.calls,triangles:Ng.info.render.triangles,points:Ng.info.render.points,lines:Ng.info.render.lines,sceneObjects:Pg.children.length,reducedMode:Mg,shadows:jg.shadows,shadowMode:jg.shadowMode,pixelRatio:Ng.getPixelRatio()}}),startSolo:()=>{W_.close(),ty(),dv(`solo`,!1)},setBotsFrozen:e=>{N_=e},setRenderPaused:e=>{m_=e},openMenu:()=>{B_(),xg.classList.remove(`hidden`)},fireOnce:()=>{P_=!0,Yg=!0,gv(performance.now()),Yg=!1,P_=!1},throwGrenade:()=>Dv(),switchWeapon:e=>pv(e),reload:()=>mv(),melee:()=>Ev(),setAds:e=>{F_=e,y_=e},setStance:e=>{e!==$.stance&&lv(e===`stand`?`stand`:e===`prone`?`toggle-prone`:`toggle-crouch`)},damage:e=>{$.invulnerableUntil=0,iv(e,Hg.keys().next().value??$.id)},endMatch:()=>{$.kills=25,zv(performance.now())},rematch:()=>{W_.close(),ty(),dv(`solo`,!1)}};function iy(e,t){let n=new Set;e.traverse(e=>{if(!(e instanceof U)||t.getObjectById(e.id))return;let r=Array.isArray(e.material)?e.material:[e.material];for(let e of r){if(n.has(e)||!(e instanceof W))continue;n.add(e);let{r:t,g:r,b:i}=e.color;Math.max(t,r,i)<.16&&e.color.lerp(new H(5989988),.24)}})}async function ay(){let e=Z(`#solo`),t=Z(`#host`),n=Z(`#join`);e.disabled=!0,t.disabled=!0,n.disabled=!0,V_(`Loading authored arena art, weapons and advanced collision…`);let r=eg.create(Q.colliders,Q.bounds),i=G_.load((e,t)=>{V_(`Loading authored weapons ${e}/${t}…`)}),a=Mp(Pg,(e,t)=>{V_(`Loading authored arena models ${e}/${t}…`)},Mg),[o,,s]=await Promise.all([r,i,a]);I_=o,zg=s.root;let c=Q.raycastMeshes.filter(e=>e.visible||e.userData.collisionProxy===!0);Q.raycastMeshes.splice(0,Q.raycastMeshes.length,...c),s.root.traverse(e=>{e instanceof U&&e.userData.blocksShots===!0&&Q.raycastMeshes.push(e)});let l=Pg.getObjectByName(`Atomic Acres arena`);l&&Wd(l,Pg,()=>``,Mg),Wd(s.root,Pg,()=>``,Mg),jg.shadowMode===`static`&&(Ng.shadowMap.needsUpdate=!0),iy(Pg,G_.root),G_.setWeapon($.weapon,!0),uv(),G_.root.visible=!1,Fg.position.set(0,30,-22),Fg.lookAt(0,.8,4),Fg.fov=65,Fg.updateProjectionMatrix(),e.disabled=!1,t.disabled=!U_,n.disabled=!U_,V_(`Pass 11 ready — balanced 60 FPS rendering, full arsenal, match flow and route storytelling active.`),requestAnimationFrame(ny)}ay().catch(H_);