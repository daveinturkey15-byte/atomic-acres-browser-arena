...
export function analyseCombat(summary, driverReport, callsign = 'Jigglyclaw') {
  ...
  return {
    ...
    control: {
      ...
      killAnchorActivations: optionalNumeric(driverReport?.input?.killAnchorActivations),
      killAnchorRenewals: optionalNumeric(driverReport?.input?.killAnchorRenewals),
      killAnchorActiveFrames: optionalNumeric(driverReport?.input?.killAnchorActiveFrames),
      killAnchorEngagementFrames: optionalNumeric(driverReport?.input?.killAnchorEngagementFrames),
      ...
      respawnReentryFrames: optionalNumeric(driverReport?.input?.respawnReentryFrames),
      lastLifeDurationMs: optionalNumeric(driverReport?.input?.lastLifeDurationMs),
      quickDeathStreak: optionalNumeric(driverReport?.input?.quickDeathStreak),
      quickDeathReceipts: optionalNumeric(driverReport?.input?.quickDeathReceipts),
      ...
      offensivePursuitFrames: optionalNumeric(driverReport?.input?.offensivePursuitFrames),
      offensiveEngagementFrames: optionalNumeric(driverReport?.input?.offensiveEngagementFrames),
      offensiveStableAimFrames: optionalNumeric(driverReport?.input?.offensiveStableAimFrames),
      offensivePostShotStrafeFrames: optionalNumeric(driverReport?.input?.offensivePostShotStrafeFrames),
      offensiveLaneIsolationActivations: optionalNumeric(driverReport?.input?.offensiveLaneIsolationActivations),
      offensiveLaneIsolationFrames: optionalNumeric(driverReport?.input?.offensiveLaneIsolationFrames),
      offensiveLaneEngagementSuppressions: optionalNumeric(driverReport?.input?.offensiveLaneEngagementSuppressions),
      offensiveLaneLastReceipt: driverReport?.input?.offensiveLaneLastReceipt ?? null,
      coverEngagementSuppressedFrames: optionalNumeric(driverReport?.input?.coverEngagementSuppressedFrames),
      ...
      exposureHeightSuppressions: optionalNumeric(driverReport?.input?.exposureHeightSuppressions),
      ...
      activeInputVeto: driverReport?.input?.activeInputVeto ?? null,
      pointerLockLosses: optionalNumeric(driverReport?.input?.pointerLockLosses),
      focusLosses: optionalNumeric(driverReport?.input?.focusLosses),
      hudFreshnessFailures: optionalNumeric(driverReport?.input?.hudFreshnessFailures),
