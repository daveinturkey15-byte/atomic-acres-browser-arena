...
const choreography = {
  ...
  arenas: {
    ...
    // RAID2: tenth in ARENA_SELECTIONS (HF-408, owner 2026-09-02), spread after
    // map3 so its key lands tenth here too. Without this line the roster
...
if (choreography.schemaVersion !== 4
  ...
  || choreography.media.cacheKey !== 'pass66-runtime-preview-v15'
  || choreography.fps !== 30
