    ...
    "look-and-feel": {
        ...
        "tasks": [
            ("lf-identity-residuals",
             ...
             "(1) index.html theme-color and favicon are DONE - warmed 2026-08-25 and now guarded. "
             "(2) The AQUA team score reads teal in solo and gun-range where there is no "
            ...
            ("lf-grade-depth",
             "FOUND AND DELIBERATELY NOT ACTED ON, because it needs eyes rather than "
             "arithmetic and it is yours: #color-grade in src/style.css:79 lays "
             "linear-gradient(180deg, rgba(24,73,92,.09), transparent 38%, rgba(221,113,46,.08)) "
             "over EVERY frame at mix-blend-mode soft-light. The UI sweep flagged the first "
             "stop as a cold wash, and over the top 38% of the screen it is - but read the "
             "whole rule before you touch it: cool shadows over warm highlights is a real "
             "filmic grade, not a leftover, and the warm stop is already there at the bottom. "
             "So the question is not is it cold, it is does it serve the look the owner wants "
             "after everything else went warm. Capture frames before and after on at least "
             "two arenas and JUDGE them; do not rotate it by formula. NOTE src/style.css is "
             "unowned in Pass 81, so you may edit it - but it is NOT layered, so anything you "
             "put there beats @layer legacy and can silently outrank another sheet. "
