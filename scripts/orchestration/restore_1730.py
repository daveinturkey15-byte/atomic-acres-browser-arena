#!/usr/bin/env python3
"""Give the machine back at 17:30.
...
for a, b in [("RESERVE_GB = 11.0  # 17:30 window: owner needs ~9 GB for ComfyUI", "RESERVE_GB = 5.5"),
             ("BROWSER_SLOTS = 1  # 17:30 window", "BROWSER_SLOTS = 2"),
             ("VERIFY_SLOTS = 1  # 17:30 window; vitest peaks at 5.63 GB", "VERIFY_SLOTS = 2")]:
    s = s.replace(a, b, 1)
