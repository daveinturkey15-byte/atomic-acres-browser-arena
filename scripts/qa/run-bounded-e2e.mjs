...
const groups = [
  ...
  { name: 'pass71-glass-quality-bullet', timeoutMs: 360_000, args: ['tests/e2e/pass71-glass-lifecycle-matrix.spec.ts', '--project=chromium', '--workers=1', '--grep', 'quality: all six authored panes breach by bullet'] },
  { name: 'pass71-glass-quality-knife', timeoutMs: 360_000, args: ['tests/e2e/pass71-glass-lifecycle-matrix.spec.ts', '--project=chromium', '--workers=1', '--grep', 'quality: all six authored panes breach by knife'] },
  { name: 'pass71-glass-quality-grenade', timeoutMs: 360_000, args: ['tests/e2e/pass71-glass-lifecycle-matrix.spec.ts', '--project=chromium', '--workers=1', '--grep', 'quality: all six authored panes breach by grenade'] },
  ...
  { name: 'pass71-glass-performance-bullet', timeoutMs: 360_000, args: ['tests/e2e/pass71-glass-lifecycle-matrix.spec.ts', '--project=chromium', '--workers=1', '--grep', 'performance: all six authored panes breach by bullet'] },
  { name: 'pass71-glass-performance-knife', timeoutMs: 360_000, args: ['tests/e2e/pass71-glass-lifecycle-matrix.spec.ts', '--project=chromium', '--workers=1', '--grep', 'performance: all six authored panes breach by knife'] },
  { name: 'pass71-glass-performance-grenade', timeoutMs: 360_000, args: ['tests/e2e/pass71-glass-lifecycle-matrix.spec.ts', '--project=chromium', '--workers=1', '--grep', 'performance: all six authored panes breach by grenade'] },
