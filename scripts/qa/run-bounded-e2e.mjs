...
const groups = [
  ...
  { name: 'boot-and-authored', timeoutMs: 900_000, args: ['tests/e2e/atomic-acres.spec.ts', '--project=chromium', '--workers=1', '--grep', 'boot and authored presentation', '--grep-invert', 'field kit for deployment'] },
