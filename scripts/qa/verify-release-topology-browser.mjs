...
async function verifyLegacyRoute(name, configure) {
  ...
  try {
    ...
    const eyebrow = await verifyRuntime(page, 'channels/experimental-netcode-pass', 'PASS 62');
...
try {
  ...
  await verifyChoice('experimental', 'channels/experimental-netcode-pass', 'PASS 62');
  await verifyChoice('stable', 'channels/recent-stable', 'PASS 60');
