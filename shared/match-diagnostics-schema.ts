...
export const MATCH_DIAGNOSTIC_ARENAS = [
  ...
  // world-studio opens the catalog; newworld-prime stays last.
  'world-studio',
  ...
  // Paired with worker/migrations/0010_add_world_studio_and_prime_arenas.sql.
  // world-studio is the menu default (HF-495) and newworld-prime is the
  // Day-2-promoted selectable arena (map-selection.ts); both were missing
  // from this boundary, so their match diagnostics were being rejected.
  'newworld-prime',
] as const;
