...
- The three helicopter captures bake a compact black/grey rotor and cockpit/HUD treatment over the real arena footage. The main rotor is a heavily foreshortened set of discrete, partially clipped radial blade sweeps with a small mast/hub and pose-responsive shift/bank; a filled or full-disc surface is forbidden. The overlay uses half-scale framing and separated panels so it does not obscure the selected map.
...
- missing compact black/grey helicopter rotor/cockpit or cat ear/paw overlay markers, fewer than two legible blade sweeps, an oversized rotor stage, or any filled/full-disc main-rotor surface;
