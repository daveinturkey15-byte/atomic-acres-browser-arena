...
// can be the safe backup". After the pass86 publish the ONLY trees on gh-pages
// are channels/pass86 and channels/pass85, so the second card must be the PASS 85
...
// scripts/orchestration/publish_pass86.py parses this line and refuses to publish
// unless it resolves to channels/pass85.
const stableFallback = releaseChannels.pass85Backup ?? releaseChannels.stable;
