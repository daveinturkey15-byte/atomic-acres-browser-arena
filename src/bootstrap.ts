...
// can be the safe backup". After the pass92 publish the ONLY trees on gh-pages
// are channels/pass92 and channels/pass91, so the second card must be the PASS 91
...
// scripts/orchestration/publish_pass92.py parses this line and refuses to publish
// unless it resolves to channels/pass91.
const stableFallback = releaseChannels.pass91Backup ?? releaseChannels.stable;
