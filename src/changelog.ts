...
export const CHANGELOG: readonly ChangelogEntry[] = Object.freeze([
  Object.freeze({
    ...
    areas: Object.freeze(['STABILITY', 'COMBAT', 'AI', 'VEHICLES', 'DESTRUCTION', 'HUD', 'GRAPHICS']),
    summary: 'Pass 66 is The Big One: a stability-first reconciliation of frame pacing, loading, combat presentation, vehicle support, destructible-world authority and readable menus while the byte-exact Pass 63 build remains selectable as Stable.',
    highlights: Object.freeze([
      ...
      'Menu and loading previews remain prerecorded and first-frame gated so map admission does not compete with a second live arena renderer',
      'Options Escape resumes an active match directly and persists one coherent graphics/settings update',
      ...
      'Bots query the same semantic smoke corridors as players and lose targeting and fire when a facing, visible flashbang blinds them',
      ...
      'Drone and Chopper entry use explicit interaction priority, with tap actions kept separate from one-second hold-to-enter support controls',
      'The Railgun launches from a layered muzzle ignition into its one-second map-spanning beam, with fixed damage and multi-target kill credit retained',
      'The always-on arena bed is filtered and bounded to remove broadband hiss without losing positional weapon, vehicle or impact sound',
      'Dense loadout, killstreak, lobby, project-map and last-release surfaces use a larger readable tactical type scale without expanding the combat HUD',
