...
describe('killstreak presentation', () => {
  ...
  it('renders a sleek chopper/care/drone vocabulary and retires stale entities', () => {
    ...
    expect(presentation.telemetry()).toEqual({
      ...
      swarmInstanceMatrixSignatures: expect.any(Array),
      swarmAnimatedInstanceMatrixSignatures: expect.any(Array),
      liveWorldMatrixWalks: expect.any(Number),
      nodesWalked: expect.any(Number),
      redundantCheckoutNodeUpdates: expect.any(Number),
      autoUpdatingNodes: expect.any(Number),
