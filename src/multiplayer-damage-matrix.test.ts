...
const matrix: MatrixCase[] = [
  ...
  { route: 'quad host-to-guest gun', requested: 31, modifier: 2, expected: 62, cause: { kind: 'gun', weapon: 'carbine' } },
  { route: 'quad guest-to-host gun', requested: 31, modifier: 2, expected: 62, cause: { kind: 'gun', weapon: 'carbine' } },
