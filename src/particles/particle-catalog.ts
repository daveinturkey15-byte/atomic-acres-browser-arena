...
export const ARENA_PARTICLE_PROFILES: Readonly<Record<ArenaId, ArenaParticleProfile>> = Object.freeze({
  ...
  'atomic-acres': arena(
    ...
    { density: 0.55, colorWarm: 0xf6e7c4, colorCool: 0xcfd6c2, radiusM: 0.016, riseMps: 0.05, swirlMps: 0.16, windPull: 0.55, opacity: 0.085 },
    { density: 0.35, kind: 'ash', colorWarm: 0xe0d2b4, colorCool: 0x9a9382, radiusM: 0.045, fallMps: 0.34, windPull: 0.8, flutterMps: 0.5, spinRadiansPerSecond: 1.5, opacity: 0.12 },
    0.55, 20, 12, 4,
  ),
  ...
  'skyline-terminal': arena(
    ...
    { density: 0.5, colorWarm: 0xdfe4ec, colorCool: 0xb8c4d4, radiusM: 0.014, riseMps: 0.09, swirlMps: 0.22, windPull: 0.72, opacity: 0.08 },
    { density: 0.3, kind: 'lint', colorWarm: 0xd7d9d2, colorCool: 0x8f948f, radiusM: 0.038, fallMps: 0.42, windPull: 0.92, flutterMps: 0.62, spinRadiansPerSecond: 2.2, opacity: 0.1 },
    0.4, 22, 14, 4,
  ),
  // North-sea rig: salt mist and rust flakes off the deck, hard one-way wind.
  'rustworks-1v1': arena(
    'rustworks-1v1', 'north-sea-salt-and-rust',
    { density: 0.45, colorWarm: 0xd9dee2, colorCool: 0xa8b6c0, radiusM: 0.018, riseMps: 0.12, swirlMps: 0.3, windPull: 0.85, opacity: 0.09 },
    { density: 0.4, kind: 'foam', colorWarm: 0xf0f4f6, colorCool: 0xbfae96, radiusM: 0.05, fallMps: -0.05, windPull: 0.95, flutterMps: 0.8, spinRadiansPerSecond: 1.1, opacity: 0.13 },
    0.3, 22, 13, 5,
  ),
  // Indoors. The classic shooting-range look: motes hanging in the strip lights.
  'gun-range': arena(
    'gun-range', 'indoor-motes-in-strip-light',
    { density: 0.85, colorWarm: 0xfff2d8, colorCool: 0xe6e2d4, radiusM: 0.012, riseMps: 0.035, swirlMps: 0.1, windPull: 0.25, opacity: 0.11 },
    { density: 0.12, kind: 'lint', colorWarm: 0xf2ece0, colorCool: 0xcac3b4, radiusM: 0.03, fallMps: 0.2, windPull: 0.3, flutterMps: 0.3, spinRadiansPerSecond: 1.8, opacity: 0.09 },
    0.9, 14, 7, 3,
  ),
  // Tropical: pollen and seed fluff in the shafts, leaves off the palms.
  farcrysis: arena(
    'farcrysis', 'jungle-pollen-and-leaf-fall',
    { density: 0.7, colorWarm: 0xfff0cc, colorCool: 0xd8e6bc, radiusM: 0.015, riseMps: 0.07, swirlMps: 0.2, windPull: 0.6, opacity: 0.1 },
    { density: 0.6, kind: 'leaf', colorWarm: 0xc7d97a, colorCool: 0x7d9a44, radiusM: 0.075, fallMps: 0.5, windPull: 0.88, flutterMps: 1.15, spinRadiansPerSecond: 2.6, opacity: 0.16 },
    1, 21, 14, 4,
  ),
  // Open water: salt haze and torn foam off the crests.
  'high-seas': arena(
    'high-seas', 'open-ocean-spray-and-salt',
    { density: 0.5, colorWarm: 0xe8f1f6, colorCool: 0xbcd2de, radiusM: 0.017, riseMps: 0.14, swirlMps: 0.34, windPull: 0.9, opacity: 0.095 },
    { density: 0.75, kind: 'foam', colorWarm: 0xffffff, colorCool: 0xcfe2ea, radiusM: 0.055, fallMps: -0.08, windPull: 0.97, flutterMps: 0.9, spinRadiansPerSecond: 1.3, opacity: 0.15 },
    0.35, 24, 12, 5,
  ),
});
