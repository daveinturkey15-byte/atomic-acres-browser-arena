...
export const PASS65_RENDERER_FEATURES: readonly RendererFeatureDefinition[] = Object.freeze([
  ...
  feature({
    ...
    control: control('setting', ['graphics.shadows', 'graphics.shadowResolution', 'graphics.shadowUpdateMode', 'graphics.shadowFilter', 'graphics.indirectLighting', 'graphics.clusteredLighting', 'graphics.preset', 'graphics.adaptiveResolution'], 'Off/on authored shadows, 1024/2048 maps, static/dynamic refresh, an auto/PCF/PCSS-soft filter override, bounded indirect-light scaling, and the Nuke Town practical-light cluster', 'Shadow distance, bias, local-light volumes and the clustered-light buffer remain arena-authored because arbitrary values can create leaks, clipping, and unbounded GPU work. The filter override respects the WebKit basic-depth engine floor; clustered lighting is staged with the arena-lighting rebuild.'),
