 ...
 *
 * Stamped to PASS 96 on 2026-09-02 (the pass96 cut). Stamping is part of CUTTING a
 ...
 * channels/pass96 (this build, live) and channels/pass95 (the pinned safe backup).
 * Every older tree is retired by scripts/orchestration/publish_pass96.py.
 */
