...
export const definition = createProceduralArenaVisualDefinition({
  ...
  lighting: {
    sunColor: 0xe2ebff, sunIntensity: 2.7, ambientColor: 0x536779, ambientIntensity: 0.28,
    practicals: [{ id: 'industrial-floods', policy: 'emissive-only', maximumDistance: 0, castsShadow: false }],
  },
  fog: { color: 0x293747, near: 52, far: 136 },
  shadows: { enabled: true, mapSize: 2048, maximumDistance: 180, normalBias: 0.038 },
  atmosphere: { preset: 'industrial-night', mist: 0.36, dust: 0.12, clouds: true },
  colorPipeline: colorPipeline('pass64.rustrig.hdr.v1', 1.02),
  budgets: budgets({ maximumDrawCalls: 500, maximumTriangles: 1_250_000, maximumShadowLights: 1 }),
  reviewCameras: [
    camera('rustrig-overview', [38, 31, 42], [0, 5, 0], 'overview', 1.02),
    camera('rustrig-tower-support', [14, 2.4, 12], [0, 5, 0], 'geometry', 1.02),
    camera('rustrig-container-wall', [10, 2.1, -18], [4, 2.1, -18], 'light-occlusion', 1.02),
  ],
