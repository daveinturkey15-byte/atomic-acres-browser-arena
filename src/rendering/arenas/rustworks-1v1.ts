...
export const definition = createProceduralArenaVisualDefinition({
  ...
  lighting: {
    sunColor: 0xe2ebff, sunIntensity: 3.6, ambientColor: 0x718aa5, ambientIntensity: 0.55,
    practicals: [
  ...
  colorPipeline: colorPipeline('pass64.rustrig.hdr.v1', 1.45),
  ...
  reviewCameras: [
    camera('rustrig-overview', [38, 31, 42], [0, 5, 0], 'overview', 1.45),
    camera('rustrig-tower-support', [14, 2.4, 12], [0, 5, 0], 'geometry', 1.45),
    camera('rustrig-container-wall', [10, 2.1, -18], [4, 2.1, -18], 'light-occlusion', 1.45),
  ],
