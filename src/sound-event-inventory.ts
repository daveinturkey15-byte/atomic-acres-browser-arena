...
const events: SoundEventInventoryEntry[] = [
  ...
  plannedEvent({
    ...
    // owner 2026-09-02 (HF-408): the Raid rebuild added.
    variants: ['atomic-acres', 'skyline-terminal', 'rustworks-1v1', 'gun-range', 'farcrysis', 'high-seas', 'test1', 'test2', 'map3', 'raid2'],
...
export const SOUND_EVENT_INVENTORY_SHA256 = 'ba4a40f342435d4723e3a95ab47d33f4c32260c606888c1c0db2456a699f432c';
