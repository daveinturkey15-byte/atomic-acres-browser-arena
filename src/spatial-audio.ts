...
export const ARENA_AUDIO_DEFINITIONS: Readonly<Record<ArenaId, ArenaAudioDefinition>> = Object.freeze({
  'atomic-acres': Object.freeze({
    ...
    continuousVoices: 2, bedFrequencyHz: 58, airFrequencyHz: 196, modulationHz: 0.08,
  ...
  'rustworks-1v1': Object.freeze({
    ...
    continuousVoices: 2, bedFrequencyHz: 43, airFrequencyHz: 127, modulationHz: 0.13,
  ...
  'gun-range': Object.freeze({
    ...
    continuousVoices: 2, bedFrequencyHz: 71, airFrequencyHz: 238, modulationHz: 0.06,
  ...
  'skyline-terminal': Object.freeze({
    ...
    continuousVoices: 2, bedFrequencyHz: 49, airFrequencyHz: 174, modulationHz: 0.095,
