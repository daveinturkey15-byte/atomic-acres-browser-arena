...
export const MENU_PREVIEW_VIDEO_DEFINITIONS = Object.freeze({
  'atomic-acres': Object.freeze({
    ...
    presentationId: 'menu-video-helo-nuke-town-v1',
    webm: `${ROOT}/atomic-acres.webm`,
    mp4: `${ROOT}/atomic-acres.mp4`,
    poster: `${ROOT}/atomic-acres.webp`,
    durationSeconds: 8,
    width: 960,
    height: 540,
  }),
  'skyline-terminal': Object.freeze({
    ...
    motionLabel: 'AUTHORED COCKPIT FLYOVER',
    reducedMotionLabel: 'STABILIZED PREVIEW FRAME',
    presentationId: 'menu-video-helo-terminal-v1',
    webm: `${ROOT}/skyline-terminal.webm`,
    mp4: `${ROOT}/skyline-terminal.mp4`,
    poster: `${ROOT}/skyline-terminal.webp`,
    durationSeconds: 8,
    width: 960,
    height: 540,
  }),
  'rustworks-1v1': Object.freeze({
    ...
    motionLabel: 'AUTHORED COCKPIT FLYOVER',
    reducedMotionLabel: 'STABILIZED PREVIEW FRAME',
    presentationId: 'menu-video-helo-rustrig-v1',
    webm: `${ROOT}/rustworks-1v1.webm`,
    mp4: `${ROOT}/rustworks-1v1.mp4`,
    poster: `${ROOT}/rustworks-1v1.webp`,
    durationSeconds: 8,
    width: 960,
    height: 540,
  }),
  'gun-range': Object.freeze({
    ...
    presentationId: 'menu-video-cat-gun-range-v1',
    webm: `${ROOT}/gun-range.webm`,
    mp4: `${ROOT}/gun-range.mp4`,
    poster: `${ROOT}/gun-range.webp`,
    durationSeconds: 8,
    width: 960,
    height: 540,
  }),
