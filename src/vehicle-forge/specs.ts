...
export const SEDAN_SPEC: VehicleSpec = Object.freeze({
  ...
  archGap: 0.045,
  top: Object.freeze([
    { z: 0.0, yTop: 1.04, halfWidthTop: 0.58, topRadius: 0.16 },
    { z: 0.3, yTop: 1.21, halfWidthTop: 0.81, topRadius: 0.12 },
    { z: 1.2, yTop: 1.22, halfWidthTop: 0.82, topRadius: 0.12, crease: true },
    { z: 1.62, yTop: 1.54, halfWidthTop: 0.78, topRadius: 0.18 },
    { z: 2.12, yTop: 1.80, halfWidthTop: 0.74, topRadius: 0.23 },
    { z: 2.9, yTop: 1.835, halfWidthTop: 0.75, topRadius: 0.23 },
    { z: 3.28, yTop: 1.58, halfWidthTop: 0.79, topRadius: 0.18 },
    { z: 3.52, yTop: 1.235, halfWidthTop: 0.83, topRadius: 0.12, crease: true },
    { z: 4.12, yTop: 1.215, halfWidthTop: 0.81, topRadius: 0.12 },
    { z: 4.4, yTop: 1.06, halfWidthTop: 0.59, topRadius: 0.16 },
  ]),
