...
test('offers only live Pass 64 and stable Pass 63 before the menu loads', async ({ page }) => {
  ...
  await expect(page.locator('[data-release-choice="latest"]')).toContainText('PASS 64');
