-- NUKETOWN2, Pass 85 (owner 2026-09-02, HF-407): the Nuke Town Rebuild joins
-- the canonical arena set. Keep the D1 persistence boundary aligned with the
...
CREATE TABLE match_diagnostics_v5 (
  ...
  arena TEXT NOT NULL CHECK(arena IN ('atomic-acres', 'skyline-terminal', 'rustworks-1v1', 'gun-range', 'farcrysis', 'high-seas', 'test1', 'test2', 'map3', 'nuketown2')),
